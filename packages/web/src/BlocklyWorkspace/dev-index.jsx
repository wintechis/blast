...
const TestEditor = () => {
  const [toolboxConfiguration, setToolboxConfiguration] =
    React.useState < any > ConfigFiles.INITIAL_TOOLBOX_JSON;
  ...
  const onWorkspaceChange = React.useCallback(workspace => {
    ...
    const xmlContainer = document.getElementById('generated-xml');
    if (typeof xmlContainer !== 'undefined') {
      xmlContainer.innerText = newXml;
    }
