...
declare global {
  function ruuvi_handleEvents(
    ownId: Blockly.Block.id,
    blockId: Blockly.Block.id,
  ...
  var accelerationX: unknown;
  // eslint-disable-next-line no-var
  var accelerationY: unknown;
  // eslint-disable-next-line no-var
  var accelerationZ: unknown;
  // eslint-disable-next-line no-var
  var battery: unknown;
  // eslint-disable-next-line no-var
  ...
  var txPower: unknown;
  // eslint-disable-next-line no-var
  var movementCounter: unknown;
  // eslint-disable-next-line no-var
  var measurementSequenceNumber: unknown;
  // eslint-disable-next-line no-var
  var mac: unknown;
}
