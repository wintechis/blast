...
Blocks['state'] = {
  init: function () {
    ...
    this.appendDummyInput().appendField('state').appendField(nameField, 'NAME');
...
Blocks['transition'] = {
  init: function () {
    this.appendDummyInput()
      .appendField('transition to state')
      .appendField(new FieldLabelSerializable(''), 'NAME');
    this.setPreviousStatement(true, null);
    this.setNextStatement(false);
    this.setColour(180);
    this.setTooltip('Transition to a new state.');
    this.setHelpUrl('');
  },
  /**
   * Returns the target state name of this transition.
   * @return {string} State name.
   * @this {Blockly.Block}
   */
  getStateName: function () {
  ...
  onchange: function (event) {
    ...
    if (
      ...
      if (!def) {
         ...
         *   <block type="transition" x="10" y="20">
