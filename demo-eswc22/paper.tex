...
The created block programs can be translated into source code of any predefined programming language.
...
\begin{figure}
\includegraphics[width=.97\textwidth]{screenshot 3.png}%im Ordner sind noch 2 alternative Screenshots
