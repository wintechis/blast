...
return null};Blockly.JavaScript.event_every_minutes=function(a){var b=Blockly.JavaScript.valueToCode(a,"minutes",Blockly.JavaScript.ORDER_NONE),c=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));Blockly.JavaScript.definitions_[a.id]="addIntervalEvent("+b+", "+c+");\n";return null};
var addIntervalEvent=function(a,b){a=setInterval(function(){Blast.Interrupted=!1;var c=new Interpreter("");c.stateStack[0].scope=Blast.Interpreter.globalScope;c.appendCode(b);var d=function(){try{c.step()?setTimeout(d,5):Blast.Interrupted=!1}catch(f){Blast.throwError("Error executing program:\n "+e),console.error(f)}};d()},6E4*a);Blast.States.intervalEvents.push(a)};Blast.apiFunctions.push(["addIntervalEvent",addIntervalEvent]);Blockly.JavaScript.procedures_defeval=function(a){var b=Blockly.JavaScript.variableDB_.getName(a.getFieldValue("NAME"),Blockly.PROCEDURE_CATEGORY_NAME),c="";Blockly.JavaScript.STATEMENT_PREFIX&&(c+=Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_PREFIX,a));Blockly.JavaScript.STATEMENT_SUFFIX&&(c+=Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_SUFFIX,a));c&&(c=Blockly.JavaScript.prefixLines(c,Blockly.JavaScript.INDENT));var d="";Blockly.JavaScript.INFINITE_LOOP_TRAP&&(d=Blockly.JavaScript.prefixLines(Blockly.JavaScript.injectId(Blockly.JavaScript.INFINITE_LOOP_TRAP,
