...
module$contents$Blast$Interpreter_asyncApiFunctions.push(["switchLights",module$contents$Blast$generators$ble_rgb_led_controller_switchLights]);var module$exports$Blast$blocks$joycon={};
...
13);case 13:module$contents$Blast$Ui_addToLog("Adding <code>hidinput</code> event listener","hid",f.productName),h.addEventListener("hidinput",l),h.eventListenerAttached=!0,k.jumpToEnd()}})};module$contents$Blast$Interpreter_apiFunctions.push(["handleJoyConButtons",handleJoyConButtons]);var module$exports$Blast$blocks$blinkstick={};
...
h.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readEddystoneProperty",module$contents$Blast$generators$blast_readEddystoneProperty]);var module$exports$Blast$blocks$streamdeck={};
