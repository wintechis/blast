...
window.addEventListener("load",function(){var a=window.location.hash;if(a){a=a.substring(1);try{module$contents$Blast$Storage_retrieveXML_(a)}catch(b){Blast.throwError("Could not load file."),console.error(b)}}});Blast.Ui={};var module$contents$Blast$Ui_TABS_=["workspace","javascript","xml","deviceLogs"];Blast.Ui.TABS_=module$contents$Blast$Ui_TABS_;
var module$contents$Blast$Ui_selected_="workspace",module$contents$Blast$Ui_playIcon_='<span class="icon material-icons">play_arrow</span>',module$contents$Blast$Ui_stopIcon_='<span class="icon material-icons">stop</span>',module$contents$Blast$Ui_messageCounter_=0,module$contents$Blast$Ui_messageOutputContainer=null,module$contents$Blast$Ui_statusContainer=null,module$contents$Blast$Ui_uriInput=null,module$contents$Blast$Ui_runButton=null,module$contents$Blast$Ui_addElementToOutputContainer=function(a){100<
module$contents$Blast$Ui_messageCounter_&&module$contents$Blast$Ui_messageOutputContainer.firstChild.remove();module$contents$Blast$Ui_messageOutputContainer.appendChild(a,module$contents$Blast$Ui_messageOutputContainer.firstChild);module$contents$Blast$Ui_messageOutputContainer.scrollTop=module$contents$Blast$Ui_messageOutputContainer.scrollHeight},module$contents$Blast$Ui_addMessage=function(a,b){var c="media/logo-512x512.png";window.location.href.includes("mobile")&&(c="../"+c);document.hasFocus()||
navigator.serviceWorker.ready.then(function(g){g.showNotification("Blast",{body:a,icon:c,vibrate:[200,100,200,100,200,100,200]})});var d=document.createElement("div");d.classList.add("message");b&&d.classList.add(b+"-message");d.id="message-"+module$contents$Blast$Ui_messageCounter_++;var f=document.createTextNode(a);d.appendChild(f);f=document.createElement("span");f.classList.add("time");f.innerHTML=(new Date).toLocaleTimeString();d.appendChild(f);f=function(){document.getElementById("debugModal").style.display=
"block";var g=document.getElementById("debug-tbody");g.innerHTML="";var l=document.createElement("tr");l.innerHTML="<td>BLAST</td><td>"+rev+"</td>";g.appendChild(l);for(var k in navigator)if("string"===typeof navigator[k]){l=document.createElement("tr");var m=document.createElement("td"),n=document.createElement("td");m.innerHTML=k;n.innerHTML=navigator[k];l.appendChild(m);l.appendChild(n);g.appendChild(l)}};if("error"===b){b=document.createElement("span");b.classList.add("debug-info");var h=document.createElement("a");
h.innerHTML="show debug info";h.href="#";h.onclick=f;b.appendChild(h);d.appendChild(b)}module$contents$Blast$Ui_addElementToOutputContainer(d)};Blast.Ui.addMessage=module$contents$Blast$Ui_addMessage;
...
var module$contents$Blast$Ui_init=function(){module$contents$Blast$Ui_uriInput=document.getElementById("loadWorkspace-input");module$contents$Blast$Ui_runButton=document.getElementById("runButton");module$contents$Blast$Ui_messageOutputContainer=document.getElementById("msgOutputContainer");module$contents$Blast$Ui_statusContainer=document.getElementById("statusContainer");if(!window.location.href.includes("mobile")){module$contents$Blast$Ui_tabClick_(module$contents$Blast$Ui_selected_);for(var a=
$jscomp.makeIterator(module$contents$Blast$Ui_TABS_),b=a.next();!b.done;b=a.next())b=b.value,Blast.bindClick("tab_"+b,function(c){return function(){module$contents$Blast$Ui_tabClick_(c)}}(b));module$contents$Blast$Ui_setStatus(Blast.status.READY);Blast.bindClick("UriLoadButton",module$contents$Blast$Storage_load);Blast.bindClick("UriSaveButton",module$contents$Blast$Storage_link);Blast.bindClick("saveButton",function(){module$contents$Blast$Storage_link(!0)});Blast.bindClick("clearDeviceLogsButton",
module$contents$Blast$Ui_ClearLog);Blast.bindClick("clearOutputButton",module$contents$Blast$Ui_ClearOutputContainer);module$contents$Blast$Ui_uriInput.addEventListener("keyup",function(c){13===c.keyCode&&module$contents$Blast$Storage_load()})}};Blast.Ui.initUi=module$contents$Blast$Ui_init;Blast.Toolbox={};
...
Blast.init=function(){if(!window.location.href.includes("mobile")){var a=function(){for(var b=$jscomp.makeIterator(module$contents$Blast$Ui_TABS_),c=b.next();!c.done;c=b.next())c=document.getElementById("content_"+c.value),c.style.top="35px",c.style.left="0px",c.style.height=window.innerHeight-35+"px",c.style.width=window.innerWidth-450+"px";Blast.workspace&&Blast.workspace.getToolbox().width&&(document.getElementById("tab_workspace").style.minWidth=Blast.workspace.getToolbox().width-38+"px")};window.addEventListener("resize",
a,!1);Blast.workspace=Blockly.inject("content_workspace",{media:"media/",toolbox:module$contents$Blast$Toolbox_defaultToolbox,zoom:{controls:!0,wheel:!0}});module$contents$Blast$Toolbox_init();a();Blockly.svgResize(Blast.workspace);module$contents$Blast$Ui_init();module$contents$Blast$Ui_setStatus(Blast.status.READY);Blast.generateCode();Blast.workspace.addChangeListener(function(b){b instanceof Blockly.Events.Ui||(Blast.generateCode(),module$contents$Blast$States_generateCode(),module$contents$Blast$Ui_renderContent_())});
module$contents$Blast$Ui_addMessage("Actionblock output will be displayed here","info");window.setTimeout(Blast.importPrettify,1)}};Blast.highlightBlock=function(a){Blast.workspace.highlightBlock(a);Blast.highlightPause=!0};Blast.resetUi=function(a){Blast.workspace.highlightBlock(null);Blast.highlightPause=!1;module$contents$Blast$Ui_setStatus(a)};
...
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(f,h){return module$contents$Blast$States_eventChecker(f,h)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return module$contents$Blast$States_startEventChecker()}));c=function(f){return prompt(f)};a.setProperty(b,"prompt",a.createNativeFunction(c))};Blockly.JavaScript.repeat=Blockly.JavaScript.controls_repeat_ext;Blockly.JavaScript.while_until=Blockly.JavaScript.controls_whileUntil;Blockly.JavaScript["for"]=Blockly.JavaScript.controls_for;Blockly.JavaScript.break_continue=Blockly.JavaScript.controls_flow_statements;Blockly.JavaScript.conditional_statement=Blockly.JavaScript.controls_if;Blockly.JavaScript.wait_seconds=function(a){return"waitForSeconds("+(Blockly.JavaScript.valueToCode(a,"SECONDS",Blockly.JavaScript.ORDER_ATOMIC)||0)+");\n"};
