...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(h){return h instanceof f?h:new f(function(k,m){k(h)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(h){if(null==this.batch_){this.batch_=[];var k=this;this.asyncExecuteFunction(function(){k.executeBatch_()})}this.batch_.push(h)};
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(h){d(h,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var h=this.batch_;this.batch_=[];for(var k=0;k<h.length;++k){var m=h[k];h[k]=null;try{m()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};b.prototype.asyncThrow_=function(h){this.asyncExecuteFunction(function(){throw h;})};var f=function(h){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var k=this.createResolveAndReject_();
try{h(k.resolve,k.reject)}catch(m){k.reject(m)}};f.prototype.createResolveAndReject_=function(){function h(l){return function(n){m||(m=!0,l.call(k,n))}}var k=this,m=!1;return{resolve:h(this.resolveTo_),reject:h(this.reject_)}};f.prototype.resolveTo_=function(h){if(h===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(h instanceof f)this.settleSameAsPromise_(h);else{a:switch(typeof h){case "object":var k=null!=h;break a;case "function":k=!0;break a;default:k=!1}k?this.resolveToNonPromiseObj_(h):
this.fulfill_(h)}};f.prototype.resolveToNonPromiseObj_=function(h){var k=void 0;try{k=h.then}catch(m){this.reject_(m);return}"function"==typeof k?this.settleSameAsThenable_(k,h):this.fulfill_(h)};f.prototype.reject_=function(h){this.settle_(2,h)};f.prototype.fulfill_=function(h){this.settle_(1,h)};f.prototype.settle_=function(h,k){if(0!=this.state_)throw Error("Cannot settle("+h+", "+k+"): Promise already settled in state"+this.state_);this.state_=h;this.result_=k;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};f.prototype.scheduleUnhandledRejectionCheck_=function(){var h=this;d(function(){if(h.notifyUnhandledRejection_()){var k=$jscomp.global.console;"undefined"!==typeof k&&k.error(h.result_)}},1)};f.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var h=$jscomp.global.CustomEvent,k=$jscomp.global.Event,m=$jscomp.global.dispatchEvent;if("undefined"===typeof m)return!0;"function"===typeof h?h=new h("unhandledrejection",{cancelable:!0}):
"function"===typeof k?h=new k("unhandledrejection",{cancelable:!0}):(h=$jscomp.global.document.createEvent("CustomEvent"),h.initCustomEvent("unhandledrejection",!1,!0,h));h.promise=this;h.reason=this.result_;return m(h)};f.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var h=0;h<this.onSettledCallbacks_.length;++h)g.asyncExecute(this.onSettledCallbacks_[h]);this.onSettledCallbacks_=null}};var g=new b;f.prototype.settleSameAsPromise_=function(h){var k=this.createResolveAndReject_();
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var m=this.createResolveAndReject_();try{h.call(k,m.resolve,m.reject)}catch(l){m.reject(l)}};f.prototype.then=function(h,k){function m(q,r){return"function"==typeof q?function(t){try{l(q(t))}catch(v){n(v)}}:r}var l,n,p=new f(function(q,r){l=q;n=r});this.callWhenSettled_(m(h,l),m(k,n));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function m(){switch(l.state_){case 1:h(l.result_);
break;case 2:k(l.result_);break;default:throw Error("Unexpected state: "+l.state_);}}var l=this;null==this.onSettledCallbacks_?g.asyncExecute(m):this.onSettledCallbacks_.push(m);this.isRejectionHandled_=!0};f.resolve=c;f.reject=function(h){return new f(function(k,m){m(h)})};f.race=function(h){return new f(function(k,m){for(var l=$jscomp.makeIterator(h),n=l.next();!n.done;n=l.next())c(n.value).callWhenSettled_(k,m)})};f.all=function(h){var k=$jscomp.makeIterator(h),m=k.next();return m.done?c([]):new f(function(l,
n){function p(t){return function(v){q[t]=v;r--;0==r&&l(q)}}var q=[],r=0;do q.push(void 0),r++,c(m.value).callWhenSettled_(p(q.length-1),n),m=k.next();while(!m.done)})};return f},"es6","es3");$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,f=0;f<d;f++){var g=a[f];if(b.call(c,g,f,a))return{i:f,v:g}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,f){return c==a&&"q"==d&&f==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var l=Object.seal({}),n=Object.seal({}),p=new a([[l,2],[n,3]]);if(2!=p.get(l)||3!=p.get(n))return!1;p.delete(l);p.set(n,4);return!p.has(l)&&4==p.get(n)}catch(q){return!1}}function c(){}function d(l){var n=typeof l;return"object"===n&&null!==l||"function"===n}function f(l){if(!$jscomp.owns(l,h)){var n=new c;$jscomp.defineProperty(l,h,{value:n})}}function g(l){if(!$jscomp.ISOLATE_POLYFILLS){var n=Object[l];n&&(Object[l]=
function(p){if(p instanceof c)return p;Object.isExtensible(p)&&f(p);return n(p)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var k=0,m=function(l){this.id_=(k+=Math.random()+1).toString();if(l){l=$jscomp.makeIterator(l);for(var n;!(n=l.next()).done;)n=n.value,this.set(n[0],n[1])}};m.prototype.set=function(l,n){if(!d(l))throw Error("Invalid WeakMap key");
f(l);if(!$jscomp.owns(l,h))throw Error("WeakMap key fail: "+l);l[h][this.id_]=n;return this};m.prototype.get=function(l){return d(l)&&$jscomp.owns(l,h)?l[h][this.id_]:void 0};m.prototype.has=function(l){return d(l)&&$jscomp.owns(l,h)&&$jscomp.owns(l[h],this.id_)};m.prototype.delete=function(l){return d(l)&&$jscomp.owns(l,h)&&$jscomp.owns(l[h],this.id_)?delete l[h][this.id_]:!1};return m},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var m=Object.seal({x:4}),l=new a($jscomp.makeIterator([[m,"s"]]));if("s"!=l.get(m)||1!=l.size||l.get({x:4})||l.set({x:4},"t")!=l||2!=l.size)return!1;var n=l.entries(),p=n.next();if(p.done||p.value[0]!=m||"s"!=p.value[1])return!1;p=n.next();return p.done||4!=p.value[0].x||"t"!=p.value[1]||!n.next().done?!1:!0}catch(q){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,d=function(m){this.data_={};this.head_=h();this.size=0;if(m){m=$jscomp.makeIterator(m);for(var l;!(l=m.next()).done;)l=l.value,this.set(l[0],l[1])}};d.prototype.set=function(m,l){m=0===m?0:m;var n=f(this,m);n.list||(n.list=this.data_[n.id]=[]);n.entry?n.entry.value=l:(n.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:m,value:l},n.list.push(n.entry),
this.head_.previous.next=n.entry,this.head_.previous=n.entry,this.size++);return this};d.prototype.delete=function(m){m=f(this,m);return m.entry&&m.list?(m.list.splice(m.index,1),m.list.length||delete this.data_[m.id],m.entry.previous.next=m.entry.next,m.entry.next.previous=m.entry.previous,m.entry.head=null,this.size--,!0):!1};d.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=h();this.size=0};d.prototype.has=function(m){return!!f(this,m).entry};d.prototype.get=function(m){return(m=
f(this,m).entry)&&m.value};d.prototype.entries=function(){return g(this,function(m){return[m.key,m.value]})};d.prototype.keys=function(){return g(this,function(m){return m.key})};d.prototype.values=function(){return g(this,function(m){return m.value})};d.prototype.forEach=function(m,l){for(var n=this.entries(),p;!(p=n.next()).done;)p=p.value,m.call(l,p[1],p[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var f=function(m,l){var n=l&&typeof l;"object"==n||"function"==n?c.has(l)?n=c.get(l):
(n=""+ ++k,c.set(l,n)):n="p_"+l;var p=m.data_[n];if(p&&$jscomp.owns(m.data_,n))for(m=0;m<p.length;m++){var q=p[m];if(l!==l&&q.key!==q.key||l===q.key)return{id:n,list:p,index:m,entry:q}}return{id:n,list:p,index:-1,entry:void 0}},g=function(m,l){var n=m.head_;return $jscomp.iteratorPrototype(function(){if(n){for(;n.head!=m.head_;)n=n.previous;for(;n.next!=n.head;)return n=n.next,{done:!1,value:l(n)};n=null}return{done:!0,value:void 0}})},h=function(){var m={};return m.previous=m.next=m.head=m},k=0;
...
$jscomp.polyfill("Array.prototype.findIndex",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).i}},"es6","es3");$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(b,c){var d=$jscomp.checkStringArgs(this,b,"startsWith");b+="";var f=d.length,g=b.length;c=Math.max(0,Math.min(c|0,d.length));for(var h=0;h<g&&c<f;)if(d[c++]!=b[h++])return!1;return h>=g}},"es6","es3");
...
Blast.Interpreter.addCleanUpFunction=module$contents$Blast$Interpreter_addCleanUpFunction;var module$contents$Blast$Interpreter_statesInterpreterRunning=!1,module$contents$Blast$Interpreter_setStatesInterpreterRunning=function(a){module$contents$Blast$Interpreter_statesInterpreterRunning=a};Blast.Interpreter.setStatesInterpreterRunning=module$contents$Blast$Interpreter_setStatesInterpreterRunning;
var module$contents$Blast$Interpreter_stdOut=prompt,module$contents$Blast$Interpreter_setStdOut=function(a){module$contents$Blast$Interpreter_stdOut=a};Blast.Interpreter.setStdOut=module$contents$Blast$Interpreter_setStdOut;var module$contents$Blast$Interpreter_getStdOut=function(){return module$contents$Blast$Interpreter_stdOut};Blast.Interpreter.getStdOut=module$contents$Blast$Interpreter_getStdOut;
var module$contents$Blast$Interpreter_stdInfo=prompt,module$contents$Blast$Interpreter_setStdInfo=function(a){module$contents$Blast$Interpreter_stdInfo=a};Blast.Interpreter.setStdInfo=module$contents$Blast$Interpreter_setStdInfo;var module$contents$Blast$Interpreter_getStdInfo=function(){return module$contents$Blast$Interpreter_stdInfo};Blast.Interpreter.getStdInfo=module$contents$Blast$Interpreter_getStdInfo;
var module$contents$Blast$Interpreter_stdErr=prompt,module$contents$Blast$Interpreter_setStdError=function(a){module$contents$Blast$Interpreter_stdErr=a};Blast.Interpreter.setStdError=module$contents$Blast$Interpreter_setStdError;var module$contents$Blast$Interpreter_getStdError=function(){return module$contents$Blast$Interpreter_stdErr};Blast.Interpreter.getStdError=module$contents$Blast$Interpreter_getStdError;
var module$contents$Blast$Interpreter_clipboard={},module$contents$Blast$Interpreter_removeDeviceHandlers=function(){for(var a=$jscomp.makeIterator(module$contents$Blast$Interpreter_deviceEventHandlers),b=a.next();!b.done;b=a.next())b=b.value,b.device.removeEventListener(b.type,b.fn);module$contents$Blast$Interpreter_deviceEventHandlers=[]},module$contents$Blast$Interpreter_clearIntervalEvents=function(){for(var a=$jscomp.makeIterator(module$contents$Blast$Interpreter_intervalEvents),b=a.next();!b.done;b=
a.next())clearInterval(b.value);module$contents$Blast$Interpreter_intervalEvents.length=0},module$contents$Blast$Interpreter_resetInterpreter=function(){module$contents$Blast$Interpreter_interpreter=null;module$contents$Blast$Interpreter_runner_&&(clearTimeout(module$contents$Blast$Interpreter_runner_),module$contents$Blast$Interpreter_runner_=null);module$contents$Blast$Interpreter_removeDeviceHandlers();module$contents$Blast$Interpreter_clearIntervalEvents();for(var a=$jscomp.makeIterator(module$contents$Blast$Interpreter_cleanUpFunctions),
b=a.next();!b.done;b=a.next())b=b.value,b()};Blast.Interpreter.resetInterpreter=module$contents$Blast$Interpreter_resetInterpreter;var module$contents$Blast$Interpreter_stopJS=function(){module$contents$Blast$Interpreter_resetInterpreter();module$contents$Blast$Interpreter_setStatus(module$contents$Blast$Interpreter_statusValues.STOPPED)};Blast.Interpreter.stopJS=module$contents$Blast$Interpreter_stopJS;
...
var module$contents$Blast$Interpreter_disableWorkspace=function(){var a=document.getElementById("content_workspace"),b=document.createElement("div");b.id="workspace-disabled";b.style.position="absolute";b.style.top="0";b.style.left="0";b.style.width="100%";b.style.height="100%";b.style.zIndex="1";b.style.backgroundColor="rgba(0, 0, 0, 0.1)";a.appendChild(b);Blockly.selected=null;module$contents$Blast$Interpreter_clipboard.clipboard_=Blockly.clipboard_;module$contents$Blast$Interpreter_clipboard.clipboardSource_=
Blockly.clipboardSource_;module$contents$Blast$Interpreter_clipboard.clipboardXml=Blockly.clipboardXml;module$contents$Blast$Interpreter_clipboard.clipboardTypeCounts_=Blockly.clipboardTypeCounts_;Blockly.clipboard_=null;Blockly.clipboardSource_=null;Blockly.clipboardXml=null;Blockly.clipboardTypeCounts_=null},module$contents$Blast$Interpreter_enableWorkspace=function(){var a=document.getElementById("content_workspace"),b=document.getElementById("workspace-disabled");a.removeChild(b);Blockly.clipboard_=
...
var module$contents$Blast$States$Interpreter_generateCode=function(){for(var a="while (true) {\n \n}",b=module$contents$Blast$States$Interpreter_workspace.getBlocksByType("event",!1).map(function(g){return g.id}),c=$jscomp.makeIterator(module$contents$Blast$States$Interpreter_eventCode),d=c.next();!d.done;d=c.next()){var f=$jscomp.makeIterator(d.value);d=f.next().value;f=f.next().value;b.includes(d)&&(a=a.slice(0,-2)+f+"\n"+a.slice(-1))}module$contents$Blast$States$Interpreter_latestCode=Blockly.JavaScript.finish(a)};
...
var module$contents$Blast$States$Interpreter_init=function(a){module$contents$Blast$States$Interpreter_workspace=a;module$contents$Blast$States$Interpreter_workspace.addChangeListener(function(b){b instanceof Blockly.Events.Ui||module$contents$Blast$States$Interpreter_generateCode()})};Blast.States.Interpreter.initStatesInterpreter=module$contents$Blast$States$Interpreter_init;Blast.Things={};var module$contents$Blast$Things_webBluetoothDevices=new Map,module$contents$Blast$Things_webHidNames=new Map,module$contents$Blast$Things_webHidDevices=new Map,module$contents$Blast$Things_webBluetoothButtonHandler=null,module$contents$Blast$Things_setWebBluetoothButtonHandler=function(a){module$contents$Blast$Things_webBluetoothButtonHandler=a};Blast.Things.setWebBluetoothButtonHandler=module$contents$Blast$Things_setWebBluetoothButtonHandler;
var module$contents$Blast$Things_thingsLog=function(a,b,c){console.log({adapter:b},{device:c},a)},module$contents$Blast$Things_getThingsLog=function(){return module$contents$Blast$Things_thingsLog};Blast.Things.getThingsLog=module$contents$Blast$Things_getThingsLog;var module$contents$Blast$Things_setThingsLog=function(a){module$contents$Blast$Things_thingsLog=a};Blast.Things.setThingsLog=module$contents$Blast$Things_setThingsLog;
var module$contents$Blast$Things_resetThings=function(){module$contents$Blast$Things_webBluetoothDevices.clear();module$contents$Blast$Things_webHidNames.clear();module$contents$Blast$Things_webHidDevices.clear()};Blast.Things.resetThings=module$contents$Blast$Things_resetThings;var module$contents$Blast$Things_getWebHidDevice=function(a){return module$contents$Blast$Things_webHidDevices.get(a)};Blast.Things.getWebHidDevice=module$contents$Blast$Things_getWebHidDevice;
var module$contents$Blast$Things_flyoutCategory=function(a){var b=[],c=document.createElement("label");c.setAttribute("text","WebBluetooth Blocks");b.push(c);c=document.createElement("button");c.setAttribute("text","pair via webBluetooth");c.setAttribute("callbackKey","CREATE_WEBBLUETOOTH");a.registerButtonCallback("CREATE_WEBBLUETOOTH",function(g){module$contents$Blast$Things_webBluetoothButtonHandler()});b.push(c);c=module$contents$Blast$Things_flyoutCategoryBlocksWB(a);b=b.concat(c);c=document.createElement("label");
c.setAttribute("text","WebHID Blocks");b.push(c);c=document.createElement("button");c.setAttribute("text","connect via webHID");c.setAttribute("callbackKey","CREATE_WEBHID");a.registerButtonCallback("CREATE_WEBHID",function(g){createWebHidButtonHandler()});b.push(c);a=module$contents$Blast$Things_flyoutCategoryBlocksWHid(a);b=b.concat(a);a=document.createElement("label");a.setAttribute("text","additional identifiers");b.push(a);a=Blockly.utils.xml.createElement("block");a.setAttribute("type","uri");
...
var module$contents$Blast$Things_addWebBluetoothDevice=function(a,b){var c=function(d,f){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(g){if(g)if(module$contents$Blast$Things_webBluetoothDevices.has(g)){var h="Name %1 already exists".replace("%1",g);Blockly.alert(h,function(){c(g,f)})}else module$contents$Blast$Things_webBluetoothDevices.set(g,f);else Blockly.alert("Name cannot be empty",function(){c(g,f)})})};c(b,a)};Blast.Things.addWebBluetoothDevice=module$contents$Blast$Things_addWebBluetoothDevice;
createWebHidButtonHandler=function(){var a=module$contents$Blast$Interpreter_getWorkspace();module$contents$Blast$Things_thingsLog("Requesting webHID device...","HID");navigator.hid.requestDevice({filters:[]}).then(function(b){if(0===b.length)module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");else{var c=Date.now().toString(36)+Math.random().toString(36).substring(2);module$contents$Blast$Things_addWebHidDevice(c,b[0].productName,b[0]);a.refreshToolboxSelection();
module$contents$Blast$Things_thingsLog("Connected","HID",b[0].productName)}}).catch(function(b){module$contents$Blast$Interpreter_throwError(b)})};
var module$contents$Blast$Things_addWebHidDevice=function(a,b,c){var d=function(f,g){Blockly.Variables.promptName("Connection established! Now give your device a name.",f,function(h){if(h)if(module$contents$Blast$Things_webHidNames.has(h)){var k="Name %1 already exists".replace("%1",h);Blockly.alert(k,function(){d(h,g)})}else module$contents$Blast$Things_webHidDevices.set(g,c),module$contents$Blast$Things_webHidNames.set(h,g);else Blockly.alert("Name cannot be empty",function(){d(h,g)})})};d(b,a)};
Blast.Things.addWebHidDevice=module$contents$Blast$Things_addWebHidDevice;Blast.Ui={};var module$contents$Blast$Ui_TABS_=["workspace","javascript","xml","deviceLogs"];Blast.Ui.TABS_=module$contents$Blast$Ui_TABS_;
...
f.classList.add("time");f.innerHTML=(new Date).toLocaleTimeString();d.appendChild(f);f=function(){document.getElementById("debugModal").style.display="block";var h=document.getElementById("debug-tbody");h.innerHTML="";var k=document.createElement("tr");k.innerHTML="<td>BLAST</td><td>"+rev+"</td>";h.appendChild(k);for(var m in navigator)if("string"===typeof navigator[m]){k=document.createElement("tr");var l=document.createElement("td"),n=document.createElement("td");l.innerHTML=m;n.innerHTML=navigator[m];
k.appendChild(l);k.appendChild(n);h.appendChild(k)}};if("error"===b){b=document.createElement("span");b.classList.add("debug-info");var g=document.createElement("a");g.innerHTML="show debug info";g.href="#";g.onclick=f;b.appendChild(g);d.appendChild(b)}module$contents$Blast$Ui_addElementToOutputContainer(d)};module$contents$Blast$Interpreter_setStdError(function(a){return module$contents$Blast$Ui_addMessage(a,"error")});
...
module$contents$Blast$Ui_ClearLog);module$contents$Blast$Ui_bindClick("clearOutputButton",module$contents$Blast$Ui_ClearOutputContainer);window.setTimeout(module$contents$Blast$Ui_importPrettify,1);module$contents$Blast$Ui_setStatus(module$contents$Blast$Interpreter_statusValues.READY)}};Blast.Ui.initUi=module$contents$Blast$Ui_init;Blast.Bluetooth={};var module$contents$Blast$Bluetooth_optionalServices=[];Blast.Bluetooth.optionalServices=module$contents$Blast$Bluetooth_optionalServices;var module$contents$Blast$Bluetooth_scanBlocks=[];Blast.Bluetooth.scanBlocks=module$contents$Blast$Bluetooth_scanBlocks;var module$contents$Blast$Bluetooth_LEScanResults={};Blast.Bluetooth.LEScanResults=module$contents$Blast$Bluetooth_LEScanResults;
var module$contents$Blast$Bluetooth_isLEScanRunning=!1,module$contents$Blast$Bluetooth_eventListeners=[],module$contents$Blast$Bluetooth_charEventListeners={},module$contents$Blast$Bluetooth_hexStringToArrayBuffer=function(a){a=a.replace(/^0x/,"");0!=a.length%2&&(a="0"+a);var b=a.match(/[G-Z\s]/i);b&&console.log("WARNING: found non-hex characters",b);a=a.match(/[\dA-F]{2}/gi).map(function(c){return parseInt(c,16)});return(new Uint8Array(a)).buffer},module$contents$Blast$Bluetooth_requestDevice=function(a,
b){var c,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){c=module$contents$Blast$Things_getThingsLog();c("Requesting device...","Bluetooth");if(!navigator.bluetooth)return h.jumpTo(0);a||(a={acceptAllDevices:!0,optionalServices:module$contents$Blast$Bluetooth_optionalServices});h.setCatchFinallyBlocks(3);return h.yield(navigator.bluetooth.requestDevice(a),5)}if(3!=h.nextAddress)return d=h.yieldResult,c("Device paired","Bluetooth",d.id),f=b||d.name,module$contents$Blast$Things_addWebBluetoothDevice(d.id,
f),module$contents$Blast$Interpreter_getWorkspace().refreshToolboxSelection(),h.return(d);g=h.enterCatchBlock();module$contents$Blast$Interpreter_throwError(g);h.jumpToEnd()})};Blast.Bluetooth.requestDevice=module$contents$Blast$Bluetooth_requestDevice;module$contents$Blast$Things_setWebBluetoothButtonHandler(module$contents$Blast$Bluetooth_requestDevice);
var module$contents$Blast$Bluetooth_getDeviceById=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(navigator.bluetooth.getDevices(),2);b=g.yieldResult;c=$jscomp.makeIterator(b);for(d=c.next();!d.done;d=c.next())if(f=d.value,f.id==a)return g.return(f);module$contents$Blast$Interpreter_throwError("Bluetooth device "+a+" wasn't found in paired devices.");g.jumpToEnd()})},module$contents$Blast$Bluetooth_connect=function(a){var b,
c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.setCatchFinallyBlocks(2),g.yield(module$contents$Blast$Bluetooth_getDeviceById(a),4);case 4:return b=g.yieldResult,c=module$contents$Blast$Things_getThingsLog(),c("Connecting to <code>"+a+"</code>","Bluetooth"),g.yield(b.gatt.connect(),5);case 5:return d=g.yieldResult,c("Connected","Bluetooth",a),g.return(d);case 2:f=g.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Error connecting to Bluetooth device "+
a),console.error(f),g.jumpToEnd()}})},module$contents$Blast$Bluetooth_disconnect=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.setCatchFinallyBlocks(2),g.yield(module$contents$Blast$Bluetooth_getDeviceById(a),4);case 4:return b=g.yieldResult,c=module$contents$Blast$Things_getThingsLog(),c("Disconnecting...","Bluetooth",a),g.yield(b.gatt.disconnect(),5);case 5:return d=g.yieldResult,c("Disconnected from <code>"+a+"</code>",
"Bluetooth"),g.return(d);case 2:f=g.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Error disconnecting from Bluetooth device "+a),console.error(f),g.jumpToEnd()}})},module$contents$Blast$Bluetooth_writeWithoutResponse=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:f=k.yieldResult;if(!f)return k.return();"string"===typeof d&&(d=
module$contents$Blast$Bluetooth_hexStringToArrayBuffer(d));k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Invoke <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);return k.yield(f.writeValueWithoutResponse(d),5);case 5:g("Finished <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);break;
case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),k.jumpToEnd()}})};Blast.Bluetooth.writeWithoutResponse=module$contents$Blast$Bluetooth_writeWithoutResponse;
var module$contents$Blast$Bluetooth_writeWithResponse=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:f=k.yieldResult;if(!f)return k.return();"string"===typeof d&&(d=module$contents$Blast$Bluetooth_hexStringToArrayBuffer(d));k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Invoke <code>WriteValueWithResponse</code> on characteristic <code>"+
(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);return k.yield(f.writeValueWithResponse(d),5);case 5:g("Finished <code>WriteValueWithResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),k.jumpToEnd()}})};
Blast.Bluetooth.writeWithResponse=module$contents$Blast$Bluetooth_writeWithResponse;
var module$contents$Blast$Bluetooth_getPrimaryService=function(a,b){var c,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(module$contents$Blast$Bluetooth_connect(a),2);case 2:return c=h.yieldResult,h.setCatchFinallyBlocks(3),f=module$contents$Blast$Things_getThingsLog(),f("Getting primary service <code>"+b+"</code>","Bluetooth",a),h.yield(c.getPrimaryService(b),5);case 5:d=h.yieldResult;f("Got primary service <code>"+b+"</code>","Bluetooth",
a);h.leaveTryBlock(4);break;case 3:g=h.enterCatchBlock(),console.error(g),module$contents$Blast$Interpreter_throwError("The device is not compatible with the connected block.");case 4:return h.return(d)}})};Blast.Bluetooth.getPrimaryService=module$contents$Blast$Bluetooth_getPrimaryService;
var module$contents$Blast$Bluetooth_getCharacteristic=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getPrimaryService(a,b),2);case 2:d=k.yieldResult;if(!d)return k.return();k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Getting characteristic <code>"+c+"</code> from service <code>"+b+"</code>","Bluetooth",a);return k.yield(d.getCharacteristic(c),5);
case 5:f=k.yieldResult;g("Got characteristic <code>"+c+"</code> from service <code>"+b+"</code>","Bluetooth",a);k.leaveTryBlock(4);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("The device is not compatible with the connected block.");case 4:return k.return(f)}})};Blast.Bluetooth.getCharacteristic=module$contents$Blast$Bluetooth_getCharacteristic;
var module$contents$Blast$Bluetooth_read=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:return d=k.yieldResult,k.setCatchFinallyBlocks(3),f=module$contents$Blast$Things_getThingsLog(),f("Invoke <code>ReadValue</code> on characteristic <code>"+c+"</code> from service <code>"+(b+"</code>"),"Bluetooth",a),k.yield(d.readValue(),5);case 5:return g=k.yieldResult,
f("Finished <code>ReadValue</code> on characteristic <code>"+c+"</code> from service <code>"+(b+"</code> - value: <code>"+g.toString()+"</code>"),"Bluetooth",a),k.return(g);case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error reading from Bluetooth device "+a),k.jumpToEnd()}})};Blast.Bluetooth.read=module$contents$Blast$Bluetooth_read;
var module$contents$Blast$Bluetooth_readText=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(module$contents$Blast$Bluetooth_read(a,b,c),2);d=g.yieldResult;f=(new TextDecoder).decode(d);return g.return(f)})};Blast.Bluetooth.readText=module$contents$Blast$Bluetooth_readText;
var module$contents$Blast$Bluetooth_readNumber=function(a,b,c){var d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return m.yield(module$contents$Blast$Bluetooth_read(a,b,c),2);d=m.yieldResult;d instanceof DataView||(d=new DataView(value));f=new Uint8Array(d.buffer);g=f.length;h=buffer.Buffer.from(f);k=h.readUIntBE(0,g);return m.return(k)})};Blast.Bluetooth.readNumber=module$contents$Blast$Bluetooth_readNumber;
var module$contents$Blast$Bluetooth_readHex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(module$contents$Blast$Bluetooth_read(a,b,c),2);d=g.yieldResult;f=(new Uint8Array(d.buffer)).reduce(function(h,k){return h+("0"+k.toString(16)).slice(-2)},"");return g.return(f)})};Blast.Bluetooth.readHex=module$contents$Blast$Bluetooth_readHex;
var module$contents$Blast$Bluetooth_subscribe=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:return f=k.yieldResult,g=module$contents$Blast$Things_getThingsLog(),g("Add 'characteristicvaluechanged' listener to characteristic "+c+(" of service <code>"+b+"</code>"),"Bluetooth",a),f.addEventListener("characteristicvaluechanged",d),module$contents$Blast$Bluetooth_charEventListeners[c]=
[f,"characteristicvaluechanged",d],k.setCatchFinallyBlocks(3),g("Invoke <code>startNotifications</code> on characteristic "+c+(" from service <code>"+b+"</code>"),"Bluetooth",a),k.yield(f.startNotifications(),5);case 5:g("Finished <code>startNotifications</code> on characteristic "+c+(" from service <code>"+b+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error subscribing to Bluetooth device "+a),k.jumpToEnd()}})};
Blast.Bluetooth.subscribe=module$contents$Blast$Bluetooth_subscribe;
var module$contents$Blast$Bluetooth_startLEScan=function(){var a;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){if(module$contents$Blast$Bluetooth_isLEScanRunning)return b.return();module$contents$Blast$Bluetooth_cacheLEScanResults();module$contents$Blast$Bluetooth_isLEScanRunning=!0;a=module$contents$Blast$Things_getThingsLog();a("Requesting LE Scan","Bluetooth");Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,
keepRepeatedDevices:!0}));setTimeout(module$contents$Blast$Bluetooth_stopLEScan,3E4);b.jumpToEnd()})};Blast.Bluetooth.startLEScan=module$contents$Blast$Bluetooth_startLEScan;var module$contents$Blast$Bluetooth_stopLEScan=function(){module$contents$Blast$Bluetooth_isLEScanRunning&&(module$contents$Blast$Things_getThingsLog()("Stopping LE Scan","Bluetooth"),navigator.bluetooth.stopLEScan(),module$contents$Blast$Bluetooth_isLEScanRunning=!1)};Blast.Bluetooth.stopLEScan=module$contents$Blast$Bluetooth_stopLEScan;
var module$contents$Blast$Bluetooth_cacheLEScanResults=function(){module$contents$Blast$Bluetooth_addEventListener("advertisementreceived",function(a){var b=a.device.id;module$contents$Blast$Bluetooth_LEScanResults[b]||(module$contents$Blast$Bluetooth_LEScanResults[b]=[]);module$contents$Blast$Bluetooth_LEScanResults[b].unshift(a)})},module$contents$Blast$Bluetooth_addEventListener=function(a,b){module$contents$Blast$Bluetooth_eventListeners.push([a,b]);navigator.bluetooth.addEventListener(a,b)},
module$contents$Blast$Bluetooth_removeEventListener=function(a,b){var c=module$contents$Blast$Bluetooth_eventListeners.findIndex(function(d){return d[0]===a&&d[1]===b});-1!==c&&module$contents$Blast$Bluetooth_eventListeners.splice(c,1);navigator.bluetooth.removeEventListener(a,b)},module$contents$Blast$Bluetooth_tearDown=function(){module$contents$Blast$Bluetooth_isLEScanRunning&&(module$contents$Blast$Bluetooth_isLEScanRunning=!1);if(module$contents$Blast$Bluetooth_eventListeners){for(var a=$jscomp.makeIterator(module$contents$Blast$Bluetooth_eventListeners),
b=a.next();!b.done;b=a.next())b=b.value,module$contents$Blast$Bluetooth_removeEventListener(b[0],b[1]);module$contents$Blast$Bluetooth_eventListeners.length=0}if(module$contents$Blast$Bluetooth_charEventListeners){a=$jscomp.makeIterator(Object.keys(module$contents$Blast$Bluetooth_charEventListeners));for(b=a.next();!b.done;b=a.next()){var c=module$contents$Blast$Bluetooth_charEventListeners[b.value];b=c[0];var d=c[1];c=c[2];b.stopNotifications();b.removeEventListener(d,c)}module$contents$Blast$Bluetooth_charEventListeners=
{}}module$contents$Blast$Bluetooth_LEScanResults={}};module$contents$Blast$Interpreter_addCleanUpFunction(module$contents$Blast$Bluetooth_tearDown);Blast.Storage={};
...
var module$contents$Blast$Storage_resetFileInput=function(){var a=document.getElementById("file-selector");a&&(a.value="");module$contents$Blast$Storage_filename="BLAST.xml"},module$contents$Blast$Storage_retrieveXML_=function(a){return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){Blockly.hideChaff();module$contents$Blast$Interpreter_resetInterpreter();module$contents$Blast$Things_resetThings();module$contents$Blast$Storage_resetFileInput();fetch(a).then(function(c){if(c.ok)return c.text();
module$contents$Blast$Interpreter_throwError(module$contents$Blast$Storage_NOT_FOUND_ERROR.replace("%1",a))}).then(module$contents$Blast$Storage_loadXML);b.jumpToEnd()})},module$contents$Blast$Storage_loadXML=function(a){var b=module$contents$Blast$Interpreter_getWorkspace();b.clear();try{var c=Blockly.Xml.textToDom(a)}catch(d){module$contents$Blast$Interpreter_throwError(module$contents$Blast$Storage_XML_ERROR+"\nXML: "+c);return}c.querySelector('block[type="things_webBluetooth"]')||c.querySelector('block[type="things_webHID"]')?
(module$contents$Blast$Storage_generatePairButtons(c),document.getElementById("rcModal")&&(document.getElementById("rcModal").style.display="block")):(Blockly.Xml.domToWorkspace(c,b),module$contents$Blast$Storage_monitorChanges_(b))},module$contents$Blast$Storage_generatePairButtons=function(a){window.location.href.includes("mobile")?(window.app.openReconnectDialog(),module$contents$Blast$Storage_generatePairButtonsMobile_(a)):module$contents$Blast$Storage_generatePairButtonsDesktop_(a)},module$contents$Blast$Storage_generatePairButtonsDesktop_=
function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$75:f.$jscomp$loop$prop$type$75,$jscomp$loop$prop$name$76:f.$jscomp$loop$prop$name$76,$jscomp$loop$prop$block$77:f.$jscomp$loop$prop$block$77},g=b.next()){f.$jscomp$loop$prop$block$77=g.value;f.$jscomp$loop$prop$type$75=f.$jscomp$loop$prop$block$77.getAttribute("type");if("things_webBluetooth"==
f.$jscomp$loop$prop$type$75||"things_webHID"==f.$jscomp$loop$prop$type$75){f.$jscomp$loop$prop$name$76=f.$jscomp$loop$prop$block$77.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$76))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$76));var k=document.createElement("td"),m=document.createElement("input");m.setAttribute("type","button");m.setAttribute("id","pairButton-"+f.$jscomp$loop$prop$name$76);
m.setAttribute("value","Pair");var l=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$76);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";l.appendChild(n);m.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=p.$jscomp$loop$prop$type$75?
("things_webHID"==p.$jscomp$loop$prop$type$75&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(v){0===v.length&&module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");var w=Date.now().toString(36)+Math.random().toString(36).substr(2);module$contents$Blast$Things_addWebHidDevice(w,p.$jscomp$loop$prop$name$76,v[0]);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$76).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$76).style.color=
"green";p.$jscomp$loop$prop$block$77.firstElementChild.textContent=w;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}))}).catch(function(v){module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");console.error(v)})),t.jumpTo(0)):t.yield(module$contents$Blast$Bluetooth_requestDevice(),
3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$76).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$76).style.color="green";p.$jscomp$loop$prop$block$77.firstElementChild.textContent=r.id;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}));t.jumpToEnd()})}}(f));
k.appendChild(m);g.appendChild(h);g.appendChild(k);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$76)}document.getElementById("rc-cancel").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectCancelHandler_()})}},module$contents$Blast$Storage_generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f=
{$jscomp$loop$prop$type$79:f.$jscomp$loop$prop$type$79,$jscomp$loop$prop$name$80:f.$jscomp$loop$prop$name$80,$jscomp$loop$prop$block$81:f.$jscomp$loop$prop$block$81},g=b.next())if(f.$jscomp$loop$prop$block$81=g.value,f.$jscomp$loop$prop$type$79=f.$jscomp$loop$prop$block$81.getAttribute("type"),"things_webBluetooth"==f.$jscomp$loop$prop$type$79||"things_webHID"==f.$jscomp$loop$prop$type$79)if(f.$jscomp$loop$prop$name$80=f.$jscomp$loop$prop$block$81.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$80)){g=
document.createElement("li");g.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$80);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$80);h.setAttribute("class","mdc-list-item__graphic material-icons");h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$79?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");
var k=document.createElement("span");k.setAttribute("class","mdc-list-item__primary-text");k.innerHTML=f.$jscomp$loop$prop$name$80;h.appendChild(k);k=document.createElement("span");k.setAttribute("class","mdc-list-item__secondary-text");k.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$80);k.innerHTML="disconnected";h.appendChild(k);g.appendChild(h);g.addEventListener("click",function(m){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=
m.$jscomp$loop$prop$type$79?("things_webHID"==m.$jscomp$loop$prop$type$79&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);module$contents$Blast$Things_addWebHidDevice(r,m.$jscomp$loop$prop$name$80,q[0]);document.getElementById("rc-status-"+m.$jscomp$loop$prop$name$80).innerHTML="connected";document.getElementById("rc-icon-"+
m.$jscomp$loop$prop$name$80).innerHTML="usb";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).style.color="#0d30b1";m.$jscomp$loop$prop$block$81.firstElementChild.textContent=r;module$contents$Blast$Storage_allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}))}).catch(function(q){module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");
console.error(q)})),p.jumpTo(0)):p.yield(module$contents$Blast$Bluetooth_requestDevice(),3);n=p.yieldResult;module$contents$Blast$Things_addWebBluetoothDevice(n.id,m.$jscomp$loop$prop$name$80);document.getElementById("rc-status-"+m.$jscomp$loop$prop$name$80).innerHTML="connected";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).innerHTML="bluetooth";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).style.color="#0d30b1";m.$jscomp$loop$prop$block$81.firstElementChild.textContent=
n.id;module$contents$Blast$Storage_allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$80)}window.app.initLists()},module$contents$Blast$Storage_allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=
a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0},module$contents$Blast$Storage_allConnectedMobile_=function(){var a=document.getElementById("rc-list").querySelectorAll("[id=rc-status-]");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("disconnected"==document.getElementById("rc-status-"+b.value.textContent).innerHTML)return!1;return!0},module$contents$Blast$Storage_reconnectDoneHandler_=
function(a){var b=module$contents$Blast$Interpreter_getWorkspace();window.location.href.includes("mobile")?document.getElementById("rc-dialog").style.display="none":document.getElementById("rcModal").style.display="none";var c=document.getElementById("rc-done"),d=c.cloneNode(!0);d.disabled=!0;c.parentNode.replaceChild(d,c);Blockly.Xml.domToWorkspace(a,b);module$contents$Blast$Storage_monitorChanges_(b)},module$contents$Blast$Storage_reconnectCancelHandler_=function(){document.getElementById("rcModal").style.display=
"none"},module$contents$Blast$Storage_monitorChanges_=function(a){function b(){var f=Blockly.Xml.workspaceToDom(a);f=Blockly.Xml.domToText(f);d!=f&&(window.location.hash="",a.removeChangeListener(b))}var c=Blockly.Xml.workspaceToDom(a),d=Blockly.Xml.domToText(c);a.addChangeListener(b)},module$contents$Blast$Storage_generatePath=function(){for(var a=[],b=0;12>b;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(62*Math.random())));return a.join("")};
...
var module$contents$Blast$Eddystone_getCapabilities=function(a){var b,c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone capabilities...","Eddystone",a),k.yield(module$contents$Blast$Bluetooth_read(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.CAPABILITIES_CHARACTERISTIC),2);c=k.yieldResult;c=new Int8Array(c.buffer);d=[];for(f=6;f<c.length&&
!((g=d[d.length-1])&&g>=c[f]);f++)d.push(c[f]);h={specVersion:c[0],maxSlots:c[1],maxEidPerSlot:c[2],isVarriableAdvIntervalSupported:0!==(c[3]&1),isVariableTxPowerSupported:0!==(c[3]&2),isUIDSupported:0!==(c[5]&1),isURLSupported:0!==(c[5]&2),isTLMSupported:0!==(c[5]&4),isEIDSupported:0!==(c[5]&8),supportedTxPowerLevels:d};b("Eddystone capabilities: <code>"+JSON.stringify(h)+"</code>","Eddystone",a);return k.return(h)})},module$contents$Blast$Eddystone_getActiveSlot=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==
d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone active slot...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_readNumber(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ACTIVE_SLOT_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone active slot: <code>"+c+"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getActiveSlot=module$contents$Blast$Eddystone_getActiveSlot;
var module$contents$Blast$Eddystone_setActiveSlot=function(a,b){var c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone active slot to <code>"+b+"</code>...","Eddystone",a),f.yield(module$contents$Blast$Eddystone_getCapabilities(a),2);if(3!=f.nextAddress)return d=f.yieldResult,(0>b||b>=d.maxSlots)&&module$contents$Blast$Interpreter_throwError("Eddystone slot is not valid.\n         On this device the slot must be between 0 and "+
(d.maxSlots-1)+"."),f.yield(module$contents$Blast$Bluetooth_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ACTIVE_SLOT_CHARACTERISTIC,b.toString(16)),3);c("Eddystone active slot set to <code>"+b+"</code>","Eddystone",a);return f.return()})};Blast.Eddystone.setActiveSlot=module$contents$Blast$Eddystone_setActiveSlot;
var module$contents$Blast$Eddystone_getAdvertisingInterval=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertising interval...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_readNumber(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone advertising interval: <code>"+
c+"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getAdvertisingInterval=module$contents$Blast$Eddystone_getAdvertisingInterval;
var module$contents$Blast$Eddystone_setAdvertisingInterval=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone advertising interval to <code>"+b+"</code>...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC,b.toString(16)),
2);c("Eddystone advertising interval set to <code>"+b+"</code>","Eddystone",a);return d.return()})};Blast.Eddystone.setAdvertisingInterval=module$contents$Blast$Eddystone_setAdvertisingInterval;
var module$contents$Blast$Eddystone_getTxPowerLevel=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone TX power level...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_readNumber(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.RADIO_TX_POWER_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone TX power level: <code>"+c+"</code>",
"Eddystone",a);return d.return(c)})};Blast.Eddystone.getTxPowerLevel=module$contents$Blast$Eddystone_getTxPowerLevel;
var module$contents$Blast$Eddystone_setTxPowerLevel=function(a,b){var c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone TX power level to <code>"+b+"</code>...","Eddystone",a),f.yield(module$contents$Blast$Eddystone_getCapabilities(a),2);if(3!=f.nextAddress)return d=f.yieldResult,-1===d.supportedTxPowerLevels.indexOf(b)?(module$contents$Blast$Interpreter_throwError("Eddystone TX power level is not valid.\n         On this device the TX power level must be one of "+
d.supportedTxPowerLevels+"."),f.return()):f.yield(module$contents$Blast$Bluetooth_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.RADIO_TX_POWER_CHARACTERISTIC,b.toString(16)),3);c("Eddystone TX power level set to <code>"+b+"</code>","Eddystone",a);return f.return()})};Blast.Eddystone.setTxPowerLevel=module$contents$Blast$Eddystone_setTxPowerLevel;
var module$contents$Blast$Eddystone_getAdvertisedTxPower=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertised TX power...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_readNumber(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone advertised TX power: <code>"+
c+"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getAdvertisedTxPower=module$contents$Blast$Eddystone_getAdvertisedTxPower;
var module$contents$Blast$Eddystone_setAdvertisedTxPower=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone advertised TX power to <code>"+b+"</code>...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC,b.toString(16)),2);c("Eddystone advertised TX power set to <code>"+
b+"</code>","Eddystone",a);return d.return()})};Blast.Eddystone.setAdvertisedTxPower=module$contents$Blast$Eddystone_setAdvertisedTxPower;
var module$contents$Blast$Eddystone_getLockState=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone lock state...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_readNumber(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.LOCK_STATE_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone lock state: <code>"+c+"</code>","Eddystone",
a);return d.return(c)})};Blast.Eddystone.getLockState=module$contents$Blast$Eddystone_getLockState;
var module$contents$Blast$Eddystone_getPublicECDHKey=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone public ECDH key...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_readHex(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.PUBLIC_ECDH_KEY_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone public ECDH key: <code>"+c+
"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getPublicECDHKey=module$contents$Blast$Eddystone_getPublicECDHKey;
var module$contents$Blast$Eddystone_getAdvertisingData=function(a){var b,c,d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertising data...","Eddystone",a),c=function(l){var n=parseInt(l.substring(2,4),16),p=l.substring(4,24);l=l.substring(25,37);return{frameType:"UID",txPower:n,namespace:p,instance:l}},d=function(l){var n=parseInt(l.substring(2,4),16);switch(l.substring(4,6)){case "00":var p=
"http://www.";break;case "01":p="https://www.";break;case "02":p="http://";break;case "03":p="https://";break;default:module$contents$Blast$Interpreter_throwError("Eddystone URL scheme is not valid.");return}var q=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");l=l.substring(6,l.length);for(var r=0;r<l.length;r+=2){var t=parseInt(l.substring(r,r+2),16);p=t<q.length?p+q[t]:p+String.fromCharCode(t)}return{frameType:"URL",txPower:n,url:p}},f=function(l){var n=
parseInt(l.substring(4,8),16),p=parseInt(l.substring(8,10),16)+parseInt(l.substring(10,12),16)/100,q=parseInt(l.substring(12,20),16);l=parseInt(l.substring(20,28),16);return{frameType:"TLM",batteryVoltage:n,beaconTemperature:p,pduCount:q,timeSinceReboot:l}},m.yield(module$contents$Blast$Bluetooth_readHex(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);g=m.yieldResult;b("Got Eddystone advertising data: <code>"+g+"</code>",
"Eddystone",a);h=g.substring(0,2);switch(h){case "00":return k=c(g),m.return(k.namespace+k.instance);case "10":return k=d(g),m.return(k.url);case "20":return k=f(g),m.return(k.beaconTemperature);case "30":return module$contents$Blast$Interpreter_throwError("EID frame type is not supported by blast."),m.return();default:return module$contents$Blast$Interpreter_throwError("Eddystone frame type is not valid."),m.return()}})};Blast.Eddystone.getAdvertisingData=module$contents$Blast$Eddystone_getAdvertisingData;
var module$contents$Blast$Eddystone_setAdvertisingData=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress){d=module$contents$Blast$Things_getThingsLog();d("Set Eddystone advertising data...","Eddystone",a);f=function(m){for(var l=["http://www.","https://www.","http://","https://"],n=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),p=[],q=0,r=new TextEncoder("utf-8"),t=0;t<l.length;t++)if(m.startsWith(l[t])){p.push(t);
q=l[t].length;break}for(;q<m.length;){l=q;for(t=0;t<n.length;t++)if(m.startsWith(n[t],q)){p.push(t);q+=n[t].length;break}l===q&&(p.push(r.encode(m[q])[0]),q++)}if(18<p.length)module$contents$Blast$Interpreter_throwError("URL is too long.");else return p.splice(0,0,16),new Uint8Array(p)};if("URL"===b)g=f(c);else if("UID"===b){if(!/^[0-9A-Fa-f]{32}$/.test(c))return module$contents$Blast$Interpreter_throwError("Eddystone UID must be 32 hexadecimal characters."),k.return();g="0x00"+c}return k.yield(module$contents$Blast$Bluetooth_writeWithResponse(a,
module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,g),2)}h=k.yieldResult;d("Eddystone advertising data set to <code>"+c+"</code>","Eddystone",a);return k.return(h)})};Blast.Eddystone.setAdvertisingData=module$contents$Blast$Eddystone_setAdvertisingData;var module$exports$Blast$generators$control_flow={};Blockly.JavaScript.repeat=Blockly.JavaScript.controls_repeat_ext;Blockly.JavaScript.while_until=Blockly.JavaScript.controls_whileUntil;Blockly.JavaScript["for"]=Blockly.JavaScript.controls_for;Blockly.JavaScript.break_continue=Blockly.JavaScript.controls_flow_statements;Blockly.JavaScript.conditional_statement=Blockly.JavaScript.controls_if;
...
e),console.error(f)}};d()},1E3*a),module$contents$Blast$Interpreter_intervalEvents.push(a))};module$contents$Blast$Interpreter_apiFunctions.push(["addIntervalEvent",module$contents$Blast$generators$events_addIntervalEvent]);var module$exports$Blast$generators$functions={};
...
a),Blockly.JavaScript.INDENT));for(var f=a.getFieldValue("STACK")||"",g=[],h=a.getVars(),k=0;k<h.length;k++)g[k]=Blockly.JavaScript.variableDB_.getName(h[k],Blockly.VARIABLE_CATEGORY_NAME);c="function "+b+"("+g.join(", ")+") {\n"+c+d+f+"\n}";c=Blockly.JavaScript.scrub_(a,c);Blockly.JavaScript.definitions_["%"+b]=c;return null};Blockly.JavaScript.procedures_defnoreturn=Blockly.JavaScript.procedures_defreturn;
...
a.nextConnection.targetBlock()}},rebuildShape_:function(){var a=[null],b=[null],c=null;this.getInput("ELSE")&&(c=this.getInput("ELSE").connection.targetConnection);for(var d=1;this.getInput("IF"+d);){var f=this.getInput("IF"+d),g=this.getInput("DO"+d);a.push(f.connection.targetConnection);b.push(g.connection.targetConnection);d++}this.updateShape_();this.reconnectChildBlocks_(a,b,c)},updateShape_:function(){this.getInput("ELSE")&&this.removeInput("ELSE");for(var a=1;this.getInput("IF"+a);)this.removeInput("IF"+
...
Blockly.Procedures.flyoutCategory=function(a){function b(g,h){g=$jscomp.makeIterator(g);for(var k=g.next();!k.done;k=g.next()){k=k.value;var m=k[0],l=k[1];k=Blockly.utils.xml.createElement("block");k.setAttribute("type",h);k.setAttribute("gap",16);var n=Blockly.utils.xml.createElement("mutation");n.setAttribute("name",m);k.appendChild(n);m=$jscomp.makeIterator(l);for(l=m.next();!l.done;l=m.next()){l=l.value;var p=Blockly.utils.xml.createElement("arg");p.setAttribute("name",l);n.appendChild(p)}c.push(k)}}
...
Blockly.Blocks.things_webHID={init:function(){this.appendDummyInput().appendField("HID device").appendField(new Blockly.FieldDropdown(module$contents$Blast$Things_getWebHIDDevices),"id");this.setOutput(!0,"Thing");this.setColour(60);this.setTooltip("");this.setHelpUrl("")}};var module$exports$Blast$blocks$blast={};
...
this.setOutput(!0,"String");this.setTooltip("Invokes a HTTP request.");this.setColour(0)},httpRequestValidator:function(a){this.getSourceBlock().updateInputs(a);return a},updateInputs:function(a){var b=this.getInput("body");"GET"==a?b.setVisible(!1):b.setVisible(!0)}};var module$contents$Blast$blocks$blast_HTTP_REQUEST_XML='\n<block type="http_request">\n  <value name="uri">\n    <block type="uri_from_string">\n      <value name="URI">\n        <block type="string">\n          <field name="TEXT">https://example.com</field>\n        </block>\n      </value>\n    </block>\n  </value>\n  <value name="headers">\n    <block type="string">\n      <field name="TEXT">"Content-Type": "application/json", "Accept": "application/json"</field>\n    </block>\n  </value>\n  <value name="body">\n    <block type="string_multiline">\n      <field name="TEXT">\n{\n  "object": {\n    "a": "b",\n    "c": "d",\n    "e": "f"\n  },\n  "array": [\n    1,\n    2\n  ],\n  "string": "Hello World"\n}\n      </field>\n    </block>\n  </value>\n</block>';
...
this.getSourceBlock(),c=b.getInput("FrameType");c.setVisible(!1);"advertisementData"==a?c.setVisible(!0):b.getInput("Value").setCheck("Number")},frameTypeValidator:function(a){var b=this.getSourceBlock();"UID"===a?b.getInput("Value").setCheck("String"):"URL"===a&&b.getInput("Value").setCheck("URI")}};var module$contents$Blast$blocks$blast_WRITE_EDDYSTONE_PROPERTY_XML='\n<block type="write_eddystone_property">\n  <value name="Slot">\n    <block type="math_number">\n      <field name="NUM">0</field>\n    </block>\n  </value>\n</block>';
...
this.setOutput(!0,["String","Number"]);this.setColour(255);this.setInputsInline(!0);this.setTooltip("Reads a property from an Eddystone device.");this.setHelpUrl("https://github.com/google/eddystone/tree/master/configuration-service")}};var module$contents$Blast$blocks$blast_READ_EDDYSTONE_PROPERTY_XML='\n<block type="read_eddystone_property">\n  <value name="Slot">\n    <block type="math_number">\n      <field name="NUM">0</field>\n    </block>\n  </value>\n</block>';
module$contents$Blast$Toolbox_addBlock("read_eddystone_property","Properties",module$contents$Blast$blocks$blast_READ_EDDYSTONE_PROPERTY_XML);var module$exports$Blast$generators$blast={};Blockly.JavaScript.http_request=function(a){var b=Blockly.JavaScript.valueToCode(a,"uri",Blockly.JavaScript.ORDER_NONE)||null,c=a.getFieldValue("METHOD"),d=Blockly.JavaScript.valueToCode(a,"header",Blockly.JavaScript.ORDER_NONE),f=a.getFieldValue("OUTPUT");a=Blockly.JavaScript.valueToCode(a,"body",Blockly.JavaScript.ORDER_NONE);return["sendHttpRequest("+b+",'"+c+"', \n      '{"+d+"}', "+a+", '"+f+"')\n",Blockly.JavaScript.ORDER_NONE]};
var module$contents$Blast$generators$blast_sendHttpRequest=function(a,b,c,d,f,g){var h,k,m,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return null!=a&&void 0!=a&&""!=a||module$contents$Blast$Interpreter_throwError("URI input of HttpRequest blocks must not be empty"),h=JSON.parse(c),k={method:b,headers:new Headers(h)},"GET"!==b&&d&&(k.body=d),p.setCatchFinallyBlocks(2),p.yield(fetch(a,k),4);case 4:return m=p.yieldResult,m.ok?"status"==f?(g(m.status),
p.return()):p.yield(m.text(),5):(module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+m.status+" "+m.statusText),p.return());case 5:l=p.yieldResult;g(l);p.leaveTryBlock(0);break;case 2:n=p.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+n.message),p.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["sendHttpRequest",module$contents$Blast$generators$blast_sendHttpRequest]);
...
var module$contents$Blast$generators$blast_urdfQueryWrapper=function(a,b,c,d){var f,g,h,k,m,l,n,p,q,r,t,v,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return u.setCatchFinallyBlocks(2),u.yield(fetch(a),4);case 4:return f=u.yieldResult,f.ok?u.yield(f.text(),5):(module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+f.status+" "+f.statusText),u.return());case 5:return g=u.yieldResult,urdf.clear(),h={format:b},u.yield(urdf.load(g,
h),6);case 6:return u.yield(urdf.query(c),7);case 7:f=u.yieldResult;u.leaveTryBlock(3);break;case 2:k=u.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+k.message);case 3:if("boolean"===typeof f)return d(f),u.return();m=Array(f.length);l=$jscomp.makeIterator(f);for(n=l.next();!n.done;n=l.next()){p=n.value;q=Array(Object.keys(p).length);r=$jscomp.makeIterator(Object.values(p));for(t=r.next();!t.done;t=r.next())v=t.value,q.push(v.value);m.push(q)}w=module$contents$Blast$Interpreter_getInterpreter().nativeToPseudo(m);
d(w);u.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["urdfQueryWrapper",module$contents$Blast$generators$blast_urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var module$contents$Blast$generators$blast_displayText=function(a){module$contents$Blast$Interpreter_getStdOut()(a)};module$contents$Blast$Interpreter_apiFunctions.push(["displayText",module$contents$Blast$generators$blast_displayText]);
...
f){var g=document.createElement("td");g.innerHTML=f;c.appendChild(g)}b.appendChild(c)}}module$contents$Blast$Ui_addElementToOutputContainer(b)}};module$contents$Blast$Interpreter_apiFunctions.push(["displayTable",module$contents$Blast$generators$blast_displayTable]);Blockly.JavaScript.play_audio=function(a){return"playAudio("+Blockly.JavaScript.valueToCode(a,"URI",Blockly.JavaScript.ORDER_NONE)+");\n"};
var module$contents$Blast$generators$blast_playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,f){var g=new Audio(a);g.preload="auto";g.autoplay=!0;g.onerror=function(h){module$contents$Blast$Interpreter_throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(h);f(h)};g.onended=d}),2);b();c.jumpToEnd()})};
module$contents$Blast$Interpreter_asyncApiFunctions.push(["playAudio",module$contents$Blast$generators$blast_playAudio]);Blockly.JavaScript.capture_image=function(a){return["captureImage()",Blockly.JavaScript.ORDER_NONE]};
var module$contents$Blast$generators$blast_captureImage=function(a){var b,c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return b=document.createElement("video"),b.id="video",b.setAttribute("autoplay","autoplay"),b.setAttribute("muted",!0),b.style.display="none",document.body.appendChild(b),c={video:!0},k.yield(navigator.mediaDevices.getUserMedia(c),2);if(3!=k.nextAddress)return d=k.yieldResult,b.srcObject=d,f=document.createElement("canvas"),g=f.getContext("2d"),
k.yield(new Promise(function(m,l){b.onloadedmetadata=function(){f.width=b.videoWidth;f.height=b.videoHeight;g.drawImage(b,0,0,f.width,f.height);m()};video.onerror=function(n){module$contents$Blast$Interpreter_throwError("Error trying to capture image from camera. See console for details");console.error(n);l(n)}}),3);h=f.toDataURL("image/png");b.srcObject.getTracks().forEach(function(m){return m.stop()});b.remove();f.remove();a(h);k.jumpToEnd()})};
module$contents$Blast$Interpreter_asyncApiFunctions.push(["captureImage",module$contents$Blast$generators$blast_captureImage]);Blockly.JavaScript.display_image=function(a){return"displayImage("+Blockly.JavaScript.valueToCode(a,"image",Blockly.JavaScript.ORDER_NONE)+");\n"};var module$contents$Blast$generators$blast_displayImage=function(a){var b=document.createElement("img");b.src=a;b.classList.add("output_image");module$contents$Blast$Ui_addElementToOutputContainer(b)};
module$contents$Blast$Interpreter_apiFunctions.push(["displayImage",module$contents$Blast$generators$blast_displayImage]);Blockly.JavaScript.get_signal_strength_wb=function(a){return["getRSSIWb("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE)+")",Blockly.JavaScript.ORDER_NONE]};
var module$contents$Blast$generators$blast_getRSSIWb=function(a,b){var c,d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return m.yield(navigator.bluetooth.getDevices(),2);c=m.yieldResult;d=null;f=$jscomp.makeIterator(c);for(g=f.next();!g.done;g=f.next())if(h=g.value,h.id===a){d=h;break}null==d&&module$contents$Blast$Interpreter_throwError("Error pairing with Bluetooth device.");k=new AbortController;d.addEventListener("advertisementreceived",function(l){return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){k.abort();
b(l.rssi);n.jumpToEnd()})});return m.yield(d.watchAdvertisements({signal:k.signal}),0)})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["getRSSIWb",module$contents$Blast$generators$blast_getRSSIWb]);
...
var module$contents$Blast$generators$blast_eddystoneServiceUUID="a3c87500-8ed3-4bdf-8a39-a01bebede295";module$contents$Blast$Bluetooth_optionalServices.push(module$contents$Blast$generators$blast_eddystoneServiceUUID);
var module$contents$Blast$generators$blast_writeEddystoneProperty=function(a,b,c,d,f,g){return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return a?null===b||void 0===b?(module$contents$Blast$Interpreter_throwError("No slot set."),g(),h.return()):c?h.yield(module$contents$Blast$Eddystone_setActiveSlot(a,b),2):(module$contents$Blast$Interpreter_throwError("No property set."),g(),h.return()):(module$contents$Blast$Interpreter_throwError("No bluetooth device set."),
g(),h.return());case 2:switch(c){case "advertisedTxPower":return h.jumpTo(3);case "advertisementData":return h.jumpTo(4);case "advertisingInterval":return h.jumpTo(5);case "radioTxPower":return h.jumpTo(6)}h.jumpTo(7);break;case 3:return h.yield(module$contents$Blast$Eddystone_setAdvertisedTxPower(a,f),8);case 8:h.jumpTo(7);break;case 4:return h.yield(module$contents$Blast$Eddystone_setAdvertisingData(a,d,f),9);case 9:h.jumpTo(7);break;case 5:return h.yield(module$contents$Blast$Eddystone_setAdvertisingInterval(a,
f),10);case 10:h.jumpTo(7);break;case 6:return h.yield(module$contents$Blast$Eddystone_setTxPowerLevel(a,f),11);case 11:h.jumpTo(7);break;case 7:g(),h.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["writeEddystoneProperty",module$contents$Blast$generators$blast_writeEddystoneProperty]);
Blockly.JavaScript.read_eddystone_property=function(a){var b=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE)||null,c=Blockly.JavaScript.quote_(a.getFieldValue("Property"));a=Blockly.JavaScript.valueToCode(a,"Slot",Blockly.JavaScript.ORDER_NONE)||null;return["readEddystoneProperty("+b+", "+a+", "+c+")",Blockly.JavaScript.ORDER_NONE]};
var module$contents$Blast$generators$blast_readEddystoneProperty=function(a,b,c,d){var f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return a?null===b||void 0===b?(module$contents$Blast$Interpreter_throwError("No slot set."),d(),g.return()):c?g.yield(module$contents$Blast$Eddystone_setActiveSlot(a,b),2):(module$contents$Blast$Interpreter_throwError("No property set."),d(),g.return()):(module$contents$Blast$Interpreter_throwError("No bluetooth device set."),
d(),g.return());case 2:f=null;switch(c){case "advertisedTxPower":return g.jumpTo(3);case "advertisementData":return g.jumpTo(4);case "advertisingInterval":return g.jumpTo(5);case "lockState":return g.jumpTo(6);case "publicECDHKey":return g.jumpTo(7);case "radioTxPower":return g.jumpTo(8)}g.jumpTo(9);break;case 3:return g.yield(module$contents$Blast$Eddystone_getAdvertisedTxPower(a),10);case 10:f=g.yieldResult;g.jumpTo(9);break;case 4:return g.yield(module$contents$Blast$Eddystone_getAdvertisingData(a),
11);case 11:f=g.yieldResult;g.jumpTo(9);break;case 5:return g.yield(module$contents$Blast$Eddystone_getAdvertisingInterval(a),12);case 12:f=g.yieldResult;g.jumpTo(9);break;case 6:return g.yield(module$contents$Blast$Eddystone_getLockState(a),13);case 13:f=g.yieldResult;g.jumpTo(9);break;case 7:return g.yield(module$contents$Blast$Eddystone_getPublicECDHKey(a),14);case 14:f=g.yieldResult;g.jumpTo(9);break;case 8:return g.yield(module$contents$Blast$Eddystone_getTxPowerLevel(a),15);case 15:f=g.yieldResult;
g.jumpTo(9);break;case 9:d(f),g.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readEddystoneProperty",module$contents$Blast$generators$blast_readEddystoneProperty]);var module$exports$Blast$blocks$ble_rgb_led_controller={};
...
(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n        Upgrade to Chrome version 85 or later and enable Experimental Web Platform features."),this.dispose()))}};var module$contents$Blast$blocks$ble_rgb_led_controller_SWITCH_LIGHTS_RGB_XML='\n<block type="switch_lights_rgb">\n  <value name="colour">\n    <block type="colour_picker">\n      <field name="COLOUR">#ff0000</field>\n    </block>\n  </value>\n</block>';
module$contents$Blast$Toolbox_addBlock("switch_lights_rgb","Properties",module$contents$Blast$blocks$ble_rgb_led_controller_SWITCH_LIGHTS_RGB_XML);var module$exports$Blast$generators$ble_rgb_led_controller={};Blockly.JavaScript.switch_lights_rgb=function(a){var b=Blockly.JavaScript.valueToCode(a,"colour",Blockly.JavaScript.ORDER_ATOMIC)||Blockly.JavaScript.quote_("#000000");return"switchLights("+(Blockly.JavaScript.valueToCode(a,"thing",Blockly.JavaScript.ORDER_NONE)||"null")+", "+b+");\n"};var module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID="0000fff0-0000-1000-8000-00805f9b34fb";module$contents$Blast$Bluetooth_optionalServices.push(module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID);
var module$contents$Blast$generators$ble_rgb_led_controller_switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(!a)return module$contents$Blast$Interpreter_throwError("No LED Controller is set."),c(),f.return();d="7e000503"+b.substring(1,7)+"00ef";return f.yield(module$contents$Blast$Bluetooth_writeWithoutResponse(a,module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),
2)}c();f.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["switchLights",module$contents$Blast$generators$ble_rgb_led_controller_switchLights]);var module$exports$Blast$blocks$blinkstick={};
...
var module$contents$Blast$blocks$blinkstick_BLINKSTICK_SET_COLORS_XML='\n<block type="blinkstick_set_colors">\n  <value name="index">\n    <block type="math_number">\n      <field name="NUM">0</field>\n    </block>\n  </value>\n  <value name="COLOUR">\n    <block type="colour_picker">\n      <field name="COLOUR">#00ff00</field>\n    </block>\n  </value>\n</block>\n';module$contents$Blast$Toolbox_addBlock("blinkstick_set_colors","Properties",module$contents$Blast$blocks$blinkstick_BLINKSTICK_SET_COLORS_XML);var module$exports$Blast$generators$blinkstick={},module$contents$Blast$generators$blinkstick_thingsLog=module$contents$Blast$Things_getThingsLog();
...
var module$contents$Blast$generators$blinkstick_blinkstickSetColors=function(a,b,c,d){var f,g,h,k,m,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:if(0>b||7<b)return module$contents$Blast$Interpreter_throwError("BlinkStick index must be between 0 and 7."),d(),n.return();if(!a)return module$contents$Blast$Interpreter_throwError("No BlinkStick block set."),d(),n.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Blinkstick via webHID."),
d(),n.return();if(f.opened){n.jumpTo(2);break}n.setCatchFinallyBlocks(3);return n.yield(f.open(),5);case 5:n.leaveTryBlock(2);break;case 3:n.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==f.vendorId||16869!==f.productId)return module$contents$Blast$Interpreter_throwError("The connected device is not a BlinkStick."),d(),n.return();g=parseInt(c.substring(1,3),16);h=parseInt(c.substring(3,5),
16);k=parseInt(c.substring(5,7),16);m=Int8Array.from([5,b,g,h,k]);l=function(p){var q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return r.setCatchFinallyBlocks(2),module$contents$Blast$generators$blinkstick_thingsLog("Invoke <code>sendFeatureReport</code> with value <code>"+m+"</code>","hid",f.productName),r.yield(f.sendFeatureReport(5,m),4);if(2!=r.nextAddress)return module$contents$Blast$generators$blinkstick_thingsLog("Finished <code>sendFeatureReport</code> with value <code>"+
m+"</code>","hid",f.productName),r.leaveTryBlock(0);q=r.enterCatchBlock();return 0<p?r.yield(l(--p),0):(console.error(q),module$contents$Blast$Interpreter_throwError("Failed to set BlinkStick colors, please check its connection."),r.jumpTo(0))})};return n.yield(l(5),6);case 6:d(),n.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["blinkstickSetColors",module$contents$Blast$generators$blinkstick_blinkstickSetColors]);var module$exports$Blast$blocks$huskyduino={};
...
(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),this.dispose()))}};var module$contents$Blast$blocks$huskyduino_HUSKYLENS_FORGET_FLAG_XML='\n<block type="huskylens_write_forget_flag">\n  <value name="forgetFlag">\n    <block type="logic_boolean">\n      <field name="BOOL">TRUE</field>\n    </block>\n  </value>\n</block>\n';
...
var module$contents$Blast$generators$huskyduino_HuskyServiceUUID="5be35d20-f9b0-11eb-9a03-0242ac130003";module$contents$Blast$Bluetooth_optionalServices.push(module$contents$Blast$generators$huskyduino_HuskyServiceUUID);
var module$contents$Blast$generators$huskyduino_chooseAlgo=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be35d26-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["chooseAlgo",module$contents$Blast$generators$huskyduino_chooseAlgo]);
var module$contents$Blast$generators$huskyduino_learnID=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be35eca-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["learnID",module$contents$Blast$generators$huskyduino_learnID]);
var module$contents$Blast$generators$huskyduino_forgetAll=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be361b8-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["forgetAll",module$contents$Blast$generators$huskyduino_forgetAll]);
var module$contents$Blast$generators$huskyduino_readID=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_readText(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be3628a-f9b0-11eb-9a03-0242ac130003"),2);c=d.yieldResult;b(c);d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readID",module$contents$Blast$generators$huskyduino_readID]);var module$exports$Blast$blocks$joycon={};
...
var readJoyConProperty=function(a,b,c,d,f,g){var h,k,m,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:if(!a)return module$contents$Blast$Interpreter_throwError("No Joy-Con block set."),g(),n.return();h=module$contents$Blast$Things_getWebHidDevice(a);if(!h)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),g(),n.return();if(h.opened){n.jumpTo(2);break}n.setCatchFinallyBlocks(3);
return n.yield(h.open(),5);case 5:n.leaveTryBlock(2);break;case 3:n.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==h.vendorId||8198!==h.productId&&8199!==h.productId)return module$contents$Blast$Interpreter_throwError("The connected device is not a Joy-Con."),g(),n.return();8198===h.productId?k=new JoyConLeft(h):8199===h.productId&&(k=new JoyConRight(h));return n.yield(k.open(),6);case 6:return n.yield(k.enableStandardFullMode(),
7);case 7:return n.yield(k.enableIMUMode(),8);case 8:m=module$contents$Blast$Things_getThingsLog();l=function(p){var q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){q=p.detail;if(!q||!q.actualOrientation)return r.return();m("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(q)+"</code>","hid",h.productname);m("Removing <code>hidinput</code> event listener","hid",h.productname);k.removeEventListener("hidinput",l);""!==d?"accelerometers"===b?g(q[b][c][d].acc):
"gyroscopes"===b?g(q[b][c][d][f]):g(q[b][c][d]):g(q[b][c]);r.jumpToEnd()})};if(k.eventListenerAttached){n.jumpTo(0);break}return n.yield(k.open(),10);case 10:return n.yield(k.enableStandardFullMode(),11);case 11:return n.yield(k.enableIMUMode(),12);case 12:return n.yield(k.enableVibration(),13);case 13:m("Adding <code>hidinput</code> event listener","hid",h.productname),k.addEventListener("hidinput",l),k.eventListenerAttached=!0,n.jumpToEnd()}})};
...
var handleJoyConButtons=function(a,b,c,d){var f,g,h,k,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return module$contents$Blast$Interpreter_throwError("No Joy-Con block set."),d(),l.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),d(),l.return();if(f.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);
return l.yield(f.open(),5);case 5:l.leaveTryBlock(2);break;case 3:l.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==f.vendorId||8198!==f.productId&&8199!==f.productId)return module$contents$Blast$Interpreter_throwError("The connected device is not a Joy-Con."),d(),l.return();8198===f.productId?g=new JoyConLeft(f):8199===f.productId&&(g=new JoyConRight(f));return l.yield(g.open(),6);case 6:return l.yield(g.enableStandardFullMode(),
7);case 7:return l.yield(g.enableIMUMode(),8);case 8:h=!1;k=module$contents$Blast$Things_getThingsLog();m=function(n){var p,q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){p=n.detail;if(!p||!p.actualOrientation)return t.return();k("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(p)+"</code>","hid",f.productName);p.buttonStatus[b]?h||(h=!0,module$contents$Blast$Interpreter_setInterrupted(!1),q=new Interpreter(""),q.stateStack[0].scope=module$contents$Blast$Interpreter_getInterpreter().globalScope,
q.appendCode(c),r=function(){try{q.step()?setTimeout(r,5):module$contents$Blast$Interpreter_setInterrupted(!1)}catch(v){module$contents$Blast$Interpreter_throwError("Error executing program:\n "+e),console.error(v)}},r()):h=!1;t.jumpToEnd()})};Blast.Interpreter.deviceEventHandlers.push({device:g,type:"hidinput",fn:m});if(g.eventListenerAttached){l.jumpTo(0);break}return l.yield(g.open(),10);case 10:return l.yield(g.enableStandardFullMode(),11);case 11:return l.yield(g.enableIMUMode(),12);case 12:return l.yield(g.enableVibration(),
13);case 13:k("Adding <code>hidinput</code> event listener","hid",f.productName),g.addEventListener("hidinput",m),g.eventListenerAttached=!0,l.jumpToEnd()}})};module$contents$Blast$Interpreter_apiFunctions.push(["handleJoyConButtons",handleJoyConButtons]);var module$exports$Blast$blocks$mirobot={};Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};var module$exports$Blast$generators$mirobot={};Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
var module$contents$Blast$generators$mirobot_mirobotPickUp=function(a,b){var c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return c="https://bot.rapidthings.eu/thing/action/grab_"+a.toLowerCase(),d={"Content-Type":"application/json",Accept:"application/json"},f={method:"POST",headers:new Headers(d)},k.setCatchFinallyBlocks(2),k.yield(fetch(c,f),4);if(2!=k.nextAddress){g=k.yieldResult;if(!g.ok)return module$contents$Blast$Interpreter_throwError("Failed to get "+
c+", Error: "+g.status+" "+g.statusText),k.return();b(g.status);return k.leaveTryBlock(0)}h=k.enterCatchBlock();module$contents$Blast$Interpreter_throwError("Failed to get "+c+", Error: "+h);k.jumpToEnd()})};var module$exports$Blast$blocks$ruuvi_tag={};
...
module$contents$Blast$Toolbox_addBlock("read_ruuvi_property","Properties");module$contents$Blast$Bluetooth_scanBlocks.push("read_ruuvi_property");var module$exports$Blast$generators$ruuvi_tag={};Blockly.JavaScript.read_ruuvi_property=function(a){var b=Blockly.JavaScript.quote_(a.getFieldValue("measurement"));a=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC);return["getRuuviProperty("+b+", "+a+")",Blockly.JavaScript.ORDER_NONE]};
var module$contents$Blast$generators$ruuvi_tag_getRuuviProperty=function(a,b,c){var d,f,g,h,k,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return d=function(n){var p={},q=n[0]&255,r=n[1]<<8|n[2]&255;32767<r&&(r-=65535);var t=((n[3]&255)<<8|n[4]&255)/400,v=((n[5]&255)<<8|n[6]&255)+5E4,w=(n[7]<<8|n[8]&255)/1E3,u=(n[9]<<8|n[10]&255)/1E3,y=(n[11]<<8|n[12]&255)/1E3,x=(n[13]&255)<<8|n[14]&255,z=n[15]&255;n=(n[16]&255)<<8|n[17]&255;p.destination_endpoint=q;p.temperature=
r/200;p.humidity=t;p.pressure=v;p.accelerationX=w;p.accelerationY=u;p.accelerationZ=y;p.batteryVoltage=(x>>>5)/1E3+1.6;p.txPower=2*(x&31)-40;p.movementCounter=z;p.measurementSequenceNumber=n;return p},f=function(n){if(30>n){var p=Blast.Bluetooth.LEScanResults[b];if(p){p=$jscomp.makeIterator(p);for(var q=p.next();!q.done;q=p.next())if((q=q.value.manufacturerData.get(1177))&&5==q.getUint8(0))return q}return new Promise(function(r){setTimeout(function(){r(f(n+1))},1E3)})}},module$contents$Blast$Bluetooth_startLEScan(b),
l.yield(f(0),2);(g=l.yieldResult)||module$contents$Blast$Interpreter_throwError("Timed out. No BLE advertising data found for "+b);h=[];for(k=0;k<g.byteLength;k++)h.push("0x"+("00"+g.getUint8(k).toString(16)).slice(-2));m=d(h);c(m[a]);l.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["getRuuviProperty",module$contents$Blast$generators$ruuvi_tag_getRuuviProperty]);var module$exports$Blast$blocks$streamdeck={};
Blockly.Blocks.streamdeck_button_event={init:function(){var a=this;this.appendValueInput("id").setCheck("Thing").appendField("Stream Deck Mini");this.appendDummyInput().appendField("on button").appendField(new Blockly.FieldDropdown([["up","up"],["down","down"]]),"upDown");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,"button1")}),"button1").appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,
...
Blockly.Blocks.streamdeck_set_brightness={init:function(){this.appendValueInput("value").setCheck("Number").appendField("write brightness property");this.appendValueInput("id").setCheck("Thing").appendField("to Stream Deck Mini");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("");this.setHelpUrl("")}};var module$contents$Blast$blocks$streamdeck_STREAMDECK_SET_BRIGHTNESS_XML='\n<block type="streamdeck_set_brightness">\n  <value name="value">\n    <block type="math_number">\n      <field name="NUM">100</field>\n    </block>\n  </value>\n</block>\n';
module$contents$Blast$Toolbox_addBlock("streamdeck_set_brightness","Properties",module$contents$Blast$blocks$streamdeck_STREAMDECK_SET_BRIGHTNESS_XML);var module$exports$Blast$generators$streamdeck={},module$contents$Blast$generators$streamdeck_thingsLog=module$contents$Blast$Things_getThingsLog();
Blockly.JavaScript.streamdeck_button_event=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,h="TRUE"==a.getFieldValue("button6")?1:0,k=Blockly.JavaScript.quote_(a.getFieldValue("upDown")),m=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+b+c+d+f+g+h);a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,
"statements"));Blockly.JavaScript.definitions_.eventHandlers=(Blockly.JavaScript.definitions_.eventHandlers||"")+("handleStreamdeck("+m+", "+b+", "+k+", "+a+");\n");return""};
Blockly.JavaScript.streamdeck_color_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,h="TRUE"==a.getFieldValue("button6")?1:0,k=Blockly.JavaScript.valueToCode(a,"color",Blockly.JavaScript.ORDER_NONE)||Blockly.JavaScript.quote_("#000000");a=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+
b+c+d+f+g+h);return"streamdeckColorButtons("+a+", "+b+", "+k+");\n"};
var module$contents$Blast$generators$streamdeck_handleStreamdeck=function(a,b,c,d){var f,g,h,k,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),l.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),l.return();
l.setCatchFinallyBlocks(2);return l.yield(StreamDeck.openDevice(f),4);case 4:g=l.yieldResult;l.leaveTryBlock(3);break;case 2:h=l.enterCatchBlock();if("InvalidStateError"!=h.name)return module$contents$Blast$Interpreter_throwError(h),l.return();f.close();return l.yield(StreamDeck.openDevice(f),6);case 6:g=l.yieldResult;case 3:for(m=0;m<b.length;m++)if("1"===b.charAt(m)){k=m;break}if(void 0===k)return l.return();g.on(c,function(n){module$contents$Blast$generators$streamdeck_thingsLog("Received <code>"+
c+"</code> event on button <code>"+n+"</code>","hid",f.productName);if(n===k){module$contents$Blast$Interpreter_setInterrupted(!0);var p=new Interpreter("");p.stateStack[0].scope=module$contents$Blast$Interpreter_getInterpreter().globalScope;p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):module$contents$Blast$Interpreter_setInterrupted(!1)}catch(r){module$contents$Blast$Interpreter_throwError("Error executing program:\n "+e),console.error(r)}};q()}});module$contents$Blast$Interpreter_addCleanUpFunction(function(){module$contents$Blast$generators$streamdeck_thingsLog("Removing all listeners",
"hid",f.productName);g.close();g.removeAllListeners()});l.jumpToEnd()}})};module$contents$Blast$Interpreter_apiFunctions.push(["handleStreamdeck",module$contents$Blast$generators$streamdeck_handleStreamdeck]);
var module$contents$Blast$generators$streamdeck_streamdeckColorButtons=function(a,b,c,d){var f,g,h,k,m,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),d(),p.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),
d(),p.return();p.setCatchFinallyBlocks(2);return p.yield(StreamDeck.openDevice(f),4);case 4:g=p.yieldResult;p.leaveTryBlock(3);break;case 2:h=p.enterCatchBlock();if("InvalidStateError"!=h.name)return module$contents$Blast$Interpreter_throwError(h),d(),p.return();f.close();return p.yield(StreamDeck.openDevice(f),6);case 6:g=p.yieldResult;case 3:k=parseInt(c.substring(1,3),16),m=parseInt(c.substring(3,5),16),l=parseInt(c.substring(5,7),16),n=0;case 7:if(!(n<b.length)){p.jumpTo(9);break}if("1"!==b.charAt(n)){p.jumpTo(8);
break}module$contents$Blast$generators$streamdeck_thingsLog("Invoke <code>fillKeyColor</code> with value <code>"+[n,k,m,l].toString()+"</code>","hid",f.productName);return p.yield(g.fillKeyColor(n,k,m,l),11);case 11:module$contents$Blast$generators$streamdeck_thingsLog("Finished <code>fillKeyColor</code>","hid",f.productName);case 8:n++;p.jumpTo(7);break;case 9:d(),p.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["streamdeckColorButtons",module$contents$Blast$generators$streamdeck_streamdeckColorButtons]);
...
b+c+d+f+g+h);return"streamdeckWriteOnButtons("+a+", "+b+", "+k+");\n"};
var module$contents$Blast$generators$streamdeck_streamdeckWriteOnButtons=function(a,b,c,d){var f,g,h,k,m,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),d(),q.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),
q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(f),4);case 4:g=q.yieldResult;q.leaveTryBlock(3);break;case 2:h=q.enterCatchBlock();if("InvalidStateError"!=h.name)return module$contents$Blast$Interpreter_throwError(h),d(),q.return();f.close();return q.yield(StreamDeck.openDevice(f),6);case 6:g=q.yieldResult;case 3:k=[];m=document.createElement("canvas");m.width=g.ICON_SIZE;m.height=g.ICON_SIZE;l=m.getContext("2d");l.save();l.clearRect(0,0,m.width,m.height);l.font=.8*m.height+
"px Arial";l.strokeStyle="blue";l.lineWidth=1;l.strokeText(c.toString(),8,60,.8*m.width);l.fillStyle="white";l.fillText(c.toString(),8,60,.8*m.width);n=l.getImageData(0,0,m.width,m.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&(module$contents$Blast$generators$streamdeck_thingsLog("Invoke <code>fillKeyImageData</code> with value <code>"+[p,n].toString()+"</code>","hid",f.productName),k.push(g.fillKeyBuffer(p,buffer.Buffer.from(n.data),{format:"rgba"})),module$contents$Blast$generators$streamdeck_thingsLog("Finished <code>fillKeyImageData</code>",
"hid",f.productName));l.restore();return q.yield(Promise.all(k),7);case 7:d(),q.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["streamdeckWriteOnButtons",module$contents$Blast$generators$streamdeck_streamdeckWriteOnButtons]);
Blockly.JavaScript.streamdeck_set_brightness=function(a){var b=Blockly.JavaScript.valueToCode(a,"value",Blockly.JavaScript.ORDER_NONE)||Blockly.JavaScript.quote_("100");return"streamdeckSetBrightness("+(Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null)+", "+b+");\n"};
var module$contents$Blast$generators$streamdeck_streamdeckSetBrightness=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),c(),h.return();if(1>b||100<b)return module$contents$Blast$Interpreter_throwError("Brightness must be between 1 and 100."),c(),h.return();d=module$contents$Blast$Things_getWebHidDevice(a);if(!d)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),
c(),h.return();h.setCatchFinallyBlocks(2);return h.yield(StreamDeck.openDevice(d),4);case 4:f=h.yieldResult;h.leaveTryBlock(3);break;case 2:g=h.enterCatchBlock();if("InvalidStateError"!=g.name)return module$contents$Blast$Interpreter_throwError(g),c(),h.return();d.close();return h.yield(StreamDeck.openDevice(d),6);case 6:f=h.yieldResult;case 3:return module$contents$Blast$generators$streamdeck_thingsLog("Invoke <code>setBrightness</code> with value <code>"+b+"</code>","hid",d.productName),h.yield(f.setBrightness(b),
7);case 7:module$contents$Blast$generators$streamdeck_thingsLog("Finished <code>setBrightness</code>","hid",d.productName),c(),h.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["streamdeckSetBrightness",module$contents$Blast$generators$streamdeck_streamdeckSetBrightness]);var module$exports$Blast$blocks$web_speech={};Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};module$contents$Blast$Toolbox_addBlock("text_to_speech","actions");
...
var module$contents$Blast$generators$web_speech_webSpeech=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){c=module$contents$Blast$Interpreter_getWorkspace().getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";f="";d.onresult=function(h){for(var k=h.resultIndex;k<h.results.length;++k)h.results[k].isFinal&&(f+=h.results[k][0].transcript)};d.onend=function(){b(f)};d.start();g.jumpToEnd()})};
module$contents$Blast$Interpreter_asyncApiFunctions.push(["webSpeech",module$contents$Blast$generators$web_speech_webSpeech]);var module$contents$Blast$generators$web_speech_textToSpeech=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=new SpeechSynthesisUtterance,c.text=a,window.speechSynthesis.speak(c),d.yield(new Promise(function(f){c.onend=f}),2);b();d.jumpToEnd()})};
...
module$contents$Blast$Toolbox_addBlock("read_mijia_property","Properties");var module$exports$Blast$generators$xiamoi_thermometer={};Blockly.JavaScript.read_mijia_property=function(a){var b=Blockly.JavaScript.quote_(a.getFieldValue("measurement"));a=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC);return["readMijiaProperty("+b+", "+a+")",Blockly.JavaScript.ORDER_NONE]};var module$contents$Blast$generators$xiamoi_thermometer_XiaomiServiceUUID="ebe0ccb0-7a0a-4b0c-8a1a-6ff2997da3a6";module$contents$Blast$Bluetooth_optionalServices.push(module$contents$Blast$generators$xiamoi_thermometer_XiaomiServiceUUID);
var module$contents$Blast$generators$xiamoi_thermometer_readMijiaProperty=function(a,b,c){b?module$contents$Blast$Bluetooth_subscribe(b,module$contents$Blast$generators$xiamoi_thermometer_XiaomiServiceUUID,"ebe0ccc1-7a0a-4b0c-8a1a-6ff2997da3a6",function(d){var f=d.target.value,g=f.getUint8(1)&128;d=(f.getUint8(1)&127)<<8|f.getUint8(0);g&&(d-=32767);d/=100;f=f.getUint8(2);"temperature"===a?c(d):"humidity"===a&&c(f)}):(module$contents$Blast$Interpreter_throwError("No Thermometer is set."),c())};
