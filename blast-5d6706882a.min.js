...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(g){return g instanceof f?g:new f(function(m,k){m(g)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(g){if(null==this.batch_){this.batch_=[];var m=this;this.asyncExecuteFunction(function(){m.executeBatch_()})}this.batch_.push(g)};
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(g){d(g,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var g=this.batch_;this.batch_=[];for(var m=0;m<g.length;++m){var k=g[m];g[m]=null;try{k()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};b.prototype.asyncThrow_=function(g){this.asyncExecuteFunction(function(){throw g;})};var f=function(g){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var m=this.createResolveAndReject_();
try{g(m.resolve,m.reject)}catch(k){m.reject(k)}};f.prototype.createResolveAndReject_=function(){function g(l){return function(n){k||(k=!0,l.call(m,n))}}var m=this,k=!1;return{resolve:g(this.resolveTo_),reject:g(this.reject_)}};f.prototype.resolveTo_=function(g){if(g===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof f)this.settleSameAsPromise_(g);else{a:switch(typeof g){case "object":var m=null!=g;break a;case "function":m=!0;break a;default:m=!1}m?this.resolveToNonPromiseObj_(g):
this.fulfill_(g)}};f.prototype.resolveToNonPromiseObj_=function(g){var m=void 0;try{m=g.then}catch(k){this.reject_(k);return}"function"==typeof m?this.settleSameAsThenable_(m,g):this.fulfill_(g)};f.prototype.reject_=function(g){this.settle_(2,g)};f.prototype.fulfill_=function(g){this.settle_(1,g)};f.prototype.settle_=function(g,m){if(0!=this.state_)throw Error("Cannot settle("+g+", "+m+"): Promise already settled in state"+this.state_);this.state_=g;this.result_=m;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};f.prototype.scheduleUnhandledRejectionCheck_=function(){var g=this;d(function(){if(g.notifyUnhandledRejection_()){var m=$jscomp.global.console;"undefined"!==typeof m&&m.error(g.result_)}},1)};f.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var g=$jscomp.global.CustomEvent,m=$jscomp.global.Event,k=$jscomp.global.dispatchEvent;if("undefined"===typeof k)return!0;"function"===typeof g?g=new g("unhandledrejection",{cancelable:!0}):
...
g.callWhenSettled_(m.resolve,m.reject)};f.prototype.settleSameAsThenable_=function(g,m){var k=this.createResolveAndReject_();try{g.call(m,k.resolve,k.reject)}catch(l){k.reject(l)}};f.prototype.then=function(g,m){function k(q,r){return"function"==typeof q?function(t){try{l(q(t))}catch(v){n(v)}}:r}var l,n,p=new f(function(q,r){l=q;n=r});this.callWhenSettled_(k(g,l),k(m,n));return p};f.prototype.catch=function(g){return this.then(void 0,g)};f.prototype.callWhenSettled_=function(g,m){function k(){switch(l.state_){case 1:g(l.result_);
break;case 2:m(l.result_);break;default:throw Error("Unexpected state: "+l.state_);}}var l=this;null==this.onSettledCallbacks_?h.asyncExecute(k):this.onSettledCallbacks_.push(k);this.isRejectionHandled_=!0};f.resolve=c;f.reject=function(g){return new f(function(m,k){k(g)})};f.race=function(g){return new f(function(m,k){for(var l=$jscomp.makeIterator(g),n=l.next();!n.done;n=l.next())c(n.value).callWhenSettled_(m,k)})};f.all=function(g){var m=$jscomp.makeIterator(g),k=m.next();return k.done?c([]):new f(function(l,
n){function p(t){return function(v){q[t]=v;r--;0==r&&l(q)}}var q=[],r=0;do q.push(void 0),r++,c(k.value).callWhenSettled_(p(q.length-1),n),k=m.next();while(!k.done)})};return f},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,f){return c==a&&"q"==d&&f==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var l=Object.seal({}),n=Object.seal({}),p=new a([[l,2],[n,3]]);if(2!=p.get(l)||3!=p.get(n))return!1;p.delete(l);p.set(n,4);return!p.has(l)&&4==p.get(n)}catch(q){return!1}}function c(){}function d(l){var n=typeof l;return"object"===n&&null!==l||"function"===n}function f(l){if(!$jscomp.owns(l,g)){var n=new c;$jscomp.defineProperty(l,g,{value:n})}}function h(l){if(!$jscomp.ISOLATE_POLYFILLS){var n=Object[l];n&&(Object[l]=
function(p){if(p instanceof c)return p;Object.isExtensible(p)&&f(p);return n(p)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var g="$jscomp_hidden_"+Math.random();h("freeze");h("preventExtensions");h("seal");var m=0,k=function(l){this.id_=(m+=Math.random()+1).toString();if(l){l=$jscomp.makeIterator(l);for(var n;!(n=l.next()).done;)n=n.value,this.set(n[0],n[1])}};k.prototype.set=function(l,n){if(!d(l))throw Error("Invalid WeakMap key");
f(l);if(!$jscomp.owns(l,g))throw Error("WeakMap key fail: "+l);l[g][this.id_]=n;return this};k.prototype.get=function(l){return d(l)&&$jscomp.owns(l,g)?l[g][this.id_]:void 0};k.prototype.has=function(l){return d(l)&&$jscomp.owns(l,g)&&$jscomp.owns(l[g],this.id_)};k.prototype.delete=function(l){return d(l)&&$jscomp.owns(l,g)&&$jscomp.owns(l[g],this.id_)?delete l[g][this.id_]:!1};return k},"es6","es3");$jscomp.MapEntry=function(){};
...
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,d=function(k){this.data_={};this.head_=g();this.size=0;if(k){k=$jscomp.makeIterator(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}};d.prototype.set=function(k,l){k=0===k?0:k;var n=f(this,k);n.list||(n.list=this.data_[n.id]=[]);n.entry?n.entry.value=l:(n.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:k,value:l},n.list.push(n.entry),
...
f(this,k).entry)&&k.value};d.prototype.entries=function(){return h(this,function(k){return[k.key,k.value]})};d.prototype.keys=function(){return h(this,function(k){return k.key})};d.prototype.values=function(){return h(this,function(k){return k.value})};d.prototype.forEach=function(k,l){for(var n=this.entries(),p;!(p=n.next()).done;)p=p.value,k.call(l,p[1],p[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var f=function(k,l){var n=l&&typeof l;"object"==n||"function"==n?c.has(l)?n=c.get(l):
(n=""+ ++m,c.set(l,n)):n="p_"+l;var p=k.data_[n];if(p&&$jscomp.owns(k.data_,n))for(k=0;k<p.length;k++){var q=p[k];if(l!==l&&q.key!==q.key||l===q.key)return{id:n,list:p,index:k,entry:q}}return{id:n,list:p,index:-1,entry:void 0}},h=function(k,l){var n=k.head_;return $jscomp.iteratorPrototype(function(){if(n){for(;n.head!=k.head_;)n=n.previous;for(;n.next!=n.head;)return n=n.next,{done:!1,value:l(n)};n=null}return{done:!0,value:void 0}})},g=function(){var k={};return k.previous=k.next=k.head=k},m=0;
...
$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,f=0;f<d;f++){var h=a[f];if(b.call(c,h,f,a))return{i:f,v:h}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
...
$jscomp.polyfill("Uint32Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Float32Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");var Blast={States:{}},module$contents$Blast$States_StateBlock;Blast.States.StateBlock=module$contents$Blast$States_StateBlock;var module$contents$Blast$States_interpreter=null;Blast.States.statesInterpreter=module$contents$Blast$States_interpreter;
var module$contents$Blast$States_runner_=null,module$contents$Blast$States_latestCode="",module$contents$Blast$States_eventCode=new Map,module$contents$Blast$States_eventValues=new Map,module$contents$Blast$States_intervalEvents=[];Blast.States.intervalEvents=module$contents$Blast$States_intervalEvents;var module$contents$Blast$States_eventChecker=function(a,b){var c=module$contents$Blast$States_eventValues.get(a);module$contents$Blast$States_eventValues.set(a,b);return void 0!=c?!c&&b:!1};
Blast.States.eventChecker=module$contents$Blast$States_eventChecker;var module$contents$Blast$States_addEventCode=function(a,b){module$contents$Blast$States_eventCode.set(a,b)};Blast.States.addEventCode=module$contents$Blast$States_addEventCode;var module$contents$Blast$States_removeEventCode=function(a){module$contents$Blast$States_eventCode.delete(a)};Blast.States.removeEventCode=module$contents$Blast$States_removeEventCode;
var module$contents$Blast$States_generateCode=function(){for(var a="while (true) {\n \n}",b=Blast.workspace.getBlocksByType("event",!1).map(function(h){return h.id}),c=$jscomp.makeIterator(module$contents$Blast$States_eventCode),d=c.next();!d.done;d=c.next()){var f=$jscomp.makeIterator(d.value);d=f.next().value;f=f.next().value;b.includes(d)&&(a=a.slice(0,-2)+f+"\n"+a.slice(-1))}module$contents$Blast$States_latestCode=Blockly.JavaScript.finish(a)};Blast.States.generateEventCode=module$contents$Blast$States_generateCode;
var module$contents$Blast$States_startEventChecker=function(){module$contents$Blast$States_interpreter=null;module$contents$Blast$States_interpreter=new Interpreter("");module$contents$Blast$States_interpreter.stateStack[0].scope=Blast.Interpreter.globalScope;module$contents$Blast$States_interpreter.appendCode(module$contents$Blast$States_latestCode);module$contents$Blast$States_runner_=function(){if(module$contents$Blast$States_interpreter)try{module$contents$Blast$States_interpreter.step(),setTimeout(module$contents$Blast$States_runner_,
1)}catch(a){Blast.throwError("Error executing program:\n%e".replace("%e",a)),Blast.resetInterpreter(),console.error(a)}};module$contents$Blast$States_runner_()};Blast.States.startEventChecker=module$contents$Blast$States_startEventChecker;
...
f.setAttribute("name",c);d.appendChild(f);b.push(d)}if(a=module$contents$Blast$Toolbox_getCategory("States and Events"))for(a=$jscomp.makeIterator(a.contents),c=a.next();!c.done;c=a.next())c=c.value,d=Blockly.utils.xml.createElement("block"),d.setAttribute("type",c.type),d.setAttribute("gap",16),b.push(d);return b};Blast.States.statesFlyoutCategory=module$contents$Blast$States_flyoutCategory;
var module$contents$Blast$States_getDefinition=function(a,b){b=b.getTopBlocks(!1);b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next())if(c=c.value,c.getStateDef){var d=c.getStateDef()[0];if(d&&Blockly.Names.equals(d,a))return c}return null};Blast.States.getDefinition=module$contents$Blast$States_getDefinition;
var module$contents$Blast$States_clearIntervalEvents=function(){for(var a=$jscomp.makeIterator(module$contents$Blast$States_intervalEvents),b=a.next();!b.done;b=a.next())clearInterval(b.value);module$contents$Blast$States_intervalEvents=[]};Blast.States.clearIntervalEvents=module$contents$Blast$States_clearIntervalEvents;var module$contents$Blast$States_resetInterpreter=function(){clearTimeout(module$contents$Blast$States_runner_);module$contents$Blast$States_runner_=null};
Blast.States.resetInterpreter=module$contents$Blast$States_resetInterpreter;Blast.Storage={};
var module$contents$Blast$Storage_HTTPREQUEST_ERROR="There was a problem with the request.\n",module$contents$Blast$Storage_LINK_ALERT="Load your blocks with this link:\n\n%1",module$contents$Blast$Storage_NOT_FOUND_ERROR='Sorry, couldn\'t find "%1".',module$contents$Blast$Storage_XML_ERROR="Could not load your saved file.\nPerhaps it was created with a different version of Blast?",module$contents$Blast$Storage_filename="BLAST.xml",module$contents$Blast$Storage_link=function(a){var b=Blast.workspace,
c=Blockly.Xml.workspaceToDom(b,!0);1==b.getTopBlocks(!1).length&&c.querySelector&&(b=c.querySelector("block"))&&(b.removeAttribute("x"),b.removeAttribute("y"));c=module$contents$Blast$Storage_removeDeviceId_(c);c=Blockly.Xml.domToPrettyText(c);!0===a?(c=new Blob([c],{type:"text/xml"}),saveAs(c,module$contents$Blast$Storage_filename)):((a=document.getElementById("loadWorkspace-input").value)&&0!=a.length||(a="storage/"+module$contents$Blast$Storage_generatePath()),c=Blockly.Xml.domToText(c),module$contents$Blast$Storage_saveXML_(a,
c))};Blast.Storage.link=module$contents$Blast$Storage_link;
var module$contents$Blast$Storage_removeDeviceId_=function(a){var b=a.querySelectorAll("block");b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=c.getAttribute("type");if("things_webBluetooth"==d||"things_webHID"==d)if(c=c.firstElementChild){var f=c.textContent,h="things_webBluetooth"==d?Blast.Things.getWebBluetoothDevices():Blast.Things.getWebHIDDevices();d=void 0;h=$jscomp.makeIterator(h);for(var g=h.next();!g.done;g=h.next()){g=$jscomp.makeIterator(g.value);var m=
g.next().value;if(g.next().value===f){d=m;break}}c.textContent=d}}return a},module$contents$Blast$Storage_saveXML_=function(a,b){Blockly.hideChaff();fetch(a,{method:"PUT",body:b}).then(function(c){c.ok?(location.hash=a,Blockly.alert(module$contents$Blast$Storage_LINK_ALERT.replace("%1",window.location.href))):Blast.throwError(module$contents$Blast$Storage_HTTPREQUEST_ERROR)})},module$contents$Blast$Storage_load=function(){var a=document.getElementById("loadWorkspace-input").value;if(""==a)Blockly.alert("Enter a URI first.");
else{var b=a.split("/").pop();-1<b.indexOf(".")&&(module$contents$Blast$Storage_filename=b);module$contents$Blast$Storage_retrieveXML_(a)}};Blast.Storage.load=module$contents$Blast$Storage_load;
...
var module$contents$Blast$Storage_resetFileInput=function(){var a=document.getElementById("file-selector");a&&(a.value="");module$contents$Blast$Storage_filename="BLAST.xml"},module$contents$Blast$Storage_retrieveXML_=function(a){return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){Blockly.hideChaff();Blast.resetInterpreter();Blast.resetUi(Blast.status.READY);Blast.Things.webHidDevices=new Map;Blast.Things.webHidNames=new Map;Blast.Things.webBluetoothDevices=new Map;module$contents$Blast$Storage_resetFileInput();
fetch(a).then(function(c){if(c.ok)return c.text();Blast.throwError(module$contents$Blast$Storage_NOT_FOUND_ERROR.replace("%1",a))}).then(module$contents$Blast$Storage_loadXML);b.jumpToEnd()})},module$contents$Blast$Storage_loadXML=function(a){Blast.workspace.clear();try{var b=Blockly.Xml.textToDom(a)}catch(c){Blast.throwError(module$contents$Blast$Storage_XML_ERROR+"\nXML: "+b);return}b.querySelector('block[type="things_webBluetooth"]')||b.querySelector('block[type="things_webHID"]')?(module$contents$Blast$Storage_generatePairButtons(b),
document.getElementById("rcModal")&&(document.getElementById("rcModal").style.display="block")):(Blockly.Xml.domToWorkspace(b,Blast.workspace),module$contents$Blast$Storage_monitorChanges_(Blast.workspace))},module$contents$Blast$Storage_generatePairButtons=function(a){window.location.href.includes("mobile")?(window.app.openReconnectDialog(),module$contents$Blast$Storage_generatePairButtonsMobile_(a)):module$contents$Blast$Storage_generatePairButtonsDesktop_(a)},module$contents$Blast$Storage_generatePairButtonsDesktop_=
function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$74:f.$jscomp$loop$prop$type$74,$jscomp$loop$prop$name$75:f.$jscomp$loop$prop$name$75,$jscomp$loop$prop$block$76:f.$jscomp$loop$prop$block$76},h=b.next()){f.$jscomp$loop$prop$block$76=h.value;f.$jscomp$loop$prop$type$74=f.$jscomp$loop$prop$block$76.getAttribute("type");if("things_webBluetooth"==
f.$jscomp$loop$prop$type$74||"things_webHID"==f.$jscomp$loop$prop$type$74){f.$jscomp$loop$prop$name$75=f.$jscomp$loop$prop$block$76.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$75))continue;h=document.createElement("tr");var g=document.createElement("td");g.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$75));var m=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+f.$jscomp$loop$prop$name$75);
k.setAttribute("value","Pair");var l=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$75);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";l.appendChild(n);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=p.$jscomp$loop$prop$type$74?
("things_webHID"==p.$jscomp$loop$prop$type$74&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(v){0===v.length&&Blast.throwError("Connection failed or cancelled by User.");var w=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(w,v[0]);Blast.Things.addWebHidDevice(w,p.$jscomp$loop$prop$name$75);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).style.color=
"green";p.$jscomp$loop$prop$block$76.firstElementChild.textContent=w;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)})))}).catch(function(v){Blast.throwError("Connection failed or cancelled by User.");
console.error(v)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).style.color="green";p.$jscomp$loop$prop$block$76.firstElementChild.textContent=r.id;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));m.appendChild(k);h.appendChild(g);h.appendChild(m);h.appendChild(l);c.appendChild(h);d.push(f.$jscomp$loop$prop$name$75)}document.getElementById("rc-cancel").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectCancelHandler_()})}},module$contents$Blast$Storage_generatePairButtonsMobile_=function(a){for(var b=
a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$78:f.$jscomp$loop$prop$type$78,$jscomp$loop$prop$name$79:f.$jscomp$loop$prop$name$79,$jscomp$loop$prop$block$80:f.$jscomp$loop$prop$block$80},h=b.next())if(f.$jscomp$loop$prop$block$80=h.value,f.$jscomp$loop$prop$type$78=f.$jscomp$loop$prop$block$80.getAttribute("type"),"things_webBluetooth"==f.$jscomp$loop$prop$type$78||
"things_webHID"==f.$jscomp$loop$prop$type$78)if(f.$jscomp$loop$prop$name$79=f.$jscomp$loop$prop$block$80.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$79)){h=document.createElement("li");h.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$79);h.setAttribute("class","mdc-list-item");var g=document.createElement("span");g.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$79);g.setAttribute("class","mdc-list-item__graphic material-icons");g.setAttribute("aria-hidden","true");
g.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$78?"bluetooth_disabled":"usb_off";h.appendChild(g);g=document.createElement("span");g.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$79;g.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$79);m.innerHTML=
"disconnected";g.appendChild(m);h.appendChild(g);h.addEventListener("click",function(k){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$78?("things_webHID"==k.$jscomp$loop$prop$type$78&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$79);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$79).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).style.color="#0d30b1";k.$jscomp$loop$prop$block$80.firstElementChild.textContent=r;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=
!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;Blast.Things.addWebBluetoothDevice(n.id,k.$jscomp$loop$prop$name$79);
document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$79).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).style.color="#0d30b1";k.$jscomp$loop$prop$block$80.firstElementChild.textContent=n.id;module$contents$Blast$Storage_allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(h);d.push(f.$jscomp$loop$prop$name$79)}window.app.initLists()},module$contents$Blast$Storage_allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;
return!0},module$contents$Blast$Storage_allConnectedMobile_=function(){var a=document.getElementById("rc-list").querySelectorAll("[id=rc-status-]");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("disconnected"==document.getElementById("rc-status-"+b.value.textContent).innerHTML)return!1;return!0},module$contents$Blast$Storage_reconnectDoneHandler_=function(a){window.location.href.includes("mobile")?document.getElementById("rc-dialog").style.display="none":document.getElementById("rcModal").style.display=
"none";Blockly.Xml.domToWorkspace(a,Blast.workspace);module$contents$Blast$Storage_monitorChanges_(Blast.workspace)},module$contents$Blast$Storage_reconnectCancelHandler_=function(){document.getElementById("rcModal").style.display="none"},module$contents$Blast$Storage_monitorChanges_=function(a){function b(){var f=Blockly.Xml.workspaceToDom(a);f=Blockly.Xml.domToText(f);d!=f&&(window.location.hash="",a.removeChangeListener(b))}var c=Blockly.Xml.workspaceToDom(a),d=Blockly.Xml.domToText(c);a.addChangeListener(b)},
module$contents$Blast$Storage_generatePath=function(){for(var a=[],b=0;12>b;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(62*Math.random())));return a.join("")};window.addEventListener("load",function(){var a=window.location.hash;if(a){a=a.substring(1);try{module$contents$Blast$Storage_retrieveXML_(a)}catch(b){Blast.throwError("Could not load file."),console.error(b)}}});Blast.Ui={};
var module$contents$Blast$Ui_TABS_=["workspace","javascript","xml","deviceLogs"],module$contents$Blast$Ui_selected_="workspace",module$contents$Blast$Ui_playIcon_='<span class="icon material-icons">play_arrow</span>',module$contents$Blast$Ui_stopIcon_='<span class="icon material-icons">stop</span>',module$contents$Blast$Ui_messageCounter_=0,module$contents$Blast$Ui_messageOutputContainer=null,module$contents$Blast$Ui_statusContainer=null,module$contents$Blast$Ui_uriInput=null,module$contents$Blast$Ui_runButton=null,
module$contents$Blast$Ui_addElementToOutputContainer=function(a){100<module$contents$Blast$Ui_messageCounter_&&module$contents$Blast$Ui_messageOutputContainer.firstChild.remove();module$contents$Blast$Ui_messageOutputContainer.appendChild(a,module$contents$Blast$Ui_messageOutputContainer.firstChild);module$contents$Blast$Ui_messageOutputContainer.scrollTop=module$contents$Blast$Ui_messageOutputContainer.scrollHeight},module$contents$Blast$Ui_addMessage=function(a,b){var c="media/logo-512x512.png";
window.location.href.includes("mobile")&&(c="../"+c);document.hasFocus()||navigator.serviceWorker.ready.then(function(g){g.showNotification("Blast",{body:a,icon:c,vibrate:[200,100,200,100,200,100,200]})});var d=document.createElement("div");d.classList.add("message");b&&d.classList.add(b+"-message");d.id="message-"+module$contents$Blast$Ui_messageCounter_++;var f=document.createTextNode(a);d.appendChild(f);f=document.createElement("span");f.classList.add("time");f.innerHTML=(new Date).toLocaleTimeString();
d.appendChild(f);f=function(){document.getElementById("debugModal").style.display="block";var g=document.getElementById("debug-tbody");g.innerHTML="";var m=document.createElement("tr");m.innerHTML="<td>BLAST</td><td>"+rev+"</td>";g.appendChild(m);for(var k in navigator)if("string"===typeof navigator[k]){m=document.createElement("tr");var l=document.createElement("td"),n=document.createElement("td");l.innerHTML=k;n.innerHTML=navigator[k];m.appendChild(l);m.appendChild(n);g.appendChild(m)}};if("error"===
b){b=document.createElement("span");b.classList.add("debug-info");var h=document.createElement("a");h.innerHTML="show debug info";h.href="#";h.onclick=f;b.appendChild(h);d.appendChild(b)}module$contents$Blast$Ui_addElementToOutputContainer(d)};Blast.Ui.addMessage=module$contents$Blast$Ui_addMessage;
...
Blockly.svgResize(Blast.workspace)},module$contents$Blast$Ui_renderContent_=function(){var a=document.getElementById("content_xml"),b=Blockly.Xml.workspaceToDom(Blast.workspace);b=Blockly.Xml.domToPrettyText(b);a.value=b;a.focus();a=document.getElementById("content_javascript");a.textContent=Blast.latestCode.replace(/highlightBlock\('.*'\);\n/gm,"");a.className=a.className.replace("prettyprinted","");"object"==typeof PR&&PR.prettyPrint()};Blast.Ui.renderContent_=module$contents$Blast$Ui_renderContent_;
var module$contents$Blast$Ui_addToLog=function(a,b,c){var d=document.getElementById("content_deviceLogs"),f=document.createElement("div");f.className="logItem";if(b){var h=document.createElement("span");h.classList.add("log-adapter");"bluetooth"===b.toLowerCase()?(h.textContent="Bluetooth",h.classList.add("log-bluetooth")):"HID"===b.toUpperCase()?(h.textContent="HID",h.classList.add("log-hid")):"eddystone"===b.toLowerCase()?(h.textContent="Eddystone",h.classList.add("log-eddystone")):h.textContent=
b;f.appendChild(h)}c&&(b=document.createElement("span"),b.classList.add("log-device"),b.textContent=c,f.appendChild(b));c=new Date;c="["+(("0"+c.getHours()).slice(-2)+":"+("0"+c.getMinutes()).slice(-2)+":"+("0"+c.getSeconds()).slice(-2))+"] ";b=document.createElement("span");b.classList.add("log-timestamp");b.textContent=c;f.appendChild(b);c=document.createElement("span");c.classList.add("log-message");c.innerHTML=a;f.appendChild(c);d.appendChild(f);d.scrollTop=d.scrollHeight};Blast.Ui.addToLog=module$contents$Blast$Ui_addToLog;
var module$contents$Blast$Ui_ClearOutputContainer=function(){for(var a=module$contents$Blast$Ui_messageOutputContainer;"clearOutputButton"!==a.lastChild.id;)console.log(a.lastChild.id),a.removeChild(a.lastChild)},module$contents$Blast$Ui_ClearLog=function(){for(var a=document.getElementById("content_deviceLogs");"clearDeviceLogsButton"!==a.lastChild.id;)a.removeChild(a.lastChild)},module$contents$Blast$Ui_setStatus=function(a){if(a===Blast.status.RUNNING){var b=Blast.stopJS;var c=module$contents$Blast$Ui_stopIcon_;
var d="Stop the execution"}else b=Blast.runJS,c=module$contents$Blast$Ui_playIcon_,d="Run block program";module$contents$Blast$Ui_runButton.onclick=b;module$contents$Blast$Ui_runButton.title=d;module$contents$Blast$Ui_runButton.innerHTML=c;module$contents$Blast$Ui_statusContainer.innerHTML=a};Blast.Ui.setStatus=module$contents$Blast$Ui_setStatus;
var module$contents$Blast$Ui_init=function(){module$contents$Blast$Ui_uriInput=document.getElementById("loadWorkspace-input");module$contents$Blast$Ui_runButton=document.getElementById("runButton");module$contents$Blast$Ui_messageOutputContainer=document.getElementById("msgOutputContainer");module$contents$Blast$Ui_statusContainer=document.getElementById("statusContainer");if(!window.location.href.includes("mobile")){var a=function(){for(var c=$jscomp.makeIterator(module$contents$Blast$Ui_TABS_),
d=c.next();!d.done;d=c.next())d=document.getElementById("content_"+d.value),d.style.top="35px",d.style.left="0px",d.style.height=window.innerHeight-35+"px",d.style.width=window.innerWidth-450+"px";Blast.workspace&&Blast.workspace.getToolbox().width&&(document.getElementById("tab_workspace").style.minWidth=Blast.workspace.getToolbox().width-38+"px")};window.addEventListener("resize",a,!1);a();module$contents$Blast$Ui_tabClick_(module$contents$Blast$Ui_selected_);a=$jscomp.makeIterator(module$contents$Blast$Ui_TABS_);
for(var b=a.next();!b.done;b=a.next())b=b.value,Blast.bindClick("tab_"+b,function(c){return function(){module$contents$Blast$Ui_tabClick_(c)}}(b));module$contents$Blast$Ui_setStatus(Blast.status.READY);Blast.bindClick("UriLoadButton",module$contents$Blast$Storage_load);Blast.bindClick("UriSaveButton",module$contents$Blast$Storage_link);Blast.bindClick("saveButton",function(){module$contents$Blast$Storage_link(!0)});Blast.bindClick("clearDeviceLogsButton",module$contents$Blast$Ui_ClearLog);Blast.bindClick("clearOutputButton",
module$contents$Blast$Ui_ClearOutputContainer);module$contents$Blast$Ui_uriInput.addEventListener("keyup",function(c){13===c.keyCode&&module$contents$Blast$Storage_load()})}};Blast.Ui.initUi=module$contents$Blast$Ui_init;Blast.Toolbox={};
var module$contents$Blast$Toolbox_defaultToolbox={kind:"categoryToolbox",contents:[{kind:"CATEGORY",contents:[],name:"Things and Resources",custom:"THINGS",colour:"60"},{kind:"sep",gap:"32"},{kind:"CATEGORY",contents:[],name:"Properties",colour:"255"},{kind:"CATEGORY",contents:[],name:"Actions",colour:"0"},{kind:"CATEGORY",contents:[],name:"States and Events",custom:"STATES",colour:"180"},{kind:"sep",gap:"32"},{kind:"CATEGORY",contents:[],name:"Requests and Queries",colour:"0"},{kind:"sep",gap:"32"},
{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"while_until"},{kind:"BLOCK",type:"break_continue"},{kind:"BLOCK",type:"conditional_statement"},{kind:"BLOCK",type:"controls_forEach"}],name:"Control Flow",colour:"120"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"logic_compare"},{kind:"BLOCK",type:"logic_operation"},{kind:"BLOCK",type:"logic_negate"}],name:"Boolean Expressions",colour:"210"},{kind:"CATEGORY",contents:[],name:"Functions",colour:"290",custom:"PROCEDURE"},{kind:"CATEGORY",contents:[{kind:"BLOCK",
type:"lists_create_empty"},{kind:"BLOCK",type:"lists_create_with"},{kind:"BLOCK",type:"lists_repeat"},{kind:"BLOCK",type:"lists_length"},{kind:"BLOCK",type:"lists_isEmpty"},{kind:"BLOCK",type:"lists_indexOf"},{kind:"BLOCK",type:"lists_getIndex"},{kind:"BLOCK",type:"lists_setIndex"},{kind:"BLOCK",type:"lists_getSublist"},{kind:"BLOCK",type:"lists_sort"},{kind:"BLOCK",type:"lists_split"},{kind:"BLOCK",type:"lists_reverse"}],name:"Lists",colour:"310"},{kind:"CATEGORY",contents:[],name:"Variables",custom:"VARIABLE",
colour:"330"},{kind:"sep",gap:"32"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"string"},{kind:"BLOCK",type:"string_multiline"},{kind:"BLOCK",type:"string_join"},{kind:"BLOCK",type:"string_length"},{kind:"BLOCK",type:"string_isEmpty"},{kind:"BLOCK",type:"string_indexOf"},{kind:"BLOCK",type:"string_charAt"},{kind:"BLOCK",type:"string_getSubstring"},{kind:"BLOCK",type:"string_changeCase"},{kind:"BLOCK",type:"string_trim"},{kind:"BLOCK",type:"string_count"},{kind:"BLOCK",type:"string_replace"},{kind:"BLOCK",
type:"string_reverse"},{kind:"BLOCK",type:"string_showPrompt"}],name:"Strings",colour:"160"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"number_value"},{kind:"BLOCK",type:"number_arithmetic"},{kind:"BLOCK",type:"number_single"},{kind:"BLOCK",type:"number_trig"},{kind:"BLOCK",type:"number_constant"},{kind:"BLOCK",type:"number_property"},{kind:"BLOCK",type:"number_round"},{kind:"BLOCK",type:"number_on_list"},{kind:"BLOCK",type:"number_modulo"},{kind:"BLOCK",type:"number_constrain"},{kind:"BLOCK",
type:"number_random"},{kind:"BLOCK",type:"number_random_float"},{kind:"BLOCK",type:"number_atan2"}],name:"Numbers",colour:"230"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"logic_boolean"}],name:"Booleans",colour:"210"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"colour_picker"},{kind:"BLOCK",type:"colour_random"}],name:"Colours",colour:"20"}]},module$contents$Blast$Toolbox_currentToolbox=module$contents$Blast$Toolbox_defaultToolbox;Blast.Toolbox.currentToolbox=module$contents$Blast$Toolbox_defaultToolbox;
var module$contents$Blast$Toolbox_init=function(){Blast.workspace.registerToolboxCategoryCallback("STATES",module$contents$Blast$States_flyoutCategory);Blast.workspace.registerToolboxCategoryCallback("THINGS",Blast.Things.flyoutCategory)};Blast.Toolbox.initToolbox=module$contents$Blast$Toolbox_init;var module$contents$Blast$Toolbox_getCategory=function(a){return module$contents$Blast$Toolbox_defaultToolbox.contents.find(function(b){return b.name?b.name.toLowerCase()===a.toLowerCase():!1})};
Blast.Toolbox.getCategory=module$contents$Blast$Toolbox_getCategory;var module$contents$Blast$Toolbox_addBlock=function(a,b,c){a={kind:"BLOCK",type:a,blockxml:c};(b=module$contents$Blast$Toolbox_getCategory(b))&&b.contents.push(a)};Blast.Toolbox.addBlock=module$contents$Blast$Toolbox_addBlock;Blast.config={};Blast.workspace=null;Blast.highlightPause=!1;Blast.apiFunctions=[];Blast.asyncApiFunctions=[];Blast.latestCode="";Blast.Interpreter=null;Blast.Interrupted=!1;Blast.eventInWorkspace=[];Blast.deviceEventHandlers=[];Blast.cleanUpFunctions=[];Blast.runner_=null;Blast.status={READY:"ready",RUNNING:"running",STOPPED:"stopped",ERROR:"error"};Blast.bindClick=function(a,b){"string"==typeof a&&(a=document.getElementById(a));a.addEventListener("click",b,!0);a.addEventListener("touchend",b,!0)};
Blast.importPrettify=function(){var a=document.createElement("script");a.setAttribute("src","https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js");document.head.appendChild(a)};Blast.getBBox_=function(a){var b=a.offsetHeight,c=a.offsetWidth,d=0,f=0;do d+=a.offsetLeft,f+=a.offsetTop,a=a.offsetParent;while(a);return{height:b,width:c,x:d,y:f}};
Blast.init=function(){window.location.href.includes("mobile")||(Blast.workspace=Blockly.inject("content_workspace",{media:"media/",toolbox:module$contents$Blast$Toolbox_defaultToolbox,zoom:{controls:!0,wheel:!0}}),module$contents$Blast$Toolbox_init(),Blockly.svgResize(Blast.workspace),module$contents$Blast$Ui_init(),module$contents$Blast$Ui_setStatus(Blast.status.READY),Blast.generateCode(),Blast.workspace.addChangeListener(function(a){a instanceof Blockly.Events.Ui||(Blast.generateCode(),module$contents$Blast$States_generateCode(),
module$contents$Blast$Ui_renderContent_())}),module$contents$Blast$Ui_addMessage("Actionblock output will be displayed here","info"),window.setTimeout(Blast.importPrettify,1))};Blast.highlightBlock=function(a){Blast.workspace.highlightBlock(a);Blast.highlightPause=!0};Blast.resetUi=function(a){Blast.workspace.highlightBlock(null);Blast.highlightPause=!1;module$contents$Blast$Ui_setStatus(a)};
...
Blast.resetInterpreter=function(){Blast.Interpreter=null;Blast.runner_&&(clearTimeout(Blast.runner_),Blast.runner_=null);Blast.Bluetooth.tearDown();Blast.removeDeviceHandlers();module$contents$Blast$States_clearIntervalEvents();for(var a=$jscomp.makeIterator(Blast.cleanUpFunctions),b=a.next();!b.done;b=a.next())b=b.value,b()};
...
Blast.runJS=function(){Blast.resetUi(Blast.status.RUNNING);module$contents$Blast$Ui_addMessage("execution started","info");null==Blast.Interpreter&&(Blast.highlightPause=!1,Blast.Interpreter=new Interpreter(Blast.latestCode,initApi),Blast.runner_=function(){if(Blast.Interpreter)try{Blast.Interrupted?setTimeout(Blast.runner_,1):Blast.Interpreter.step()?setTimeout(Blast.runner_,1):Blast.States.statesInterpreter||0<Blast.eventInWorkspace.length||(Blast.resetUi(Blast.status.READY),module$contents$Blast$Ui_addMessage("execution completed",
"info"),Blast.resetInterpreter())}catch(a){Blast.throwError(a),Blast.resetInterpreter(),console.error(a)}},Blast.runner_())};Blast.stopJS=function(){Blast.resetInterpreter();Blast.States.statesInterpreter&&module$contents$Blast$States_resetInterpreter();Blast.resetUi(Blast.status.STOPPED)};
Blast.throwError=function(a){a||(a="Error executing program - See console for details.");module$contents$Blast$Ui_addMessage(a,"error");module$contents$Blast$Ui_setStatus(Blast.status.ERROR);Blast.resetInterpreter();module$contents$Blast$Ui_addMessage("Execution stopped","info")};Blast.handleFetchErrors=function(a,b){a.ok||(b?Blast.throwError(b):Blast.throwError("Error processing HTTP Request."));return a};window.addEventListener("load",Blast.init);Blast.Things={};Blast.Things.webBluetoothDevices=new Map;Blast.Things.webHidNames=new Map;Blast.Things.webHidDevices=new Map;
Blast.Things.flyoutCategory=function(a){var b=[],c=document.createElement("label");c.setAttribute("text","WebBluetooth Blocks");b.push(c);c=document.createElement("button");c.setAttribute("text","pair via webBluetooth");c.setAttribute("callbackKey","CREATE_WEBBLUETOOTH");a.registerButtonCallback("CREATE_WEBBLUETOOTH",function(h){Blast.Things.createWebBluetoothButtonHandler()});b.push(c);c=Blast.Things.flyoutCategoryBlocksWB(a);b=b.concat(c);c=document.createElement("label");c.setAttribute("text",
"WebHID Blocks");b.push(c);c=document.createElement("button");c.setAttribute("text","connect via webHID");c.setAttribute("callbackKey","CREATE_WEBHID");a.registerButtonCallback("CREATE_WEBHID",function(h){Blast.Things.createWebHidButtonHandler()});b.push(c);a=Blast.Things.flyoutCategoryBlocksWHid(a);b=b.concat(a);a=document.createElement("label");a.setAttribute("text","additional identifiers");b.push(a);a=Blockly.utils.xml.createElement("block");a.setAttribute("type","uri");b.push(a);a=Blockly.utils.xml.createElement("block");
a.setAttribute("type","uri_from_string");b.push(a);a=document.createElement("label");a.setAttribute("text","example audio URIs");b.push(a);a=$jscomp.makeIterator(["https://studio.code.org/blockly/media/skins/dance/win.mp3","https://studio.code.org/blockly/media/click.mp3","https://upload.wikimedia.org/wikipedia/commons/2/25/243020_plasterbrain_game-start.ogg","https://upload.wikimedia.org/wikipedia/commons/d/d9/Wilhelm_Scream.ogg"]);for(c=a.next();!c.done;c=a.next()){c=c.value;var d=Blockly.utils.xml.createElement("block");
d.setAttribute("type","uri");var f=Blockly.utils.xml.createElement("field");f.setAttribute("name","URI");f.textContent=c;d.appendChild(f);b.push(d)}return b};Blast.Things.flyoutCategoryBlocksWHid=function(){var a=[];if(0<Blast.Things.webHidDevices.size&&Blockly.Blocks.things_webHID){var b=Blockly.utils.xml.createElement("block");b.setAttribute("type","things_webHID");b.setAttribute("gap",8);a.push(b)}return a};
...
Blast.Things.addWebBluetoothDevice=function(a,b){var c=function(d,f){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(h){if(h)if(Blast.Things.webBluetoothDevices.has(h)){var g="Name %1 already exists".replace("%1",h);Blockly.alert(g,function(){c(h,f)})}else Blast.Things.webBluetoothDevices.set(h,f);else Blockly.alert("Name cannot be empty",function(){c(h,f)})})};c(b,a)};
Blast.Things.createWebHidButtonHandler=function(){module$contents$Blast$Ui_addToLog("Requesting webHID device...","HID");navigator.hid.requestDevice({filters:[]}).then(function(a){if(0===a.length)Blast.throwError("Connection failed or cancelled by User.");else{var b=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(b,a[0]);Blast.Things.addWebHidDevice(b,a[0].productName);Blast.workspace.refreshToolboxSelection();module$contents$Blast$Ui_addToLog("Connected",
"HID",a[0].productName)}}).catch(function(a){Blast.throwError(a)})};Blast.Things.addWebHidDevice=function(a,b){var c=function(d,f){Blockly.Variables.promptName("Connection established! Now give your device a name.",d,function(h){if(h)if(Blast.Things.webHidNames.has(h)){var g="Name %1 already exists".replace("%1",h);Blockly.alert(g,function(){c(h,f)})}else Blast.Things.webHidNames.set(h,f);else Blockly.alert("Name cannot be empty",function(){c(h,f)})})};c(b,a)};Blast.Bluetooth={};Blast.Bluetooth.optionalServices=[];Blast.Bluetooth.scanBlocks=[];Blast.Bluetooth.LEScanResults={};Blast.Bluetooth.isLEScanRunning=!1;Blast.Bluetooth.eventListeners=[];Blast.Bluetooth.charEventListeners={};function hexStringToArrayBuffer(a){a=a.replace(/^0x/,"");0!=a.length%2&&(a="0"+a);var b=a.match(/[G-Z\s]/i);b&&console.log("WARNING: found non-hex characters",b);a=a.match(/[\dA-F]{2}/gi).map(function(c){return parseInt(c,16)});return(new Uint8Array(a)).buffer}
...
Blast.throwError("Error disconnecting from Bluetooth device "+a),console.error(d),f.jumpToEnd()}})};
...
break;case 3:f=h.enterCatchBlock(),console.error(f),Blast.throwError("The device is not compatible with the connected block.");case 4:return h.return(d)}})};
...
c+"</code> from service <code>"+b+"</code>","Bluetooth",a);g.leaveTryBlock(4);break;case 3:h=g.enterCatchBlock(),console.error(h),Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(f)}})};
...
c+"</code> from service <code>"+(b+"</code> - value: <code>"+f.toString()+"</code>"),"Bluetooth",a),g.return(f);case 3:h=g.enterCatchBlock(),console.error(h),Blast.throwError("Error reading from Bluetooth device "+a),g.jumpToEnd()}})};Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=h.yieldResult;f=(new TextDecoder).decode(d);return h.return(f)})};
Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,f,h,g,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=k.yieldResult;d instanceof DataView||(d=new DataView(value));f=new Uint8Array(d.buffer);h=f.length;g=buffer.Buffer.from(f);m=g.readUIntBE(0,h);return k.return(m)})};
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=h.yieldResult;f=(new Uint8Array(d.buffer)).reduce(function(g,m){return g+("0"+m.toString(16)).slice(-2)},"");return h.return(f)})};
...
Blast.Bluetooth.Eddystone.setActiveSlot=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return module$contents$Blast$Ui_addToLog("Setting Eddystone active slot to <code>"+b+"</code>...","Eddystone",a),d.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2);if(3!=d.nextAddress)return c=d.yieldResult,(0>b||b>=c.maxSlots)&&Blast.throwError("Eddystone slot is not valid.\n         On this device the slot must be between 0 and "+(c.maxSlots-1)+"."),
d.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC,b.toString(16)),3);module$contents$Blast$Ui_addToLog("Eddystone active slot set to <code>"+b+"</code>","Eddystone",a);return d.return()})};
...
a);return c.return(b)})};
Blast.Bluetooth.Eddystone.getAdvertisingData=function(a){var b,c,d,f,h,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return module$contents$Blast$Ui_addToLog("Reading Eddystone advertising data...","Eddystone",a),b=function(k){var l=parseInt(k.substring(2,4),16),n=k.substring(4,24);k=k.substring(25,37);return{frameType:"UID",txPower:l,namespace:n,instance:k}},c=function(k){var l=parseInt(k.substring(2,4),16);switch(k.substring(4,6)){case "00":var n="http://www.";
break;case "01":n="https://www.";break;case "02":n="http://";break;case "03":n="https://";break;default:Blast.throwError("Eddystone URL scheme is not valid.");return}var p=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");k=k.substring(6,k.length);for(var q=0;q<k.length;q+=2){var r=parseInt(k.substring(q,q+2),16);n=r<p.length?n+p[r]:n+String.fromCharCode(r)}return{frameType:"URL",txPower:l,url:n}},d=function(k){var l=parseInt(k.substring(4,8),16),n=parseInt(k.substring(8,
10),16)+parseInt(k.substring(10,12),16)/100,p=parseInt(k.substring(12,20),16);k=parseInt(k.substring(20,28),16);return{frameType:"TLM",batteryVoltage:l,beaconTemperature:n,pduCount:p,timeSinceReboot:k}},m.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);f=m.yieldResult;module$contents$Blast$Ui_addToLog("Got Eddystone advertising data: <code>"+f+"</code>","Eddystone",a);h=f.substring(0,2);switch(h){case "00":return g=
b(f),m.return(g.namespace+g.instance);case "10":return g=c(f),m.return(g.url);case "20":return g=d(f),m.return(g.beaconTemperature);case "30":return Blast.throwError("EID frame type is not supported by blast."),m.return();default:return Blast.throwError("Eddystone frame type is not valid."),m.return()}})};
Blast.Bluetooth.Eddystone.setAdvertisingData=function(a,b,c){var d,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress){module$contents$Blast$Ui_addToLog("Set Eddystone advertising data...","Eddystone",a);d=function(m){for(var k=["http://www.","https://www.","http://","https://"],l=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),n=[],p=0,q=new TextEncoder("utf-8"),r=0;r<k.length;r++)if(m.startsWith(k[r])){n.push(r);p=k[r].length;
break}for(;p<m.length;){k=p;for(r=0;r<l.length;r++)if(m.startsWith(l[r],p)){n.push(r);p+=l[r].length;break}k===p&&(n.push(q.encode(m[p])[0]),p++)}if(18<n.length)Blast.throwError("URL is too long.");else return n.splice(0,0,16),new Uint8Array(n)};if("URL"===b)f=d(c);else if("UID"===b){if(!/^[0-9A-Fa-f]{32}$/.test(c))return Blast.throwError("Eddystone UID must be 32 hexadecimal characters."),g.return();f="0x00"+c}return g.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,
Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,f),2)}h=g.yieldResult;module$contents$Blast$Ui_addToLog("Eddystone advertising data set to <code>"+c+"</code>","Eddystone",a);return g.return(h)})};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(f){f=f?f.toString():"";return Blast.highlightBlock(f)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(f){Blast.Interrupted=f};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(f,h){return module$contents$Blast$States_eventChecker(f,h)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return module$contents$Blast$States_startEventChecker()}));c=function(f){return prompt(f)};a.setProperty(b,"prompt",a.createNativeFunction(c))};var COLOUR_RGB_XML='\n<block type="colour_rgb">\n    <value name="RED">\n        <block type="math_number">\n            <field name="NUM">100</field>\n        </block>\n    </value>\n    <value name="GREEN">\n        <block type="math_number">\n            <field name="NUM">50</field>\n        </block>\n    </value>\n    <value name="BLUE">\n        <block type="math_number">\n            <field name="NUM">0</field>\n        </block>\n    </value>\n</block>';
module$contents$Blast$Toolbox_addBlock("colour_rgb","colours",COLOUR_RGB_XML);var COLOUR_BLEND_XML='\n<block type="colour_blend">\n    <value name="COLOUR1">\n        <block type="colour_picker">\n            <field name="COLOUR">#ff0000</field>\n        </block>\n    </value>\n    <value name="COLOUR2">\n        <block type="colour_picker">\n            <field name="COLOUR">#3333ff</field>\n        </block>\n    </value>\n    <value name="RATIO">\n        <block type="math_number">\n            <field name="NUM">50</field>\n        </block>\n    </value>\n</block>';
module$contents$Blast$Toolbox_addBlock("colour_blend","colours",COLOUR_BLEND_XML);Blockly.Blocks.repeat=Blockly.Blocks.controls_repeat_ext;Blockly.Blocks["for"]=Blockly.Blocks.controls_for;Blockly.Blocks.while_until=Blockly.Blocks.controls_whileUntil;Blockly.Blocks.break_continue=Blockly.Blocks.controls_flow_statements;Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES.push("repeat","while_until","for");var REPEAT_XML='\n<block type="repeat">\n  <value name="TIMES">\n    <block type="math_number">\n      <field name="NUM">10</field>\n    </block>\n  </value>\n</block>';
module$contents$Blast$Toolbox_addBlock("repeat","Control Flow",REPEAT_XML);var FOR_XML='\n<block type="for">\n  <value name="FROM">\n    <block type="math_number">\n      <field name="NUM">0</field>\n    </block>\n  </value>\n  <value name="TO">\n    <block type="math_number">\n      <field name="NUM">5</field>\n    </block>\n  </value>\n  <value name="BY">\n    <block type="math_number">\n      <field name="NUM">1</field>\n    </block>\n  </value>\n</block>';
module$contents$Blast$Toolbox_addBlock("for","Control Flow",FOR_XML);
...
module$contents$Blast$Toolbox_addBlock("wait_seconds","Control Flow",WAIT_SECONDS_XML);Blockly.Blocks.controls_if_if={init:function(){this.appendDummyInput().appendField("%{BKY_CONTROLS_IF_IF_TITLE_IF}");this.setNextStatement(!0,null);this.contextMenu=!1;this.setColour(120);this.setTooltip("%{BKY_CONTROLS_IF_IF_TOOLTIP}")}};
...
Blockly.Procedures.flyoutCategory=function(a){function b(h,g){h=$jscomp.makeIterator(h);for(var m=h.next();!m.done;m=h.next()){m=m.value;var k=m[0],l=m[1];m=Blockly.utils.xml.createElement("block");m.setAttribute("type",g);m.setAttribute("gap",16);var n=Blockly.utils.xml.createElement("mutation");n.setAttribute("name",k);m.appendChild(n);k=$jscomp.makeIterator(l);for(l=k.next();!l.done;l=k.next()){l=l.value;var p=Blockly.utils.xml.createElement("arg");p.setAttribute("name",l);n.appendChild(p)}c.push(m)}}
...
Blockly.JavaScript.event=function(a){var b=a.getFieldValue("entersExits"),c=a.getFieldValue("NAME"),d=Blockly.JavaScript.statementToCode(a,"statements");Blockly.JavaScript.definitions_.eventChecker="startEventChecker()";if(c=module$contents$Blast$States_getDefinition(c,Blast.workspace))c=Blockly.JavaScript.valueToCode(c,"state_condition",Blockly.JavaScript.ORDER_NONE),"ENTERS"!=b&&(c="!("+c+")"),module$contents$Blast$States_addEventCode(a.id,'if(eventChecker("'+a.id+'", '+c+")) {\n        setInterrupt(true);\n        "+
...
var sendHttpRequest=function(a,b,c,d,f,h){var g,m,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty"),g=JSON.parse(c),m={method:b,headers:new Headers(g)},"GET"!==b&&d&&(m.body=d),p.setCatchFinallyBlocks(2),p.yield(fetch(a,m),4);case 4:return k=p.yieldResult,k.ok?"status"==f?(h(k.status),p.return()):p.yield(k.text(),5):(Blast.throwError("Failed to get "+
a+", Error: "+k.status+" "+k.statusText),p.return());case 5:l=p.yieldResult;h(l);p.leaveTryBlock(0);break;case 2:n=p.enterCatchBlock(),Blast.throwError("Failed to get "+a+", Error: "+n.message),p.jumpToEnd()}})};Blast.asyncApiFunctions.push(["sendHttpRequest",sendHttpRequest]);
...
var urdfQueryWrapper=function(a,b,c,d){var f,h,g,m,k,l,n,p,q,r,t,v,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return u.setCatchFinallyBlocks(2),u.yield(fetch(a),4);case 4:return f=u.yieldResult,f.ok?u.yield(f.text(),5):(Blast.throwError("Failed to get "+a+", Error: "+f.status+" "+f.statusText),u.return());case 5:return h=u.yieldResult,urdf.clear(),g={format:b},u.yield(urdf.load(h,g),6);case 6:return u.yield(urdf.query(c),7);case 7:f=u.yieldResult;
u.leaveTryBlock(3);break;case 2:m=u.enterCatchBlock(),Blast.throwError("Failed to get "+a+", Error: "+m.message);case 3:if("boolean"===typeof f)return d(f),u.return();k=Array(f.length);l=$jscomp.makeIterator(f);for(n=l.next();!n.done;n=l.next()){p=n.value;q=Array(Object.keys(p).length);r=$jscomp.makeIterator(Object.values(p));for(t=r.next();!t.done;t=r.next())v=t.value,q.push(v.value);k.push(q)}w=Blast.Interpreter.nativeToPseudo(k);d(w);u.jumpToEnd()}})};
Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var displayText=function(a){module$contents$Blast$Ui_addMessage(a)};Blast.apiFunctions.push(["displayText",displayText]);Blockly.JavaScript.display_table=function(a){return"displayTable("+Blockly.JavaScript.valueToCode(a,"table",Blockly.JavaScript.ORDER_NONE)+");\n"};
var displayTable=function(a){a=Blast.Interpreter.pseudoToNative(a);if(0==a.length)module$contents$Blast$Ui_addMessage("empty table");else{var b=document.createElement("table");b.classList.add("output_table");a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){var d=c.value;c=document.createElement("tr");if(void 0!==d){d=$jscomp.makeIterator(d);for(var f=d.next();!f.done;f=d.next())if(f=f.value,void 0!==f){var h=document.createElement("td");h.innerHTML=f;c.appendChild(h)}b.appendChild(c)}}Blast.Ui.addElementToOutputContainer(b)}};
...
var playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,f){var h=new Audio(a);h.preload="auto";h.autoplay=!0;h.onerror=function(g){Blast.throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(g);f(g)};h.onended=d}),2);b();c.jumpToEnd()})};Blast.asyncApiFunctions.push(["playAudio",playAudio]);Blockly.JavaScript.capture_image=function(a){return["captureImage()",Blockly.JavaScript.ORDER_NONE]};
var captureImage=function(a){var b,c,d,f,h,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return b=document.createElement("video"),b.id="video",b.setAttribute("autoplay","autoplay"),b.setAttribute("muted",!0),b.style.display="none",document.body.appendChild(b),c={video:!0},m.yield(navigator.mediaDevices.getUserMedia(c),2);if(3!=m.nextAddress)return d=m.yieldResult,b.srcObject=d,f=document.createElement("canvas"),h=f.getContext("2d"),m.yield(new Promise(function(k,
l){b.onloadedmetadata=function(){f.width=b.videoWidth;f.height=b.videoHeight;h.drawImage(b,0,0,f.width,f.height);k()};video.onerror=function(n){Blast.throwError("Error trying to capture image from camera. See console for details");console.error(n);l(n)}}),3);g=f.toDataURL("image/png");b.srcObject.getTracks().forEach(function(k){return k.stop()});b.remove();f.remove();a(g);m.jumpToEnd()})};Blast.asyncApiFunctions.push(["captureImage",captureImage]);
Blockly.JavaScript.display_image=function(a){return"displayImage("+Blockly.JavaScript.valueToCode(a,"image",Blockly.JavaScript.ORDER_NONE)+");\n"};var displayImage=function(a){var b=document.createElement("img");b.src=a;b.classList.add("output_image");Blast.Ui.addElementToOutputContainer(b)};Blast.apiFunctions.push(["displayImage",displayImage]);Blockly.JavaScript.get_signal_strength_wb=function(a){return["getRSSIWb("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE)+")",Blockly.JavaScript.ORDER_NONE]};
var getRSSIWb=function(a,b){var c,d,f,h,g,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(navigator.bluetooth.getDevices(),2);c=k.yieldResult;d=null;f=$jscomp.makeIterator(c);for(h=f.next();!h.done;h=f.next())if(g=h.value,g.id===a){d=g;break}null==d&&Blast.throwError("Error pairing with Bluetooth device.");m=new AbortController;d.addEventListener("advertisementreceived",function(l){return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){m.abort();
b(l.rssi);n.jumpToEnd()})});return k.yield(d.watchAdvertisements({signal:m.signal}),0)})};Blast.asyncApiFunctions.push(["getRSSIWb",getRSSIWb]);
...
var switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(!a)return Blast.throwError("No LED Controller is set."),c(),f.return();d="7e000503"+b.substring(1,7)+"00ef";return f.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),2)}c();f.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.blinkstick_set_colors={init:function(){this.appendValueInput("COLOUR").setCheck("Colour").appendField("write colour property");this.appendValueInput("index").setCheck("Number").appendField("of LED #");this.appendValueInput("thing").setCheck("Thing").appendField("to BlinkStick");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Set the color properties of a tulogic BlinkStick.");this.setHelpUrl("https://www.blinkstick.com/")}};
...
var blinkstickSetColors=function(a,b,c,d){var f,h,g,m,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:if(0>b||7<b)return Blast.throwError("BlinkStick index must be between 0 and 7."),d(),n.return();if(!a)return Blast.throwError("No BlinkStick block set."),d(),n.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Blinkstick via webHID."),d(),n.return();if(f.opened){n.jumpTo(2);
break}n.setCatchFinallyBlocks(3);return n.yield(f.open(),5);case 5:n.leaveTryBlock(2);break;case 3:n.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==f.vendorId||16869!==f.productId)return Blast.throwError("The connected device is not a BlinkStick."),d(),n.return();h=parseInt(c.substring(1,3),16);g=parseInt(c.substring(3,5),16);m=parseInt(c.substring(5,7),16);k=Int8Array.from([5,b,h,g,m]);l=function(p){var q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==
r.nextAddress)return r.setCatchFinallyBlocks(2),module$contents$Blast$Ui_addToLog("Invoke <code>sendFeatureReport</code> with value <code>"+k+"</code>","hid",f.productName),r.yield(f.sendFeatureReport(5,k),4);if(2!=r.nextAddress)return module$contents$Blast$Ui_addToLog("Finished <code>sendFeatureReport</code> with value <code>"+k+"</code>","hid",f.productName),r.leaveTryBlock(0);q=r.enterCatchBlock();return 0<p?r.yield(l(--p),0):(console.error(q),Blast.throwError("Failed to set BlinkStick colors, please check its connection."),
r.jumpTo(0))})};return n.yield(l(5),6);case 6:d(),n.jumpToEnd()}})};Blast.asyncApiFunctions.push(["blinkstickSetColors",blinkstickSetColors]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
...
Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};module$contents$Blast$Toolbox_addBlock("joycon_button_events","States and Events");Blockly.JavaScript.joycon_read_property=function(a){var b=a.getFieldValue("property"),c=a.getFieldValue("propertySubValue")||"",d=a.getFieldValue("propertySubValue2")||"",f=a.getFieldValue("propertySubValue3")||"";return["readJoyConProperty("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE)+", '"+b+"', '"+c+"', '"+d+"', '"+f+"')",Blockly.JavaScript.ORDER_NONE]};
var readJoyConProperty=function(a,b,c,d,f,h){var g,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),h(),l.return();g=Blast.Things.webHidDevices.get(a);if(!g)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),h(),l.return();if(g.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(g.open(),5);case 5:l.leaveTryBlock(2);
break;case 3:l.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==g.vendorId||8198!==g.productId&&8199!==g.productId)return Blast.throwError("The connected device is not a Joy-Con."),h(),l.return();8198===g.productId?m=new JoyConLeft(g):8199===g.productId&&(m=new JoyConRight(g));return l.yield(m.open(),6);case 6:return l.yield(m.enableStandardFullMode(),7);case 7:return l.yield(m.enableIMUMode(),8);case 8:k=function(n){var p;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){p=n.detail;if(!p||!p.actualOrientation)return q.return();module$contents$Blast$Ui_addToLog("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(p)+"</code>","hid",g.productname);module$contents$Blast$Ui_addToLog("Removing <code>hidinput</code> event listener","hid",g.productname);m.removeEventListener("hidinput",k);""!==d?"accelerometers"===b?h(p[b][c][d].acc):"gyroscopes"===b?h(p[b][c][d][f]):h(p[b][c][d]):h(p[b][c]);
q.jumpToEnd()})};if(m.eventListenerAttached){l.jumpTo(0);break}return l.yield(m.open(),10);case 10:return l.yield(m.enableStandardFullMode(),11);case 11:return l.yield(m.enableIMUMode(),12);case 12:return l.yield(m.enableVibration(),13);case 13:module$contents$Blast$Ui_addToLog("Adding <code>hidinput</code> event listener","hid",g.productname),m.addEventListener("hidinput",k),m.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);
...
var handleJoyConButtons=function(a,b,c,d){var f,h,g,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),d(),k.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),d(),k.return();if(f.opened){k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(f.open(),5);case 5:k.leaveTryBlock(2);
break;case 3:k.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==f.vendorId||8198!==f.productId&&8199!==f.productId)return Blast.throwError("The connected device is not a Joy-Con."),d(),k.return();8198===f.productId?h=new JoyConLeft(f):8199===f.productId&&(h=new JoyConRight(f));return k.yield(h.open(),6);case 6:return k.yield(h.enableStandardFullMode(),7);case 7:return k.yield(h.enableIMUMode(),8);case 8:g=!1;m=function(l){var n,
p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){n=l.detail;if(!n||!n.actualOrientation)return r.return();module$contents$Blast$Ui_addToLog("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(n)+"</code>","hid",f.productName);n.buttonStatus[b]?g||(g=!0,Blast.Interrupted=!1,p=new Interpreter(""),p.stateStack[0].scope=Blast.Interpreter.globalScope,p.appendCode(c),q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(t){Blast.throwError("Error executing program:\n "+
e),console.error(t)}},q()):g=!1;r.jumpToEnd()})};Blast.deviceEventHandlers.push({device:h,type:"hidinput",fn:m});if(h.eventListenerAttached){k.jumpTo(0);break}return k.yield(h.open(),10);case 10:return k.yield(h.enableStandardFullMode(),11);case 11:return k.yield(h.enableIMUMode(),12);case 12:return k.yield(h.enableVibration(),13);case 13:module$contents$Blast$Ui_addToLog("Adding <code>hidinput</code> event listener","hid",f.productName),h.addEventListener("hidinput",m),h.eventListenerAttached=!0,
k.jumpToEnd()}})};Blast.apiFunctions.push(["handleJoyConButtons",handleJoyConButtons]);Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("Robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};module$contents$Blast$Toolbox_addBlock("mirobot_pickup","actions");Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
var mirobotPickUp=function(a,b){var c,d,f,h,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return c="https://bot.rapidthings.eu/thing/action/grab_"+a.toLowerCase(),d={"Content-Type":"application/json",Accept:"application/json"},f={method:"POST",headers:new Headers(d)},m.setCatchFinallyBlocks(2),m.yield(fetch(c,f),4);if(2!=m.nextAddress){h=m.yieldResult;if(!h.ok)return Blast.throwError("Failed to get "+c+", Error: "+h.status+" "+h.statusText),m.return();b(h.status);
return m.leaveTryBlock(0)}g=m.enterCatchBlock();Blast.throwError("Failed to get "+c+", Error: "+g);m.jumpToEnd()})};Blast.asyncApiFunctions.push(["mirobot_pickup",mirobotPickUp]);Blockly.Blocks.read_ruuvi_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["temperature","temperature"],["humidity","humidity"],["pressure","pressure"],["acceleration X","accelerationX"],["acceleration Y","accelerationY"],["acceleration Z","accelerationZ"],["battery voltage","batteryVoltage"],["txPower","txPower"],["movement counter","movementCounter"],["measurement sequence number","measurementSequenceNumber"]]),
...
var getRuuviProperty=function(a,b,c){var d,f,h,g,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return d=function(n){var p={},q=n[0]&255,r=n[1]<<8|n[2]&255;32767<r&&(r-=65535);var t=((n[3]&255)<<8|n[4]&255)/400,v=((n[5]&255)<<8|n[6]&255)+5E4,w=(n[7]<<8|n[8]&255)/1E3,u=(n[9]<<8|n[10]&255)/1E3,y=(n[11]<<8|n[12]&255)/1E3,x=(n[13]&255)<<8|n[14]&255,z=n[15]&255;n=(n[16]&255)<<8|n[17]&255;p.destination_endpoint=q;p.temperature=r/200;p.humidity=t;p.pressure=v;p.accelerationX=
w;p.accelerationY=u;p.accelerationZ=y;p.batteryVoltage=(x>>>5)/1E3+1.6;p.txPower=2*(x&31)-40;p.movementCounter=z;p.measurementSequenceNumber=n;return p},f=function(n){if(30>n){var p=Blast.Bluetooth.LEScanResults[b];if(p){p=$jscomp.makeIterator(p);for(var q=p.next();!q.done;q=p.next())if((q=q.value.manufacturerData.get(1177))&&5==q.getUint8(0))return q}return new Promise(function(r){setTimeout(function(){r(f(n+1))},1E3)})}},Blast.Bluetooth.startLEScan(b),l.yield(f(0),2);(h=l.yieldResult)||Blast.throwError("Timed out. No BLE advertising data found for "+
b);g=[];for(m=0;m<h.byteLength;m++)g.push("0x"+("00"+h.getUint8(m).toString(16)).slice(-2));k=d(g);c(k[a]);l.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.streamdeck_button_event={init:function(){var a=this;this.appendValueInput("id").setCheck("Thing").appendField("Streamdeck mini");this.appendDummyInput().appendField("on button").appendField(new Blockly.FieldDropdown([["up","up"],["down","down"]]),"upDown");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,"button1")}),"button1").appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,
...
b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};module$contents$Blast$Toolbox_addBlock("streamdeck_button_event","States and Events");
...
module$contents$Blast$Toolbox_addBlock("streamdeck_set_brightness","Properties",STREAMDECK_SET_BRIGHTNESS_XML);Blockly.JavaScript.streamdeck_button_event=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,h="TRUE"==a.getFieldValue("button5")?1:0,g="TRUE"==a.getFieldValue("button6")?1:0,m=Blockly.JavaScript.quote_(a.getFieldValue("upDown")),k=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+b+c+d+f+h+g);a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,
"statements"));Blockly.JavaScript.definitions_.eventHandlers=(Blockly.JavaScript.definitions_.eventHandlers||"")+("handleStreamdeck("+k+", "+b+", "+m+", "+a+");\n");return""};
Blockly.JavaScript.streamdeck_color_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,h="TRUE"==a.getFieldValue("button5")?1:0,g="TRUE"==a.getFieldValue("button6")?1:0,m=Blockly.JavaScript.valueToCode(a,"color",Blockly.JavaScript.ORDER_NONE)||Blockly.JavaScript.quote_("#000000");a=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+
b+c+d+f+h+g);return"streamdeckColorButtons("+a+", "+b+", "+m+");\n"};
var handleStreamdeck=function(a,b,c,d){var f,h,g,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),l.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),l.return();l.setCatchFinallyBlocks(2);return l.yield(StreamDeck.openDevice(f),4);case 4:h=l.yieldResult;l.leaveTryBlock(3);
break;case 2:g=l.enterCatchBlock();if("InvalidStateError"!=g.name)return Blast.throwError(g),l.return();f.close();return l.yield(StreamDeck.openDevice(f),6);case 6:h=l.yieldResult;case 3:for(k=0;k<b.length;k++)if("1"===b.charAt(k)){m=k;break}if(void 0===m)return l.return();h.on(c,function(n){module$contents$Blast$Ui_addToLog("Received <code>"+c+"</code> event on button <code>"+n+"</code>","hid",f.productName);if(n===m){Blast.Interrupted=!0;var p=new Interpreter("");p.stateStack[0].scope=Blast.Interpreter.globalScope;
p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(r){Blast.throwError("Error executing program:\n "+e),console.error(r)}};q()}});Blast.cleanUpFunctions.push(function(){module$contents$Blast$Ui_addToLog("Removing all listeners","hid",f.productName);h.close();h.removeAllListeners()});l.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);
var streamdeckColorButtons=function(a,b,c,d){var f,h,g,m,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),p.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),p.return();p.setCatchFinallyBlocks(2);return p.yield(StreamDeck.openDevice(f),4);case 4:h=p.yieldResult;
p.leaveTryBlock(3);break;case 2:g=p.enterCatchBlock();if("InvalidStateError"!=g.name)return Blast.throwError(g),d(),p.return();f.close();return p.yield(StreamDeck.openDevice(f),6);case 6:h=p.yieldResult;case 3:m=parseInt(c.substring(1,3),16),k=parseInt(c.substring(3,5),16),l=parseInt(c.substring(5,7),16),n=0;case 7:if(!(n<b.length)){p.jumpTo(9);break}if("1"!==b.charAt(n)){p.jumpTo(8);break}module$contents$Blast$Ui_addToLog("Invoke <code>fillKeyColor</code> with value <code>"+[n,m,k,l].toString()+
"</code>","hid",f.productName);return p.yield(h.fillKeyColor(n,m,k,l),11);case 11:module$contents$Blast$Ui_addToLog("Finished <code>fillKeyColor</code>","hid",f.productName);case 8:n++;p.jumpTo(7);break;case 9:d(),p.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckColorButtons",streamdeckColorButtons]);
...
b+c+d+f+h+g);return"streamdeckWriteOnButtons("+a+", "+b+", "+m+");\n"};
var streamdeckWriteOnButtons=function(a,b,c,d){var f,h,g,m,k,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),q.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(f),4);case 4:h=q.yieldResult;
q.leaveTryBlock(3);break;case 2:g=q.enterCatchBlock();if("InvalidStateError"!=g.name)return Blast.throwError(g),d(),q.return();f.close();return q.yield(StreamDeck.openDevice(f),6);case 6:h=q.yieldResult;case 3:m=[];k=document.createElement("canvas");k.width=h.ICON_SIZE;k.height=h.ICON_SIZE;l=k.getContext("2d");l.save();l.clearRect(0,0,k.width,k.height);l.font=.8*k.height+"px Arial";l.strokeStyle="blue";l.lineWidth=1;l.strokeText(c.toString(),8,60,.8*k.width);l.fillStyle="white";l.fillText(c.toString(),
8,60,.8*k.width);n=l.getImageData(0,0,k.width,k.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&(module$contents$Blast$Ui_addToLog("Invoke <code>fillKeyImageData</code> with value <code>"+[p,n].toString()+"</code>","hid",f.productName),m.push(h.fillKeyBuffer(p,buffer.Buffer.from(n.data),{format:"rgba"})),module$contents$Blast$Ui_addToLog("Finished <code>fillKeyImageData</code>","hid",f.productName));l.restore();return q.yield(Promise.all(m),7);case 7:d(),q.jumpToEnd()}})};
Blast.asyncApiFunctions.push(["streamdeckWriteOnButtons",streamdeckWriteOnButtons]);Blockly.JavaScript.streamdeck_set_brightness=function(a){var b=Blockly.JavaScript.valueToCode(a,"value",Blockly.JavaScript.ORDER_NONE)||Blockly.JavaScript.quote_("100");return"streamdeckSetBrightness("+(Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null)+", "+b+");\n"};
var streamdeckSetBrightness=function(a,b,c){var d,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),c(),g.return();if(1>b||100<b)return Blast.throwError("Brightness must be between 1 and 100."),c(),g.return();d=Blast.Things.webHidDevices.get(a);if(!d)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),c(),g.return();g.setCatchFinallyBlocks(2);
return g.yield(StreamDeck.openDevice(d),4);case 4:f=g.yieldResult;g.leaveTryBlock(3);break;case 2:h=g.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),c(),g.return();d.close();return g.yield(StreamDeck.openDevice(d),6);case 6:f=g.yieldResult;case 3:return module$contents$Blast$Ui_addToLog("Invoke <code>setBrightness</code> with value <code>"+b+"</code>","hid",d.productName),g.yield(f.setBrightness(b),7);case 7:module$contents$Blast$Ui_addToLog("Finished <code>setBrightness</code>",
"hid",d.productName),c(),g.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckSetBrightness",streamdeckSetBrightness]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};module$contents$Blast$Toolbox_addBlock("text_to_speech","actions");
