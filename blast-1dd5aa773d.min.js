...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Array.from",function(a){return a?a:function(b,c,d){c=null!=c?c:function(m){return m};var f=[],g="undefined"!=typeof Symbol&&Symbol.iterator&&b[Symbol.iterator];if("function"==typeof g){b=g.call(b);for(var h=0;!(g=b.next()).done;)f.push(c.call(d,g.value,h++))}else for(g=b.length,h=0;h<g;h++)f.push(c.call(d,b[h],h));return f}},"es6","es3");var Blast={States:{}};Blast.States.Interpreter=null;
...
type:"while_until"},{kind:"BLOCK",type:"wait_seconds"},{kind:"BLOCK",type:"break_continue"},{kind:"BLOCK",type:"conditional_statement"}],name:"Control Flow",colour:"120"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"logic_compare"},{kind:"BLOCK",type:"logic_operation"},{kind:"BLOCK",type:"logic_negate"}],name:"Boolean Expressions",colour:"210"},{kind:"CATEGORY",contents:[],name:"Functions",colour:"290",custom:"PROCEDURE"},{kind:"sep",gap:"32"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"string"},
{kind:"BLOCK",type:"string_join"},{kind:"BLOCK",type:"string_length"},{kind:"BLOCK",type:"string_indexOf"},{kind:"BLOCK",type:"string_charAt"},{kind:"BLOCK",type:"string_getSubstring"},{kind:"BLOCK",type:"string_changeCase"},{kind:"BLOCK",type:"string_replace"},{kind:"BLOCK",type:"string_showPrompt"}],name:"Strings",colour:"160"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"number_value"},{kind:"BLOCK",type:"number_infinity"},{kind:"BLOCK",type:"number_arithmetic"},{kind:"BLOCK",type:"number_modulo"},
{kind:"BLOCK",type:"number_random"}],name:"Numbers",colour:"230"},{kind:"CATEGORY",contents:[{kind:"BLOCK",type:"logic_boolean"}],name:"Booleans",colour:"210"},{kind:"sep",gap:"32"},{kind:"CATEGORY",contents:[],name:"Variables",custom:"VARIABLE",colour:"330"}]};Blast.Toolbox.currentToolbox=defaultToolbox;Blast.Toolbox.init=function(){Blast.workspace.registerToolboxCategoryCallback("STATES",Blast.States.flyoutCategory);Blast.workspace.registerToolboxCategoryCallback("THINGS",Blast.Things.flyoutCategory)};
...
Blast.resetInterpreter=function(){Blast.Interpreter=null;Blast.runner_&&(clearTimeout(Blast.runner_),Blast.runner_=null);Blast.Bluetooth.tearDown();Blast.removeDeviceHandlers()};Blast.removeDeviceHandlers=function(){for(var a=$jscomp.makeIterator(Blast.deviceEventHandlers),b=a.next();!b.done;b=a.next())b=b.value,b.device.removeEventListener(b.type,b.fn);Blast.deviceEventHandlers=[]};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$50:f.$jscomp$loop$prop$type$50,$jscomp$loop$prop$name$51:f.$jscomp$loop$prop$name$51,$jscomp$loop$prop$block$52:f.$jscomp$loop$prop$block$52},g=b.next()){f.$jscomp$loop$prop$block$52=g.value;f.$jscomp$loop$prop$type$50=f.$jscomp$loop$prop$block$52.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$50||"things_webHID"==f.$jscomp$loop$prop$type$50){f.$jscomp$loop$prop$name$51=f.$jscomp$loop$prop$block$52.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$51))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$51));var m=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$51);k.setAttribute("value","Pair");var l=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$51);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";l.appendChild(n);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
p.$jscomp$loop$prop$type$50?("things_webHID"==p.$jscomp$loop$prop$type$50&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(u){0===u.length&&Blast.throwError("Connection failed or cancelled by User.");var v=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(v,u[0]);Blast.Things.addWebHidDevice(v,p.$jscomp$loop$prop$name$51);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$51).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
p.$jscomp$loop$prop$name$51).style.color="green";p.$jscomp$loop$prop$block$52.firstElementChild.textContent=v;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(u){Blast.throwError("Connection failed or cancelled by User.");
console.error(u)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$51).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$51).style.color="green";p.$jscomp$loop$prop$block$52.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));m.appendChild(k);g.appendChild(h);g.appendChild(m);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$51)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$54:f.$jscomp$loop$prop$type$54,$jscomp$loop$prop$name$55:f.$jscomp$loop$prop$name$55,$jscomp$loop$prop$block$56:f.$jscomp$loop$prop$block$56},g=b.next())if(f.$jscomp$loop$prop$block$56=g.value,f.$jscomp$loop$prop$type$54=f.$jscomp$loop$prop$block$56.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$54||"things_webHID"==f.$jscomp$loop$prop$type$54)if(f.$jscomp$loop$prop$name$55=f.$jscomp$loop$prop$block$56.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$55)){g=document.createElement("li");g.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$55);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$55);h.setAttribute("class","mdc-list-item__graphic material-icons");
h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$54?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$55;h.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$55);
m.innerHTML="disconnected";h.appendChild(m);g.appendChild(h);g.addEventListener("click",function(k){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$54?("things_webHID"==k.$jscomp$loop$prop$type$54&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$55);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$55).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).style.color="#0d30b1";k.$jscomp$loop$prop$block$56.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;Blast.Things.addWebBluetoothDevice(n.id,k.$jscomp$loop$prop$name$55);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$55).innerHTML=
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).style.color="#0d30b1";k.$jscomp$loop$prop$block$56.firstElementChild.textContent=n.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$55)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
d=f(d);m.setCatchFinallyBlocks(3);console.log("Writing to "+g.uuid);return m.yield(g.writeValueWithoutResponse(d),5);case 5:console.log("Wrote to "+g.uuid);m.leaveTryBlock(4);break;case 3:h=m.enterCatchBlock(),console.error(h),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block.");case 4:return m.yield(Blast.Bluetooth.disconnect(a),0)}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a,b),2);case 2:return c=g.yieldResult,console.log("connected to "+c),g.setCatchFinallyBlocks(3),console.log("Getting primary service "+b+" from "+a),g.yield(c.getPrimaryService(b),5);case 5:d=g.yieldResult;console.log("Got primary service "+b+" from "+a);g.leaveTryBlock(4);break;case 3:f=g.enterCatchBlock(),console.error(f),
Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=h.yieldResult;if(!d)return h.return();h.setCatchFinallyBlocks(3);console.log("Getting characteristic "+c+" from "+a);return h.yield(d.getCharacteristic(c),5);case 5:f=h.yieldResult;console.log("Got characteristic "+c+" from "+a);h.leaveTryBlock(4);break;case 3:g=h.enterCatchBlock(),
console.error(g),Blast.throwError("The device is not compatible with the connected block.");case 4:return h.return(f)}})};
...
Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){console.log("startLEScan");console.log(Blast.Bluetooth.isLEScanRunning);if(Blast.Bluetooth.isLEScanRunning)return a.return();Blast.Bluetooth.cacheLEScanResults();Blast.Bluetooth.isLEScanRunning=!0;Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));setTimeout(Blast.Bluetooth.stopLEScan,
3E4);a.jumpToEnd()})};Blast.Bluetooth.stopLEScan=function(){Blast.Bluetooth.isLEScanRunning&&(navigator.bluetooth.stopLEScan(),Blast.Bluetooth.isLEScanRunning=!1)};Blast.Bluetooth.cacheLEScanResults=function(){Blast.Bluetooth.addEventListener("advertisementreceived",function(a){var b=a.device.id;Blast.Bluetooth.LEScanResults[b]||(Blast.Bluetooth.LEScanResults[b]=[]);Blast.Bluetooth.LEScanResults[b].unshift(a)})};
...
Blast.Bluetooth.tearDown=function(){console.log("Tearing down webBluetooth.");Blast.Bluetooth.isLEScanRunning&&(Blast.Bluetooth.isLEScanRunning=!1);if(Blast.Bluetooth.eventListeners){for(var a=$jscomp.makeIterator(Blast.Bluetooth.eventListeners),b=a.next();!b.done;b=a.next())b=b.value,Blast.Bluetooth.removeEventListener(b[0],b[1]);Blast.Bluetooth.eventListeners=[]}if(Blast.Bluetooth.charEventListeners){a=$jscomp.makeIterator(Object.keys(Blast.Bluetooth.charEventListeners));for(b=a.next();!b.done;b=
a.next()){var c=Blast.Bluetooth.charEventListeners[b.value];b=c[0];var d=c[1];c=c[2];b.stopNotifications();b.removeEventListener(d,c)}Blast.Bluetooth.charEventListeners={}}Blast.Bluetooth.LEScanResults={}};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(f){f=f?f.toString():"";return Blast.highlightBlock(f)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(f){Blast.Interrupted=f};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(f,g){return Blast.States.eventChecker(f,g)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return Blast.States.startEventChecker()}));c=function(f){return prompt(f)};a.setProperty(b,"prompt",a.createNativeFunction(c))};Blockly.Blocks.repeat=Blockly.Blocks.controls_repeat_ext;Blockly.Blocks["for"]=Blockly.Blocks.controls_for;Blockly.Blocks.while_until=Blockly.Blocks.controls_whileUntil;Blockly.Blocks.break_continue=Blockly.Blocks.controls_flow_statements;Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES.push("repeat","while_until","for");var REPEAT_XML='\n<block type="repeat">\n  <value name="TIMES">\n    <block type="math_number">\n      <field name="NUM">10</field>\n    </block>\n  </value>\n</block>';
...
var switchLights=function(a,b,c,d,f){var g,h,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress){if(!a)return Blast.throwError("No LED Controller is set."),f(),l.return();g=parseInt(b).toString(16).padStart(2,"0");h=parseInt(c).toString(16).padStart(2,"0");m=parseInt(d).toString(16).padStart(2,"0");k="7e000503"+g+h+m+"00ef";return l.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",k),2)}f();l.jumpToEnd()})};
Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.blinkstick_set_colors={init:function(){this.appendValueInput("index").setCheck("Number").appendField("write color properties of LED");this.appendValueInput("red").appendField("red");this.appendValueInput("green").setCheck("Number").appendField("green");this.appendValueInput("blue").setCheck("Number").appendField("blue");this.appendValueInput("thing").setCheck("Thing").appendField("to BlinkStick");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);
...
Blast.Toolbox.addBlock("blinkstick_set_colors","Properties",BLINKSTICK_SET_COLORS_XML);Blockly.JavaScript.blinkstick_set_colors=function(a){var b=Blockly.JavaScript.valueToCode(a,"red",Blockly.JavaScript.ORDER_ATOMIC)||"0",c=Blockly.JavaScript.valueToCode(a,"green",Blockly.JavaScript.ORDER_ATOMIC)||"0",d=Blockly.JavaScript.valueToCode(a,"blue",Blockly.JavaScript.ORDER_ATOMIC)||"0",f=Blockly.JavaScript.valueToCode(a,"index",Blockly.JavaScript.ORDER_ATOMIC)||"0";return"blinkstickSetColors("+(Blockly.JavaScript.valueToCode(a,"thing",Blockly.JavaScript.ORDER_ATOMIC)||"''")+", "+f+", "+
b+", "+c+", "+d+")\n;"};
var blinkstickSetColors=function(a,b,c,d,f,g){var h,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(0>b||7<b)return Blast.throwError("BlinkStick index must be between 0 and 7."),g(),l.return();if(!a)return Blast.throwError("No BlinkStick block set."),g(),l.return();h=Blast.Things.webHidDevices.get(a);if(!h)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Blinkstick via webHID."),g(),l.return();if(h.opened){l.jumpTo(2);
break}l.setCatchFinallyBlocks(3);return l.yield(h.open(),5);case 5:l.leaveTryBlock(2);break;case 3:l.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==h.vendorId||16869!==h.productId)return Blast.throwError("The connected device is not a BlinkStick."),g(),l.return();m=Int8Array.from([5,b,c,d,f]);k=function(n){var p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return q.setCatchFinallyBlocks(2),
q.yield(h.sendFeatureReport(5,m),4);if(2!=q.nextAddress)return q.leaveTryBlock(0);p=q.enterCatchBlock();return 0<n?q.yield(k(--n),0):(console.error(p),Blast.throwError("Failed to set BlinkStick colors, please check its connection."),q.jumpTo(0))})};return l.yield(k(5),6);case 6:g(),l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["blinkstickSetColors",blinkstickSetColors]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
...
b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};Blast.Toolbox.addBlock("streamdeck_buttons","States and Events");Blockly.JavaScript.streamdeck_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,h="TRUE"==a.getFieldValue("button6")?1:0,m=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE);b=[b,c,d,f,g,h];a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));Blockly.JavaScript.definitions_.eventHandlers=
(Blockly.JavaScript.definitions_.eventHandlers||"")+("handleStreamdeck("+m+", ["+b+"], "+a+");\n");return""};
var handleStreamdeck=function(a,b,c,d){var f,g,h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:if(!a)return Blast.throwError("No streamdeck block set."),d(),k.return();f="inputreport";g=Blast.Things.webHidDevices.get(a);if(!g)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),k.return();if(g.opened){k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(g.open(),5);case 5:k.leaveTryBlock(2);
break;case 3:h=k.enterCatchBlock(),console.error(h),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(4057!=g.vendorId)return Blast.throwError("The connected device is not a Streamdeck."),k.return();m=function(l){if(1===l.reportId&&(l=new Int8Array(l.data.buffer),l=Array.from(l).slice(0,6),b=b.toString().split(",").map(Number),l.every(function(q,r){return q===b[r]}))){Blast.Interrupted=!0;var n=new Interpreter("");n.stateStack[0].scope=Blast.Interpreter.globalScope;
n.appendCode(c);var p=function(){try{n.step()?setTimeout(p,5):Blast.Interrupted=!1}catch(q){Blast.throwError("Error executing program:\n "+e),console.error(q)}};p()}};Blast.deviceEventHandlers.push({device:g,type:f,fn:m});g.addEventListener(f,m);k.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
