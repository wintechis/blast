...
Blast.States.resetInterpreter=module$contents$Blast$States_resetInterpreter;Blast.Ui={};
...
for(var b=a.next();!b.done;b=a.next())b=b.value,Blast.bindClick("tab_"+b,function(c){return function(){module$contents$Blast$Ui_tabClick_(c)}}(b));module$contents$Blast$Ui_setStatus(Blast.status.READY);Blast.bindClick("UriLoadButton",Blast.Storage.load);Blast.bindClick("UriSaveButton",Blast.Storage.link);Blast.bindClick("saveButton",function(){Blast.Storage.link(!0)});Blast.bindClick("clearDeviceLogsButton",module$contents$Blast$Ui_ClearLog);Blast.bindClick("clearOutputButton",module$contents$Blast$Ui_ClearOutputContainer);
module$contents$Blast$Ui_uriInput.addEventListener("keyup",function(c){13===c.keyCode&&Blast.Storage.load()})}};Blast.Ui.initUi=module$contents$Blast$Ui_init;Blast.Toolbox={};
...
c))};
Blast.Storage.removeDeviceId_=function(a){var b=a.querySelectorAll("block");b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=c.getAttribute("type");if("things_webBluetooth"==d||"things_webHID"==d)if(c=c.firstElementChild){var f=c.textContent,h="things_webBluetooth"==d?Blast.Things.getWebBluetoothDevices():Blast.Things.getWebHIDDevices();d=void 0;h=$jscomp.makeIterator(h);for(var g=h.next();!g.done;g=h.next()){g=$jscomp.makeIterator(g.value);var m=g.next().value;if(g.next().value===
f){d=m;break}}c.textContent=d}}return a};Blast.Storage.saveXML_=function(a,b){Blockly.hideChaff();fetch(a,{method:"PUT",body:b}).then(function(c){c.ok?(location.hash=a,Blockly.alert(Blast.Storage.LINK_ALERT.replace("%1",window.location.href))):Blast.throwError(Blast.Storage.HTTPREQUEST_ERROR)})};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$74:f.$jscomp$loop$prop$type$74,$jscomp$loop$prop$name$75:f.$jscomp$loop$prop$name$75,$jscomp$loop$prop$block$76:f.$jscomp$loop$prop$block$76},h=b.next()){f.$jscomp$loop$prop$block$76=h.value;f.$jscomp$loop$prop$type$74=f.$jscomp$loop$prop$block$76.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$74||"things_webHID"==f.$jscomp$loop$prop$type$74){f.$jscomp$loop$prop$name$75=f.$jscomp$loop$prop$block$76.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$75))continue;h=document.createElement("tr");var g=document.createElement("td");g.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$75));var m=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$75);k.setAttribute("value","Pair");var l=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$75);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";l.appendChild(n);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
p.$jscomp$loop$prop$type$74?("things_webHID"==p.$jscomp$loop$prop$type$74&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(v){0===v.length&&Blast.throwError("Connection failed or cancelled by User.");var w=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(w,v[0]);Blast.Things.addWebHidDevice(w,p.$jscomp$loop$prop$name$75);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
p.$jscomp$loop$prop$name$75).style.color="green";p.$jscomp$loop$prop$block$76.firstElementChild.textContent=w;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(v){Blast.throwError("Connection failed or cancelled by User.");
console.error(v)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$75).style.color="green";p.$jscomp$loop$prop$block$76.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));m.appendChild(k);h.appendChild(g);h.appendChild(m);h.appendChild(l);c.appendChild(h);d.push(f.$jscomp$loop$prop$name$75)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$78:f.$jscomp$loop$prop$type$78,$jscomp$loop$prop$name$79:f.$jscomp$loop$prop$name$79,$jscomp$loop$prop$block$80:f.$jscomp$loop$prop$block$80},h=b.next())if(f.$jscomp$loop$prop$block$80=h.value,f.$jscomp$loop$prop$type$78=f.$jscomp$loop$prop$block$80.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$78||"things_webHID"==f.$jscomp$loop$prop$type$78)if(f.$jscomp$loop$prop$name$79=f.$jscomp$loop$prop$block$80.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$79)){h=document.createElement("li");h.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$79);h.setAttribute("class","mdc-list-item");var g=document.createElement("span");g.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$79);g.setAttribute("class","mdc-list-item__graphic material-icons");
g.setAttribute("aria-hidden","true");g.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$78?"bluetooth_disabled":"usb_off";h.appendChild(g);g=document.createElement("span");g.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$79;g.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$79);
m.innerHTML="disconnected";g.appendChild(m);h.appendChild(g);h.addEventListener("click",function(k){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$78?("things_webHID"==k.$jscomp$loop$prop$type$78&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$79);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$79).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).style.color="#0d30b1";k.$jscomp$loop$prop$block$80.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;Blast.Things.addWebBluetoothDevice(n.id,k.$jscomp$loop$prop$name$79);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$79).innerHTML=
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).style.color="#0d30b1";k.$jscomp$loop$prop$block$80.firstElementChild.textContent=n.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(h);d.push(f.$jscomp$loop$prop$name$79)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(f,h){return Blast.States.eventChecker(f,h)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return module$contents$Blast$States_startEventChecker()}));c=function(f){return prompt(f)};a.setProperty(b,"prompt",a.createNativeFunction(c))};var COLOUR_RGB_XML='\n<block type="colour_rgb">\n    <value name="RED">\n        <block type="math_number">\n            <field name="NUM">100</field>\n        </block>\n    </value>\n    <value name="GREEN">\n        <block type="math_number">\n            <field name="NUM">50</field>\n        </block>\n    </value>\n    <value name="BLUE">\n        <block type="math_number">\n            <field name="NUM">0</field>\n        </block>\n    </value>\n</block>';
