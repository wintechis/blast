...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Array.from",function(a){return a?a:function(b,c,d){c=null!=c?c:function(p){return p};var h=[],g="undefined"!=typeof Symbol&&Symbol.iterator&&b[Symbol.iterator];if("function"==typeof g){b=g.call(b);for(var m=0;!(g=b.next()).done;)h.push(c.call(d,g.value,m++))}else for(g=b.length,m=0;m<g;m++)h.push(c.call(d,b[m],m));return h}},"es6","es3");
...
$jscomp.polyfill("Number.isFinite",function(a){return a?a:function(b){return"number"!==typeof b?!1:!isNaN(b)&&Infinity!==b&&-Infinity!==b}},"es6","es3");var Blast={States:{}};Blast.States.Interpreter=null;Blast.States.runner_=null;Blast.States.latestCode="";Blast.States.eventCode=new Map;Blast.States.eventValues=new Map;Blast.States.eventChecker=function(a,b){var c=Blast.States.eventValues.get(a);Blast.States.eventValues.set(a,b);return void 0!=c?!c&&b:!1};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],h={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;h={$jscomp$loop$prop$type$60:h.$jscomp$loop$prop$type$60,$jscomp$loop$prop$name$61:h.$jscomp$loop$prop$name$61,$jscomp$loop$prop$block$62:h.$jscomp$loop$prop$block$62},g=b.next()){h.$jscomp$loop$prop$block$62=g.value;h.$jscomp$loop$prop$type$60=h.$jscomp$loop$prop$block$62.getAttribute("type");
if("things_webBluetooth"==h.$jscomp$loop$prop$type$60||"things_webHID"==h.$jscomp$loop$prop$type$60){h.$jscomp$loop$prop$name$61=h.$jscomp$loop$prop$block$62.firstElementChild.textContent;if(d.includes(h.$jscomp$loop$prop$name$61))continue;g=document.createElement("tr");var m=document.createElement("td");m.appendChild(document.createTextNode(h.$jscomp$loop$prop$name$61));var p=document.createElement("td"),l=document.createElement("input");l.setAttribute("type","button");l.setAttribute("id","pairButton-"+
h.$jscomp$loop$prop$name$61);l.setAttribute("value","Pair");var n=document.createElement("td"),q=document.createElement("span");q.setAttribute("id","pairStatus-"+h.$jscomp$loop$prop$name$61);q.innerHTML="&#x2718;";q.style.color="red";q.style.fontSize="20px";q.style.fontWeight="bold";q.style.marginRight="10px";n.appendChild(q);l.addEventListener("click",function(t){return function(){var w,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(C){if(1==C.nextAddress)return"things_webBluetooth"!=
t.$jscomp$loop$prop$type$60?("things_webHID"==t.$jscomp$loop$prop$type$60&&(w=[],navigator.hid.requestDevice({filters:w}).then(function(D){0===D.length&&Blast.throwError("Connection failed or cancelled by User.");var B=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(B,D[0]);Blast.Things.addWebHidDevice(B,t.$jscomp$loop$prop$name$61);document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$61).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
t.$jscomp$loop$prop$name$61).style.color="green";t.$jscomp$loop$prop$block$62.firstElementChild.textContent=B;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(D){Blast.throwError("Connection failed or cancelled by User.");
console.error(D)})),C.jumpTo(0)):C.yield(Blast.Bluetooth.requestDevice(),3);z=C.yieldResult;document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$61).innerHTML="&#x2714;";document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$61).style.color="green";t.$jscomp$loop$prop$block$62.firstElementChild.textContent=z.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));C.jumpToEnd()})}}(h));p.appendChild(l);g.appendChild(m);g.appendChild(p);g.appendChild(n);c.appendChild(g);d.push(h.$jscomp$loop$prop$name$61)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],h={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;h={$jscomp$loop$prop$type$64:h.$jscomp$loop$prop$type$64,$jscomp$loop$prop$name$65:h.$jscomp$loop$prop$name$65,$jscomp$loop$prop$block$66:h.$jscomp$loop$prop$block$66},g=b.next())if(h.$jscomp$loop$prop$block$66=g.value,h.$jscomp$loop$prop$type$64=h.$jscomp$loop$prop$block$66.getAttribute("type"),
"things_webBluetooth"==h.$jscomp$loop$prop$type$64||"things_webHID"==h.$jscomp$loop$prop$type$64)if(h.$jscomp$loop$prop$name$65=h.$jscomp$loop$prop$block$66.firstElementChild.textContent,!d.includes(h.$jscomp$loop$prop$name$65)){g=document.createElement("li");g.setAttribute("id","rc-item-"+h.$jscomp$loop$prop$name$65);g.setAttribute("class","mdc-list-item");var m=document.createElement("span");m.setAttribute("id","rc-icon-"+h.$jscomp$loop$prop$name$65);m.setAttribute("class","mdc-list-item__graphic material-icons");
m.setAttribute("aria-hidden","true");m.innerHTML="things_webBluetooth"==h.$jscomp$loop$prop$type$64?"bluetooth_disabled":"usb_off";g.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__text");var p=document.createElement("span");p.setAttribute("class","mdc-list-item__primary-text");p.innerHTML=h.$jscomp$loop$prop$name$65;m.appendChild(p);p=document.createElement("span");p.setAttribute("class","mdc-list-item__secondary-text");p.setAttribute("id","rc-status-"+h.$jscomp$loop$prop$name$65);
p.innerHTML="disconnected";m.appendChild(p);g.appendChild(m);g.addEventListener("click",function(l){return function(){var n,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=l.$jscomp$loop$prop$type$64?("things_webHID"==l.$jscomp$loop$prop$type$64&&(n=[],navigator.hid.requestDevice({filters:n}).then(function(w){0===w.length&&Blast.throwError("Connection failed or cancelled by User.");var z=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(z,w[0]);Blast.Things.addWebHidDevice(z,l.$jscomp$loop$prop$name$65);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$65).innerHTML="connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$65).innerHTML="usb";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$65).style.color="#0d30b1";l.$jscomp$loop$prop$block$66.firstElementChild.textContent=z;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(w){Blast.throwError("Connection failed or cancelled by User.");console.error(w)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);q=t.yieldResult;Blast.Things.addWebBluetoothDevice(q.id,l.$jscomp$loop$prop$name$65);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$65).innerHTML=
"connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$65).innerHTML="bluetooth";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$65).style.color="#0d30b1";l.$jscomp$loop$prop$block$66.firstElementChild.textContent=q.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(h));c.appendChild(g);d.push(h.$jscomp$loop$prop$name$65)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};Blast.Toolbox.addBlock("streamdeck_buttons","States and Events");Blockly.JavaScript.streamdeck_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,h="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,m="TRUE"==a.getFieldValue("button6")?1:0,p=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=[b,c,d,h,g,m];a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));Blockly.JavaScript.definitions_.eventHandlers=
(Blockly.JavaScript.definitions_.eventHandlers||"")+("handleStreamdeck("+p+", ["+b+"], "+a+");\n");console.log("foo");return""};
var handleStreamdeck=function(a,b,c,d){var h,g,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return Blast.throwError("No streamdeck block set."),d(),l.return();h="inputreport";g=Blast.Things.webHidDevices.get(a);if(!g)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),l.return();if(g.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(g.open(),5);case 5:l.leaveTryBlock(2);
break;case 3:m=l.enterCatchBlock(),console.error(m),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(4057!=g.vendorId)return Blast.throwError("The connected device is not a Streamdeck."),l.return();p=function(n){if(1===n.reportId&&(n=new Int8Array(n.data.buffer),n=Array.from(n).slice(0,6),b=b.toString().split(",").map(Number),n.every(function(w,z){return w===b[z]}))){Blast.Interrupted=!0;var q=new Interpreter("");q.stateStack[0].scope=Blast.Interpreter.globalScope;
q.appendCode(c);var t=function(){try{q.step()?setTimeout(t,5):Blast.Interrupted=!1}catch(w){Blast.throwError("Error executing program:\n "+e),console.error(w)}};t()}};Blast.deviceEventHandlers.push({device:g,type:h,fn:p});g.addEventListener(h,p);l.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);/*
