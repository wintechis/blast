...
var module$contents$Blast$Interpreter_disableWorkspace=function(){var a=document.getElementById("content_workspace"),b=document.createElement("div");b.style.position="absolute";b.style.top="0";b.style.left="0";b.style.width="100%";b.style.height="100%";b.style.zIndex="1";b.style.backgroundColor="rgba(0, 0, 0, 0.1)";a.appendChild(b);Blockly.selected=null;module$contents$Blast$Interpreter_clipboard.clipboard_=Blockly.clipboard_;module$contents$Blast$Interpreter_clipboard.clipboardSource_=Blockly.clipboardSource_;
module$contents$Blast$Interpreter_clipboard.clipboardXml=Blockly.clipboardXml;module$contents$Blast$Interpreter_clipboard.clipboardTypeCounts_=Blockly.clipboardTypeCounts_;Blockly.clipboard_=null;Blockly.clipboardSource_=null;Blockly.clipboardXml=null;Blockly.clipboardTypeCounts_=null},module$contents$Blast$Interpreter_enableWorkspace=function(){var a=document.getElementById("content_workspace"),b=a.lastChild;"DIV"===b.tagName&&a.removeChild(b);Blockly.clipboard_=module$contents$Blast$Interpreter_clipboard.clipboard_;
Blockly.clipboardSource_=module$contents$Blast$Interpreter_clipboard.clipboardSource_;Blockly.clipboardXml=module$contents$Blast$Interpreter_clipboard.clipboardXml;Blockly.clipboardTypeCounts_=module$contents$Blast$Interpreter_clipboard.clipboardTypeCounts_};module$contents$Blast$Interpreter_onStatusChange.ready.push(module$contents$Blast$Interpreter_enableWorkspace);module$contents$Blast$Interpreter_onStatusChange.stopped.push(module$contents$Blast$Interpreter_enableWorkspace);module$contents$Blast$Interpreter_onStatusChange.error.push(module$contents$Blast$Interpreter_enableWorkspace);
...
"green";p.$jscomp$loop$prop$block$77.firstElementChild.textContent=w;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}))}).catch(function(v){module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");console.error(v)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;
document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$76).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$76).style.color="green";p.$jscomp$loop$prop$block$77.firstElementChild.textContent=r.id;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}));t.jumpToEnd()})}}(f));k.appendChild(m);
g.appendChild(h);g.appendChild(k);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$76)}document.getElementById("rc-cancel").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectCancelHandler_()})}},module$contents$Blast$Storage_generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$79:f.$jscomp$loop$prop$type$79,
$jscomp$loop$prop$name$80:f.$jscomp$loop$prop$name$80,$jscomp$loop$prop$block$81:f.$jscomp$loop$prop$block$81},g=b.next())if(f.$jscomp$loop$prop$block$81=g.value,f.$jscomp$loop$prop$type$79=f.$jscomp$loop$prop$block$81.getAttribute("type"),"things_webBluetooth"==f.$jscomp$loop$prop$type$79||"things_webHID"==f.$jscomp$loop$prop$type$79)if(f.$jscomp$loop$prop$name$80=f.$jscomp$loop$prop$block$81.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$80)){g=document.createElement("li");g.setAttribute("id",
"rc-item-"+f.$jscomp$loop$prop$name$80);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$80);h.setAttribute("class","mdc-list-item__graphic material-icons");h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$79?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var k=document.createElement("span");
k.setAttribute("class","mdc-list-item__primary-text");k.innerHTML=f.$jscomp$loop$prop$name$80;h.appendChild(k);k=document.createElement("span");k.setAttribute("class","mdc-list-item__secondary-text");k.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$80);k.innerHTML="disconnected";h.appendChild(k);g.appendChild(h);g.addEventListener("click",function(m){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=m.$jscomp$loop$prop$type$79?
("things_webHID"==m.$jscomp$loop$prop$type$79&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);module$contents$Blast$Things_addWebHidDevice(r,m.$jscomp$loop$prop$name$80,q[0]);document.getElementById("rc-status-"+m.$jscomp$loop$prop$name$80).innerHTML="connected";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).innerHTML=
"usb";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).style.color="#0d30b1";m.$jscomp$loop$prop$block$81.firstElementChild.textContent=r;module$contents$Blast$Storage_allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}))}).catch(function(q){module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");console.error(q)})),
p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;module$contents$Blast$Things_addWebBluetoothDevice(n.id,m.$jscomp$loop$prop$name$80);document.getElementById("rc-status-"+m.$jscomp$loop$prop$name$80).innerHTML="connected";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).innerHTML="bluetooth";document.getElementById("rc-icon-"+m.$jscomp$loop$prop$name$80).style.color="#0d30b1";m.$jscomp$loop$prop$block$81.firstElementChild.textContent=n.id;module$contents$Blast$Storage_allConnectedMobile_()&&
(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$80)}window.app.initLists()},module$contents$Blast$Storage_allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+
b.value.firstElementChild.textContent).innerHTML)return!1;return!0},module$contents$Blast$Storage_allConnectedMobile_=function(){var a=document.getElementById("rc-list").querySelectorAll("[id=rc-status-]");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("disconnected"==document.getElementById("rc-status-"+b.value.textContent).innerHTML)return!1;return!0},module$contents$Blast$Storage_reconnectDoneHandler_=function(a){var b=module$contents$Blast$Interpreter_getWorkspace();window.location.href.includes("mobile")?
document.getElementById("rc-dialog").style.display="none":document.getElementById("rcModal").style.display="none";var c=document.getElementById("rc-done"),d=c.cloneNode(!0);d.disabled=!0;c.parentNode.replaceChild(d,c);Blockly.Xml.domToWorkspace(a,b);module$contents$Blast$Storage_monitorChanges_(b)},module$contents$Blast$Storage_reconnectCancelHandler_=function(){document.getElementById("rcModal").style.display="none"},module$contents$Blast$Storage_monitorChanges_=function(a){function b(){var f=Blockly.Xml.workspaceToDom(a);
...
Blast.Bluetooth.requestDevice=function(a,b){var c,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){c=module$contents$Blast$Things_getThingsLog();c("Requesting device...","Bluetooth");if(!navigator.bluetooth)return h.jumpTo(0);a||(a={acceptAllDevices:!0},a.optionalServices=Blast.Bluetooth.optionalServices);h.setCatchFinallyBlocks(3);return h.yield(navigator.bluetooth.requestDevice(a),5)}if(3!=h.nextAddress)return d=h.yieldResult,c("Device paired","Bluetooth",
d.id),f=b||d.name,module$contents$Blast$Things_addWebBluetoothDevice(d.id,f),module$contents$Blast$Interpreter_getWorkspace().refreshToolboxSelection(),h.return(d);g=h.enterCatchBlock();module$contents$Blast$Interpreter_throwError(g);h.jumpToEnd()})};
...
Blast.Bluetooth.connect=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.setCatchFinallyBlocks(2),g.yield(Blast.Bluetooth.getDeviceById(a),4);case 4:return b=g.yieldResult,c=module$contents$Blast$Things_getThingsLog(),c("Connecting to <code>"+a+"</code>","Bluetooth"),g.yield(b.gatt.connect(),5);case 5:return d=g.yieldResult,c("Connected","Bluetooth",a),g.return(d);case 2:f=g.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Error connecting to Bluetooth device "+
a),console.error(f),g.jumpToEnd()}})};
Blast.Bluetooth.disconnect=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.setCatchFinallyBlocks(2),g.yield(Blast.Bluetooth.getDeviceById(a),4);case 4:return b=g.yieldResult,c=module$contents$Blast$Things_getThingsLog(),c("Disconnecting...","Bluetooth",a),g.yield(b.gatt.disconnect(),5);case 5:return d=g.yieldResult,c("Disconnected from <code>"+a+"</code>","Bluetooth"),g.return(d);case 2:f=g.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Error disconnecting from Bluetooth device "+
a),console.error(f),g.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=k.yieldResult;if(!f)return k.return();"string"===typeof d&&(d=hexStringToArrayBuffer(d));k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Invoke <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+
"</code>"),"Bluetooth",a);return k.yield(f.writeValueWithoutResponse(d),5);case 5:g("Finished <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),k.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithResponse=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=k.yieldResult;if(!f)return k.return();"string"===typeof d&&(d=hexStringToArrayBuffer(d));k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Invoke <code>WriteValueWithResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+
"</code>"),"Bluetooth",a);return k.yield(f.writeValueWithResponse(d),5);case 5:g("Finished <code>WriteValueWithResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),k.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.connect(a),2);case 2:return c=h.yieldResult,h.setCatchFinallyBlocks(3),f=module$contents$Blast$Things_getThingsLog(),f("Getting primary service <code>"+b+"</code>","Bluetooth",a),h.yield(c.getPrimaryService(b),5);case 5:d=h.yieldResult;f("Got primary service <code>"+b+"</code>","Bluetooth",a);h.leaveTryBlock(4);break;
case 3:g=h.enterCatchBlock(),console.error(g),module$contents$Blast$Interpreter_throwError("The device is not compatible with the connected block.");case 4:return h.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=k.yieldResult;if(!d)return k.return();k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Getting characteristic <code>"+c+"</code> from service <code>"+b+"</code>","Bluetooth",a);return k.yield(d.getCharacteristic(c),5);case 5:f=k.yieldResult;g("Got characteristic <code>"+
c+"</code> from service <code>"+b+"</code>","Bluetooth",a);k.leaveTryBlock(4);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("The device is not compatible with the connected block.");case 4:return k.return(f)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return d=k.yieldResult,k.setCatchFinallyBlocks(3),f=module$contents$Blast$Things_getThingsLog(),f("Invoke <code>ReadValue</code> on characteristic <code>"+c+"</code> from service <code>"+(b+"</code>"),"Bluetooth",a),k.yield(d.readValue(),5);case 5:return g=k.yieldResult,f("Finished <code>ReadValue</code> on characteristic <code>"+
c+"</code> from service <code>"+(b+"</code> - value: <code>"+g.toString()+"</code>"),"Bluetooth",a),k.return(g);case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error reading from Bluetooth device "+a),k.jumpToEnd()}})};Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;f=(new TextDecoder).decode(d);return g.return(f)})};
Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return m.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=m.yieldResult;d instanceof DataView||(d=new DataView(value));f=new Uint8Array(d.buffer);g=f.length;h=buffer.Buffer.from(f);k=h.readUIntBE(0,g);return m.return(k)})};
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;f=(new Uint8Array(d.buffer)).reduce(function(h,k){return h+("0"+k.toString(16)).slice(-2)},"");return g.return(f)})};
Blast.Bluetooth.gatt_subscribe=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return f=k.yieldResult,g=module$contents$Blast$Things_getThingsLog(),g("Add 'characteristicvaluechanged' listener to characteristic "+c+(" of service <code>"+b+"</code>"),"Bluetooth",a),f.addEventListener("characteristicvaluechanged",d),Blast.Bluetooth.charEventListeners[c]=[f,"characteristicvaluechanged",
d],k.setCatchFinallyBlocks(3),g("Invoke <code>startNotifications</code> on characteristic "+c+(" from service <code>"+b+"</code>"),"Bluetooth",a),k.yield(f.startNotifications(),5);case 5:g("Finished <code>startNotifications</code> on characteristic "+c+(" from service <code>"+b+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error subscribing to Bluetooth device "+a),k.jumpToEnd()}})};
Blast.Bluetooth.startLEScan=function(){var a;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){if(Blast.Bluetooth.isLEScanRunning)return b.return();Blast.Bluetooth.cacheLEScanResults();Blast.Bluetooth.isLEScanRunning=!0;a=module$contents$Blast$Things_getThingsLog();a("Requesting LE Scan","Bluetooth");Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));setTimeout(Blast.Bluetooth.stopLEScan,
3E4);b.jumpToEnd()})};Blast.Bluetooth.stopLEScan=function(){Blast.Bluetooth.isLEScanRunning&&(module$contents$Blast$Things_getThingsLog()("Stopping LE Scan","Bluetooth"),navigator.bluetooth.stopLEScan(),Blast.Bluetooth.isLEScanRunning=!1)};Blast.Bluetooth.cacheLEScanResults=function(){Blast.Bluetooth.addEventListener("advertisementreceived",function(a){var b=a.device.id;Blast.Bluetooth.LEScanResults[b]||(Blast.Bluetooth.LEScanResults[b]=[]);Blast.Bluetooth.LEScanResults[b].unshift(a)})};
...
Blast.Bluetooth.Eddystone.getPublicECDHKey=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone public ECDH key...","Eddystone",a),d.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.PUBLIC_ECDH_KEY_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone public ECDH key: <code>"+c+"</code>","Eddystone",a);return d.return(c)})};
...
q=l[t].length;break}for(;q<m.length;){l=q;for(t=0;t<n.length;t++)if(m.startsWith(n[t],q)){p.push(t);q+=n[t].length;break}l===q&&(p.push(r.encode(m[q])[0]),q++)}if(18<p.length)module$contents$Blast$Interpreter_throwError("URL is too long.");else return p.splice(0,0,16),new Uint8Array(p)};if("URL"===b)g=f(c);else if("UID"===b){if(!/^[0-9A-Fa-f]{32}$/.test(c))return module$contents$Blast$Interpreter_throwError("Eddystone UID must be 32 hexadecimal characters."),k.return();g="0x00"+c}return k.yield(Blast.Bluetooth.gatt_writeWithResponse(a,
Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,g),2)}h=k.yieldResult;d("Eddystone advertising data set to <code>"+c+"</code>","Eddystone",a);return k.return(h)})};var module$exports$Blast$blocks$colours={},module$contents$Blast$blocks$colours_COLOUR_RGB_XML='\n<block type="colour_rgb">\n    <value name="RED">\n        <block type="math_number">\n            <field name="NUM">100</field>\n        </block>\n    </value>\n    <value name="GREEN">\n        <block type="math_number">\n            <field name="NUM">50</field>\n        </block>\n    </value>\n    <value name="BLUE">\n        <block type="math_number">\n            <field name="NUM">0</field>\n        </block>\n    </value>\n</block>';
...
var module$contents$Blast$generators$blast_eddystoneServiceUUID="a3c87500-8ed3-4bdf-8a39-a01bebede295";Blast.Bluetooth.optionalServices.push(module$contents$Blast$generators$blast_eddystoneServiceUUID);
...
g.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readEddystoneProperty",module$contents$Blast$generators$blast_readEddystoneProperty]);var module$exports$Blast$blocks$ble_rgb_led_controller={};
...
module$contents$Blast$Toolbox_addBlock("switch_lights_rgb","Properties",module$contents$Blast$blocks$ble_rgb_led_controller_SWITCH_LIGHTS_RGB_XML);var module$exports$Blast$generators$ble_rgb_led_controller={};Blockly.JavaScript.switch_lights_rgb=function(a){var b=Blockly.JavaScript.valueToCode(a,"colour",Blockly.JavaScript.ORDER_ATOMIC)||Blockly.JavaScript.quote_("#000000");return"switchLights("+(Blockly.JavaScript.valueToCode(a,"thing",Blockly.JavaScript.ORDER_NONE)||"null")+", "+b+");\n"};var module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID="0000fff0-0000-1000-8000-00805f9b34fb";Blast.Bluetooth.optionalServices.push(module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID);
var module$contents$Blast$generators$ble_rgb_led_controller_switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(!a)return module$contents$Blast$Interpreter_throwError("No LED Controller is set."),c(),f.return();d="7e000503"+b.substring(1,7)+"00ef";return f.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),2)}c();f.jumpToEnd()})};
module$contents$Blast$Interpreter_asyncApiFunctions.push(["switchLights",module$contents$Blast$generators$ble_rgb_led_controller_switchLights]);var module$exports$Blast$blocks$blinkstick={};
...
var module$contents$Blast$generators$huskyduino_HuskyServiceUUID="5be35d20-f9b0-11eb-9a03-0242ac130003";Blast.Bluetooth.optionalServices.push(module$contents$Blast$generators$huskyduino_HuskyServiceUUID);
var module$contents$Blast$generators$huskyduino_chooseAlgo=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be35d26-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["chooseAlgo",module$contents$Blast$generators$huskyduino_chooseAlgo]);
var module$contents$Blast$generators$huskyduino_learnID=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be35eca-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["learnID",module$contents$Blast$generators$huskyduino_learnID]);
var module$contents$Blast$generators$huskyduino_forgetAll=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be361b8-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["forgetAll",module$contents$Blast$generators$huskyduino_forgetAll]);
var module$contents$Blast$generators$huskyduino_readID=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_read_text(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be3628a-f9b0-11eb-9a03-0242ac130003"),2);c=d.yieldResult;b(c);d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readID",module$contents$Blast$generators$huskyduino_readID]);var module$exports$Blast$blocks$streamdeck={};
