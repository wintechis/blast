...
$jscomp.polyfill("Array.from",function(a){return a?a:function(b,c,d){c=null!=c?c:function(k){return k};var e=[],g="undefined"!=typeof Symbol&&Symbol.iterator&&b[Symbol.iterator];if("function"==typeof g){b=g.call(b);for(var f=0;!(g=b.next()).done;)e.push(c.call(d,g.value,f++))}else for(g=b.length,f=0;f<g;f++)e.push(c.call(d,b[f],f));return e}},"es6","es3");var Blast={States:{}};Blast.States.Interpreter=null;Blast.States.runner_=null;Blast.States.latestCode="";Blast.States.eventCode=new Map;
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$43:e.$jscomp$loop$prop$type$43,$jscomp$loop$prop$name$44:e.$jscomp$loop$prop$name$44},g=b.next()){g=g.value;e.$jscomp$loop$prop$type$43=g.getAttribute("type");if("things_webBluetooth"==e.$jscomp$loop$prop$type$43||"things_webHID"==e.$jscomp$loop$prop$type$43){e.$jscomp$loop$prop$name$44=
g.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$44))continue;g=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$44));var k=document.createElement("td"),h=document.createElement("input");h.setAttribute("type","button");h.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$44);h.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$44);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);h.addEventListener("click",function(n){return function(){var p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return"things_webBluetooth"!=n.$jscomp$loop$prop$type$43?("things_webHID"==n.$jscomp$loop$prop$type$43&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(r){0===r.length&&
...
q.jumpToEnd()})}}(e));k.appendChild(h);g.appendChild(f);g.appendChild(k);g.appendChild(l);c.appendChild(g);d.push(e.$jscomp$loop$prop$name$44)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$46:e.$jscomp$loop$prop$type$46,$jscomp$loop$prop$name$47:e.$jscomp$loop$prop$name$47},g=b.next())if(g=g.value,e.$jscomp$loop$prop$type$46=g.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$46||"things_webHID"==e.$jscomp$loop$prop$type$46)if(e.$jscomp$loop$prop$name$47=
g.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$47)){g=document.createElement("li");g.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$47);g.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$47);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$46?"bluetooth_disabled":"usb_off";g.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var k=document.createElement("span");k.setAttribute("class","mdc-list-item__primary-text");k.innerHTML=e.$jscomp$loop$prop$name$47;f.appendChild(k);k=document.createElement("span");k.setAttribute("class","mdc-list-item__secondary-text");k.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$47);k.innerHTML="disconnected";f.appendChild(k);g.appendChild(f);g.addEventListener("click",function(h){return function(){var l;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return"things_webBluetooth"!=h.$jscomp$loop$prop$type$46?("things_webHID"==h.$jscomp$loop$prop$type$46&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(n){0===n.length&&Blast.throwError("Connection failed or cancelled by User.");var p=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(p,n[0]);Blast.Things.addWebHidDevice(p,"");document.getElementById("rc-status-"+
h.$jscomp$loop$prop$name$47).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$47).innerHTML="usb";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$47).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){wHidLog("Argh! "+n)})),m.jumpTo(0)):m.yield(Blast.Bluetooth.requestDevice(),
3);Blast.Things.addWebBluetoothDevice(device.id,h.$jscomp$loop$prop$name$47);document.getElementById("rc-status-"+h.$jscomp$loop$prop$name$47).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$47).innerHTML="bluetooth";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$47).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
m.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$47)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function e(h){h=h.replace(/^0x/,"");0!=h.length%2&&(h="0"+h);var l=h.match(/[G-Z\s]/i);l&&console.log("WARNING: found non-hex characters",l);h=h.match(/[\dA-F]{2}/gi).map(function(m){return parseInt(m,16)});return(new Uint8Array(h)).buffer}var g,f,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.connect(a,b),2);case 2:return g=h.yieldResult,h.yield(g.getPrimaryService(b),
3);case 3:return f=h.yieldResult,h.yield(f.getCharacteristic(c),4);case 4:return k=h.yieldResult,d=e(d),h.yield(k.writeValueWithoutResponse(d),0)}})};
...
a),console.error(f),k.jumpToEnd()}})};Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;e=(new TextDecoder).decode(d);return g.return(e)})};
...
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;e=(new Uint8Array(d)).reduce(function(f,k){return f+("0"+k.toString(16)).slice(-2)},"");return g.return(e)})};
...
Blockly.Blocks.huskylens_learn_id={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("learning a face with ID").appendField(new Blockly.FieldNumber(0,1,255,1),"ID");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("ID shoud be a value between 1 and 255");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),
this.dispose()))}};Blast.Toolbox.addBlock("huskylens_learn_id","Properties");
Blockly.Blocks.huskylens_forget_all={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("write a forget flag to Huskyduino").appendField(new Blockly.FieldCheckbox("TRUE"),"ForgetFlag");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("forget all learned knowledge under this algorithm");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),
this.dispose()))}};Blast.Toolbox.addBlock("huskylens_forget_all","Properties");
Blockly.Blocks.huskylens_read_id={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read face IDs out from Huskyduino");this.setOutput(!0,"String");this.setColour(255);this.setTooltip("read maximal 10 IDs out");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),this.dispose()))}};
Blast.Toolbox.addBlock("huskylens_read_id","Properties");Blockly.JavaScript.huskylens_choose_algo=function(a){var b=a.getFieldValue("Algorithms");return"chooseAlgo("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+{face_recognition:"0x01",object_tracking:"0x02",object_recognition:"0x03",line_tracking:"0x04",color_recognition:"0x05",tag_recognition:"0x06",object_classification:"0x07"}[b]+"');\n"};
Blockly.JavaScript.huskylens_learn_id=function(a){var b="0x"+a.getFieldValue("ID").toString(16);return"learnID("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+b+"');\n"};Blockly.JavaScript.huskylens_forget_all=function(a){var b="TRUE"==a.getFieldValue("ForgetFlag");return"forgetAll("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '0x"+(b?"01":"00")+"');\n"};
...
var sendHttpRequest=function(a,b,c,d,e,g){var f,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");f=JSON.parse(c);k={method:b,headers:new Headers(f)};d&&(k.body=d);fetch(a,k).then(Blast.handleFetchErrors).then(function(l){var m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return"status"==e&&g(l.status),n.yield(l.text(),2);m=n.yieldResult;g(m);n.jumpToEnd()})}).catch(function(l){Blast.throwError(l.message+
...
var readJoyConProperty=function(a,b,c,d,e,g){var f,k,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:f=Blast.Things.webHidDevices.get(a);if(f.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(f.open(),5);case 5:l.leaveTryBlock(2);break;case 3:l.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:return 8198===f.productId?k=new JoyConLeft(f):8199===f.productId&&(k=new JoyConRight(f)),
l.yield(k.open(),6);case 6:return l.yield(k.enableStandardFullMode(),7);case 7:return l.yield(k.enableIMUMode(),8);case 8:h=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){n=m.detail;if(!n||!n.actualOrientation)return p.return();console.log(n);k.removeEventListener("hidinput",h);""!==d?"accelerometers"===b?g(n[b][c][d].acc):"gyroscopes"===b?g(n[b][c][d][e]):g(n[b][c][d]):g(n[b][c]);p.jumpToEnd()})};if(k.eventListenerAttached){l.jumpTo(0);break}return l.yield(k.open(),
10);case 10:return l.yield(k.enableStandardFullMode(),11);case 11:return l.yield(k.enableIMUMode(),12);case 12:return l.yield(k.enableVibration(),13);case 13:k.addEventListener("hidinput",h),k.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.read_ruuvi_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["temperature","temperature"],["humidity","humidity"],["pressure","pressure"],["acceleration X","accelerationX"],["acceleration Y","accelerationY"],["acceleration Z","accelerationZ"],["battery voltage","batteryVoltage"],["txPower","txPower"],["movement counter","movementCounter"],["measurement sequence number","measurementSequenceNumber"]]),
...
b+"], "+a+");\n"};
var handleStreamdeck=function(a,b,c){var d,e,g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:d="inputreport";e=Blast.Things.webHidDevices.get(a);if(e.opened){k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(e.open(),5);case 5:k.leaveTryBlock(2);break;case 3:g=k.enterCatchBlock(),console.error(g),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:f=function(h){if(1===h.reportId&&(h=new Int8Array(h.data.buffer),
h=Array.from(h).slice(0,6),b=b.toString().split(",").map(Number),h.every(function(n,p){return n===b[p]}))){Blast.Interrupted=!0;var l=new Interpreter("");l.stateStack[0].scope=Blast.Interpreter.globalScope;l.appendCode(c);var m=function(){try{l.step()?setTimeout(m,5):Blast.Interrupted=!1}catch(n){Blockly.alert("Error executing program:\n%e".replace("%e",n)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(n)}};m()}},Blast.deviceEventHandlers.push({device:e,type:d,fn:f}),
e.addEventListener(d,f),k.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);
