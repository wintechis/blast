...
a),console.error(l),g.jumpToEnd()}})};Blast.Bluetooth.requestLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){return a.yield(navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}),0)})};Blast.Bluetooth.addEventListener=function(a,b){navigator.bluetooth.addEventListener(a,b)};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(e){e=e?e.toString():"";return Blast.highlightBlock(e)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(e){Blast.Interrupted=e};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
var getRuuviMeasurement=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return d=function(f){var l={},g=f[0]&255,h=f[1]<<8|f[2]&255;32767<h&&(h-=65535);var m=((f[3]&255)<<8|f[4]&255)/400,n=((f[5]&255)<<8|f[6]&255)+5E4,p=(f[7]<<8|f[8]&255)/1E3,q=(f[9]<<8|f[10]&255)/1E3,t=(f[11]<<8|f[12]&255)/1E3,r=(f[13]&255)<<8|f[14]&255,u=f[15]&255;f=(f[16]&255)<<8|f[17]&255;l.destination_endpoint=g;l.temperature=h/200;l.humidity=m;l.pressure=n;l.accelerationX=
p;l.accelerationY=q;l.accelerationZ=t;l.batteryVoltage=(r>>>5)/1E3+1.6;l.txPower=2*(r&31)-40;l.movementCounter=u;l.measurementSequenceNumber=f;return l},e=function(f){if(f.device.id==b&&(f=f.manufacturerData.get(1177))&&5==f.getUint8(0)){for(var l=[],g=0;g<f.byteLength;g++)l.push("0x"+("00"+f.getUint8(g).toString(16)).slice(-2));values=d(l);c(valies[a])}},k.yield(Blast.Bluetooth.requestLEScan(),2);Blast.Bluetooth.addEventListener("advertisementreceived",e);k.jumpToEnd()})};
Blast.asyncApiFunctions.push(["getRuuviMeasurement",getRuuviMeasurement]);Blockly.Blocks.switch_lights_rgb={init:function(){this.appendDummyInput().appendField("write RGB lights property of");this.appendValueInput("mac").setCheck("Thing");this.appendDummyInput().appendField("red").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_red").appendField("green").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_green").appendField("blue").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_blue");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);
