...
m){function n(t){return function(r){p[t]=r;q--;0==q&&h(p)}}var p=[],q=0;do p.push(void 0),q++,c(g.value).callWhenSettled_(n(p.length-1),m),g=l.next();while(!g.done)})};return e},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
...
a),console.error(f),l.jumpToEnd()}})};Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0});a.jumpToEnd()})};
Blast.Bluetooth.checkForLEScan=function(){console.log("foo");if(!Blast.Bluetooth.isLEScanRunning)for(var a=$jscomp.makeIterator(Blast.Bluetooth.scanBlocks),b=a.next();!b.done;b=a.next())if(0<Blast.workspace.getBlocksByType(b.value).length){Blast.Bluetooth.startLEScan();Blast.Bluetooth.isLEScanRunning=!0;break}};Blast.Bluetooth.cacheLEScanResults=function(){Blast.Bluetooth.addEventListener("advertisementreceived",function(a){Blast.Bluetooth.LEScanResults[a.device.id]=a})};
...
var getRuuviProperty=function(a,b,c){var d,e,k,f,l,g,h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:d=function(p){var q={},t=p[0]&255,r=p[1]<<8|p[2]&255;32767<r&&(r-=65535);var v=((p[3]&255)<<8|p[4]&255)/400,w=((p[5]&255)<<8|p[6]&255)+5E4,x=(p[7]<<8|p[8]&255)/1E3,y=(p[9]<<8|p[10]&255)/1E3,z=(p[11]<<8|p[12]&255)/1E3,u=(p[13]&255)<<8|p[14]&255,A=p[15]&255;p=(p[16]&255)<<8|p[17]&255;q.destination_endpoint=t;q.temperature=r/200;q.humidity=v;q.pressure=
w;q.accelerationX=x;q.accelerationY=y;q.accelerationZ=z;q.batteryVoltage=(u>>>5)/1E3+1.6;q.txPower=2*(u&31)-40;q.movementCounter=A;q.measurementSequenceNumber=p;return q};if(e=Blast.Bluetooth.LEScanResults[b]){n.jumpTo(2);break}k=0;case 3:if(!(20>k)){n.jumpTo(2);break}return n.yield(new Promise(function(p){return setTimeout(p,1E3)}),6);case 6:e=Blast.Bluetooth.LEScanResults[b];k++;n.jumpTo(3);break;case 2:e||Blast.throwError("No LE advertising data found for "+b);if(e.device.id!=b)return n.return();
f=e.manufacturerData.get(1177);if(!f)return n.return();l=f.getUint8(0);if(5!=l)return n.return();g=[];for(h=0;h<f.byteLength;h++)g.push("0x"+("00"+f.getUint8(h).toString(16)).slice(-2));m=d(g);c(m[a]);n.jumpToEnd()}})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.streamdeck_buttons={init:function(){this.appendValueInput("id").setCheck("Thing").appendField("Streamdeck mini");this.appendDummyInput().appendField("on button press:");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE"),"button1").appendField(new Blockly.FieldCheckbox("FALSE"),"button2").appendField(new Blockly.FieldCheckbox("FALSE"),"button3");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE"),
