...
$jscomp.polyfill("Array.from",function(a){return a?a:function(b,c,d){c=null!=c?c:function(l){return l};var e=[],h="undefined"!=typeof Symbol&&Symbol.iterator&&b[Symbol.iterator];if("function"==typeof h){b=h.call(b);for(var f=0;!(h=b.next()).done;)e.push(c.call(d,h.value,f++))}else for(h=b.length,f=0;f<h;f++)e.push(c.call(d,b[f],f));return e}},"es6","es3");var Blast={States:{}};Blast.States.Interpreter=null;Blast.States.runner_=null;Blast.States.latestCode="";Blast.States.eventCode=new Map;
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;e={$jscomp$loop$prop$type$38:e.$jscomp$loop$prop$type$38,$jscomp$loop$prop$name$39:e.$jscomp$loop$prop$name$39},h=b.next()){h=h.value;e.$jscomp$loop$prop$type$38=h.getAttribute("type");if("things_webBluetooth"==e.$jscomp$loop$prop$type$38||"things_webHID"==e.$jscomp$loop$prop$type$38){e.$jscomp$loop$prop$name$39=
h.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$39))continue;h=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$39));var l=document.createElement("td"),g=document.createElement("input");g.setAttribute("type","button");g.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$39);g.setAttribute("value","Pair");var k=document.createElement("td"),m=document.createElement("span");m.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$39);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";k.appendChild(m);g.addEventListener("click",function(n){return function(){if("things_webBluetooth"==n.$jscomp$loop$prop$type$38){var p={acceptAllDevices:!0};p.optionalServices=Blast.Bluetooth.optionalServices;navigator.bluetooth.requestDevice(p).then(function(q){Blast.Things.addWebBluetoothDevice(q.id,n.$jscomp$loop$prop$name$39);document.getElementById("pairStatus-"+
n.$jscomp$loop$prop$name$39).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(q){Blast.throwError("Error connecting to WebBluetooth device:\n"+q)})}else"things_webHID"==n.$jscomp$loop$prop$type$38&&navigator.hid.requestDevice({filters:[]}).then(function(q){0===
q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,"");document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(q){wHidLog("Argh! "+q)})}}(e));l.appendChild(g);h.appendChild(f);h.appendChild(l);h.appendChild(k);c.appendChild(h);d.push(e.$jscomp$loop$prop$name$39)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;e={$jscomp$loop$prop$type$41:e.$jscomp$loop$prop$type$41,$jscomp$loop$prop$name$42:e.$jscomp$loop$prop$name$42},h=b.next())if(h=h.value,e.$jscomp$loop$prop$type$41=h.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$41||"things_webHID"==e.$jscomp$loop$prop$type$41)if(e.$jscomp$loop$prop$name$42=
h.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$42)){h=document.createElement("li");h.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$42);h.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$42);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$41?"bluetooth_disabled":"usb_off";h.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=e.$jscomp$loop$prop$name$42;f.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$42);l.innerHTML="disconnected";f.appendChild(l);h.appendChild(f);h.addEventListener("click",function(g){return function(){if("things_webBluetooth"==
g.$jscomp$loop$prop$type$41){var k={acceptAllDevices:!0};k.optionalServices=Blast.Bluetooth.optionalServices;navigator.bluetooth.requestDevice(k).then(function(m){Blast.Things.addWebBluetoothDevice(m.id,g.$jscomp$loop$prop$name$42);document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$42).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).innerHTML="bluetooth";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&
(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(m){Blast.throwError("Error connecting to WebBluetooth device:\n"+m)})}else"things_webHID"==g.$jscomp$loop$prop$type$41&&navigator.hid.requestDevice({filters:[]}).then(function(m){0===m.length&&Blast.throwError("Connection failed or cancelled by User.");var n=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(n,m[0]);Blast.Things.addWebHidDevice(n,"");document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$42).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).innerHTML="usb";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(m){wHidLog("Argh! "+
m)})}}(e));c.appendChild(h);d.push(e.$jscomp$loop$prop$name$42)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Things.createWebBluetoothButtonHandler=function(){var a={acceptAllDevices:!0};a.optionalServices=Blast.Bluetooth.optionalServices;navigator.bluetooth.requestDevice(a).then(function(b){Blast.Things.addWebBluetoothDevice(b.id,b.name);Blast.workspace.refreshToolboxSelection()}).catch(function(b){Blast.throwError(b)})};
Blast.Things.addWebBluetoothDevice=function(a,b){var c=function(d,e){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(h){if(h){var f=Blast.Things.webBluetoothDevices.has(h);f?(f="Name %1 already exists".replace("%1",f.name),Blockly.alert(f,function(){c(h)})):Blast.Things.webBluetoothDevices.set(h,e)}else Blockly.alert("Name cannot be empty",function(){c(h,e)})})};c(b,a)};
...
Blast.Things.addWebHidDevice=function(a,b){var c=function(d,e){Blockly.Variables.promptName("Connection established! Now give your device a name.",d,function(h){if(h){var f=Blast.Things.webHidNames.has(h);f?(f="Name %1 already exists".replace("%1",f.name),Blockly.alert(f,function(){c(h)})):Blast.Things.webHidNames.set(h,e)}else Blockly.alert("Name cannot be empty",function(){c(h,e)})})};c(b,a)};Blast.Bluetooth={};Blast.Bluetooth.optionalServices=[];Blast.Bluetooth.scanBlocks=[];Blast.Bluetooth.LEScanResults={};Blast.Bluetooth.isLEScanRunning=!1;Blast.Bluetooth.eventListeners=[];
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function e(g){g=g.replace(/^0x/,"");0!=g.length%2&&(g="0"+g);var k=g.match(/[G-Z\s]/i);k&&console.log("WARNING: found non-hex characters",k);g=g.match(/[\dA-F]{2}/gi).map(function(m){return parseInt(m,16)});return(new Uint8Array(g)).buffer}var h,f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a,b),2);case 2:return h=g.yieldResult,g.yield(h.getPrimaryService(b),
3);case 3:return f=g.yieldResult,g.yield(f.getCharacteristic(c),4);case 4:return l=g.yieldResult,d=e(d),g.yield(l.writeValueWithoutResponse(d),0)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,e,h,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.setCatchFinallyBlocks(2),l.yield(Blast.Bluetooth.connect(a,b),4);case 4:return d=l.yieldResult,l.yield(d.getPrimaryService(b),5);case 5:return e=l.yieldResult,l.yield(e.getCharacteristic(c),6);case 6:return h=l.yieldResult,l.yield(h.readValue(),7);case 7:return l.return(l.yieldResult);case 2:f=l.enterCatchBlock(),Blast.throwError("Error reading from Bluetooth device "+
a),console.error(f),l.jumpToEnd()}})};Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){if(Blast.Bluetooth.isLEScanRunning)return a.return();Blast.Bluetooth.cacheLEScanResults();Blast.Bluetooth.isLEScanRunning=!0;Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));setTimeout(Blast.Bluetooth.stopLEScan,3E4);a.jumpToEnd()})};
...
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(e,h){return Blast.States.eventChecker(e,h)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return Blast.States.startEventChecker()}));c=function(e){return prompt(e)};a.setProperty(b,"prompt",a.createNativeFunction(c))};Blockly.Blocks.repeat=Blockly.Blocks.controls_repeat_ext;Blockly.Blocks.while_until=Blockly.Blocks.controls_whileUntil;Blockly.Blocks["for"]=Blockly.Blocks.controls_for;Blockly.Blocks.break_continue=Blockly.Blocks.controls_flow_statements;Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES.push("repeat","while_until","for");
...
var sendHttpRequest=function(a,b,c,d,e,h){var f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");f=JSON.parse(c);l={method:b,headers:new Headers(f)};d&&(l.body=d);fetch(a,l).then(Blast.handleFetchErrors).then(function(k){"status"==e&&h(k.status);h(k.text())}).then(function(k){urdf.clear();urdf.load(k).then(function(){urdf.query("SELECT * WHERE {?subject ?predicate ?object}").then(function(m){h(m)})})}).catch(function(k){Blast.throwError(k.message+
...
var urdfQueryWrapper=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){urdf.clear();d="\n FROM <"+a+">\n";b=b.slice(0,b.indexOf("WHERE"))+d+b.slice(b.indexOf("WHERE"));urdf.query(b).then(function(h){c(h)});e.jumpToEnd()})};Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var displayText=function(a){Blast.Ui.addMessage(a)};
...
var playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,e){var h=new Audio(a);h.preload="auto";h.autoplay=!0;h.onerror=function(f){Blast.throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(f);e(f)};h.onended=d}),2);b();c.jumpToEnd()})};Blast.asyncApiFunctions.push(["playAudio",playAudio]);
...
this.dispose()))}};Blast.Toolbox.addBlock("huskylens_forgetall","Properties");Blockly.JavaScript.huskylens_choosealgo=function(a){var b=a.getFieldValue("Algorithms");return"chooseAlgo( "+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+{face_recognition:"0x01",object_tracking:"0x02",object_recognition:"0x03",line_tracking:"0x04",color_recognition:"0x05",tag_recognition:"0x06",object_classification:"0x07"}[b]+"');\n"};
Blockly.JavaScript.huskylens_learnid=function(a){var b="0x"+a.getFieldValue("ID").toString(16);console.log("value of id is "+b);return"learnID( "+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+b+"');\n"};Blockly.JavaScript.huskylens_forgetall=function(a){var b="TRUE"==a.getFieldValue("ForgetFlag");return"forgetAll("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '0x"+(b?"01":"00")+"');\n"};var serviceUUID="5be35d20-f9b0-11eb-9a03-0242ac130003";
Blast.Bluetooth.optionalServices.push(serviceUUID);var chooseAlgo=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,serviceUUID,"5be35d26-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["chooseAlgo",chooseAlgo]);
var learnID=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,serviceUUID,"5be35eca-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["learnID",learnID]);
var forgetAll=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,serviceUUID,"5be361b8-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["forgetAll",forgetAll]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
=======
...
var mirobotPickUp=function(a,b){var c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){c="https://bot.rapidthings.eu/thing/action/grab_"+a.toLowerCase();d={"Content-Type":"application/json",Accept:"application/json"};e={method:"POST",headers:new Headers(d)};fetch(c,e).then(Blast.handleFetchErrors).then(function(f){b(f.status)}).catch(function(f){Blast.throwError(f.message+"\nSee console for details.")});h.jumpToEnd()})};Blast.asyncApiFunctions.push(["mirobot_pickup",mirobotPickUp]);Blockly.Blocks.switch_lights_rgb={init:function(){this.appendDummyInput().appendField("write RGB lights property of");this.appendValueInput("mac").setCheck("Thing");this.appendDummyInput().appendField("red").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_red").appendField("green").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_green").appendField("blue").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_blue");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);
this.setTooltip("Switches checked lights on and unchecked ones off.");this.setHelpUrl("");this.firstTime=!0},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n        Upgrade to Chrome version 85 or later and enable Experimental Web Platform features."),this.dispose()))}};Blast.Toolbox.addBlock("switch_lights_rgb","Properties");
Blockly.Blocks.switch_lights_ryg={init:function(){this.appendDummyInput().appendField("write RYG lights property of");this.appendValueInput("mac").setCheck("Thing");this.appendDummyInput().appendField("red").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_red").appendField("yellow").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_yellow").appendField("green").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_green");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);
this.setTooltip("Swichtes checked lights on and unchecked ones off.");this.setHelpUrl("");this.firstTime=!0},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n        Upgrade to Chrome version 85 or later and enable Experimental Web Platform features."),this.dispose()))}};Blast.Toolbox.addBlock("switch_lights_ryg","Properties");Blockly.JavaScript.switch_lights_rgb=function(a){var b="TRUE"==a.getFieldValue("cb_red"),c="TRUE"==a.getFieldValue("cb_green"),d="TRUE"==a.getFieldValue("cb_blue");return"switchLights("+Blockly.JavaScript.valueToCode(a,"mac",Blockly.JavaScript.ORDER_NONE)+", '7e000503"+((b?"ff":"00")+(c?"ff":"00")+(d?"ff":"00")+"00ef');\n")};
Blockly.JavaScript.switch_lights_ryg=function(a){var b="TRUE"==a.getFieldValue("cb_red"),c="TRUE"==a.getFieldValue("cb_yellow"),d="TRUE"==a.getFieldValue("cb_green");return"switchLights("+Blockly.JavaScript.valueToCode(a,"mac",Blockly.JavaScript.ORDER_NONE)+", '7e000503"+((b?"ff":"00")+(d?"ff":"00")+(c?"ff":"00")+"00ef');\n")};var serviceUUID="0000fff0-0000-1000-8000-00805f9b34fb";Blast.Bluetooth.optionalServices.push(serviceUUID);
var switchLights=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,serviceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
...
var readJoyConProperty=function(a,b,c,d,e,h){var f,l,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:f=Blast.Things.webHidDevices.get(a);if(f.opened){k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(f.open(),5);case 5:k.leaveTryBlock(2);break;case 3:k.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:return 8198===f.productId?l=new JoyConLeft(f):8199===f.productId&&(l=new JoyConRight(f)),
k.yield(l.open(),6);case 6:return k.yield(l.enableStandardFullMode(),7);case 7:return k.yield(l.enableIMUMode(),8);case 8:g=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){n=m.detail;if(!n||!n.actualOrientation)return p.return();console.log(n);l.removeEventListener("hidinput",g);""!==d?"accelerometers"===b?h(n[b][c][d].acc):"gyroscopes"===b?h(n[b][c][d][e]):h(n[b][c][d]):h(n[b][c]);p.jumpToEnd()})};if(l.eventListenerAttached){k.jumpTo(0);break}return k.yield(l.open(),
<<<<<<< HEAD
10);case 10:return k.yield(l.enableStandardFullMode(),11);case 11:return k.yield(l.enableIMUMode(),12);case 12:return k.yield(l.enableVibration(),13);case 13:l.addEventListener("hidinput",g),l.eventListenerAttached=!0,k.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("Robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};Blast.Toolbox.addBlock("mirobot_pickup","actions");Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
...
=======
10);case 10:return k.yield(l.enableStandardFullMode(),11);case 11:return k.yield(l.enableIMUMode(),12);case 12:return k.yield(l.enableVibration(),13);case 13:l.addEventListener("hidinput",g),l.eventListenerAttached=!0,k.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.read_ruuvi_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["temperature","temperature"],["humidity","humidity"],["pressure","pressure"],["acceleration X","accelerationX"],["acceleration Y","accelerationY"],["acceleration Z","accelerationZ"],["battery voltage","batteryVoltage"],["txPower","txPower"],["movement counter","movementCounter"],["measurement sequence number","measurementSequenceNumber"]]),
>>>>>>> 7e5fd916c5d560834ae7159b65d89caad06708c8
...
var getRuuviProperty=function(a,b,c){var d,e,h,f,l,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return d=function(m){var n={},p=m[0]&255,q=m[1]<<8|m[2]&255;32767<q&&(q-=65535);var r=((m[3]&255)<<8|m[4]&255)/400,t=((m[5]&255)<<8|m[6]&255)+5E4,v=(m[7]<<8|m[8]&255)/1E3,w=(m[9]<<8|m[10]&255)/1E3,x=(m[11]<<8|m[12]&255)/1E3,u=(m[13]&255)<<8|m[14]&255,y=m[15]&255;m=(m[16]&255)<<8|m[17]&255;n.destination_endpoint=p;n.temperature=q/200;n.humidity=r;n.pressure=t;n.accelerationX=
v;n.accelerationY=w;n.accelerationZ=x;n.batteryVoltage=(u>>>5)/1E3+1.6;n.txPower=2*(u&31)-40;n.movementCounter=y;n.measurementSequenceNumber=m;return n},e=function(m){if(30>m){var n=Blast.Bluetooth.LEScanResults[b];if(n){n=$jscomp.makeIterator(n);for(var p=n.next();!p.done;p=n.next())if((p=p.value.manufacturerData.get(1177))&&5==p.getUint8(0))return p}return new Promise(function(q){setTimeout(function(){q(e(m+1))},1E3)})}},Blast.Bluetooth.startLEScan(b),k.yield(e(0),2);(h=k.yieldResult)||Blast.throwError("Timed out. No BLE advertising data found for "+
b);f=[];for(l=0;l<h.byteLength;l++)f.push("0x"+("00"+h.getUint8(l).toString(16)).slice(-2));g=d(f);c(g[a]);k.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
...
b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};Blast.Toolbox.addBlock("streamdeck_buttons","States and Events");Blockly.JavaScript.streamdeck_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,e="TRUE"==a.getFieldValue("button4")?1:0,h="TRUE"==a.getFieldValue("button5")?1:0,f="TRUE"==a.getFieldValue("button6")?1:0,l=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE);b=[b,c,d,e,h,f];a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));return"handleStreamdeck("+l+", ["+
b+"], "+a+");\n"};
var handleStreamdeck=function(a,b,c){var d,e,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:d="inputreport";e=Blast.Things.webHidDevices.get(a);if(e.opened){f.jumpTo(2);break}f.setCatchFinallyBlocks(3);return f.yield(e.open(),5);case 5:f.leaveTryBlock(2);break;case 3:f.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:h=function(l){if(1===l.reportId&&(l=new Int8Array(l.data.buffer),l=
Array.from(l).slice(0,6),b=b.toString().split(",").map(Number),l.every(function(m,n){return m===b[n]}))){Blast.Interrupted=!0;var g=new Interpreter("");g.stateStack[0].scope=Blast.Interpreter.globalScope;g.appendCode(c);var k=function(){try{g.step()?setTimeout(k,5):Blast.Interrupted=!1}catch(m){Blockly.alert("Error executing program:\n%e".replace("%e",m)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(m)}};k()}},Blast.deviceEventHandlers.push({device:e,type:d,fn:h}),
<<<<<<< HEAD
e.addEventListener(d,h),f.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
Blockly.Blocks.web_speech={init:function(){this.appendDummyInput().appendField("speech to text");this.setOutput(!0,"String");this.setColour(0);this.setTooltip("outputs speech command from microphone as a string");this.setHelpUrl("");this.firstTime=!0;this.recognition=null},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,"webkitSpeechRecognition"in window?this.recognition=new webkitSpeechRecognition:(Blockly.alert('Web Speech API is not supported by this browser.\n        Upgrade to <a href="//www.google.com/chrome">Chrome</a>\n        version 25 or later.'),
this.dispose()))}};Blast.Toolbox.addBlock("web_speech","actions");Blockly.JavaScript.text_to_speech=function(a){return"textToSpeech("+Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_ATOMIC)+");\n"};Blockly.JavaScript.web_speech=function(a){return["webSpeech('"+a.id+"')",Blockly.JavaScript.ORDER_NONE]};
var webSpeech=function(a,b){var c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){c=Blast.workspace.getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";e="";d.onresult=function(f){for(var l=f.resultIndex;l<f.results.length;++l)f.results[l].isFinal&&(e+=f.results[l][0].transcript)};d.onend=function(){b(e)};d.start();h.jumpToEnd()})};Blast.asyncApiFunctions.push(["webSpeech",webSpeech]);
var textToSpeech=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=new SpeechSynthesisUtterance,c.text=a,window.speechSynthesis.speak(c),d.yield(new Promise(function(e){c.onend=e}),2);b();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["textToSpeech",textToSpeech]);
=======
e.addEventListener(d,h),f.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);
>>>>>>> 7e5fd916c5d560834ae7159b65d89caad06708c8
