...
m){function n(u){return function(p){q[u]=p;t--;0==t&&h(q)}}var q=[],t=0;do q.push(void 0),t++,c(g.value).callWhenSettled_(n(q.length-1),m),g=l.next();while(!g.done)})};return e},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var h=Object.seal({}),m=Object.seal({}),n=new a([[h,2],[m,3]]);if(2!=n.get(h)||3!=n.get(m))return!1;n.delete(h);n.set(m,4);return!n.has(h)&&4==n.get(m)}catch(q){return!1}}function c(){}function d(h){var m=typeof h;return"object"===m&&null!==h||"function"===m}function e(h){if(!$jscomp.owns(h,f)){var m=new c;$jscomp.defineProperty(h,f,{value:m})}}function k(h){if(!$jscomp.ISOLATE_POLYFILLS){var m=Object[h];m&&(Object[h]=
...
(m=""+ ++l,c.set(h,m)):m="p_"+h;var n=g.data_[m];if(n&&$jscomp.owns(g.data_,m))for(g=0;g<n.length;g++){var q=n[g];if(h!==h&&q.key!==q.key||h===q.key)return{id:m,list:n,index:g,entry:q}}return{id:m,list:n,index:-1,entry:void 0}},k=function(g,h){var m=g.head_;return $jscomp.iteratorPrototype(function(){if(m){for(;m.head!=g.head_;)m=m.previous;for(;m.next!=m.head;)return m=m.next,{done:!1,value:h(m)};m=null}return{done:!0,value:void 0}})},f=function(){var g={};return g.previous=g.next=g.head=g},l=0;
...
Blast.resetInterpreter=function(){Blast.Interpreter=null;Blast.runner_&&(clearTimeout(Blast.runner_),Blast.runner_=null);Blast.Bluetooth.isLEScanRunning=!1};Blast.removeDeviceHandlers=function(){for(var a=$jscomp.makeIterator(Blast.deviceEventHandlers),b=a.next();!b.done;b=a.next())b=b.value,b.device.removeEventListener(b.type,b.fn);Blast.deviceEventHandlers=[]};
Blast.runJS=function(){Blast.resetUi(Blast.status.RUNNING);null==Blast.Interpreter&&(Blast.highlightPause=!1,Blast.Interpreter=new Interpreter(Blast.latestCode,initApi),Blast.Bluetooth.checkForLEScan(),Blast.runner_=function(){if(Blast.Interpreter)try{Blast.Interrupted?setTimeout(Blast.runner_,5):Blast.Interpreter.step()?setTimeout(Blast.runner_,5):Blast.States.Interpreter||0<Blast.eventInWorkspace.length||(Blast.removeDeviceHandlers(),Blast.resetUi(Blast.status.READY),Blast.resetInterpreter())}catch(a){Blockly.alert("Error executing program:\n%e".replace("%e",
...
a),console.error(f),l.jumpToEnd()}})};Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){Blast.Bluetooth.cacheLEScanResults();Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));a.jumpToEnd()})};
Blast.Bluetooth.checkForLEScan=function(){if(!Blast.Bluetooth.isLEScanRunning)for(var a=$jscomp.makeIterator(Blast.Bluetooth.scanBlocks),b=a.next();!b.done;b=a.next())if(0<Blast.workspace.getBlocksByType(b.value).length){Blast.Bluetooth.startLEScan();Blast.Bluetooth.isLEScanRunning=!0;break}};Blast.Bluetooth.cacheLEScanResults=function(){Blast.Bluetooth.addEventListener("advertisementreceived",function(a){var b=a.device.id;Blast.Bluetooth.LEScanResults[b]||(Blast.Bluetooth.LEScanResults[b]=[]);Blast.Bluetooth.LEScanResults[b].push(a)})};
Blast.Bluetooth.addEventListener=function(a,b){navigator.bluetooth.addEventListener(a,b)};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(e){e=e?e.toString():"";return Blast.highlightBlock(e)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(e){Blast.Interrupted=e};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
g=Array.from(g).slice(0,6),c=c.toString().split(",").map(Number),g.every(function(n,q){return n===c[q]}))){Blast.Interrupted=!0;var h=new Interpreter("");h.stateStack[0].scope=Blast.Interpreter.globalScope;h.appendCode(d);var m=function(){try{h.step()?setTimeout(m,5):Blast.Interrupted=!1}catch(n){Blockly.alert("Error executing program:\n%e".replace("%e",n)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(n)}};m()}},Blast.deviceEventHandlers.push({device:k,type:e,fn:f}),
...
var getRuuviProperty=function(a,b,c){var d,e,k,f,l,g,h,m,n,q,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:d=function(p){var r={},x=p[0]&255,v=p[1]<<8|p[2]&255;32767<v&&(v-=65535);var y=((p[3]&255)<<8|p[4]&255)/400,z=((p[5]&255)<<8|p[6]&255)+5E4,A=(p[7]<<8|p[8]&255)/1E3,B=(p[9]<<8|p[10]&255)/1E3,C=(p[11]<<8|p[12]&255)/1E3,w=(p[13]&255)<<8|p[14]&255,D=p[15]&255;p=(p[16]&255)<<8|p[17]&255;r.destination_endpoint=x;r.temperature=v/200;r.humidity=y;r.pressure=
z;r.accelerationX=A;r.accelerationY=B;r.accelerationZ=C;r.batteryVoltage=(w>>>5)/1E3+1.6;r.txPower=2*(w&31)-40;r.movementCounter=D;r.measurementSequenceNumber=p;return r},k=0;case 2:if(!(30>k)){u.jumpTo(3);break}if(f=Blast.Bluetooth.LEScanResults[b])for(l=$jscomp.makeIterator(f),g=l.next();!g.done;g=l.next())if(h=g.value,e=h.manufacturerData.get(1177))m=e.getUint8(0),5==m&&(k=30);return u.yield(new Promise(function(p){return setTimeout(p,1E3)}),4);case 4:k++;u.jumpTo(2);break;case 3:e||Blast.throwError("No BLE advertising data found for "+
b);n=[];for(q=0;q<e.byteLength;q++)n.push("0x"+("00"+e.getUint8(q).toString(16)).slice(-2));t=d(n);c(t[a]);u.jumpToEnd()}})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
