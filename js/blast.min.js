...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;e={$jscomp$loop$prop$type$43:e.$jscomp$loop$prop$type$43,$jscomp$loop$prop$name$44:e.$jscomp$loop$prop$name$44},h=b.next()){h=h.value;e.$jscomp$loop$prop$type$43=h.getAttribute("type");if("things_webBluetooth"==e.$jscomp$loop$prop$type$43||"things_webHID"==e.$jscomp$loop$prop$type$43){e.$jscomp$loop$prop$name$44=
h.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$44))continue;h=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$44));var l=document.createElement("td"),g=document.createElement("input");g.setAttribute("type","button");g.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$44);g.setAttribute("value","Pair");var k=document.createElement("td"),m=document.createElement("span");m.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$44);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";k.appendChild(m);g.addEventListener("click",function(n){return function(){var p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return"things_webBluetooth"!=n.$jscomp$loop$prop$type$43?("things_webHID"==n.$jscomp$loop$prop$type$43&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(r){0===r.length&&
...
q.jumpToEnd()})}}(e));l.appendChild(g);h.appendChild(f);h.appendChild(l);h.appendChild(k);c.appendChild(h);d.push(e.$jscomp$loop$prop$name$44)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;e={$jscomp$loop$prop$type$46:e.$jscomp$loop$prop$type$46,$jscomp$loop$prop$name$47:e.$jscomp$loop$prop$name$47},h=b.next())if(h=h.value,e.$jscomp$loop$prop$type$46=h.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$46||"things_webHID"==e.$jscomp$loop$prop$type$46)if(e.$jscomp$loop$prop$name$47=
h.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$47)){h=document.createElement("li");h.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$47);h.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$47);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$46?"bluetooth_disabled":"usb_off";h.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=e.$jscomp$loop$prop$name$47;f.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$47);l.innerHTML="disconnected";f.appendChild(l);h.appendChild(f);h.addEventListener("click",function(g){return function(){var k;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return"things_webBluetooth"!=g.$jscomp$loop$prop$type$46?("things_webHID"==g.$jscomp$loop$prop$type$46&&(k=[],navigator.hid.requestDevice({filters:k}).then(function(n){0===n.length&&Blast.throwError("Connection failed or cancelled by User.");var p=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(p,n[0]);Blast.Things.addWebHidDevice(p,"");document.getElementById("rc-status-"+
g.$jscomp$loop$prop$name$47).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$47).innerHTML="usb";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$47).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){wHidLog("Argh! "+n)})),m.jumpTo(0)):m.yield(Blast.Bluetooth.requestDevice(),
...
m.jumpToEnd()})}}(e));c.appendChild(h);d.push(e.$jscomp$loop$prop$name$47)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Things.addWebBluetoothDevice=function(a,b){var c=function(d,e){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(h){if(h)if(Blast.Things.webBluetoothDevices.has(h)){var f="Name %1 already exists".replace("%1",h);Blockly.alert(f,function(){c(h)})}else Blast.Things.webBluetoothDevices.set(h,e);else Blockly.alert("Name cannot be empty",function(){c(h,e)})})};c(b,a)};
