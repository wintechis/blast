...
b),2);case 2:return k=g.yieldResult,g.yield(k.getPrimaryService(b),3);case 3:return f=g.yieldResult,g.yield(f.getCharacteristic(c),4);case 4:return l=g.yieldResult,d=e(d),g.yield(l.writeValueWithoutResponse(d),5);case 5:return g.return()}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,e,k,f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.setCatchFinallyBlocks(2),g.yield(Blast.Bluetooth.connect(a,b),4);case 4:return d=g.yieldResult,g.yield(d.getPrimaryService(b),5);case 5:return e=g.yieldResult,g.yield(e.getCharacteristic(c),6);case 6:return k=g.yieldResult,g.yield(k.readValue(),7);case 7:return f=g.yieldResult,g.return(f);case 2:l=g.enterCatchBlock(),Blast.throwError("Error reading from Bluetooth device "+
a),console.error(l),g.jumpToEnd()}})};Blast.Bluetooth.requestLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){Blockly.alert("Please allow the Bluetooth-scan to continue.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));a.jumpToEnd()})};Blast.Bluetooth.addEventListener=function(a,b){navigator.bluetooth.addEventListener(a,b)};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(e){e=e?e.toString():"";return Blast.highlightBlock(e)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(e){Blast.Interrupted=e};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
Blast.Toolbox.addBlock("get_ruuvi_measurement","Properties");Blockly.JavaScript.get_ruuvi_measurement=function(a){var b=a.getFieldValue("measurement");a=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC);return["getRuuviMeasurement('"+b+"', "+a+")",Blockly.JavaScript.ORDER_NONE]};
var getRuuviMeasurement=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){d=function(f){var l={},g=f[0]&255,h=f[1]<<8|f[2]&255;32767<h&&(h-=65535);var m=((f[3]&255)<<8|f[4]&255)/400,n=((f[5]&255)<<8|f[6]&255)+5E4,p=(f[7]<<8|f[8]&255)/1E3,q=(f[9]<<8|f[10]&255)/1E3,t=(f[11]<<8|f[12]&255)/1E3,r=(f[13]&255)<<8|f[14]&255,u=f[15]&255;f=(f[16]&255)<<8|f[17]&255;l.destination_endpoint=g;l.temperature=h/200;l.humidity=m;l.pressure=n;l.accelerationX=p;l.accelerationY=q;
l.accelerationZ=t;l.batteryVoltage=(r>>>5)/1E3+1.6;l.txPower=2*(r&31)-40;l.movementCounter=u;l.measurementSequenceNumber=f;return l};e=function(f){if(f.device.id==b&&(f=f.manufacturerData.get(1177))&&5==f.getUint8(0)){for(var l=[],g=0;g<f.byteLength;g++)l.push("0x"+("00"+f.getUint8(g).toString(16)).slice(-2));f=d(l);c(f[a])}};Blast.Bluetooth.addEventListener("advertisementreceived",e);Blast.Bluetooth.requestLEScan();k.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviMeasurement",getRuuviMeasurement]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
