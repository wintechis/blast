...
Blast.Ui.addMessage=function(a){var b="media/blast-icon.png";window.location.href.includes("mobile")&&(b="../"+b);navigator.serviceWorker.ready.then(function(e){e.showNotification("Blast",{body:a,icon:b,vibrate:[200,100,200,100,200,100,200]})});var c=document.createElement("div");c.classList.add("message");c.id="message-"+Blast.Ui.messageCounter_++;var d=document.createTextNode(a);c.appendChild(d);d=document.createElement("span");d.classList.add("time");d.innerHTML=(new Date).toLocaleTimeString();
