...
"pairStatus-"+e.$jscomp$loop$prop$name$39);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";k.appendChild(m);g.addEventListener("click",function(n){return function(){"things_webBluetooth"==n.$jscomp$loop$prop$type$38?navigator.bluetooth.requestDevice({acceptAllDevices:!0,optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb","0000180a-0000-1000-8000-00805f9b34fb"]}).then(function(p){Blast.Things.addWebBluetoothDevice(p.id,n.$jscomp$loop$prop$name$39);
document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(p){Blast.throwError("Error connecting to WebBluetooth device:\n"+p)}):"things_webHID"==n.$jscomp$loop$prop$type$38&&
navigator.hid.requestDevice({filters:[]}).then(function(p){0===p.length&&Blast.throwError("Connection failed or cancelled by User.");var q=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(q,p[0]);Blast.Things.addWebHidDevice(q,"");document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=
!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(p){wHidLog("Argh! "+p)})}}(e));l.appendChild(g);h.appendChild(f);h.appendChild(l);h.appendChild(k);c.appendChild(h);d.push(e.$jscomp$loop$prop$name$39)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
...
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=e.$jscomp$loop$prop$name$42;f.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$42);l.innerHTML="disconnected";f.appendChild(l);h.appendChild(f);h.addEventListener("click",function(g){return function(){"things_webBluetooth"==
g.$jscomp$loop$prop$type$41?navigator.bluetooth.requestDevice({acceptAllDevices:!0,optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb","0000180a-0000-1000-8000-00805f9b34fb"]}).then(function(k){Blast.Things.addWebBluetoothDevice(k.id,g.$jscomp$loop$prop$name$42);document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$42).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).innerHTML="bluetooth";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).style.color=
"#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(k){Blast.throwError("Error connecting to WebBluetooth device:\n"+k)}):"things_webHID"==g.$jscomp$loop$prop$type$41&&navigator.hid.requestDevice({filters:[]}).then(function(k){0===k.length&&Blast.throwError("Connection failed or cancelled by User.");var m=Date.now().toString(36)+
Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(m,k[0]);Blast.Things.addWebHidDevice(m,"");document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$42).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).innerHTML="usb";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(k){wHidLog("Argh! "+k)})}}(e));c.appendChild(h);d.push(e.$jscomp$loop$prop$name$42)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Things.createWebBluetoothButtonHandler=function(){navigator.bluetooth.requestDevice({acceptAllDevices:!0,optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb","0000180a-0000-1000-8000-00805f9b34fb"]}).then(function(a){Blast.Things.addWebBluetoothDevice(a.id,a.name);Blast.workspace.refreshToolboxSelection()}).catch(function(a){Blast.throwError(a)})};
...
b),2);case 2:return h=g.yieldResult,console.log(h),g.yield(h.getPrimaryService(b),3);case 3:return f=g.yieldResult,console.log(f),g.yield(f.getCharacteristic(c),4);case 4:return l=g.yieldResult,console.log(l),d=e(d),console.log(d),g.yield(l.writeValueWithoutResponse(d),5);case 5:console.log(done),g.jumpToEnd()}})};
...
this.dispose()))}};Blast.Toolbox.addBlock("huskylens_forgetall","Properties");Blockly.JavaScript.huskylens_choosealgo=function(a){var b=a.getFieldValue("Algorithms");return"chooseAlgo( "+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+{face_recognition:"0x01",object_tracking:"0x02",object_recognition:"0x03",line_tracking:"0x04",color_recognition:"0x05",tag_recognition:"0x6",object_classification:"0x7"}[b]+"');\n"};
Blockly.JavaScript.huskylens_learnid=function(a){var b=a.getFieldValue("ID");return"learnID( "+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+b+"');\n"};Blockly.JavaScript.huskylens_forgetall=function(a){var b="TRUE"==a.getFieldValue("ForgetFlag");return"forgetAll("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+b+"');\n"};
var chooseAlgo=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,6154,"5be35d26-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["chooseAlgo",chooseAlgo]);
var learnID=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,"180A","5be35eca-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["learnID",learnID]);
var forgetAll=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,"180A","5be361b8-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["forgetAll",forgetAll]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
