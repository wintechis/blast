...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$45:e.$jscomp$loop$prop$type$45,$jscomp$loop$prop$name$46:e.$jscomp$loop$prop$name$46},g=b.next()){g=g.value;e.$jscomp$loop$prop$type$45=g.getAttribute("type");if("things_webBluetooth"==e.$jscomp$loop$prop$type$45||"things_webHID"==e.$jscomp$loop$prop$type$45){e.$jscomp$loop$prop$name$46=
g.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$46))continue;g=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$46));var k=document.createElement("td"),h=document.createElement("input");h.setAttribute("type","button");h.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$46);h.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$46);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);h.addEventListener("click",function(n){return function(){var p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return"things_webBluetooth"!=n.$jscomp$loop$prop$type$45?("things_webHID"==n.$jscomp$loop$prop$type$45&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(r){0===r.length&&
Blast.throwError("Connection failed or cancelled by User.");var t=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(t,r[0]);Blast.Things.addWebHidDevice(t,"");document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$46).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$46).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(r){wHidLog("Argh! "+r)})),q.jumpTo(0)):q.yield(Blast.Bluetooth.requestDevice(),3);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$46).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$46).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
q.jumpToEnd()})}}(e));k.appendChild(h);g.appendChild(f);g.appendChild(k);g.appendChild(l);c.appendChild(g);d.push(e.$jscomp$loop$prop$name$46)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$48:e.$jscomp$loop$prop$type$48,$jscomp$loop$prop$name$49:e.$jscomp$loop$prop$name$49},g=b.next())if(g=g.value,e.$jscomp$loop$prop$type$48=g.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$48||"things_webHID"==e.$jscomp$loop$prop$type$48)if(e.$jscomp$loop$prop$name$49=
g.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$49)){g=document.createElement("li");g.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$49);g.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$49);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$48?"bluetooth_disabled":"usb_off";g.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var k=document.createElement("span");k.setAttribute("class","mdc-list-item__primary-text");k.innerHTML=e.$jscomp$loop$prop$name$49;f.appendChild(k);k=document.createElement("span");k.setAttribute("class","mdc-list-item__secondary-text");k.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$49);k.innerHTML="disconnected";f.appendChild(k);g.appendChild(f);g.addEventListener("click",function(h){return function(){var l;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return"things_webBluetooth"!=h.$jscomp$loop$prop$type$48?("things_webHID"==h.$jscomp$loop$prop$type$48&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(n){0===n.length&&Blast.throwError("Connection failed or cancelled by User.");var p=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(p,n[0]);Blast.Things.addWebHidDevice(p,"");document.getElementById("rc-status-"+
h.$jscomp$loop$prop$name$49).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$49).innerHTML="usb";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$49).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){wHidLog("Argh! "+n)})),m.jumpTo(0)):m.yield(Blast.Bluetooth.requestDevice(),
3);Blast.Things.addWebBluetoothDevice(device.id,h.$jscomp$loop$prop$name$49);document.getElementById("rc-status-"+h.$jscomp$loop$prop$name$49).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$49).innerHTML="bluetooth";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$49).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
m.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$49)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
