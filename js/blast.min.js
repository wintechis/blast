...
Blast.Ui.addMessage=function(a,b){var c="media/logo-512x512.png";window.location.href.includes("mobile")&&(c="../"+c);navigator.serviceWorker.ready.then(function(e){e.showNotification("Blast",{body:a,icon:c,vibrate:[200,100,200,100,200,100,200]})});var d=document.createElement("div");d.classList.add("message");b&&d.classList.add(b+"-message");d.id="message-"+Blast.Ui.messageCounter_++;b=document.createTextNode(a);d.appendChild(b);b=document.createElement("span");b.classList.add("time");b.innerHTML=
(new Date).toLocaleTimeString();d.appendChild(b);Blast.Ui.addElementToOutputContainer(d)};
