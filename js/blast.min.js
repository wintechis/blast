...
Blast.Storage.generatePairButtons=function(a){var b=a.querySelectorAll("block");for(a=document.getElementById("rc-tbody");a.firstChild;)a.removeChild(a.firstChild);var c={};b=$jscomp.makeIterator(b);for(var d=b.next();!d.done;c={$jscomp$loop$prop$name$35:c.$jscomp$loop$prop$name$35},d=b.next())if(d=d.value,"things_webBluetooth"==d.getAttribute("type")){c.$jscomp$loop$prop$name$35=d.firstElementChild.textContent;d=document.createElement("tr");var e=document.createElement("td");e.appendChild(document.createTextNode(c.$jscomp$loop$prop$name$35));
var k=document.createElement("td"),f=document.createElement("input");f.setAttribute("type","button");f.setAttribute("id","pairButton-"+c.$jscomp$loop$prop$name$35);f.setAttribute("value","Pair");var m=document.createElement("td"),g=document.createElement("span");g.setAttribute("id","pairStatus-"+c.$jscomp$loop$prop$name$35);g.innerHTML="&#x2718;";g.style.color="red";g.style.fontSize="20px";g.style.fontWeight="bold";g.style.marginRight="10px";m.appendChild(g);f.addEventListener("click",function(h){return function(){navigator.bluetooth.requestDevice({acceptAllDevices:!0,
optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb"]}).then(function(l){Blast.Things.addWebBluetoothDevice(l.id,h.$jscomp$loop$prop$name$35);document.getElementById("pairStatus-"+h.$jscomp$loop$prop$name$35).innerHTML="&#x2714;";document.getElementById("pairStatus-"+h.$jscomp$loop$prop$name$35).style.color="green"}).catch(function(l){Blast.throwError("Error connecting to WebBluetooth device:\n"+l)})}}(c));k.appendChild(f);d.appendChild(e);d.appendChild(k);d.appendChild(m);a.appendChild(d)}};
