...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Array.from",function(a){return a?a:function(b,c,d){c=null!=c?c:function(l){return l};var e=[],h="undefined"!=typeof Symbol&&Symbol.iterator&&b[Symbol.iterator];if("function"==typeof h){b=h.call(b);for(var f=0;!(h=b.next()).done;)e.push(c.call(d,h.value,f++))}else for(h=b.length,f=0;f<h;f++)e.push(c.call(d,b[f],f));return e}},"es6","es3");var Blast={States:{}};Blast.States.Interpreter=null;
...
Blast.Ui.addMessage=function(a){var b="media/logo-512x512.png";window.location.href.includes("mobile")&&(b="../"+b);navigator.serviceWorker.ready.then(function(e){e.showNotification("Blast",{body:a,icon:b,vibrate:[200,100,200,100,200,100,200]})});var c=document.createElement("div");c.classList.add("message");c.id="message-"+Blast.Ui.messageCounter_++;var d=document.createTextNode(a);c.appendChild(d);d=document.createElement("span");d.classList.add("time");d.innerHTML=(new Date).toLocaleTimeString();
c.appendChild(d);Blast.Ui.addElementToOutputContainer(c)};
...
Blast.Storage.removeDeviceId_=function(a){var b=a.querySelectorAll("block");b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next())if(c=c.value,"things_webBluetooth"==c.getAttribute("type")&&(c=c.firstElementChild)){for(var d=c.textContent,e=void 0,h=$jscomp.makeIterator(Blast.Things.webBluetoothDevices.entries()),f=h.next();!f.done;f=h.next()){f=$jscomp.makeIterator(f.value);var l=f.next().value;if(f.next().value===d){e=l;break}}c.textContent=e}return a};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d={};b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;d={$jscomp$loop$prop$name$38:d.$jscomp$loop$prop$name$38},e=b.next()){e=e.value;if("things_webBluetooth"==e.getAttribute("type")){d.$jscomp$loop$prop$name$38=e.firstElementChild.textContent;e=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(d.$jscomp$loop$prop$name$38));
var f=document.createElement("td"),l=document.createElement("input");l.setAttribute("type","button");l.setAttribute("id","pairButton-"+d.$jscomp$loop$prop$name$38);l.setAttribute("value","Pair");var g=document.createElement("td"),k=document.createElement("span");k.setAttribute("id","pairStatus-"+d.$jscomp$loop$prop$name$38);k.innerHTML="&#x2718;";k.style.color="red";k.style.fontSize="20px";k.style.fontWeight="bold";k.style.marginRight="10px";g.appendChild(k);l.addEventListener("click",function(m){return function(){navigator.bluetooth.requestDevice({acceptAllDevices:!0,
optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb"]}).then(function(n){Blast.Things.addWebBluetoothDevice(n.id,m.$jscomp$loop$prop$name$38);document.getElementById("pairStatus-"+m.$jscomp$loop$prop$name$38).innerHTML="&#x2714;";document.getElementById("pairStatus-"+m.$jscomp$loop$prop$name$38).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){Blast.throwError("Error connecting to WebBluetooth device:\n"+
n)})}}(d));f.appendChild(l);e.appendChild(h);e.appendChild(f);e.appendChild(g);c.appendChild(e)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d={};b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;d={$jscomp$loop$prop$name$40:d.$jscomp$loop$prop$name$40},e=b.next())if(e=e.value,"things_webBluetooth"==e.getAttribute("type")){d.$jscomp$loop$prop$name$40=e.firstElementChild.textContent;e=document.createElement("li");e.setAttribute("id","rc-item-"+d.$jscomp$loop$prop$name$40);
e.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+d.$jscomp$loop$prop$name$40);h.setAttribute("class","mdc-list-item__graphic material-icons");h.setAttribute("aria-hidden","true");h.innerHTML="bluetooth";e.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var f=document.createElement("span");f.setAttribute("class","mdc-list-item__primary-text");f.innerHTML=d.$jscomp$loop$prop$name$40;h.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__secondary-text");f.setAttribute("id","rc-status-"+d.$jscomp$loop$prop$name$40);f.innerHTML="unpaired";h.appendChild(f);e.appendChild(h);e.addEventListener("click",function(l){return function(){navigator.bluetooth.requestDevice({acceptAllDevices:!0,optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb"]}).then(function(g){Blast.Things.addWebBluetoothDevice(g.id,l.$jscomp$loop$prop$name$40);document.getElementById("rc-status-"+
l.$jscomp$loop$prop$name$40).innerHTML="connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$40).innerHTML="bluetooth_connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$40).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(g){Blast.throwError("Error connecting to WebBluetooth device:\n"+
g)})}}(d));c.appendChild(e)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
Blast.Storage.allConnectedMobile_=function(){var a=document.getElementById("rc-list").querySelectorAll("[id=rc-status-]");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("unpaired"==document.getElementById("rc-status-"+b.value.textContent).innerHTML)return!1;return!0};
...
Blast.Things.addWebBluetoothDevice=function(a,b){var c=function(d,e){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(h){if(h){var f=Blast.Things.webBluetoothDevices.has(h);f?(f="Name %1 already exists".replace("%1",f.name),Blockly.alert(f,function(){c(h)})):Blast.Things.webBluetoothDevices.set(h,e)}else Blockly.alert("Name cannot be empty",function(){c(h,e)})})};c(b,a)};Blast.Things.createWebHidButtonHandler=function(){wHidModal.style.display="block"};
