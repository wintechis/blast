...
$jscomp.polyfillIsolated=function(a,b,c,d){var e=a.split(".");a=1===e.length;d=e[0];d=!a&&d in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var k=0;k<e.length-1;k++){var f=e[k];if(!(f in d))return;d=d[f]}e=e[e.length-1];c=$jscomp.IS_SYMBOL_NATIVE&&"es6"===c?d[e]:null;b=b(c);null!=b&&(a?$jscomp.defineProperty($jscomp.polyfills,e,{configurable:!0,writable:!0,value:b}):b!==c&&(void 0===$jscomp.propertyToPolyfillSymbol[e]&&($jscomp.propertyToPolyfillSymbol[e]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(e):
...
$jscomp.asyncExecutePromiseGenerator=function(a){function b(d){return a.next(d)}function c(d){return a.throw(d)}return new Promise(function(d,e){function k(f){f.done?d(f.value):Promise.resolve(f.value).then(b,c).then(k,e)}k(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.asyncExecutePromiseGeneratorProgram=function(a){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(a)))};
...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(f){return f instanceof e?f:new e(function(m,g){m(f)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(f){if(null==this.batch_){this.batch_=[];var m=this;this.asyncExecuteFunction(function(){m.executeBatch_()})}this.batch_.push(f)};
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(f){d(f,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var f=this.batch_;this.batch_=[];for(var m=0;m<f.length;++m){var g=f[m];f[m]=null;try{g()}catch(h){this.asyncThrow_(h)}}}this.batch_=null};b.prototype.asyncThrow_=function(f){this.asyncExecuteFunction(function(){throw f;})};var e=function(f){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var m=this.createResolveAndReject_();
...
break;case 2:m(h.result_);break;default:throw Error("Unexpected state: "+h.state_);}}var h=this;null==this.onSettledCallbacks_?k.asyncExecute(g):this.onSettledCallbacks_.push(g);this.isRejectionHandled_=!0};e.resolve=c;e.reject=function(f){return new e(function(m,g){g(f)})};e.race=function(f){return new e(function(m,g){for(var h=$jscomp.makeIterator(f),l=h.next();!l.done;l=h.next())c(l.value).callWhenSettled_(m,g)})};e.all=function(f){var m=$jscomp.makeIterator(f),g=m.next();return g.done?c([]):new e(function(h,
l){function n(r){return function(t){p[r]=t;q--;0==q&&h(p)}}var p=[],q=0;do p.push(void 0),q++,c(g.value).callWhenSettled_(n(p.length-1),l),g=m.next();while(!g.done)})};return e},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var h=Object.seal({}),l=Object.seal({}),n=new a([[h,2],[l,3]]);if(2!=n.get(h)||3!=n.get(l))return!1;n.delete(h);n.set(l,4);return!n.has(h)&&4==n.get(l)}catch(p){return!1}}function c(){}function d(h){var l=typeof h;return"object"===l&&null!==h||"function"===l}function e(h){if(!$jscomp.owns(h,f)){var l=new c;$jscomp.defineProperty(h,f,{value:l})}}function k(h){if(!$jscomp.ISOLATE_POLYFILLS){var l=Object[h];l&&(Object[h]=
function(n){if(n instanceof c)return n;Object.isExtensible(n)&&e(n);return l(n)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var f="$jscomp_hidden_"+Math.random();k("freeze");k("preventExtensions");k("seal");var m=0,g=function(h){this.id_=(m+=Math.random()+1).toString();if(h){h=$jscomp.makeIterator(h);for(var l;!(l=h.next()).done;)l=l.value,this.set(l[0],l[1])}};g.prototype.set=function(h,l){if(!d(h))throw Error("Invalid WeakMap key");
e(h);if(!$jscomp.owns(h,f))throw Error("WeakMap key fail: "+h);h[f][this.id_]=l;return this};g.prototype.get=function(h){return d(h)&&$jscomp.owns(h,f)?h[f][this.id_]:void 0};g.prototype.has=function(h){return d(h)&&$jscomp.owns(h,f)&&$jscomp.owns(h[f],this.id_)};g.prototype.delete=function(h){return d(h)&&$jscomp.owns(h,f)&&$jscomp.owns(h[f],this.id_)?delete h[f][this.id_]:!1};return g},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var g=Object.seal({x:4}),h=new a($jscomp.makeIterator([[g,"s"]]));if("s"!=h.get(g)||1!=h.size||h.get({x:4})||h.set({x:4},"t")!=h||2!=h.size)return!1;var l=h.entries(),n=l.next();if(n.done||n.value[0]!=g||"s"!=n.value[1])return!1;n=l.next();return n.done||4!=n.value[0].x||"t"!=n.value[1]||!l.next().done?!1:!0}catch(p){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,d=function(g){this.data_={};this.head_=f();this.size=0;if(g){g=$jscomp.makeIterator(g);for(var h;!(h=g.next()).done;)h=h.value,this.set(h[0],h[1])}};d.prototype.set=function(g,h){g=0===g?0:g;var l=e(this,g);l.list||(l.list=this.data_[l.id]=[]);l.entry?l.entry.value=h:(l.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:g,value:h},l.list.push(l.entry),
...
$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var k=a[e];if(b.call(c,k,e,a))return{i:e,v:k}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
...
$jscomp.polyfill("Array.from",function(a){return a?a:function(b,c,d){c=null!=c?c:function(m){return m};var e=[],k="undefined"!=typeof Symbol&&Symbol.iterator&&b[Symbol.iterator];if("function"==typeof k){b=k.call(b);for(var f=0;!(k=b.next()).done;)e.push(c.call(d,k.value,f++))}else for(k=b.length,f=0;f<k;f++)e.push(c.call(d,b[f],f));return e}},"es6","es3");var Blast={States:{}};Blast.States.Interpreter=null;Blast.States.runner_=null;Blast.States.latestCode="";Blast.States.eventCode=new Map;
...
Blast.States.generateCode=function(){for(var a="while (true) {\n \n}",b=Blast.workspace.getBlocksByType("event",!1).map(function(k){return k.id}),c=$jscomp.makeIterator(Blast.States.eventCode),d=c.next();!d.done;d=c.next()){var e=$jscomp.makeIterator(d.value);d=e.next().value;e=e.next().value;b.includes(d)&&(a=a.slice(0,-2)+e+"\n"+a.slice(-1))}Blast.States.latestCode=Blockly.JavaScript.finish(a)};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;e={$jscomp$loop$prop$type$43:e.$jscomp$loop$prop$type$43,$jscomp$loop$prop$name$44:e.$jscomp$loop$prop$name$44},k=b.next()){k=k.value;e.$jscomp$loop$prop$type$43=k.getAttribute("type");if("things_webBluetooth"==e.$jscomp$loop$prop$type$43||"things_webHID"==e.$jscomp$loop$prop$type$43){e.$jscomp$loop$prop$name$44=
k.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$44))continue;k=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$44));var m=document.createElement("td"),g=document.createElement("input");g.setAttribute("type","button");g.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$44);g.setAttribute("value","Pair");var h=document.createElement("td"),l=document.createElement("span");l.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$44);l.innerHTML="&#x2718;";l.style.color="red";l.style.fontSize="20px";l.style.fontWeight="bold";l.style.marginRight="10px";h.appendChild(l);g.addEventListener("click",function(n){return function(){var p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return"things_webBluetooth"!=n.$jscomp$loop$prop$type$43?("things_webHID"==n.$jscomp$loop$prop$type$43&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(r){0===r.length&&
Blast.throwError("Connection failed or cancelled by User.");var t=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(t,r[0]);Blast.Things.addWebHidDevice(t,"");document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(r){wHidLog("Argh! "+r)})),q.jumpTo(0)):q.yield(Blast.Bluetooth.requestDevice(),3);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
q.jumpToEnd()})}}(e));m.appendChild(g);k.appendChild(f);k.appendChild(m);k.appendChild(h);c.appendChild(k);d.push(e.$jscomp$loop$prop$name$44)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;e={$jscomp$loop$prop$type$46:e.$jscomp$loop$prop$type$46,$jscomp$loop$prop$name$47:e.$jscomp$loop$prop$name$47},k=b.next())if(k=k.value,e.$jscomp$loop$prop$type$46=k.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$46||"things_webHID"==e.$jscomp$loop$prop$type$46)if(e.$jscomp$loop$prop$name$47=
k.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$47)){k=document.createElement("li");k.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$47);k.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$47);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$46?"bluetooth_disabled":"usb_off";k.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=e.$jscomp$loop$prop$name$47;f.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$47);m.innerHTML="disconnected";f.appendChild(m);k.appendChild(f);k.addEventListener("click",function(g){return function(){var h;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return"things_webBluetooth"!=g.$jscomp$loop$prop$type$46?("things_webHID"==g.$jscomp$loop$prop$type$46&&(h=[],navigator.hid.requestDevice({filters:h}).then(function(n){0===n.length&&Blast.throwError("Connection failed or cancelled by User.");var p=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(p,n[0]);Blast.Things.addWebHidDevice(p,"");document.getElementById("rc-status-"+
g.$jscomp$loop$prop$name$47).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$47).innerHTML="usb";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$47).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){wHidLog("Argh! "+n)})),l.jumpTo(0)):l.yield(Blast.Bluetooth.requestDevice(),
3);Blast.Things.addWebBluetoothDevice(device.id,g.$jscomp$loop$prop$name$47);document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$47).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$47).innerHTML="bluetooth";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$47).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
l.jumpToEnd()})}}(e));c.appendChild(k);d.push(e.$jscomp$loop$prop$name$47)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Things.addWebBluetoothDevice=function(a,b){var c=function(d,e){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(k){if(k)if(Blast.Things.webBluetoothDevices.has(k)){var f="Name %1 already exists".replace("%1",k);Blockly.alert(f,function(){c(k,e)})}else Blast.Things.webBluetoothDevices.set(k,e);else Blockly.alert("Name cannot be empty",function(){c(k,e)})})};c(b,a)};
...
Blast.Things.addWebHidDevice=function(a,b){var c=function(d,e){Blockly.Variables.promptName("Connection established! Now give your device a name.",d,function(k){if(k)if(Blast.Things.webHidNames.has(k)){var f="Name %1 already exists".replace("%1",k);Blockly.alert(f,function(){c(k,e)})}else Blast.Things.webHidNames.set(k,e);else Blockly.alert("Name cannot be empty",function(){c(k,e)})})};c(b,a)};Blast.Bluetooth={};Blast.Bluetooth.optionalServices=[];Blast.Bluetooth.scanBlocks=[];Blast.Bluetooth.LEScanResults={};Blast.Bluetooth.isLEScanRunning=!1;Blast.Bluetooth.eventListeners=[];
Blast.Bluetooth.requestDevice=function(a){return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){navigator.bluetooth&&(a||(a={acceptAllDevices:!0},a.optionalServices=Blast.Bluetooth.optionalServices),navigator.bluetooth.requestDevice(a).then(function(c){Blast.Things.addWebBluetoothDevice(c.id,c.name);Blast.workspace.refreshToolboxSelection();return c}).catch(function(c){Blast.throwError(c)}));b.jumpToEnd()})};
Blast.Bluetooth.getDeviceById=function(a){var b,c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(navigator.bluetooth.getDevices(),2);b=k.yieldResult;c=$jscomp.makeIterator(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,e.id==a)return k.return(e);Blast.throwError("Bluetooth device "+a+" wasn't found in paired devices.");k.jumpToEnd()})};
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function e(g){g=g.replace(/^0x/,"");0!=g.length%2&&(g="0"+g);var h=g.match(/[G-Z\s]/i);h&&console.log("WARNING: found non-hex characters",h);g=g.match(/[\dA-F]{2}/gi).map(function(l){return parseInt(l,16)});return(new Uint8Array(g)).buffer}var k,f,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a,b),2);case 2:return k=g.yieldResult,g.yield(k.getPrimaryService(b),
3);case 3:return f=g.yieldResult,g.yield(f.getCharacteristic(c),4);case 4:return m=g.yieldResult,d=e(d),g.yield(m.writeValueWithoutResponse(d),0)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,e,k,f,m,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.setCatchFinallyBlocks(2),h.yield(Blast.Bluetooth.connect(a,b),4);case 4:return d=h.yieldResult,h.yield(d.getPrimaryService(b),5);case 5:return e=h.yieldResult,h.yield(e.getCharacteristic(c),6);case 6:return k=h.yieldResult,h.yield(k.readValue(),7);case 7:return f=h.yieldResult,m=(new TextDecoder).decode(f),h.return(m);case 2:g=h.enterCatchBlock(),
Blast.throwError("Error reading from Bluetooth device "+a),console.error(g),h.jumpToEnd()}})};
...
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(e,k){return Blast.States.eventChecker(e,k)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return Blast.States.startEventChecker()}));c=function(e){return prompt(e)};a.setProperty(b,"prompt",a.createNativeFunction(c))};Blockly.Blocks.repeat=Blockly.Blocks.controls_repeat_ext;Blockly.Blocks.while_until=Blockly.Blocks.controls_whileUntil;Blockly.Blocks["for"]=Blockly.Blocks.controls_for;Blockly.Blocks.break_continue=Blockly.Blocks.controls_flow_statements;Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES.push("repeat","while_until","for");
...
a.nextConnection.targetBlock()}},rebuildShape_:function(){var a=[null],b=[null],c=null;this.getInput("ELSE")&&(c=this.getInput("ELSE").connection.targetConnection);for(var d=1;this.getInput("IF"+d);){var e=this.getInput("IF"+d),k=this.getInput("DO"+d);a.push(e.connection.targetConnection);b.push(k.connection.targetConnection);d++}this.updateShape_();this.reconnectChildBlocks_(a,b,c)},updateShape_:function(){this.getInput("ELSE")&&this.removeInput("ELSE");for(var a=1;this.getInput("IF"+a);)this.removeInput("IF"+
...
var sendHttpRequest=function(a,b,c,d,e,k){var f,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");f=JSON.parse(c);m={method:b,headers:new Headers(f)};d&&(m.body=d);fetch(a,m).then(Blast.handleFetchErrors).then(function(h){"status"==e&&k(h.status);k(h.text())}).then(function(h){urdf.clear();urdf.load(h).then(function(){urdf.query("SELECT * WHERE {?subject ?predicate ?object}").then(function(l){k(l)})})}).catch(function(h){Blast.throwError(h.message+
"\nSee console for details.")});g.jumpToEnd()})};Blast.asyncApiFunctions.push(["sendHttpRequest",sendHttpRequest]);Blockly.JavaScript.sparql_query=function(a){var b=a.getFieldValue("query");a=Blockly.JavaScript.valueToCode(a,"uri",Blockly.JavaScript.ORDER_NONE);b=b.replace(/"/g,'\\"').replace(/[\n\r]/g," ");return["urdfQueryWrapper("+a+", '"+b+"')",Blockly.JavaScript.ORDER_NONE]};
...
var urdfQueryWrapper=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){urdf.clear();d="\n FROM <"+a+">\n";b=b.slice(0,b.indexOf("WHERE"))+d+b.slice(b.indexOf("WHERE"));urdf.query(b).then(function(k){c(k)});e.jumpToEnd()})};Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var displayText=function(a){Blast.Ui.addMessage(a)};
...
var playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,e){var k=new Audio(a);k.preload="auto";k.autoplay=!0;k.onerror=function(f){Blast.throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(f);e(f)};k.onended=d}),2);b();c.jumpToEnd()})};Blast.asyncApiFunctions.push(["playAudio",playAudio]);
...
this.setTooltip("Swichtes checked lights on and unchecked ones off.");this.setHelpUrl("");this.firstTime=!0},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n        Upgrade to Chrome version 85 or later and enable Experimental Web Platform features."),this.dispose()))}};Blast.Toolbox.addBlock("switch_lights_ryg","Properties");Blockly.JavaScript.switch_lights_rgb=function(a){var b="TRUE"==a.getFieldValue("cb_red"),c="TRUE"==a.getFieldValue("cb_green"),d="TRUE"==a.getFieldValue("cb_blue");return"switchLights("+Blockly.JavaScript.valueToCode(a,"mac",Blockly.JavaScript.ORDER_NONE)+", '7e000503"+((b?"ff":"00")+(c?"ff":"00")+(d?"ff":"00")+"00ef');\n")};
Blockly.JavaScript.switch_lights_ryg=function(a){var b="TRUE"==a.getFieldValue("cb_red"),c="TRUE"==a.getFieldValue("cb_yellow"),d="TRUE"==a.getFieldValue("cb_green");return"switchLights("+Blockly.JavaScript.valueToCode(a,"mac",Blockly.JavaScript.ORDER_NONE)+", '7e000503"+((b?"ff":"00")+(d?"ff":"00")+(c?"ff":"00")+"00ef');\n")};var serviceUUID="0000fff0-0000-1000-8000-00805f9b34fb";Blast.Bluetooth.optionalServices.push(serviceUUID);
var switchLights=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",b),2);c();d.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.huskylens_choosealgo={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("write").appendField(new Blockly.FieldDropdown([["Face Recognition","face_recognition"],["Object Tracking","object_tracking"],["Object Recognition","object_recognition"],["Line Tracking","line_tracking"],["Color Recognition","color_recognition"],["Tag Recognition","tag_recognition"],["Object Classification","object_classification"]]),"Algorithms").appendField("Algorithm to Huskyduino");
this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Choose the algorithm for Huskylens");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),this.dispose()))}};Blast.Toolbox.addBlock("huskylens_choosealgo","Properties");
Blockly.Blocks.huskylens_learnid={init:function(){this.appendValueInput("Thing").setCheck(null).appendField("learning a face with ID").appendField(new Blockly.FieldNumber(0,1,255,1),"ID");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("ID shoud be a value between 1 and 255");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),
this.dispose()))}};Blast.Toolbox.addBlock("huskylens_learnid","Properties");
Blockly.Blocks.huskylens_forgetall={init:function(){this.appendValueInput("Thing").setCheck(null).appendField("write a forget flag to Huskyduino").appendField(new Blockly.FieldCheckbox("TRUE"),"ForgetFlag");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("forget all learned knowledge under this algorithm");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),
this.dispose()))}};Blast.Toolbox.addBlock("huskylens_forgetall","Properties");
Blockly.Blocks.huskylens_readid={init:function(){this.appendValueInput("Thing").setCheck(null).appendField("read face IDs out from Huskyduino");this.setOutput(!0,"String");this.setColour(255);this.setTooltip("read maximal 10 IDs out");this.setHelpUrl("")},onchange:function(){!this.isInFlyout&&this.firstTime&&this.rendered&&(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n                Upgrade to Chrome version 85 or later."),this.dispose()))}};
Blast.Toolbox.addBlock("huskylens_readid","Properties");Blockly.JavaScript.huskylens_choosealgo=function(a){var b=a.getFieldValue("Algorithms");return"chooseAlgo( "+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+{face_recognition:"0x01",object_tracking:"0x02",object_recognition:"0x03",line_tracking:"0x04",color_recognition:"0x05",tag_recognition:"0x06",object_classification:"0x07"}[b]+"');\n"};
Blockly.JavaScript.huskylens_learnid=function(a){var b="0x"+a.getFieldValue("ID").toString(16);console.log("value of id is "+b);return"learnID( "+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '"+b+"');\n"};Blockly.JavaScript.huskylens_forgetall=function(a){var b="TRUE"==a.getFieldValue("ForgetFlag");return"forgetAll("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+", '0x"+(b?"01":"00")+"');\n"};
Blockly.JavaScript.huskylens_readid=function(a){return["readID("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC)+")",Blockly.JavaScript.ORDER_NONE]};var HuskyServiceUUID="5be35d20-f9b0-11eb-9a03-0242ac130003";Blast.Bluetooth.optionalServices.push(HuskyServiceUUID);
...
var readJoyConProperty=function(a,b,c,d,e,k){var f,m,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:f=Blast.Things.webHidDevices.get(a);if(f.opened){h.jumpTo(2);break}h.setCatchFinallyBlocks(3);return h.yield(f.open(),5);case 5:h.leaveTryBlock(2);break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:return 8198===f.productId?m=new JoyConLeft(f):8199===f.productId&&(m=new JoyConRight(f)),
h.yield(m.open(),6);case 6:return h.yield(m.enableStandardFullMode(),7);case 7:return h.yield(m.enableIMUMode(),8);case 8:g=function(l){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){n=l.detail;if(!n||!n.actualOrientation)return p.return();console.log(n);m.removeEventListener("hidinput",g);""!==d?"accelerometers"===b?k(n[b][c][d].acc):"gyroscopes"===b?k(n[b][c][d][e]):k(n[b][c][d]):k(n[b][c]);p.jumpToEnd()})};if(m.eventListenerAttached){h.jumpTo(0);break}return h.yield(m.open(),
10);case 10:return h.yield(m.enableStandardFullMode(),11);case 11:return h.yield(m.enableIMUMode(),12);case 12:return h.yield(m.enableVibration(),13);case 13:m.addEventListener("hidinput",g),m.eventListenerAttached=!0,h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("Robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};Blast.Toolbox.addBlock("mirobot_pickup","actions");Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
var mirobotPickUp=function(a,b){var c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){c="https://bot.rapidthings.eu/thing/action/grab_"+a.toLowerCase();d={"Content-Type":"application/json",Accept:"application/json"};e={method:"POST",headers:new Headers(d)};fetch(c,e).then(Blast.handleFetchErrors).then(function(f){b(f.status)}).catch(function(f){Blast.throwError(f.message+"\nSee console for details.")});k.jumpToEnd()})};Blast.asyncApiFunctions.push(["mirobot_pickup",mirobotPickUp]);Blockly.Blocks.read_ruuvi_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["temperature","temperature"],["humidity","humidity"],["pressure","pressure"],["acceleration X","accelerationX"],["acceleration Y","accelerationY"],["acceleration Z","accelerationZ"],["battery voltage","batteryVoltage"],["txPower","txPower"],["movement counter","movementCounter"],["measurement sequence number","measurementSequenceNumber"]]),
...
var getRuuviProperty=function(a,b,c){var d,e,k,f,m,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return d=function(l){var n={},p=l[0]&255,q=l[1]<<8|l[2]&255;32767<q&&(q-=65535);var r=((l[3]&255)<<8|l[4]&255)/400,t=((l[5]&255)<<8|l[6]&255)+5E4,v=(l[7]<<8|l[8]&255)/1E3,w=(l[9]<<8|l[10]&255)/1E3,x=(l[11]<<8|l[12]&255)/1E3,u=(l[13]&255)<<8|l[14]&255,y=l[15]&255;l=(l[16]&255)<<8|l[17]&255;n.destination_endpoint=p;n.temperature=q/200;n.humidity=r;n.pressure=t;n.accelerationX=
v;n.accelerationY=w;n.accelerationZ=x;n.batteryVoltage=(u>>>5)/1E3+1.6;n.txPower=2*(u&31)-40;n.movementCounter=y;n.measurementSequenceNumber=l;return n},e=function(l){if(30>l){var n=Blast.Bluetooth.LEScanResults[b];if(n){n=$jscomp.makeIterator(n);for(var p=n.next();!p.done;p=n.next())if((p=p.value.manufacturerData.get(1177))&&5==p.getUint8(0))return p}return new Promise(function(q){setTimeout(function(){q(e(l+1))},1E3)})}},Blast.Bluetooth.startLEScan(b),h.yield(e(0),2);(k=h.yieldResult)||Blast.throwError("Timed out. No BLE advertising data found for "+
b);f=[];for(m=0;m<k.byteLength;m++)f.push("0x"+("00"+k.getUint8(m).toString(16)).slice(-2));g=d(f);c(g[a]);h.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.streamdeck_buttons={init:function(){this.appendValueInput("id").setCheck("Thing").appendField("Streamdeck mini");this.appendDummyInput().appendField("on button press:");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE"),"button1").appendField(new Blockly.FieldCheckbox("FALSE"),"button2").appendField(new Blockly.FieldCheckbox("FALSE"),"button3");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE"),
...
b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};Blast.Toolbox.addBlock("streamdeck_buttons","States and Events");Blockly.JavaScript.streamdeck_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,e="TRUE"==a.getFieldValue("button4")?1:0,k="TRUE"==a.getFieldValue("button5")?1:0,f="TRUE"==a.getFieldValue("button6")?1:0,m=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE);b=[b,c,d,e,k,f];a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));return"handleStreamdeck("+m+", ["+
b+"], "+a+");\n"};
var handleStreamdeck=function(a,b,c){var d,e,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:d="inputreport";e=Blast.Things.webHidDevices.get(a);if(e.opened){f.jumpTo(2);break}f.setCatchFinallyBlocks(3);return f.yield(e.open(),5);case 5:f.leaveTryBlock(2);break;case 3:f.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:k=function(m){if(1===m.reportId&&(m=new Int8Array(m.data.buffer),m=
Array.from(m).slice(0,6),b=b.toString().split(",").map(Number),m.every(function(l,n){return l===b[n]}))){Blast.Interrupted=!0;var g=new Interpreter("");g.stateStack[0].scope=Blast.Interpreter.globalScope;g.appendCode(c);var h=function(){try{g.step()?setTimeout(h,5):Blast.Interrupted=!1}catch(l){Blockly.alert("Error executing program:\n%e".replace("%e",l)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(l)}};h()}},Blast.deviceEventHandlers.push({device:e,type:d,fn:k}),
e.addEventListener(d,k),f.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
...
var webSpeech=function(a,b){var c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){c=Blast.workspace.getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";e="";d.onresult=function(f){for(var m=f.resultIndex;m<f.results.length;++m)f.results[m].isFinal&&(e+=f.results[m][0].transcript)};d.onend=function(){b(e)};d.start();k.jumpToEnd()})};Blast.asyncApiFunctions.push(["webSpeech",webSpeech]);
