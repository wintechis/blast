...
k),m.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.JavaScript.joycon_button_events=function(a){var b=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE),c=Blockly.JavaScript.quote_(a.getFieldValue("button"));a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));return"handleJoyConButtons("+b+", "+c+", "+a+");\n"};
