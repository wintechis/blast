...
Blast.throwError("Connection failed or cancelled by User.");var t=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(t,r[0]);Blast.Things.addWebHidDevice(t,n.$jscomp$loop$prop$name$47);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$47).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$47).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
