...
"measurement").appendField("property of RuuviTag");this.setOutput(!0,["String","Number"]);this.setColour(255);this.setTooltip("Reads the temperature property of a Ruuvi Tag.");this.setHelpUrl("");this.firstTime=!0},onchange:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){if(a.isInFlyout||!a.firstTime||!a.rendered)return b.jumpTo(0);a.firstTime=!1;return navigator.bluetooth?b.yield(Blast.Bluetooth.requestLEScan(),0):(Blockly.alert("Webbluetooth is not supported by this browser.\n\n        Upgrade to Chrome version 85 or later."),
a.dispose(),b.jumpTo(0))})}};Blast.Toolbox.addBlock("get_ruuvi_measurement","Properties");Blockly.JavaScript.get_ruuvi_measurement=function(a){var b=a.getFieldValue("measurement");a=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_ATOMIC);return["getRuuviMeasurement('"+b+"', "+a+")",Blockly.JavaScript.ORDER_NONE]};
