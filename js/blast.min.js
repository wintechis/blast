...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$41:e.$jscomp$loop$prop$type$41,$jscomp$loop$prop$name$42:e.$jscomp$loop$prop$name$42,$jscomp$loop$prop$block$43:e.$jscomp$loop$prop$block$43},g=b.next()){e.$jscomp$loop$prop$block$43=g.value;e.$jscomp$loop$prop$type$41=e.$jscomp$loop$prop$block$43.getAttribute("type");
if("things_webBluetooth"==e.$jscomp$loop$prop$type$41||"things_webHID"==e.$jscomp$loop$prop$type$41){e.$jscomp$loop$prop$name$42=e.$jscomp$loop$prop$block$43.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$42))continue;g=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$42));var l=document.createElement("td"),h=document.createElement("input");h.setAttribute("type","button");h.setAttribute("id","pairButton-"+
e.$jscomp$loop$prop$name$42);h.setAttribute("value","Pair");var k=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+e.$jscomp$loop$prop$name$42);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";k.appendChild(m);h.addEventListener("click",function(n){return function(){var p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return"things_webBluetooth"!=
n.$jscomp$loop$prop$type$41?("things_webHID"==n.$jscomp$loop$prop$type$41&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(t){0===t.length&&Blast.throwError("Connection failed or cancelled by User.");var u=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(u,t[0]);Blast.Things.addWebHidDevice(u,n.$jscomp$loop$prop$name$42);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$42).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
n.$jscomp$loop$prop$name$42).style.color="green";n.$jscomp$loop$prop$block$43.firstElementChild.textContent=u;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(t){wHidLog("Argh! "+t)})),r.jumpTo(0)):r.yield(Blast.Bluetooth.requestDevice(),3);q=r.yieldResult;document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$42).innerHTML=
"&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$42).style.color="green";n.$jscomp$loop$prop$block$43.firstElementChild.textContent=q.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));r.jumpToEnd()})}}(e));l.appendChild(h);g.appendChild(f);g.appendChild(l);g.appendChild(k);c.appendChild(g);d.push(e.$jscomp$loop$prop$name$42)}document.getElementById("rc-cancel").addEventListener("click",
function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$45:e.$jscomp$loop$prop$type$45,$jscomp$loop$prop$name$46:e.$jscomp$loop$prop$name$46,$jscomp$loop$prop$block$47:e.$jscomp$loop$prop$block$47},g=b.next())if(e.$jscomp$loop$prop$block$47=g.value,e.$jscomp$loop$prop$type$45=e.$jscomp$loop$prop$block$47.getAttribute("type"),
"things_webBluetooth"==e.$jscomp$loop$prop$type$45||"things_webHID"==e.$jscomp$loop$prop$type$45)if(e.$jscomp$loop$prop$name$46=e.$jscomp$loop$prop$block$47.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$46)){g=document.createElement("li");g.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$46);g.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$46);f.setAttribute("class","mdc-list-item__graphic material-icons");
f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$45?"bluetooth_disabled":"usb_off";g.appendChild(f);f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=e.$jscomp$loop$prop$name$46;f.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$46);
l.innerHTML="disconnected";f.appendChild(l);g.appendChild(f);g.addEventListener("click",function(h){return function(){var k,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return"things_webBluetooth"!=h.$jscomp$loop$prop$type$45?("things_webHID"==h.$jscomp$loop$prop$type$45&&(k=[],navigator.hid.requestDevice({filters:k}).then(function(p){0===p.length&&Blast.throwError("Connection failed or cancelled by User.");var q=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(q,p[0]);Blast.Things.addWebHidDevice(q,h.$jscomp$loop$prop$name$46);document.getElementById("rc-status-"+h.$jscomp$loop$prop$name$46).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$46).innerHTML="usb";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$46).style.color="#0d30b1";h.$jscomp$loop$prop$block$47.firstElementChild.textContent=q;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(p){wHidLog("Argh! "+p)})),n.jumpTo(0)):n.yield(Blast.Bluetooth.requestDevice(),3);m=n.yieldResult;Blast.Things.addWebBluetoothDevice(m.id,h.$jscomp$loop$prop$name$46);document.getElementById("rc-status-"+h.$jscomp$loop$prop$name$46).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$46).innerHTML="bluetooth";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$46).style.color="#0d30b1";
h.$jscomp$loop$prop$block$47.firstElementChild.textContent=m.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));n.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$46)}window.app.initLists()};
...
var getRSSIWb=function(a,b){var c,d,e,g,f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(navigator.bluetooth.getDevices(),2);c=h.yieldResult;d=null;e=$jscomp.makeIterator(c);for(g=e.next();!g.done;g=e.next())if(f=g.value,f.id===a){d=f;break}null==d&&Blast.throwError("Error pairing with Bluetooth device.");l=new AbortController;d.addEventListener("advertisementreceived",function(k){return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){console.log(k.rssi);
l.abort();b(k.rssi);m.jumpToEnd()})});return h.yield(d.watchAdvertisements({signal:l.signal}),0)})};Blast.asyncApiFunctions.push(["getRSSIWb",getRSSIWb]);Blockly.Blocks.switch_lights_rgb={init:function(){this.appendValueInput("red").setCheck("Number").appendField("write color properties: red ");this.appendValueInput("green").setCheck("Number").appendField("green");this.appendValueInput("blue").setCheck("Number").appendField("blue");this.appendValueInput("thing").setCheck("Thing").appendField("to LED controller");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Switches checked lights on and unchecked ones off.");
