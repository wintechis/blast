...
document.getElementById("reconnectModal")&&(document.getElementById("rcModal").style.display="block")):(Blockly.Xml.domToWorkspace(c,Blast.workspace),Blast.Storage.monitorChanges_(Blast.workspace))});b.jumpToEnd()})};Blast.Storage.generatePairButtons=function(a){window.location.href.includes("mobile")?this.generatePairButtonsMobile_(a):this.generatePairButtonsDesktop_(a)};
