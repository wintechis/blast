...
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(f){d(f,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var f=this.batch_;this.batch_=[];for(var m=0;m<f.length;++m){var g=f[m];f[m]=null;try{g()}catch(k){this.asyncThrow_(k)}}}this.batch_=null};b.prototype.asyncThrow_=function(f){this.asyncExecuteFunction(function(){throw f;})};var e=function(f){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var m=this.createResolveAndReject_();
try{f(m.resolve,m.reject)}catch(g){m.reject(g)}};e.prototype.createResolveAndReject_=function(){function f(k){return function(l){g||(g=!0,k.call(m,l))}}var m=this,g=!1;return{resolve:f(this.resolveTo_),reject:f(this.reject_)}};e.prototype.resolveTo_=function(f){if(f===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(f instanceof e)this.settleSameAsPromise_(f);else{a:switch(typeof f){case "object":var m=null!=f;break a;case "function":m=!0;break a;default:m=!1}m?this.resolveToNonPromiseObj_(f):
...
f.callWhenSettled_(m.resolve,m.reject)};e.prototype.settleSameAsThenable_=function(f,m){var g=this.createResolveAndReject_();try{f.call(m,g.resolve,g.reject)}catch(k){g.reject(k)}};e.prototype.then=function(f,m){function g(p,q){return"function"==typeof p?function(r){try{k(p(r))}catch(t){l(t)}}:q}var k,l,n=new e(function(p,q){k=p;l=q});this.callWhenSettled_(g(f,k),g(m,l));return n};e.prototype.catch=function(f){return this.then(void 0,f)};e.prototype.callWhenSettled_=function(f,m){function g(){switch(k.state_){case 1:f(k.result_);
break;case 2:m(k.result_);break;default:throw Error("Unexpected state: "+k.state_);}}var k=this;null==this.onSettledCallbacks_?h.asyncExecute(g):this.onSettledCallbacks_.push(g);this.isRejectionHandled_=!0};e.resolve=c;e.reject=function(f){return new e(function(m,g){g(f)})};e.race=function(f){return new e(function(m,g){for(var k=$jscomp.makeIterator(f),l=k.next();!l.done;l=k.next())c(l.value).callWhenSettled_(m,g)})};e.all=function(f){var m=$jscomp.makeIterator(f),g=m.next();return g.done?c([]):new e(function(k,
l){function n(r){return function(t){p[r]=t;q--;0==q&&k(p)}}var p=[],q=0;do p.push(void 0),q++,c(g.value).callWhenSettled_(n(p.length-1),l),g=m.next();while(!g.done)})};return e},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),n=new a([[k,2],[l,3]]);if(2!=n.get(k)||3!=n.get(l))return!1;n.delete(k);n.set(l,4);return!n.has(k)&&4==n.get(l)}catch(p){return!1}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!$jscomp.owns(k,f)){var l=new c;$jscomp.defineProperty(k,f,{value:l})}}function h(k){if(!$jscomp.ISOLATE_POLYFILLS){var l=Object[k];l&&(Object[k]=
function(n){if(n instanceof c)return n;Object.isExtensible(n)&&e(n);return l(n)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var f="$jscomp_hidden_"+Math.random();h("freeze");h("preventExtensions");h("seal");var m=0,g=function(k){this.id_=(m+=Math.random()+1).toString();if(k){k=$jscomp.makeIterator(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}};g.prototype.set=function(k,l){if(!d(k))throw Error("Invalid WeakMap key");
...
e(this,g).entry)&&g.value};d.prototype.entries=function(){return h(this,function(g){return[g.key,g.value]})};d.prototype.keys=function(){return h(this,function(g){return g.key})};d.prototype.values=function(){return h(this,function(g){return g.value})};d.prototype.forEach=function(g,k){for(var l=this.entries(),n;!(n=l.next()).done;)n=n.value,g.call(k,n[1],n[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var e=function(g,k){var l=k&&typeof k;"object"==l||"function"==l?c.has(k)?l=c.get(k):
(l=""+ ++m,c.set(k,l)):l="p_"+k;var n=g.data_[l];if(n&&$jscomp.owns(g.data_,l))for(g=0;g<n.length;g++){var p=n[g];if(k!==k&&p.key!==p.key||k===p.key)return{id:l,list:n,index:g,entry:p}}return{id:l,list:n,index:-1,entry:void 0}},h=function(g,k){var l=g.head_;return $jscomp.iteratorPrototype(function(){if(l){for(;l.head!=g.head_;)l=l.previous;for(;l.next!=l.head;)return l=l.next,{done:!1,value:k(l)};l=null}return{done:!0,value:void 0}})},f=function(){var g={};return g.previous=g.next=g.head=g},m=0;
...
Blast.Storage.removeDeviceId_=function(a){var b=a.querySelectorAll("block");b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=c.getAttribute("type");if("things_webBluetooth"==d||"things_webHID"==d)if(c=c.firstElementChild){var e=c.textContent,h="things_webBluetooth"==d?Blast.Things.getWebBluetoothDevices():Blast.Things.getWebHIDDevices();d=void 0;h=$jscomp.makeIterator(h);for(var f=h.next();!f.done;f=h.next()){f=$jscomp.makeIterator(f.value);var m=f.next().value;if(f.next().value===
...
(Blast.Storage.generatePairButtons(c),document.getElementById("rcModal")&&(document.getElementById("rcModal").style.display="block")):(Blockly.Xml.domToWorkspace(c,Blast.workspace),Blast.Storage.monitorChanges_(Blast.workspace))});b.jumpToEnd()})};Blast.Storage.generatePairButtons=function(a){window.location.href.includes("mobile")?(window.app.openReconnectDialog(),this.generatePairButtonsMobile_(a)):this.generatePairButtonsDesktop_(a)};
...
h.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$39))continue;h=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$39));var m=document.createElement("td"),g=document.createElement("input");g.setAttribute("type","button");g.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$39);g.setAttribute("value","Pair");var k=document.createElement("td"),l=document.createElement("span");l.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$39);l.innerHTML="&#x2718;";l.style.color="red";l.style.fontSize="20px";l.style.fontWeight="bold";l.style.marginRight="10px";k.appendChild(l);g.addEventListener("click",function(n){return function(){"things_webBluetooth"==n.$jscomp$loop$prop$type$38?navigator.bluetooth.requestDevice({acceptAllDevices:!0,optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb"]}).then(function(p){Blast.Things.addWebBluetoothDevice(p.id,n.$jscomp$loop$prop$name$39);document.getElementById("pairStatus-"+
n.$jscomp$loop$prop$name$39).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(p){Blast.throwError("Error connecting to WebBluetooth device:\n"+p)}):"things_webHID"==n.$jscomp$loop$prop$type$38&&navigator.hid.requestDevice({filters:[]}).then(function(p){0===
p.length&&Blast.throwError("Connection failed or cancelled by User.");var q=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(q,p[0]);Blast.Things.addWebHidDevice(q,"");document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$39).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(p){wHidLog("Argh! "+p)})}}(e));m.appendChild(g);h.appendChild(f);h.appendChild(m);h.appendChild(k);c.appendChild(h);d.push(e.$jscomp$loop$prop$name$39)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
...
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=e.$jscomp$loop$prop$name$42;f.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$42);m.innerHTML="disconnected";f.appendChild(m);h.appendChild(f);h.addEventListener("click",function(g){return function(){"things_webBluetooth"==
g.$jscomp$loop$prop$type$41?navigator.bluetooth.requestDevice({acceptAllDevices:!0,optionalServices:["0000fff0-0000-1000-8000-00805f9b34fb"]}).then(function(k){Blast.Things.addWebBluetoothDevice(k.id,g.$jscomp$loop$prop$name$42);document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$42).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).innerHTML="bluetooth";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&
(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(k){Blast.throwError("Error connecting to WebBluetooth device:\n"+k)}):"things_webHID"==g.$jscomp$loop$prop$type$41&&navigator.hid.requestDevice({filters:[]}).then(function(k){0===k.length&&Blast.throwError("Connection failed or cancelled by User.");var l=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(l,k[0]);Blast.Things.addWebHidDevice(l,"");document.getElementById("rc-status-"+g.$jscomp$loop$prop$name$42).innerHTML="connected";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).innerHTML="usb";document.getElementById("rc-icon-"+g.$jscomp$loop$prop$name$42).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(k){wHidLog("Argh! "+
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function e(g){g=g.replace(/^0x/,"");0!=g.length%2&&console.log("WARNING: expecting an even number of characters in the hexString");var k=g.match(/[G-Z\s]/i);k&&console.log("WARNING: found non-hex characters",k);g=g.match(/[\dA-F]{2}/gi).map(function(l){return parseInt(l,16)});return(new Uint8Array(g)).buffer}var h,f,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a,
b),2);case 2:return h=g.yieldResult,g.yield(h.getPrimaryService(b),3);case 3:return f=g.yieldResult,g.yield(f.getCharacteristic(c),4);case 4:return m=g.yieldResult,d=e(d),g.yield(m.writeValueWithoutResponse(d),0)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,e,h,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:return m.setCatchFinallyBlocks(2),m.yield(Blast.Bluetooth.connect(a,b),4);case 4:return d=m.yieldResult,m.yield(d.getPrimaryService(b),5);case 5:return e=m.yieldResult,m.yield(e.getCharacteristic(c),6);case 6:return h=m.yieldResult,m.yield(h.readValue(),7);case 7:return m.return(m.yieldResult);case 2:f=m.enterCatchBlock(),Blast.throwError("Error reading from Bluetooth device "+
a),console.error(f),m.jumpToEnd()}})};Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){if(Blast.Bluetooth.isLEScanRunning)return a.return();Blast.Bluetooth.cacheLEScanResults();Blast.Bluetooth.isLEScanRunning=!0;Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));setTimeout(Blast.Bluetooth.stopLEScan,3E4);a.jumpToEnd()})};
...
var sendHttpRequest=function(a,b,c,d,e,h){var f,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");f=JSON.parse(c);m={method:b,headers:new Headers(f)};d&&(m.body=d);fetch(a,m).then(Blast.handleFetchErrors).then(function(k){"status"==e&&h(k.status);h(k.text())}).then(function(k){urdf.clear();urdf.load(k).then(function(){urdf.query("SELECT * WHERE {?subject ?predicate ?object}").then(function(l){h(l)})})}).catch(function(k){Blast.throwError(k.message+
...
b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=Blast.eventInWorkspace.indexOf(this.id);-1!==a&&Blast.eventInWorkspace.splice(a,1)}};Blast.Toolbox.addBlock("streamdeck_buttons","States and Events");Blockly.JavaScript.streamdeck_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,e="TRUE"==a.getFieldValue("button4")?1:0,h="TRUE"==a.getFieldValue("button5")?1:0,f="TRUE"==a.getFieldValue("button6")?1:0,m=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE);b=[b,c,d,e,h,f];a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,"statements"));return"handleStreamdeck("+m+", ["+
b+"], "+a+");\n"};
var handleStreamdeck=function(a,b,c){var d,e,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:d="inputreport";console.log(c);e=Blast.Things.webHidDevices.get(a);if(e.opened){f.jumpTo(2);break}f.setCatchFinallyBlocks(3);return f.yield(e.open(),5);case 5:f.leaveTryBlock(2);break;case 3:f.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:h=function(m){if(1===m.reportId&&(m=new Int8Array(m.data.buffer),
m=Array.from(m).slice(0,6),b=b.toString().split(",").map(Number),m.every(function(l,n){return l===b[n]}))){Blast.Interrupted=!0;var g=new Interpreter("");g.stateStack[0].scope=Blast.Interpreter.globalScope;g.appendCode(c);var k=function(){try{g.step()?setTimeout(k,5):Blast.Interrupted=!1}catch(l){Blockly.alert("Error executing program:\n%e".replace("%e",l)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(l)}};k()}},Blast.deviceEventHandlers.push({device:e,type:d,fn:h}),
...
var webSpeech=function(a,b){var c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){c=Blast.workspace.getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";e="";d.onresult=function(f){for(var m=f.resultIndex;m<f.results.length;++m)f.results[m].isFinal&&(e+=f.results[m][0].transcript)};d.onend=function(){b(e)};d.start();h.jumpToEnd()})};Blast.asyncApiFunctions.push(["webSpeech",webSpeech]);
