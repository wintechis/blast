...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$46:e.$jscomp$loop$prop$type$46,$jscomp$loop$prop$name$47:e.$jscomp$loop$prop$name$47},g=b.next()){g=g.value;e.$jscomp$loop$prop$type$46=g.getAttribute("type");if("things_webBluetooth"==e.$jscomp$loop$prop$type$46||"things_webHID"==e.$jscomp$loop$prop$type$46){e.$jscomp$loop$prop$name$47=
g.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$47))continue;g=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$47));var k=document.createElement("td"),h=document.createElement("input");h.setAttribute("type","button");h.setAttribute("id","pairButton-"+e.$jscomp$loop$prop$name$47);h.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id",
"pairStatus-"+e.$jscomp$loop$prop$name$47);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);h.addEventListener("click",function(n){return function(){var p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return"things_webBluetooth"!=n.$jscomp$loop$prop$type$46?("things_webHID"==n.$jscomp$loop$prop$type$46&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(r){0===r.length&&
Blast.throwError("Connection failed or cancelled by User.");var t=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(t,r[0]);Blast.Things.addWebHidDevice(t,"");document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$47).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$47).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(r){wHidLog("Argh! "+r)})),q.jumpTo(0)):q.yield(Blast.Bluetooth.requestDevice(),3);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$47).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$47).style.color="green";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
q.jumpToEnd()})}}(e));k.appendChild(h);g.appendChild(f);g.appendChild(k);g.appendChild(l);c.appendChild(g);d.push(e.$jscomp$loop$prop$name$47)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$49:e.$jscomp$loop$prop$type$49,$jscomp$loop$prop$name$50:e.$jscomp$loop$prop$name$50},g=b.next())if(g=g.value,e.$jscomp$loop$prop$type$49=g.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$49||"things_webHID"==e.$jscomp$loop$prop$type$49)if(e.$jscomp$loop$prop$name$50=
g.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$50)){g=document.createElement("li");g.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$50);g.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$50);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$49?"bluetooth_disabled":"usb_off";g.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var k=document.createElement("span");k.setAttribute("class","mdc-list-item__primary-text");k.innerHTML=e.$jscomp$loop$prop$name$50;f.appendChild(k);k=document.createElement("span");k.setAttribute("class","mdc-list-item__secondary-text");k.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$50);k.innerHTML="disconnected";f.appendChild(k);g.appendChild(f);g.addEventListener("click",function(h){return function(){var l;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return"things_webBluetooth"!=h.$jscomp$loop$prop$type$49?("things_webHID"==h.$jscomp$loop$prop$type$49&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(n){0===n.length&&Blast.throwError("Connection failed or cancelled by User.");var p=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(p,n[0]);Blast.Things.addWebHidDevice(p,"");document.getElementById("rc-status-"+
h.$jscomp$loop$prop$name$50).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$50).innerHTML="usb";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$50).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){wHidLog("Argh! "+n)})),m.jumpTo(0)):m.yield(Blast.Bluetooth.requestDevice(),
3);Blast.Things.addWebBluetoothDevice(device.id,h.$jscomp$loop$prop$name$50);document.getElementById("rc-status-"+h.$jscomp$loop$prop$name$50).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$50).innerHTML="bluetooth";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$50).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
m.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$50)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("&#x2718;"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
l.jumpToEnd()})});k.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRSSIWb",getRSSIWb]);Blockly.Blocks.blinkstick_set_colors={init:function(){this.appendValueInput("red").setCheck("Number").appendField("write color properties: red ");this.appendValueInput("green").setCheck("Number").appendField("green");this.appendValueInput("blue").setCheck("Number").appendField("blue");this.appendValueInput("thing").setCheck("Thing").appendField("to BlinkStick");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Set the color properties of a tulogic BlinkStick.");
this.setHelpUrl("https://www.blinkstick.com/")}};Blast.Toolbox.addBlock("blinkstick_set_colors","Properties");Blockly.JavaScript.blinkstick_set_colors=function(a){var b=Blockly.JavaScript.valueToCode(a,"red",Blockly.JavaScript.ORDER_ATOMIC)||"0",c=Blockly.JavaScript.valueToCode(a,"green",Blockly.JavaScript.ORDER_ATOMIC)||"0",d=Blockly.JavaScript.valueToCode(a,"blue",Blockly.JavaScript.ORDER_ATOMIC)||"0";return"blinkstickSetColors("+(Blockly.JavaScript.valueToCode(a,"thing",Blockly.JavaScript.ORDER_ATOMIC)||"''")+", "+b+", "+c+", "+d+")"};
var blinkstickSetColors=function(a,b,c,d,e){var g,f,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(!a)return Blast.throwError("No BlinkStick block set."),e(),h.return();g=Blast.Things.webHidDevices.get(a);if(g.opened){h.jumpTo(2);break}h.setCatchFinallyBlocks(3);return h.yield(g.open(),5);case 5:h.leaveTryBlock(2);break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==
g.vendorId||16869!==g.productId)return Blast.throwError("The connected device is not a BlinkStick."),e(),h.return();f=Int8Array.from([5,1,b,c,d]);k=function(l){var m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return n.setCatchFinallyBlocks(2),n.yield(g.sendFeatureReport(5,f),4);if(2!=n.nextAddress)return n.leaveTryBlock(0);m=n.enterCatchBlock();return 0<l?n.yield(k(--l),0):(console.error(m),Blast.throwError("Failed to set BlinkStick colors, please check its connection."),
n.jumpTo(0))})};return h.yield(k(5),6);case 6:e(),h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["blinkstickSetColors",blinkstickSetColors]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
...
var readJoyConProperty=function(a,b,c,d,e,g){var f,k,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),g(),l.return();f=Blast.Things.webHidDevices.get(a);if(f.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(f.open(),5);case 5:l.leaveTryBlock(2);break;case 3:l.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==
f.vendorId||8198!==f.productId)return Blast.throwError("The connected device is not a Joy-Con."),g(),l.return();8198===f.productId?k=new JoyConLeft(f):8199===f.productId&&(k=new JoyConRight(f));return l.yield(k.open(),6);case 6:return l.yield(k.enableStandardFullMode(),7);case 7:return l.yield(k.enableIMUMode(),8);case 8:h=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){n=m.detail;if(!n||!n.actualOrientation)return p.return();console.log(n);k.removeEventListener("hidinput",
h);""!==d?"accelerometers"===b?g(n[b][c][d].acc):"gyroscopes"===b?g(n[b][c][d][e]):g(n[b][c][d]):g(n[b][c]);p.jumpToEnd()})};if(k.eventListenerAttached){l.jumpTo(0);break}return l.yield(k.open(),10);case 10:return l.yield(k.enableStandardFullMode(),11);case 11:return l.yield(k.enableIMUMode(),12);case 12:return l.yield(k.enableVibration(),13);case 13:k.addEventListener("hidinput",h),k.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("Robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};Blast.Toolbox.addBlock("mirobot_pickup","actions");Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
...
b+"], "+a+");\n"};
var handleStreamdeck=function(a,b,c){var d,e,g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:if(!a)return Blast.throwError("No streamdeck block set."),callback(),k.return();d="inputreport";e=Blast.Things.webHidDevices.get(a);if(e.opened){k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(e.open(),5);case 5:k.leaveTryBlock(2);break;case 3:g=k.enterCatchBlock(),console.error(g),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(4057!=
e.vendorId)return Blast.throwError("The connected device is not a Stream Deck."),k.return();f=function(h){if(1===h.reportId&&(h=new Int8Array(h.data.buffer),h=Array.from(h).slice(0,6),b=b.toString().split(",").map(Number),h.every(function(n,p){return n===b[p]}))){Blast.Interrupted=!0;var l=new Interpreter("");l.stateStack[0].scope=Blast.Interpreter.globalScope;l.appendCode(c);var m=function(){try{l.step()?setTimeout(m,5):Blast.Interrupted=!1}catch(n){Blockly.alert("Error executing program:\n%e".replace("%e",
n)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(n)}};m()}};Blast.deviceEventHandlers.push({device:e,type:d,fn:f});e.addEventListener(d,f);k.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
...
b);f=[];for(k=0;k<g.byteLength;k++)f.push("0x"+("00"+g.getUint8(k).toString(16)).slice(-2));h=d(f);c(h[a]);l.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);
