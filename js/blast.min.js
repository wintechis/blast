...
var blinkstickSetColors=function(a,b,c,d,e){var g,f,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:g=Blast.Things.webHidDevices.get(a);if(g.opened){h.jumpTo(2);break}h.setCatchFinallyBlocks(3);return h.yield(g.open(),5);case 5:h.leaveTryBlock(2);break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:return f=Int8Array.from([5,1,b,c,d]),k=function(l){var m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==
n.nextAddress)return n.setCatchFinallyBlocks(2),n.yield(g.sendFeatureReport(5,f),4);if(2!=n.nextAddress)return n.leaveTryBlock(0);m=n.enterCatchBlock();return 0<l?n.yield(k(--l),0):(console.error(m),Blast.throwError("Failed to set BlinkStick colors after "+retires+" retries,         please check its connection."),n.jumpTo(0))})},h.yield(k(5),6);case 6:e(),h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["blinkstickSetColors",blinkstickSetColors]);Blockly.Blocks.switch_lights_rgb={init:function(){this.appendDummyInput().appendField("write RGB lights property of");this.appendValueInput("thing").setCheck("Thing");this.appendDummyInput().appendField("red").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_red").appendField("green").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_green").appendField("blue").appendField(new Blockly.FieldCheckbox("TRUE"),"cb_blue");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);
