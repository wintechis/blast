...
b),2);case 2:return h=g.yieldResult,g.yield(h.getPrimaryService(b),3);case 3:return f=g.yieldResult,g.yield(f.getCharacteristic(c),4);case 4:return l=g.yieldResult,d=e(d),g.yield(l.writeValueWithoutResponse(d),0)}})};
