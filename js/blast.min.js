...
Blast.States.eventValues=new Map;Blast.States.eventChecker=function(a,b){var c=Blast.States.eventValues.get(a);Blast.States.eventValues.set(a,b);return void 0!=c?(console.log(!c&&b),!c&&b):!1};Blast.States.addEventCode=function(a,b){Blast.States.eventCode.set(a,b)};Blast.States.removeEventCode=function(a){Blast.States.eventCode.delete(a)};
...
k.addEventListener(e,f),m.jumpToEnd()}})};Blast.asyncApiFunctions.push(["handleStreamdeck",handleStreamdeck]);
