...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$47:e.$jscomp$loop$prop$type$47,$jscomp$loop$prop$name$48:e.$jscomp$loop$prop$name$48,$jscomp$loop$prop$block$49:e.$jscomp$loop$prop$block$49},g=b.next()){e.$jscomp$loop$prop$block$49=g.value;e.$jscomp$loop$prop$type$47=e.$jscomp$loop$prop$block$49.getAttribute("type");
if("things_webBluetooth"==e.$jscomp$loop$prop$type$47||"things_webHID"==e.$jscomp$loop$prop$type$47){e.$jscomp$loop$prop$name$48=e.$jscomp$loop$prop$block$49.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$48))continue;g=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$48));var l=document.createElement("td"),h=document.createElement("input");h.setAttribute("type","button");h.setAttribute("id","pairButton-"+
e.$jscomp$loop$prop$name$48);h.setAttribute("value","Pair");var k=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+e.$jscomp$loop$prop$name$48);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";k.appendChild(m);h.addEventListener("click",function(n){return function(){var p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return"things_webBluetooth"!=
n.$jscomp$loop$prop$type$47?("things_webHID"==n.$jscomp$loop$prop$type$47&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(t){0===t.length&&Blast.throwError("Connection failed or cancelled by User.");var u=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(u,t[0]);Blast.Things.addWebHidDevice(u,n.$jscomp$loop$prop$name$48);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$48).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
n.$jscomp$loop$prop$name$48).style.color="green";n.$jscomp$loop$prop$block$49.firstElementChild.textContent=u;console.log(n.$jscomp$loop$prop$block$49);Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(t){wHidLog("Argh! "+t)})),r.jumpTo(0)):r.yield(Blast.Bluetooth.requestDevice(),3);q=r.yieldResult;document.getElementById("pairStatus-"+
n.$jscomp$loop$prop$name$48).innerHTML="&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$48).style.color="green";n.$jscomp$loop$prop$block$49.firstElementChild.textContent=q.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));r.jumpToEnd()})}}(e));l.appendChild(h);g.appendChild(f);g.appendChild(l);g.appendChild(k);c.appendChild(g);
d.push(e.$jscomp$loop$prop$name$48)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$51:e.$jscomp$loop$prop$type$51,$jscomp$loop$prop$name$52:e.$jscomp$loop$prop$name$52},g=b.next())if(g=g.value,e.$jscomp$loop$prop$type$51=g.getAttribute("type"),"things_webBluetooth"==e.$jscomp$loop$prop$type$51||"things_webHID"==e.$jscomp$loop$prop$type$51)if(e.$jscomp$loop$prop$name$52=
g.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$52)){g=document.createElement("li");g.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$52);g.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$52);f.setAttribute("class","mdc-list-item__graphic material-icons");f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$51?"bluetooth_disabled":"usb_off";g.appendChild(f);
f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=e.$jscomp$loop$prop$name$52;f.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$52);l.innerHTML="disconnected";f.appendChild(l);g.appendChild(f);g.addEventListener("click",function(h){return function(){var k;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return"things_webBluetooth"!=h.$jscomp$loop$prop$type$51?("things_webHID"==h.$jscomp$loop$prop$type$51&&(k=[],navigator.hid.requestDevice({filters:k}).then(function(n){0===n.length&&Blast.throwError("Connection failed or cancelled by User.");var p=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(p,n[0]);Blast.Things.addWebHidDevice(p,"");document.getElementById("rc-status-"+
h.$jscomp$loop$prop$name$52).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$52).innerHTML="usb";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$52).style.color="#0d30b1";Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(n){wHidLog("Argh! "+n)})),m.jumpTo(0)):m.yield(Blast.Bluetooth.requestDevice(),
3);Blast.Things.addWebBluetoothDevice(device.id,h.$jscomp$loop$prop$name$52);document.getElementById("rc-status-"+h.$jscomp$loop$prop$name$52).innerHTML="connected";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$52).innerHTML="bluetooth";document.getElementById("rc-icon-"+h.$jscomp$loop$prop$name$52).style.color="#0d30b1";Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));
m.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$52)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if(b=document.getElementById("pairStatus-"+b.value.firstElementChild.textContent),console.log(b.innerHTML),"\u2718"==b.innerHTML)return!1;return!0};
