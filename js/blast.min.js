...
b+", "+c+", "+d+")\n;"};
var blinkstickSetColors=function(a,b,c,d,e,g){var f,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(0>b||7<b)return Blast.throwError("BlinkStick index must be between 0 and 7."),g(),h.return();if(!a)return Blast.throwError("No BlinkStick block set."),g(),h.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Device is not a Blinkstick."),g(),h.return();if(f.opened){h.jumpTo(2);break}h.setCatchFinallyBlocks(3);return h.yield(f.open(),
5);case 5:h.leaveTryBlock(2);break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==f.vendorId||16869!==f.productId)return Blast.throwError("The connected device is not a BlinkStick."),g(),h.return();l=Int8Array.from([5,b,c,d,e]);k=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.setCatchFinallyBlocks(2),p.yield(f.sendFeatureReport(5,l),4);if(2!=p.nextAddress)return p.leaveTryBlock(0);
n=p.enterCatchBlock();return 0<m?p.yield(k(--m),0):(console.error(n),Blast.throwError("Failed to set BlinkStick colors, please check its connection."),p.jumpTo(0))})};return h.yield(k(5),6);case 6:g(),h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["blinkstickSetColors",blinkstickSetColors]);Blockly.Blocks.switch_lights_rgb={init:function(){this.appendValueInput("red").setCheck("Number").appendField("write color properties: red ");this.appendValueInput("green").setCheck("Number").appendField("green");this.appendValueInput("blue").setCheck("Number").appendField("blue");this.appendValueInput("thing").setCheck("Thing").appendField("to LED controller");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Switches checked lights on and unchecked ones off.");
...
var readJoyConProperty=function(a,b,c,d,e,g){var f,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),g(),h.return();f=Blast.Things.webHidDevices.get(a);if(f.opened){h.jumpTo(2);break}h.setCatchFinallyBlocks(3);return h.yield(f.open(),5);case 5:h.leaveTryBlock(2);break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==
f.vendorId||8198!==f.productId)return Blast.throwError("The connected device is not a Joy-Con."),g(),h.return();8198===f.productId?l=new JoyConLeft(f):8199===f.productId&&(l=new JoyConRight(f));return h.yield(l.open(),6);case 6:return h.yield(l.enableStandardFullMode(),7);case 7:return h.yield(l.enableIMUMode(),8);case 8:k=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){n=m.detail;if(!n||!n.actualOrientation)return p.return();l.removeEventListener("hidinput",k);""!==
d?"accelerometers"===b?g(n[b][c][d].acc):"gyroscopes"===b?g(n[b][c][d][e]):g(n[b][c][d]):g(n[b][c]);p.jumpToEnd()})};if(l.eventListenerAttached){h.jumpTo(0);break}return h.yield(l.open(),10);case 10:return h.yield(l.enableStandardFullMode(),11);case 11:return h.yield(l.enableIMUMode(),12);case 12:return h.yield(l.enableVibration(),13);case 13:l.addEventListener("hidinput",k),l.eventListenerAttached=!0,h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("Robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};Blast.Toolbox.addBlock("mirobot_pickup","actions");Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
