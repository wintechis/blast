...
Blast.Storage.loadXMLFromFile=function(a){return new Promise(function(b,c){var d=a.target.files[0].name;-1<d.indexOf(".")&&(Blast.Storage.filename=d);d=new FileReader;d.onload=function(f){Blast.Storage.loadXML(f.target.result);b()};d.onerror=function(f){c(f.target.error)};d.readAsText(a.target.files[0])})};
...
p.$jscomp$loop$prop$name$51).style.color="green";p.$jscomp$loop$prop$block$52.firstElementChild.textContent=v;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(u){wHidLog("Argh! "+u)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$51).innerHTML=
"&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$51).style.color="green";p.$jscomp$loop$prop$block$52.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));t.jumpToEnd()})}}(f));m.appendChild(k);g.appendChild(h);g.appendChild(m);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$51)}document.getElementById("rc-cancel").addEventListener("click",
function(){return Blast.Storage.reconnectCancelHandler_()})}};
...
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$55);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$55).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).style.color="#0d30b1";k.$jscomp$loop$prop$block$56.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(q){wHidLog("Argh! "+q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;Blast.Things.addWebBluetoothDevice(n.id,k.$jscomp$loop$prop$name$55);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$55).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$55).style.color="#0d30b1";
k.$jscomp$loop$prop$block$56.firstElementChild.textContent=n.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$55)}window.app.initLists()};
Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
