...
Blast.Bluetooth.gatt_read=function(a,b,c,d){var e,k,f,l,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.setCatchFinallyBlocks(2),h.yield(Blast.Bluetooth.connect(a,b),4);case 4:return e=h.yieldResult,h.yield(e.getPrimaryService(b),5);case 5:return k=h.yieldResult,h.yield(k.getCharacteristic(c),6);case 6:return f=h.yieldResult,h.yield(f.readValue(),7);case 7:return l=h.yieldResult,h.return(l);case 2:g=h.enterCatchBlock(),Blast.throwError("Error reading from Bluetooth device "+
a),console.error(g),h.jumpToEnd()}})};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(e){e=e?e.toString():"";return Blast.highlightBlock(e)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(e){Blast.Interrupted=e};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
var getTemperature=function(a,b){var c,d,e,k,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return l.yield(navigator.bluetooth.getDevices(),2);c=l.yieldResult;d=null;e=$jscomp.makeIterator(c);for(k=e.next();!k.done;k=e.next())if(f=k.value,f.id==a){d=f;break}null==d&&Blast.throwError("Error pairing with Bluetooth device.");d.gatt.connect().then(function(g){return g.getPrimaryService("6e400001-b5a3-f393-e0A9-e50e24dcca9e")}).then(function(g){return g.getCharacteristic("")}).then(function(g){return g.readValue()}).then(function(g){b(g)}).catch(function(g){Blast.throwError(g.message)});
