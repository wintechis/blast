...
p;l.accelerationY=q;l.accelerationZ=t;l.batteryVoltage=(r>>>5)/1E3+1.6;l.txPower=2*(r&31)-40;l.movementCounter=u;l.measurementSequenceNumber=f;return l},e=function(f){if(f.device.id==b&&(f=f.manufacturerData.get(1177))&&5==f.getUint8(0)){for(var l=[],g=0;g<f.byteLength;g++)l.push("0x"+("00"+f.getUint8(g).toString(16)).slice(-2));values=d(l);c(values[a])}},k.yield(Blast.Bluetooth.requestLEScan(),2);Blast.Bluetooth.addEventListener("advertisementreceived",e);k.jumpToEnd()})};
