...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function e(l){l=l.replace(/^0x/,"");0!=l.length%2&&(l="0"+l);var k=l.match(/[G-Z\s]/i);k&&console.log("WARNING: found non-hex characters",k);l=l.match(/[\dA-F]{2}/gi).map(function(h){return parseInt(h,16)});return(new Uint8Array(l)).buffer}var g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return g=l.yieldResult,d=e(d),l.setCatchFinallyBlocks(3),
l.yield(g.writeValueWithoutResponse(d),5);case 5:l.leaveTryBlock(4);break;case 3:f=l.enterCatchBlock(),Blast.throwError("Error writing to Bluetooth device "+a),Blast.throwError("Make sure the device is compatible and turned on."),console.error(f);case 4:Blast.Bluetooth.disconnect(a),l.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){switch(e.nextAddress){case 1:return e.yield(Blast.Bluetooth.connect(a,b),2);case 2:return c=e.yieldResult,e.setCatchFinallyBlocks(3),e.yield(c.getPrimaryService(b),5);case 5:d=e.yieldResult;e.leaveTryBlock(4);break;case 3:e.enterCatchBlock(),Blast.throwError("Service "+b+" not found on device "+a+".");case 4:return e.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,e,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:return d=f.yieldResult,f.setCatchFinallyBlocks(3),f.yield(d.getCharacteristic(c),5);case 5:e=f.yieldResult;f.leaveTryBlock(4);break;case 3:g=f.enterCatchBlock(),Blast.throwError("Characteristic "+c+" not found on device "+a+"."),console.error(g);case 4:return f.return(e)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return d=Blast.Bluetooth.getCharacteristic(a,b,c),g.setCatchFinallyBlocks(2),g.yield(d.readValue(),4);if(2!=g.nextAddress)return g.return(g.yieldResult);e=g.enterCatchBlock();Blast.throwError("Error reading from Bluetooth device "+a);Blast.throwError("Make sure the device is compatible and turned on.");console.error(e);g.jumpToEnd()})};
...
Blast.Bluetooth.tearDown=function(){Blast.Bluetooth.isLEScanRunning&&(Blast.Bluetooth.isLEScanRunning=!1);if(Blast.Bluetooth.eventListeners)for(var a=$jscomp.makeIterator(Blast.Bluetooth.eventListeners),b=a.next();!b.done;b=a.next())b=b.value,Blast.Bluetooth.removeEventListener(b[0],b[1]);if(Blast.Bluetooth.charEventListeners)for(a=$jscomp.makeIterator(Object.keys(Blast.Bluetooth.charEventListeners)),b=a.next();!b.done;b=a.next()){var c=Blast.Bluetooth.charEventListeners[b.value];b=c[0];var d=c[1];
c=c[2];b.stopNotifications();b.removeEventListener(d,c)}Blast.Bluetooth.LEScanResults={}};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(e){e=e?e.toString():"";return Blast.highlightBlock(e)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(e){Blast.Interrupted=e};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
