...
m.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$50)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if(b=document.getElementById("pairStatus-"+b.value.firstElementChild.textContent),console.log(b.innerHTML),"\u2718"==b.innerHTML)return!1;return!0};
