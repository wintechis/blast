...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(f){return f instanceof e?f:new e(function(l,k){l(f)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(f){if(null==this.batch_){this.batch_=[];var l=this;this.asyncExecuteFunction(function(){l.executeBatch_()})}this.batch_.push(f)};
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(f){d(f,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var f=this.batch_;this.batch_=[];for(var l=0;l<f.length;++l){var k=f[l];f[l]=null;try{k()}catch(h){this.asyncThrow_(h)}}}this.batch_=null};b.prototype.asyncThrow_=function(f){this.asyncExecuteFunction(function(){throw f;})};var e=function(f){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var l=this.createResolveAndReject_();
try{f(l.resolve,l.reject)}catch(k){l.reject(k)}};e.prototype.createResolveAndReject_=function(){function f(h){return function(m){k||(k=!0,h.call(l,m))}}var l=this,k=!1;return{resolve:f(this.resolveTo_),reject:f(this.reject_)}};e.prototype.resolveTo_=function(f){if(f===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(f instanceof e)this.settleSameAsPromise_(f);else{a:switch(typeof f){case "object":var l=null!=f;break a;case "function":l=!0;break a;default:l=!1}l?this.resolveToNonPromiseObj_(f):
this.fulfill_(f)}};e.prototype.resolveToNonPromiseObj_=function(f){var l=void 0;try{l=f.then}catch(k){this.reject_(k);return}"function"==typeof l?this.settleSameAsThenable_(l,f):this.fulfill_(f)};e.prototype.reject_=function(f){this.settle_(2,f)};e.prototype.fulfill_=function(f){this.settle_(1,f)};e.prototype.settle_=function(f,l){if(0!=this.state_)throw Error("Cannot settle("+f+", "+l+"): Promise already settled in state"+this.state_);this.state_=f;this.result_=l;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
...
f.callWhenSettled_(l.resolve,l.reject)};e.prototype.settleSameAsThenable_=function(f,l){var k=this.createResolveAndReject_();try{f.call(l,k.resolve,k.reject)}catch(h){k.reject(h)}};e.prototype.then=function(f,l){function k(p,q){return"function"==typeof p?function(r){try{h(p(r))}catch(t){m(t)}}:q}var h,m,n=new e(function(p,q){h=p;m=q});this.callWhenSettled_(k(f,h),k(l,m));return n};e.prototype.catch=function(f){return this.then(void 0,f)};e.prototype.callWhenSettled_=function(f,l){function k(){switch(h.state_){case 1:f(h.result_);
break;case 2:l(h.result_);break;default:throw Error("Unexpected state: "+h.state_);}}var h=this;null==this.onSettledCallbacks_?g.asyncExecute(k):this.onSettledCallbacks_.push(k);this.isRejectionHandled_=!0};e.resolve=c;e.reject=function(f){return new e(function(l,k){k(f)})};e.race=function(f){return new e(function(l,k){for(var h=$jscomp.makeIterator(f),m=h.next();!m.done;m=h.next())c(m.value).callWhenSettled_(l,k)})};e.all=function(f){var l=$jscomp.makeIterator(f),k=l.next();return k.done?c([]):new e(function(h,
m){function n(r){return function(t){p[r]=t;q--;0==q&&h(p)}}var p=[],q=0;do p.push(void 0),q++,c(k.value).callWhenSettled_(n(p.length-1),m),k=l.next();while(!k.done)})};return e},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var h=Object.seal({}),m=Object.seal({}),n=new a([[h,2],[m,3]]);if(2!=n.get(h)||3!=n.get(m))return!1;n.delete(h);n.set(m,4);return!n.has(h)&&4==n.get(m)}catch(p){return!1}}function c(){}function d(h){var m=typeof h;return"object"===m&&null!==h||"function"===m}function e(h){if(!$jscomp.owns(h,f)){var m=new c;$jscomp.defineProperty(h,f,{value:m})}}function g(h){if(!$jscomp.ISOLATE_POLYFILLS){var m=Object[h];m&&(Object[h]=
function(n){if(n instanceof c)return n;Object.isExtensible(n)&&e(n);return m(n)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var f="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var l=0,k=function(h){this.id_=(l+=Math.random()+1).toString();if(h){h=$jscomp.makeIterator(h);for(var m;!(m=h.next()).done;)m=m.value,this.set(m[0],m[1])}};k.prototype.set=function(h,m){if(!d(h))throw Error("Invalid WeakMap key");
e(h);if(!$jscomp.owns(h,f))throw Error("WeakMap key fail: "+h);h[f][this.id_]=m;return this};k.prototype.get=function(h){return d(h)&&$jscomp.owns(h,f)?h[f][this.id_]:void 0};k.prototype.has=function(h){return d(h)&&$jscomp.owns(h,f)&&$jscomp.owns(h[f],this.id_)};k.prototype.delete=function(h){return d(h)&&$jscomp.owns(h,f)&&$jscomp.owns(h[f],this.id_)?delete h[f][this.id_]:!1};return k},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var k=Object.seal({x:4}),h=new a($jscomp.makeIterator([[k,"s"]]));if("s"!=h.get(k)||1!=h.size||h.get({x:4})||h.set({x:4},"t")!=h||2!=h.size)return!1;var m=h.entries(),n=m.next();if(n.done||n.value[0]!=k||"s"!=n.value[1])return!1;n=m.next();return n.done||4!=n.value[0].x||"t"!=n.value[1]||!m.next().done?!1:!0}catch(p){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,d=function(k){this.data_={};this.head_=f();this.size=0;if(k){k=$jscomp.makeIterator(k);for(var h;!(h=k.next()).done;)h=h.value,this.set(h[0],h[1])}};d.prototype.set=function(k,h){k=0===k?0:k;var m=e(this,k);m.list||(m.list=this.data_[m.id]=[]);m.entry?m.entry.value=h:(m.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:k,value:h},m.list.push(m.entry),
...
e(this,k).entry)&&k.value};d.prototype.entries=function(){return g(this,function(k){return[k.key,k.value]})};d.prototype.keys=function(){return g(this,function(k){return k.key})};d.prototype.values=function(){return g(this,function(k){return k.value})};d.prototype.forEach=function(k,h){for(var m=this.entries(),n;!(n=m.next()).done;)n=n.value,k.call(h,n[1],n[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var e=function(k,h){var m=h&&typeof h;"object"==m||"function"==m?c.has(h)?m=c.get(h):
(m=""+ ++l,c.set(h,m)):m="p_"+h;var n=k.data_[m];if(n&&$jscomp.owns(k.data_,m))for(k=0;k<n.length;k++){var p=n[k];if(h!==h&&p.key!==p.key||h===p.key)return{id:m,list:n,index:k,entry:p}}return{id:m,list:n,index:-1,entry:void 0}},g=function(k,h){var m=k.head_;return $jscomp.iteratorPrototype(function(){if(m){for(;m.head!=k.head_;)m=m.previous;for(;m.next!=m.head;)return m=m.next,{done:!1,value:h(m)};m=null}return{done:!0,value:void 0}})},f=function(){var k={};return k.previous=k.next=k.head=k},l=0;
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$43:e.$jscomp$loop$prop$type$43,$jscomp$loop$prop$name$44:e.$jscomp$loop$prop$name$44,$jscomp$loop$prop$block$45:e.$jscomp$loop$prop$block$45},g=b.next()){e.$jscomp$loop$prop$block$45=g.value;e.$jscomp$loop$prop$type$43=e.$jscomp$loop$prop$block$45.getAttribute("type");
if("things_webBluetooth"==e.$jscomp$loop$prop$type$43||"things_webHID"==e.$jscomp$loop$prop$type$43){e.$jscomp$loop$prop$name$44=e.$jscomp$loop$prop$block$45.firstElementChild.textContent;if(d.includes(e.$jscomp$loop$prop$name$44))continue;g=document.createElement("tr");var f=document.createElement("td");f.appendChild(document.createTextNode(e.$jscomp$loop$prop$name$44));var l=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
e.$jscomp$loop$prop$name$44);k.setAttribute("value","Pair");var h=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+e.$jscomp$loop$prop$name$44);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";h.appendChild(m);k.addEventListener("click",function(n){return function(){var p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return"things_webBluetooth"!=
n.$jscomp$loop$prop$type$43?("things_webHID"==n.$jscomp$loop$prop$type$43&&(p=[],navigator.hid.requestDevice({filters:p}).then(function(t){0===t.length&&Blast.throwError("Connection failed or cancelled by User.");var u=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(u,t[0]);Blast.Things.addWebHidDevice(u,n.$jscomp$loop$prop$name$44);document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
n.$jscomp$loop$prop$name$44).style.color="green";n.$jscomp$loop$prop$block$45.firstElementChild.textContent=u;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(t){wHidLog("Argh! "+t)})),r.jumpTo(0)):r.yield(Blast.Bluetooth.requestDevice(),3);q=r.yieldResult;document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).innerHTML=
"&#x2714;";document.getElementById("pairStatus-"+n.$jscomp$loop$prop$name$44).style.color="green";n.$jscomp$loop$prop$block$45.firstElementChild.textContent=q.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));r.jumpToEnd()})}}(e));l.appendChild(k);g.appendChild(f);g.appendChild(l);g.appendChild(h);c.appendChild(g);d.push(e.$jscomp$loop$prop$name$44)}document.getElementById("rc-cancel").addEventListener("click",
function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],e={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;e={$jscomp$loop$prop$type$47:e.$jscomp$loop$prop$type$47,$jscomp$loop$prop$name$48:e.$jscomp$loop$prop$name$48,$jscomp$loop$prop$block$49:e.$jscomp$loop$prop$block$49},g=b.next())if(e.$jscomp$loop$prop$block$49=g.value,e.$jscomp$loop$prop$type$47=e.$jscomp$loop$prop$block$49.getAttribute("type"),
"things_webBluetooth"==e.$jscomp$loop$prop$type$47||"things_webHID"==e.$jscomp$loop$prop$type$47)if(e.$jscomp$loop$prop$name$48=e.$jscomp$loop$prop$block$49.firstElementChild.textContent,!d.includes(e.$jscomp$loop$prop$name$48)){g=document.createElement("li");g.setAttribute("id","rc-item-"+e.$jscomp$loop$prop$name$48);g.setAttribute("class","mdc-list-item");var f=document.createElement("span");f.setAttribute("id","rc-icon-"+e.$jscomp$loop$prop$name$48);f.setAttribute("class","mdc-list-item__graphic material-icons");
f.setAttribute("aria-hidden","true");f.innerHTML="things_webBluetooth"==e.$jscomp$loop$prop$type$47?"bluetooth_disabled":"usb_off";g.appendChild(f);f=document.createElement("span");f.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=e.$jscomp$loop$prop$name$48;f.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+e.$jscomp$loop$prop$name$48);
l.innerHTML="disconnected";f.appendChild(l);g.appendChild(f);g.addEventListener("click",function(k){return function(){var h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$47?("things_webHID"==k.$jscomp$loop$prop$type$47&&(h=[],navigator.hid.requestDevice({filters:h}).then(function(p){0===p.length&&Blast.throwError("Connection failed or cancelled by User.");var q=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(q,p[0]);Blast.Things.addWebHidDevice(q,k.$jscomp$loop$prop$name$48);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$48).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$48).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$48).style.color="#0d30b1";k.$jscomp$loop$prop$block$49.firstElementChild.textContent=q;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)}))}).catch(function(p){wHidLog("Argh! "+p)})),n.jumpTo(0)):n.yield(Blast.Bluetooth.requestDevice(),3);m=n.yieldResult;Blast.Things.addWebBluetoothDevice(m.id,k.$jscomp$loop$prop$name$48);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$48).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$48).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$48).style.color="#0d30b1";
k.$jscomp$loop$prop$block$49.firstElementChild.textContent=m.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)}));n.jumpToEnd()})}}(e));c.appendChild(g);d.push(e.$jscomp$loop$prop$name$48)}window.app.initLists()};
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function e(l){l=l.replace(/^0x/,"");0!=l.length%2&&(l="0"+l);var k=l.match(/[G-Z\s]/i);k&&console.log("WARNING: found non-hex characters",k);l=l.match(/[\dA-F]{2}/gi).map(function(h){return parseInt(h,16)});return(new Uint8Array(l)).buffer}var g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:g=l.yieldResult;if(!g)return l.return();
d=e(d);l.setCatchFinallyBlocks(3);return l.yield(g.writeValueWithoutResponse(d),5);case 5:l.leaveTryBlock(4);break;case 3:f=l.enterCatchBlock(),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),console.error(f);case 4:Blast.Bluetooth.disconnect(a),l.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a,b),2);case 2:return c=g.yieldResult,g.setCatchFinallyBlocks(3),g.yield(c.getPrimaryService(b),5);case 5:d=g.yieldResult;g.leaveTryBlock(4);break;case 3:e=g.enterCatchBlock(),Blast.throwError("The device is not compatible with the connected block."),console.error(e);case 4:return g.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,e,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=f.yieldResult;if(!d)return f.return();f.setCatchFinallyBlocks(3);return f.yield(d.getCharacteristic(c),5);case 5:e=f.yieldResult;f.leaveTryBlock(4);break;case 3:g=f.enterCatchBlock(),Blast.throwError("The device is not compatible with the connected block."),console.error(g);case 4:return f.return(e)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return d=Blast.Bluetooth.getCharacteristic(a,b,c),g.setCatchFinallyBlocks(2),g.yield(d.readValue(),4);if(2!=g.nextAddress)return g.return(g.yieldResult);e=g.enterCatchBlock();Blast.throwError("Error reading from Bluetooth device "+a);console.error(e);g.jumpToEnd()})};
Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;e=(new TextDecoder).decode(d);return g.return(e)})};Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;e=(new DataView(d)).getUint8(0);return g.return(e)})};
...
Blast.Bluetooth.gatt_subscribe=function(a,b,c,d){var e,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return e=f.yieldResult,e.addEventListener("characteristicvaluechanged",d),Blast.Bluetooth.charEventListeners[c]=[e,"characteristicvaluechanged",d],f.setCatchFinallyBlocks(3),f.yield(e.startNotifications(),5);case 5:f.leaveTryBlock(0);break;case 3:g=f.enterCatchBlock(),Blast.throwError("Error subscribing to Bluetooth device "+
a),console.error(g),f.jumpToEnd()}})};Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){if(Blast.Bluetooth.isLEScanRunning)return a.return();Blast.Bluetooth.cacheLEScanResults();Blast.Bluetooth.isLEScanRunning=!0;Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));setTimeout(Blast.Bluetooth.stopLEScan,3E4);a.jumpToEnd()})};
...
Blast.Bluetooth.tearDown=function(){Blast.Bluetooth.isLEScanRunning&&(Blast.Bluetooth.isLEScanRunning=!1);if(Blast.Bluetooth.eventListeners){for(var a=$jscomp.makeIterator(Blast.Bluetooth.eventListeners),b=a.next();!b.done;b=a.next())b=b.value,Blast.Bluetooth.removeEventListener(b[0],b[1]);Blast.Bluetooth.eventListeners=[]}if(Blast.Bluetooth.charEventListeners)for(a=$jscomp.makeIterator(Object.keys(Blast.Bluetooth.charEventListeners)),b=a.next();!b.done;b=a.next()){var c=Blast.Bluetooth.charEventListeners[b.value];
b=c[0];var d=c[1];c=c[2];b.stopNotifications();b.removeEventListener(d,c)}Blast.Bluetooth.LEScanResults={}};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(e){e=e?e.toString():"";return Blast.highlightBlock(e)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(e){Blast.Interrupted=e};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
var sendHttpRequest=function(a,b,c,d,e,g){var f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");f=JSON.parse(c);l={method:b,headers:new Headers(f)};d&&(l.body=d);fetch(a,l).then(Blast.handleFetchErrors).then(function(h){var m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return"status"==e&&g(h.status),n.yield(h.text(),2);m=n.yieldResult;g(m);n.jumpToEnd()})}).catch(function(h){Blast.throwError(h.message+
...
b+", "+c+", "+d+")\n;"};
var blinkstickSetColors=function(a,b,c,d,e,g){var f,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(0>b||7<b)return Blast.throwError("BlinkStick index must be between 0 and 7."),g(),h.return();if(!a)return Blast.throwError("No BlinkStick block set."),g(),h.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Blinkstick via webHID."),g(),h.return();if(f.opened){h.jumpTo(2);
break}h.setCatchFinallyBlocks(3);return h.yield(f.open(),5);case 5:h.leaveTryBlock(2);break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==f.vendorId||16869!==f.productId)return Blast.throwError("The connected device is not a BlinkStick."),g(),h.return();l=Int8Array.from([5,b,c,d,e]);k=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.setCatchFinallyBlocks(2),
p.yield(f.sendFeatureReport(5,l),4);if(2!=p.nextAddress)return p.leaveTryBlock(0);n=p.enterCatchBlock();return 0<m?p.yield(k(--m),0):(console.error(n),Blast.throwError("Failed to set BlinkStick colors, please check its connection."),p.jumpTo(0))})};return h.yield(k(5),6);case 6:g(),h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["blinkstickSetColors",blinkstickSetColors]);Blockly.Blocks.joycon_read_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["accelerometers","accelerometers"],["actual accelerometer","actualAccelerometer"],["actual gyroscope","actualGyroscope"],["actual orientation","actualOrientation"],["actual orientation quaternion","actualOrientationQuaternion"],["gyroscopes","gyroscopes"],["quaternion","quaternion"]],this.propertyValidator),"property").appendField("property of Nintendo JoyCon");
...
var readJoyConProperty=function(a,b,c,d,e,g){var f,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),g(),h.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),g(),h.return();if(f.opened){h.jumpTo(2);break}h.setCatchFinallyBlocks(3);return h.yield(f.open(),5);case 5:h.leaveTryBlock(2);
break;case 3:h.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==f.vendorId||8198!==f.productId)return Blast.throwError("The connected device is not a Joy-Con."),g(),h.return();8198===f.productId?l=new JoyConLeft(f):8199===f.productId&&(l=new JoyConRight(f));return h.yield(l.open(),6);case 6:return h.yield(l.enableStandardFullMode(),7);case 7:return h.yield(l.enableIMUMode(),8);case 8:k=function(m){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){n=
m.detail;if(!n||!n.actualOrientation)return p.return();l.removeEventListener("hidinput",k);""!==d?"accelerometers"===b?g(n[b][c][d].acc):"gyroscopes"===b?g(n[b][c][d][e]):g(n[b][c][d]):g(n[b][c]);p.jumpToEnd()})};if(l.eventListenerAttached){h.jumpTo(0);break}return h.yield(l.open(),10);case 10:return h.yield(l.enableStandardFullMode(),11);case 11:return h.yield(l.enableIMUMode(),12);case 12:return h.yield(l.enableVibration(),13);case 13:l.addEventListener("hidinput",k),l.eventListenerAttached=!0,
h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("Robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};Blast.Toolbox.addBlock("mirobot_pickup","actions");Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
...
b+"], "+a+");\n"};
var handleStreamdeck=function(a,b,c){var d,e,g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return Blast.throwError("No streamdeck block set."),callback(),l.return();d="inputreport";e=Blast.Things.webHidDevices.get(a);if(!e)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),callback(),l.return();if(e.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(e.open(),5);
case 5:l.leaveTryBlock(2);break;case 3:g=l.enterCatchBlock(),console.error(g),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(4057!=e.vendorId)return Blast.throwError("The connected device is not a Streamdeck."),l.return();f=function(k){if(1===k.reportId&&(k=new Int8Array(k.data.buffer),k=Array.from(k).slice(0,6),b=b.toString().split(",").map(Number),k.every(function(n,p){return n===b[p]}))){Blast.Interrupted=!0;var h=new Interpreter("");h.stateStack[0].scope=
Blast.Interpreter.globalScope;h.appendCode(c);var m=function(){try{h.step()?setTimeout(m,5):Blast.Interrupted=!1}catch(n){Blockly.alert("Error executing program:\n%e".replace("%e",n)),Blast.Ui.setStatus(Blast.status.ERROR),Blast.resetInterpreter(),console.error(n)}};m()}};Blast.deviceEventHandlers.push({device:e,type:d,fn:f});e.addEventListener(d,f);l.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
