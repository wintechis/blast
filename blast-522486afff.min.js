...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(h){return h instanceof f?h:new f(function(n,k){n(h)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(h){if(null==this.batch_){this.batch_=[];var n=this;this.asyncExecuteFunction(function(){n.executeBatch_()})}this.batch_.push(h)};
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(h){d(h,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var h=this.batch_;this.batch_=[];for(var n=0;n<h.length;++n){var k=h[n];h[n]=null;try{k()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};b.prototype.asyncThrow_=function(h){this.asyncExecuteFunction(function(){throw h;})};var f=function(h){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var n=this.createResolveAndReject_();
try{h(n.resolve,n.reject)}catch(k){n.reject(k)}};f.prototype.createResolveAndReject_=function(){function h(l){return function(m){k||(k=!0,l.call(n,m))}}var n=this,k=!1;return{resolve:h(this.resolveTo_),reject:h(this.reject_)}};f.prototype.resolveTo_=function(h){if(h===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(h instanceof f)this.settleSameAsPromise_(h);else{a:switch(typeof h){case "object":var n=null!=h;break a;case "function":n=!0;break a;default:n=!1}n?this.resolveToNonPromiseObj_(h):
this.fulfill_(h)}};f.prototype.resolveToNonPromiseObj_=function(h){var n=void 0;try{n=h.then}catch(k){this.reject_(k);return}"function"==typeof n?this.settleSameAsThenable_(n,h):this.fulfill_(h)};f.prototype.reject_=function(h){this.settle_(2,h)};f.prototype.fulfill_=function(h){this.settle_(1,h)};f.prototype.settle_=function(h,n){if(0!=this.state_)throw Error("Cannot settle("+h+", "+n+"): Promise already settled in state"+this.state_);this.state_=h;this.result_=n;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};f.prototype.scheduleUnhandledRejectionCheck_=function(){var h=this;d(function(){if(h.notifyUnhandledRejection_()){var n=$jscomp.global.console;"undefined"!==typeof n&&n.error(h.result_)}},1)};f.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var h=$jscomp.global.CustomEvent,n=$jscomp.global.Event,k=$jscomp.global.dispatchEvent;if("undefined"===typeof k)return!0;"function"===typeof h?h=new h("unhandledrejection",{cancelable:!0}):
"function"===typeof n?h=new n("unhandledrejection",{cancelable:!0}):(h=$jscomp.global.document.createEvent("CustomEvent"),h.initCustomEvent("unhandledrejection",!1,!0,h));h.promise=this;h.reason=this.result_;return k(h)};f.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var h=0;h<this.onSettledCallbacks_.length;++h)g.asyncExecute(this.onSettledCallbacks_[h]);this.onSettledCallbacks_=null}};var g=new b;f.prototype.settleSameAsPromise_=function(h){var n=this.createResolveAndReject_();
h.callWhenSettled_(n.resolve,n.reject)};f.prototype.settleSameAsThenable_=function(h,n){var k=this.createResolveAndReject_();try{h.call(n,k.resolve,k.reject)}catch(l){k.reject(l)}};f.prototype.then=function(h,n){function k(q,r){return"function"==typeof q?function(t){try{l(q(t))}catch(v){m(v)}}:r}var l,m,p=new f(function(q,r){l=q;m=r});this.callWhenSettled_(k(h,l),k(n,m));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,n){function k(){switch(l.state_){case 1:h(l.result_);
break;case 2:n(l.result_);break;default:throw Error("Unexpected state: "+l.state_);}}var l=this;null==this.onSettledCallbacks_?g.asyncExecute(k):this.onSettledCallbacks_.push(k);this.isRejectionHandled_=!0};f.resolve=c;f.reject=function(h){return new f(function(n,k){k(h)})};f.race=function(h){return new f(function(n,k){for(var l=$jscomp.makeIterator(h),m=l.next();!m.done;m=l.next())c(m.value).callWhenSettled_(n,k)})};f.all=function(h){var n=$jscomp.makeIterator(h),k=n.next();return k.done?c([]):new f(function(l,
...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var l=Object.seal({}),m=Object.seal({}),p=new a([[l,2],[m,3]]);if(2!=p.get(l)||3!=p.get(m))return!1;p.delete(l);p.set(m,4);return!p.has(l)&&4==p.get(m)}catch(q){return!1}}function c(){}function d(l){var m=typeof l;return"object"===m&&null!==l||"function"===m}function f(l){if(!$jscomp.owns(l,h)){var m=new c;$jscomp.defineProperty(l,h,{value:m})}}function g(l){if(!$jscomp.ISOLATE_POLYFILLS){var m=Object[l];m&&(Object[l]=
function(p){if(p instanceof c)return p;Object.isExtensible(p)&&f(p);return m(p)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var n=0,k=function(l){this.id_=(n+=Math.random()+1).toString();if(l){l=$jscomp.makeIterator(l);for(var m;!(m=l.next()).done;)m=m.value,this.set(m[0],m[1])}};k.prototype.set=function(l,m){if(!d(l))throw Error("Invalid WeakMap key");
f(l);if(!$jscomp.owns(l,h))throw Error("WeakMap key fail: "+l);l[h][this.id_]=m;return this};k.prototype.get=function(l){return d(l)&&$jscomp.owns(l,h)?l[h][this.id_]:void 0};k.prototype.has=function(l){return d(l)&&$jscomp.owns(l,h)&&$jscomp.owns(l[h],this.id_)};k.prototype.delete=function(l){return d(l)&&$jscomp.owns(l,h)&&$jscomp.owns(l[h],this.id_)?delete l[h][this.id_]:!1};return k},"es6","es3");$jscomp.MapEntry=function(){};
...
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,d=function(k){this.data_={};this.head_=h();this.size=0;if(k){k=$jscomp.makeIterator(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}};d.prototype.set=function(k,l){k=0===k?0:k;var m=f(this,k);m.list||(m.list=this.data_[m.id]=[]);m.entry?m.entry.value=l:(m.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:k,value:l},m.list.push(m.entry),
this.head_.previous.next=m.entry,this.head_.previous=m.entry,this.size++);return this};d.prototype.delete=function(k){k=f(this,k);return k.entry&&k.list?(k.list.splice(k.index,1),k.list.length||delete this.data_[k.id],k.entry.previous.next=k.entry.next,k.entry.next.previous=k.entry.previous,k.entry.head=null,this.size--,!0):!1};d.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=h();this.size=0};d.prototype.has=function(k){return!!f(this,k).entry};d.prototype.get=function(k){return(k=
f(this,k).entry)&&k.value};d.prototype.entries=function(){return g(this,function(k){return[k.key,k.value]})};d.prototype.keys=function(){return g(this,function(k){return k.key})};d.prototype.values=function(){return g(this,function(k){return k.value})};d.prototype.forEach=function(k,l){for(var m=this.entries(),p;!(p=m.next()).done;)p=p.value,k.call(l,p[1],p[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var f=function(k,l){var m=l&&typeof l;"object"==m||"function"==m?c.has(l)?m=c.get(l):
(m=""+ ++n,c.set(l,m)):m="p_"+l;var p=k.data_[m];if(p&&$jscomp.owns(k.data_,m))for(k=0;k<p.length;k++){var q=p[k];if(l!==l&&q.key!==q.key||l===q.key)return{id:m,list:p,index:k,entry:q}}return{id:m,list:p,index:-1,entry:void 0}},g=function(k,l){var m=k.head_;return $jscomp.iteratorPrototype(function(){if(m){for(;m.head!=k.head_;)m=m.previous;for(;m.next!=m.head;)return m=m.next,{done:!1,value:l(m)};m=null}return{done:!0,value:void 0}})},h=function(){var k={};return k.previous=k.next=k.head=k},n=0;
...
$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,f=0;f<d;f++){var g=a[f];if(b.call(c,g,f,a))return{i:f,v:g}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
...
$jscomp.polyfill("Uint32Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Float32Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");var Blast={States:{}};Blast.States.Interpreter=null;Blast.States.runner_=null;Blast.States.latestCode="";Blast.States.eventCode=new Map;Blast.States.eventValues=new Map;
...
Blast.States.generateCode=function(){for(var a="while (true) {\n \n}",b=Blast.workspace.getBlocksByType("event",!1).map(function(g){return g.id}),c=$jscomp.makeIterator(Blast.States.eventCode),d=c.next();!d.done;d=c.next()){var f=$jscomp.makeIterator(d.value);d=f.next().value;f=f.next().value;b.includes(d)&&(a=a.slice(0,-2)+f+"\n"+a.slice(-1))}Blast.States.latestCode=Blockly.JavaScript.finish(a)};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$73:f.$jscomp$loop$prop$type$73,$jscomp$loop$prop$name$74:f.$jscomp$loop$prop$name$74,$jscomp$loop$prop$block$75:f.$jscomp$loop$prop$block$75},g=b.next()){f.$jscomp$loop$prop$block$75=g.value;f.$jscomp$loop$prop$type$73=f.$jscomp$loop$prop$block$75.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$73||"things_webHID"==f.$jscomp$loop$prop$type$73){f.$jscomp$loop$prop$name$74=f.$jscomp$loop$prop$block$75.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$74))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$74));var n=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$74);k.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$74);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
p.$jscomp$loop$prop$type$73?("things_webHID"==p.$jscomp$loop$prop$type$73&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(v){0===v.length&&Blast.throwError("Connection failed or cancelled by User.");var w=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(w,v[0]);Blast.Things.addWebHidDevice(w,p.$jscomp$loop$prop$name$74);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$74).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
p.$jscomp$loop$prop$name$74).style.color="green";p.$jscomp$loop$prop$block$75.firstElementChild.textContent=w;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(v){Blast.throwError("Connection failed or cancelled by User.");
console.error(v)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$74).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$74).style.color="green";p.$jscomp$loop$prop$block$75.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));n.appendChild(k);g.appendChild(h);g.appendChild(n);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$74)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$77:f.$jscomp$loop$prop$type$77,$jscomp$loop$prop$name$78:f.$jscomp$loop$prop$name$78,$jscomp$loop$prop$block$79:f.$jscomp$loop$prop$block$79},g=b.next())if(f.$jscomp$loop$prop$block$79=g.value,f.$jscomp$loop$prop$type$77=f.$jscomp$loop$prop$block$79.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$77||"things_webHID"==f.$jscomp$loop$prop$type$77)if(f.$jscomp$loop$prop$name$78=f.$jscomp$loop$prop$block$79.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$78)){g=document.createElement("li");g.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$78);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$78);h.setAttribute("class","mdc-list-item__graphic material-icons");
h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$77?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var n=document.createElement("span");n.setAttribute("class","mdc-list-item__primary-text");n.innerHTML=f.$jscomp$loop$prop$name$78;h.appendChild(n);n=document.createElement("span");n.setAttribute("class","mdc-list-item__secondary-text");n.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$78);
n.innerHTML="disconnected";h.appendChild(n);g.appendChild(h);g.addEventListener("click",function(k){return function(){var l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$77?("things_webHID"==k.$jscomp$loop$prop$type$77&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$78);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$78).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$78).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$78).style.color="#0d30b1";k.$jscomp$loop$prop$block$79.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);m=p.yieldResult;Blast.Things.addWebBluetoothDevice(m.id,k.$jscomp$loop$prop$name$78);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$78).innerHTML=
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$78).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$78).style.color="#0d30b1";k.$jscomp$loop$prop$block$79.firstElementChild.textContent=m.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$78)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Things.addWebBluetoothDevice=function(a,b){var c=function(d,f){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(g){if(g)if(Blast.Things.webBluetoothDevices.has(g)){var h="Name %1 already exists".replace("%1",g);Blockly.alert(h,function(){c(g,f)})}else Blast.Things.webBluetoothDevices.set(g,f);else Blockly.alert("Name cannot be empty",function(){c(g,f)})})};c(b,a)};
...
Blast.Things.addWebHidDevice=function(a,b){var c=function(d,f){Blockly.Variables.promptName("Connection established! Now give your device a name.",d,function(g){if(g)if(Blast.Things.webHidNames.has(g)){var h="Name %1 already exists".replace("%1",g);Blockly.alert(h,function(){c(g,f)})}else Blast.Things.webHidNames.set(g,f);else Blockly.alert("Name cannot be empty",function(){c(g,f)})})};c(b,a)};Blast.Bluetooth={};Blast.Bluetooth.optionalServices=[];Blast.Bluetooth.scanBlocks=[];Blast.Bluetooth.LEScanResults={};Blast.Bluetooth.isLEScanRunning=!1;Blast.Bluetooth.eventListeners=[];Blast.Bluetooth.charEventListeners={};function hexStringToArrayBuffer(a){a=a.replace(/^0x/,"");0!=a.length%2&&(a="0"+a);var b=a.match(/[G-Z\s]/i);b&&console.log("WARNING: found non-hex characters",b);a=a.match(/[\dA-F]{2}/gi).map(function(c){return parseInt(c,16)});return(new Uint8Array(a)).buffer}
Blast.Bluetooth.requestDevice=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress){Blast.Ui.addToLog("Requesting device...","Bluetooth");if(!navigator.bluetooth)return g.jumpTo(0);a||(a={acceptAllDevices:!0},a.optionalServices=Blast.Bluetooth.optionalServices);g.setCatchFinallyBlocks(3);return g.yield(navigator.bluetooth.requestDevice(a),5)}if(3!=g.nextAddress)return c=g.yieldResult,Blast.Ui.addToLog("Device paired","Bluetooth",c.id),d=b||c.name,
Blast.Things.addWebBluetoothDevice(c.id,d),Blast.workspace.refreshToolboxSelection(),g.return(c);f=g.enterCatchBlock();Blast.throwError(f);g.jumpToEnd()})};
Blast.Bluetooth.getDeviceById=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(navigator.bluetooth.getDevices(),2);b=g.yieldResult;c=$jscomp.makeIterator(b);for(d=c.next();!d.done;d=c.next())if(f=d.value,f.id==a)return g.return(f);Blast.throwError("Bluetooth device "+a+" wasn't found in paired devices.");g.jumpToEnd()})};
...
a),console.error(d),f.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=h.yieldResult;if(!f)return h.return();"string"===typeof d&&(d=hexStringToArrayBuffer(d));h.setCatchFinallyBlocks(3);Blast.Ui.addToLog("Invoke <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",
a);return h.yield(f.writeValueWithoutResponse(d),5);case 5:Blast.Ui.addToLog("Finished <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithResponse=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=h.yieldResult;if(!f)return h.return();"string"===typeof d&&(d=hexStringToArrayBuffer(d));h.setCatchFinallyBlocks(3);Blast.Ui.addToLog("Invoke <code>WriteValueWithResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);return h.yield(f.writeValueWithResponse(d),
5);case 5:Blast.Ui.addToLog("Finished <code>WriteValueWithResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a),2);case 2:return c=g.yieldResult,g.setCatchFinallyBlocks(3),Blast.Ui.addToLog("Getting primary service <code>"+b+"</code>","Bluetooth",a),g.yield(c.getPrimaryService(b),5);case 5:d=g.yieldResult;Blast.Ui.addToLog("Got primary service <code>"+b+"</code>","Bluetooth",a);g.leaveTryBlock(4);break;case 3:f=g.enterCatchBlock(),
console.error(f),Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=h.yieldResult;if(!d)return h.return();h.setCatchFinallyBlocks(3);Blast.Ui.addToLog("Getting characteristic <code>"+c+"</code> from service <code>"+b+"</code>","Bluetooth",a);return h.yield(d.getCharacteristic(c),5);case 5:f=h.yieldResult;Blast.Ui.addToLog("Got characteristic <code>"+
c+"</code> from service <code>"+b+"</code>","Bluetooth",a);h.leaveTryBlock(4);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("The device is not compatible with the connected block.");case 4:return h.return(f)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return d=h.yieldResult,h.setCatchFinallyBlocks(3),Blast.Ui.addToLog("Invoke <code>ReadValue</code> on characteristic <code>"+c+"</code> from service <code>"+(b+"</code>"),"Bluetooth",a),h.yield(d.readValue(),5);case 5:return f=h.yieldResult,Blast.Ui.addToLog("Finished <code>ReadValue</code> on characteristic <code>"+
c+"</code> from service <code>"+(b+"</code> - value: <code>"+f.toString()+"</code>"),"Bluetooth",a),h.return(f);case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error reading from Bluetooth device "+a),h.jumpToEnd()}})};Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;f=(new TextDecoder).decode(d);return g.return(f)})};
Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,f,g,h,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=k.yieldResult;d instanceof DataView||(d=new DataView(value));f=new Uint8Array(d.buffer);g=f.length;h=buffer.Buffer.from(f);n=h.readUIntBE(0,g);return k.return(n)})};
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;f=(new Uint8Array(d.buffer)).reduce(function(h,n){return h+("0"+n.toString(16)).slice(-2)},"");return g.return(f)})};
Blast.Bluetooth.gatt_subscribe=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return f=h.yieldResult,Blast.Ui.addToLog("Add 'characteristicvaluechanged' listener to characteristic "+c+(" of service <code>"+b+"</code>"),"Bluetooth",a),f.addEventListener("characteristicvaluechanged",d),Blast.Bluetooth.charEventListeners[c]=[f,"characteristicvaluechanged",d],h.setCatchFinallyBlocks(3),
Blast.Ui.addToLog("Invoke <code>startNotifications</code> on characteristic "+c+(" from service <code>"+b+"</code>"),"Bluetooth",a),h.yield(f.startNotifications(),5);case 5:Blast.Ui.addToLog("Finished <code>startNotifications</code> on characteristic "+c+(" from service <code>"+b+"</code>"),"Bluetooth",a);h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error subscribing to Bluetooth device "+a),h.jumpToEnd()}})};
...
Blast.Bluetooth.Eddystone.getCapabilities=function(a){var b,c,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return Blast.Ui.addToLog("Reading Eddystone capabilities...","Eddystone",a),h.yield(Blast.Bluetooth.gatt_read(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.CAPABILITIES_CHARACTERISTIC),2);b=h.yieldResult;b=new Int8Array(b.buffer);c=[];for(d=6;d<b.length&&!((f=c[c.length-1])&&f>=b[d]);d++)c.push(b[d]);g={specVersion:b[0],
maxSlots:b[1],maxEidPerSlot:b[2],isVarriableAdvIntervalSupported:0!==(b[3]&1),isVariableTxPowerSupported:0!==(b[3]&2),isUIDSupported:0!==(b[5]&1),isURLSupported:0!==(b[5]&2),isTLMSupported:0!==(b[5]&4),isEIDSupported:0!==(b[5]&8),supportedTxPowerLevels:c};Blast.Ui.addToLog("Eddystone capabilities: <code>"+JSON.stringify(g)+"</code>","Eddystone",a);return h.return(g)})};
...
16)+parseInt(k.substring(10,12),16)/100,p=parseInt(k.substring(12,20),16);k=parseInt(k.substring(20,28),16);return{frameType:"TLM",batteryVoltage:l,beaconTemperature:m,pduCount:p,timeSinceReboot:k}},n.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);f=n.yieldResult;Blast.Ui.addToLog("Got Eddystone advertising data: <code>"+f+"</code>","Eddystone",a);g=f.substring(0,2);switch(g){case "00":return h=
b(f),n.return(h.namespace+h.instance);case "10":return h=c(f),n.return(h.url);case "20":return h=d(f),n.return(h.beaconTemperature);case "30":return Blast.throwError("EID frame type is not supported by blast."),n.return();default:return Blast.throwError("Eddystone frame type is not valid."),n.return()}})};
Blast.Bluetooth.Eddystone.setAdvertisingData=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return Blast.Ui.addToLog("Set Eddystone advertising data...","Eddystone",a),c=function(h){for(var n=["http://www.","https://www.","http://","https://"],k=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),l=[],m=0,p=new TextEncoder("utf-8"),q=0;q<n.length;q++)if(h.startsWith(n[q])){l.push(q);m=n[q].length;break}for(;m<
h.length;){n=m;for(q=0;q<k.length;q++)if(h.startsWith(k[q],m)){l.push(q);m+=k[q].length;break}n===m&&(l.push(p.encode(h[m])[0]),m++)}if(18<l.length)Blast.throwError("URL is too long.");else return l.splice(0,0,16),new Uint8Array(l)},d=c(b),g.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,d),2);f=g.yieldResult;Blast.Ui.addToLog("Eddystone advertising data set to <code>"+b+"</code>","Eddystone",
a);return g.return(f)})};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(f){f=f?f.toString():"";return Blast.highlightBlock(f)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(f){Blast.Interrupted=f};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(f,g){return Blast.States.eventChecker(f,g)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return Blast.States.startEventChecker()}));c=function(f){return prompt(f)};a.setProperty(b,"prompt",a.createNativeFunction(c))};var COLOUR_RGB_XML='\n<block type="colour_rgb">\n    <value name="RED">\n        <block type="math_number">\n            <field name="NUM">100</field>\n        </block>\n    </value>\n    <value name="GREEN">\n        <block type="math_number">\n            <field name="NUM">50</field>\n        </block>\n    </value>\n    <value name="BLUE">\n        <block type="math_number">\n            <field name="NUM">0</field>\n        </block>\n    </value>\n</block>';
...
Blockly.Procedures.flyoutCategory=function(a){function b(g,h){g=$jscomp.makeIterator(g);for(var n=g.next();!n.done;n=g.next()){n=n.value;var k=n[0],l=n[1];n=Blockly.utils.xml.createElement("block");n.setAttribute("type",h);n.setAttribute("gap",16);var m=Blockly.utils.xml.createElement("mutation");m.setAttribute("name",k);n.appendChild(m);k=$jscomp.makeIterator(l);for(l=k.next();!l.done;l=k.next()){l=l.value;var p=Blockly.utils.xml.createElement("arg");p.setAttribute("name",l);m.appendChild(p)}c.push(n)}}
...
"BODY")}};Blast.Toolbox.addBlock("http_request","Requests and Queries");
...
this.setOutput(!0,["String","Number"]);this.setColour(255);this.setInputsInline(!0);this.setTooltip("Reads a property from an eddystone device.");this.setHelpUrl("https://github.com/google/eddystone/tree/master/configuration-service")}};var READ_EDDYSTONE_PROPERTY_XML='\n<block type="read_eddystone_property">\n  <value name="Slot">\n    <block type="math_number">\n      <field name="NUM">0</field>\n    </block>\n  </value>\n</block>';Blast.Toolbox.addBlock("read_eddystone_property","Properties",READ_EDDYSTONE_PROPERTY_XML);Blockly.JavaScript.http_request=function(a){var b=Blockly.JavaScript.valueToCode(a,"uri",Blockly.JavaScript.ORDER_NONE)||null,c=a.getFieldValue("METHOD"),d=a.getFieldValue("HEADERS"),f=a.getFieldValue("OUTPUT");a=JSON.stringify(a.getFieldValue("BODY"))||null;return["sendHttpRequest("+b+",'"+c+"', \n      '{"+d+"}', "+a+", '"+f+"')\n",Blockly.JavaScript.ORDER_NONE]};
var sendHttpRequest=function(a,b,c,d,f,g){var h,n,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty"),h=JSON.parse(c),n={method:b,headers:new Headers(h)},d&&(n.body=d),p.setCatchFinallyBlocks(2),p.yield(fetch(a,n),4);case 4:k=p.yieldResult;if(!k.ok)return Blast.throwError("Failed to get "+a+", Error: "+k.status+" "+k.statusText),p.return();"status"==
f&&g(k.status);return p.yield(k.text(),5);case 5:l=p.yieldResult;g(l);p.leaveTryBlock(0);break;case 2:m=p.enterCatchBlock(),Blast.throwError("Failed to get "+a+", Error: "+m.message),p.jumpToEnd()}})};Blast.asyncApiFunctions.push(["sendHttpRequest",sendHttpRequest]);
...
var urdfQueryWrapper=function(a,b,c,d){var f,g,h,n,k,l,m,p,q,r,t,v,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return u.setCatchFinallyBlocks(2),u.yield(fetch(a),4);case 4:return f=u.yieldResult,f.ok?u.yield(f.text(),5):(Blast.throwError("Failed to get "+a+", Error: "+f.status+" "+f.statusText),u.return());case 5:return g=u.yieldResult,urdf.clear(),h={format:b},u.yield(urdf.load(g,h),6);case 6:return u.yield(urdf.query(c),7);case 7:f=u.yieldResult;
...
var displayTable=function(a){a=Blast.Interpreter.pseudoToNative(a);if(0==a.length)Blast.Ui.addMessage("empty table");else{var b=document.createElement("table");b.classList.add("output_table");console.log(a);a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){var d=c.value;c=document.createElement("tr");if(void 0!==d){d=$jscomp.makeIterator(d);for(var f=d.next();!f.done;f=d.next())if(f=f.value,void 0!==f){var g=document.createElement("td");g.innerHTML=f;c.appendChild(g)}b.appendChild(c)}}Blast.Ui.addElementToOutputContainer(b)}};
...
var playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,f){var g=new Audio(a);g.preload="auto";g.autoplay=!0;g.onerror=function(h){Blast.throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(h);f(h)};g.onended=d}),2);b();c.jumpToEnd()})};Blast.asyncApiFunctions.push(["playAudio",playAudio]);
...
var getRSSIWb=function(a,b){var c,d,f,g,h,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(navigator.bluetooth.getDevices(),2);c=k.yieldResult;d=null;f=$jscomp.makeIterator(c);for(g=f.next();!g.done;g=f.next())if(h=g.value,h.id===a){d=h;break}null==d&&Blast.throwError("Error pairing with Bluetooth device.");n=new AbortController;d.addEventListener("advertisementreceived",function(l){return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){n.abort();
...
Blockly.JavaScript.write_eddystone_property=function(a){var b=Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE)||null,c=Blockly.JavaScript.quote_(a.getFieldValue("Property")),d=Blockly.JavaScript.valueToCode(a,"Slot",Blockly.JavaScript.ORDER_NONE)||null;a=Blockly.JavaScript.valueToCode(a,"Value",Blockly.JavaScript.ORDER_NONE)||null;return"writeEddystoneProperty("+b+", "+d+", "+c+", "+a+");\n"};var eddystoneServiceUUID="a3c87500-8ed3-4bdf-8a39-a01bebede295";Blast.Bluetooth.optionalServices.push(eddystoneServiceUUID);
var writeEddystoneProperty=function(a,b,c,d,f){return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return a?null===b||void 0===b?(Blast.throwError("No slot set."),f(),g.return()):c?g.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(Blast.throwError("No property set."),f(),g.return()):(Blast.throwError("No bluetooth device set."),f(),g.return());case 2:switch(c){case "advertisedTxPower":return g.jumpTo(3);case "advertisementData":return g.jumpTo(4);case "advertisingInterval":return g.jumpTo(5);
case "radioTxPower":return g.jumpTo(6)}g.jumpTo(7);break;case 3:return g.yield(Blast.Bluetooth.Eddystone.setAdvertisedTxPower(a,d),8);case 8:g.jumpTo(7);break;case 4:return g.yield(Blast.Bluetooth.Eddystone.setAdvertisingData(a,d),9);case 9:g.jumpTo(7);break;case 5:return g.yield(Blast.Bluetooth.Eddystone.setAdvertisingInterval(a,d),10);case 10:g.jumpTo(7);break;case 6:return g.yield(Blast.Bluetooth.Eddystone.setTxPowerLevel(a,d),11);case 11:g.jumpTo(7);break;case 7:f(),g.jumpToEnd()}})};
...
var blinkstickSetColors=function(a,b,c,d){var f,g,h,n,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:if(0>b||7<b)return Blast.throwError("BlinkStick index must be between 0 and 7."),d(),m.return();if(!a)return Blast.throwError("No BlinkStick block set."),d(),m.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Blinkstick via webHID."),d(),m.return();if(f.opened){m.jumpTo(2);
break}m.setCatchFinallyBlocks(3);return m.yield(f.open(),5);case 5:m.leaveTryBlock(2);break;case 3:m.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==f.vendorId||16869!==f.productId)return Blast.throwError("The connected device is not a BlinkStick."),d(),m.return();g=parseInt(c.substring(1,3),16);h=parseInt(c.substring(3,5),16);n=parseInt(c.substring(5,7),16);k=Int8Array.from([5,b,g,h,n]);l=function(p){var q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==
...
var readJoyConProperty=function(a,b,c,d,f,g){var h,n,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),g(),l.return();h=Blast.Things.webHidDevices.get(a);if(!h)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),g(),l.return();if(h.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(h.open(),5);case 5:l.leaveTryBlock(2);
break;case 3:l.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==h.vendorId||8198!==h.productId&&8199!==h.productId)return Blast.throwError("The connected device is not a Joy-Con."),g(),l.return();8198===h.productId?n=new JoyConLeft(h):8199===h.productId&&(n=new JoyConRight(h));return l.yield(n.open(),6);case 6:return l.yield(n.enableStandardFullMode(),7);case 7:return l.yield(n.enableIMUMode(),8);case 8:k=function(m){var p;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){p=m.detail;if(!p||!p.actualOrientation)return q.return();Blast.Ui.addToLog("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(p)+"</code>","hid",h.productname);Blast.Ui.addToLog("Removing <code>hidinput</code> event listener","hid",h.productname);n.removeEventListener("hidinput",k);""!==d?"accelerometers"===b?g(p[b][c][d].acc):"gyroscopes"===b?g(p[b][c][d][f]):g(p[b][c][d]):g(p[b][c]);q.jumpToEnd()})};if(n.eventListenerAttached){l.jumpTo(0);
break}return l.yield(n.open(),10);case 10:return l.yield(n.enableStandardFullMode(),11);case 11:return l.yield(n.enableIMUMode(),12);case 12:return l.yield(n.enableVibration(),13);case 13:Blast.Ui.addToLog("Adding <code>hidinput</code> event listener","hid",h.productname),n.addEventListener("hidinput",k),n.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);
...
break;case 3:k.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==f.vendorId||8198!==f.productId&&8199!==f.productId)return Blast.throwError("The connected device is not a Joy-Con."),d(),k.return();8198===f.productId?g=new JoyConLeft(f):8199===f.productId&&(g=new JoyConRight(f));return k.yield(g.open(),6);case 6:return k.yield(g.enableStandardFullMode(),7);case 7:return k.yield(g.enableIMUMode(),8);case 8:h=!1;n=function(l){var m,
p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){m=l.detail;if(!m||!m.actualOrientation)return r.return();Blast.Ui.addToLog("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(m)+"</code>","hid",f.productName);m.buttonStatus[b]?h||(h=!0,Blast.Interrupted=!1,p=new Interpreter(""),p.stateStack[0].scope=Blast.Interpreter.globalScope,p.appendCode(c),q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(t){Blast.throwError("Error executing program:\n "+
e),console.error(t)}},q()):h=!1;r.jumpToEnd()})};Blast.deviceEventHandlers.push({device:g,type:"hidinput",fn:n});if(g.eventListenerAttached){k.jumpTo(0);break}return k.yield(g.open(),10);case 10:return k.yield(g.enableStandardFullMode(),11);case 11:return k.yield(g.enableIMUMode(),12);case 12:return k.yield(g.enableVibration(),13);case 13:Blast.Ui.addToLog("Adding <code>hidinput</code> event listener","hid",f.productName),g.addEventListener("hidinput",n),g.eventListenerAttached=!0,k.jumpToEnd()}})};
...
var mirobotPickUp=function(a,b){var c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return c="https://bot.rapidthings.eu/thing/action/grab_"+a.toLowerCase(),d={"Content-Type":"application/json",Accept:"application/json"},f={method:"POST",headers:new Headers(d)},n.setCatchFinallyBlocks(2),n.yield(fetch(c,f),4);if(2!=n.nextAddress){g=n.yieldResult;if(!g.ok)return Blast.throwError("Failed to get "+c+", Error: "+g.status+" "+g.statusText),n.return();b(g.status);
return n.leaveTryBlock(0)}h=n.enterCatchBlock();Blast.throwError("Failed to get "+c+", Error: "+h);n.jumpToEnd()})};Blast.asyncApiFunctions.push(["mirobot_pickup",mirobotPickUp]);Blockly.Blocks.read_ruuvi_property={init:function(){this.appendValueInput("Thing").setCheck("Thing").appendField("read").appendField(new Blockly.FieldDropdown([["temperature","temperature"],["humidity","humidity"],["pressure","pressure"],["acceleration X","accelerationX"],["acceleration Y","accelerationY"],["acceleration Z","accelerationZ"],["battery voltage","batteryVoltage"],["txPower","txPower"],["movement counter","movementCounter"],["measurement sequence number","measurementSequenceNumber"]]),
...
var getRuuviProperty=function(a,b,c){var d,f,g,h,n,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return d=function(m){var p={},q=m[0]&255,r=m[1]<<8|m[2]&255;32767<r&&(r-=65535);var t=((m[3]&255)<<8|m[4]&255)/400,v=((m[5]&255)<<8|m[6]&255)+5E4,w=(m[7]<<8|m[8]&255)/1E3,u=(m[9]<<8|m[10]&255)/1E3,y=(m[11]<<8|m[12]&255)/1E3,x=(m[13]&255)<<8|m[14]&255,z=m[15]&255;m=(m[16]&255)<<8|m[17]&255;p.destination_endpoint=q;p.temperature=r/200;p.humidity=t;p.pressure=v;p.accelerationX=
w;p.accelerationY=u;p.accelerationZ=y;p.batteryVoltage=(x>>>5)/1E3+1.6;p.txPower=2*(x&31)-40;p.movementCounter=z;p.measurementSequenceNumber=m;return p},f=function(m){if(30>m){var p=Blast.Bluetooth.LEScanResults[b];if(p){p=$jscomp.makeIterator(p);for(var q=p.next();!q.done;q=p.next())if((q=q.value.manufacturerData.get(1177))&&5==q.getUint8(0))return q}return new Promise(function(r){setTimeout(function(){r(f(m+1))},1E3)})}},Blast.Bluetooth.startLEScan(b),l.yield(f(0),2);(g=l.yieldResult)||Blast.throwError("Timed out. No BLE advertising data found for "+
b);h=[];for(n=0;n<g.byteLength;n++)h.push("0x"+("00"+g.getUint8(n).toString(16)).slice(-2));k=d(h);c(k[a]);l.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.streamdeck_button_event={init:function(){var a=this;this.appendValueInput("id").setCheck("Thing").appendField("Streamdeck mini");this.appendDummyInput().appendField("on button").appendField(new Blockly.FieldDropdown([["up","up"],["down","down"]]),"upDown");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,"button1")}),"button1").appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,
...
Blockly.JavaScript.streamdeck_color_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,h="TRUE"==a.getFieldValue("button6")?1:0,n=Blockly.JavaScript.valueToCode(a,"color",Blockly.JavaScript.ORDER_NONE)||Blockly.JavaScript.quote_("#000000");a=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+
b+c+d+f+g+h);return"streamdeckColorButtons("+a+", "+b+", "+n+");\n"};
var handleStreamdeck=function(a,b,c,d){var f,g,h,n,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),l.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),l.return();l.setCatchFinallyBlocks(2);return l.yield(StreamDeck.openDevice(f),4);case 4:g=l.yieldResult;l.leaveTryBlock(3);
break;case 2:h=l.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),l.return();f.close();return l.yield(StreamDeck.openDevice(f),6);case 6:g=l.yieldResult;case 3:for(k=0;k<b.length;k++)if("1"===b.charAt(k)){n=k;break}if(void 0===n)return l.return();g.on(c,function(m){Blast.Ui.addToLog("Received <code>"+c+"</code> event on button <code>"+m+"</code>","hid",f.productName);if(m===n){Blast.Interrupted=!0;var p=new Interpreter("");p.stateStack[0].scope=Blast.Interpreter.globalScope;
p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(r){Blast.throwError("Error executing program:\n "+e),console.error(r)}};q()}});Blast.cleanUpFunctions.push(function(){Blast.Ui.addToLog("Removing all listeners","hid",f.productName);g.close();g.removeAllListeners()});l.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);
var streamdeckColorButtons=function(a,b,c,d){var f,g,h,n,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),p.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),p.return();p.setCatchFinallyBlocks(2);return p.yield(StreamDeck.openDevice(f),4);case 4:g=p.yieldResult;
p.leaveTryBlock(3);break;case 2:h=p.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),d(),p.return();f.close();return p.yield(StreamDeck.openDevice(f),6);case 6:g=p.yieldResult;case 3:n=parseInt(c.substring(1,3),16),k=parseInt(c.substring(3,5),16),l=parseInt(c.substring(5,7),16),m=0;case 7:if(!(m<b.length)){p.jumpTo(9);break}if("1"!==b.charAt(m)){p.jumpTo(8);break}Blast.Ui.addToLog("Invoke <code>fillKeyColor</code> with value <code>"+[m,n,k,l].toString()+"</code>","hid",
f.productName);return p.yield(g.fillKeyColor(m,n,k,l),11);case 11:Blast.Ui.addToLog("Finished <code>fillKeyColor</code>","hid",f.productName);case 8:m++;p.jumpTo(7);break;case 9:d(),p.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckColorButtons",streamdeckColorButtons]);
...
b+c+d+f+g+h);return"streamdeckWriteOnButtons("+a+", "+b+", "+n+");\n"};
var streamdeckWriteOnButtons=function(a,b,c,d){var f,g,h,n,k,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),q.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(f),4);case 4:g=q.yieldResult;
q.leaveTryBlock(3);break;case 2:h=q.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),d(),q.return();f.close();return q.yield(StreamDeck.openDevice(f),6);case 6:g=q.yieldResult;case 3:n=[];k=document.createElement("canvas");k.width=g.ICON_SIZE;k.height=g.ICON_SIZE;l=k.getContext("2d");l.save();l.clearRect(0,0,k.width,k.height);l.font=.8*k.height+"px Arial";l.strokeStyle="blue";l.lineWidth=1;l.strokeText(c.toString(),8,60,.8*k.width);l.fillStyle="white";l.fillText(c.toString(),
8,60,.8*k.width);m=l.getImageData(0,0,k.width,k.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&(Blast.Ui.addToLog("Invoke <code>fillKeyImageData</code> with value <code>"+[p,m].toString()+"</code>","hid",f.productName),n.push(g.fillKeyBuffer(p,buffer.Buffer.from(m.data),{format:"rgba"})),Blast.Ui.addToLog("Finished <code>fillKeyImageData</code>","hid",f.productName));l.restore();return q.yield(Promise.all(n),7);case 7:d(),q.jumpToEnd()}})};
...
var streamdeckSetBrightness=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),c(),h.return();if(1>b||100<b)return Blast.throwError("Brightness must be between 1 and 100."),c(),h.return();d=Blast.Things.webHidDevices.get(a);if(!d)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),c(),h.return();h.setCatchFinallyBlocks(2);
return h.yield(StreamDeck.openDevice(d),4);case 4:f=h.yieldResult;h.leaveTryBlock(3);break;case 2:g=h.enterCatchBlock();if("InvalidStateError"!=g.name)return Blast.throwError(g),c(),h.return();d.close();return h.yield(StreamDeck.openDevice(d),6);case 6:f=h.yieldResult;case 3:return Blast.Ui.addToLog("Invoke <code>setBrightness</code> with value <code>"+b+"</code>","hid",d.productName),h.yield(f.setBrightness(b),7);case 7:Blast.Ui.addToLog("Finished <code>setBrightness</code>","hid",d.productName),
c(),h.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckSetBrightness",streamdeckSetBrightness]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
...
var webSpeech=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){c=Blast.workspace.getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";f="";d.onresult=function(h){for(var n=h.resultIndex;n<h.results.length;++n)h.results[n].isFinal&&(f+=h.results[n][0].transcript)};d.onend=function(){b(f)};d.start();g.jumpToEnd()})};Blast.asyncApiFunctions.push(["webSpeech",webSpeech]);
...
var readMijiaProperty=function(a,b,c){b?Blast.Bluetooth.gatt_subscribe(b,XiaomiServiceUUID,"ebe0ccc1-7a0a-4b0c-8a1a-6ff2997da3a6",function(d){var f=d.target.value,g=f.getUint8(1)&128;d=(f.getUint8(1)&127)<<8|f.getUint8(0);g&&(d-=32767);d/=100;f=f.getUint8(2);"temperature"===a?c(d):"humidity"===a&&c(f)}):(Blast.throwError("No Thermometer is set."),c())};Blast.asyncApiFunctions.push(["readMijiaProperty",readMijiaProperty]);
