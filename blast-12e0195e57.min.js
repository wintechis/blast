...
var switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){if(!a)return Blast.throwError("No LED Controller is set."),c(),h.return();d="7e000503"+b.substring(1,7)+"00ef";console.log(d);return h.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),2)}c();h.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.http_request={init:function(){this.appendValueInput("uri").appendField("send HTTP request to URI").setCheck("URI");this.appendDummyInput().appendField("output").appendField(new Blockly.FieldDropdown([["status","status"],["response","body"]]),"OUTPUT");this.appendDummyInput().appendField("method").appendField(new Blockly.FieldDropdown([["GET","GET"],["PUT","PUT"],["POST","POST"],["DELETE","DELETE"]],this.httpRequestValidator),"METHOD");this.appendDummyInput().appendField("headers (comma separated)");
...
"button4").appendField(new Blockly.FieldCheckbox("FALSE"),"button5").appendField(new Blockly.FieldCheckbox("FALSE"),"button6");this.setColour(0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setTooltip("");this.setHelpUrl("");this.requested=!1;this.keyState=Array(6).fill(!1)}};Blast.Toolbox.addBlock("streamdeck_color_buttons","Actions");Blockly.JavaScript.streamdeck_button_event=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,h="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,m="TRUE"==a.getFieldValue("button6")?1:0,p=Blockly.JavaScript.quote_(a.getFieldValue("upDown")),l=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+b+c+d+h+g+m);a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,
