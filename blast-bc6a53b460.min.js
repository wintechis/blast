...
" of device "+a);return h.yield(f.writeValueWithoutResponse(d),5);case 5:Blast.Ui.addToLog("Finished WriteValueWithoutResponse on characteristic "+f+" of device "+a);h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
...
f+" of device "+a);return h.yield(f.writeValueWithResponse(d),5);case 5:Blast.Ui.addToLog("Finished WriteValueWithResponse on characteristic "+f+" of device "+a);h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
