...
Blast.Bluetooth.Eddystone.getAdvertisingData=function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return b=function(g){var h=parseInt(g.substring(2,4));switch(g.substring(4,6)){case "00":var m="http://www.";break;case "01":m="https://www.";break;case "02":m="http://";break;case "03":m="https://";break;default:Blast.throwError("Eddystone URL scheme is not valid.");return}var k=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");
