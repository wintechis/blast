...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$54:f.$jscomp$loop$prop$type$54,$jscomp$loop$prop$name$55:f.$jscomp$loop$prop$name$55,$jscomp$loop$prop$block$56:f.$jscomp$loop$prop$block$56},h=b.next()){f.$jscomp$loop$prop$block$56=h.value;f.$jscomp$loop$prop$type$54=f.$jscomp$loop$prop$block$56.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$54||"things_webHID"==f.$jscomp$loop$prop$type$54){f.$jscomp$loop$prop$name$55=f.$jscomp$loop$prop$block$56.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$55))continue;h=document.createElement("tr");var g=document.createElement("td");g.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$55));var m=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$55);k.setAttribute("value","Pair");var l=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$55);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";l.appendChild(n);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
...
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));m.appendChild(k);h.appendChild(g);h.appendChild(m);h.appendChild(l);c.appendChild(h);d.push(f.$jscomp$loop$prop$name$55)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$58:f.$jscomp$loop$prop$type$58,$jscomp$loop$prop$name$59:f.$jscomp$loop$prop$name$59,$jscomp$loop$prop$block$60:f.$jscomp$loop$prop$block$60},h=b.next())if(f.$jscomp$loop$prop$block$60=h.value,f.$jscomp$loop$prop$type$58=f.$jscomp$loop$prop$block$60.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$58||"things_webHID"==f.$jscomp$loop$prop$type$58)if(f.$jscomp$loop$prop$name$59=f.$jscomp$loop$prop$block$60.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$59)){h=document.createElement("li");h.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$59);h.setAttribute("class","mdc-list-item");var g=document.createElement("span");g.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$59);g.setAttribute("class","mdc-list-item__graphic material-icons");
g.setAttribute("aria-hidden","true");g.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$58?"bluetooth_disabled":"usb_off";h.appendChild(g);g=document.createElement("span");g.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$59;g.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$59);
...
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(h);d.push(f.$jscomp$loop$prop$name$59)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
