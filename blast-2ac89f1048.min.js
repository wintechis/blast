...
f),module$contents$Blast$Interpreter_getWorkspace().refreshToolboxSelection(),h.return(d);g=h.enterCatchBlock();module$contents$Blast$Interpreter_throwError(g);h.jumpToEnd()})};Blast.Bluetooth.requestDevice=module$contents$Blast$Bluetooth_requestDevice;
...
{}}module$contents$Blast$Bluetooth_LEScanResults={}};module$contents$Blast$Interpreter_addCleanUpFunction(module$contents$Blast$Bluetooth_tearDown);Blast.Things={};var module$contents$Blast$Things_webBluetoothDevices=new Map,module$contents$Blast$Things_webHidNames=new Map,module$contents$Blast$Things_webHidDevices=new Map,module$contents$Blast$Things_thingsLog=function(a,b,c){console.log({adapter:b},{device:c},a)},module$contents$Blast$Things_getThingsLog=function(){return module$contents$Blast$Things_thingsLog};Blast.Things.getThingsLog=module$contents$Blast$Things_getThingsLog;
var module$contents$Blast$Things_setThingsLog=function(a){module$contents$Blast$Things_thingsLog=a};Blast.Things.setThingsLog=module$contents$Blast$Things_setThingsLog;var module$contents$Blast$Things_resetThings=function(){module$contents$Blast$Things_webBluetoothDevices.clear();module$contents$Blast$Things_webHidNames.clear();module$contents$Blast$Things_webHidDevices.clear()};Blast.Things.resetThings=module$contents$Blast$Things_resetThings;var module$contents$Blast$Things_getWebHidDevice=function(a){return module$contents$Blast$Things_webHidDevices.get(a)};
Blast.Things.getWebHidDevice=module$contents$Blast$Things_getWebHidDevice;
var module$contents$Blast$Things_flyoutCategory=function(a){var b=[],c=document.createElement("label");c.setAttribute("text","WebBluetooth Blocks");b.push(c);c=document.createElement("button");c.setAttribute("text","pair via webBluetooth");c.setAttribute("callbackKey","CREATE_WEBBLUETOOTH");a.registerButtonCallback("CREATE_WEBBLUETOOTH",function(g){module$contents$Blast$Things_createWebBluetoothButtonHandler()});b.push(c);c=module$contents$Blast$Things_flyoutCategoryBlocksWB(a);b=b.concat(c);c=document.createElement("label");
...
var module$contents$Blast$Things_createWebBluetoothButtonHandler=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){module$contents$Blast$Bluetooth_requestDevice();a.jumpToEnd()})},module$contents$Blast$Things_addWebBluetoothDevice=function(a,b){var c=function(d,f){Blockly.Variables.promptName("Pair successful! Now give your device a name.",d,function(g){if(g)if(module$contents$Blast$Things_webBluetoothDevices.has(g)){var h="Name %1 already exists".replace("%1",g);Blockly.alert(h,
function(){c(g,f)})}else module$contents$Blast$Things_webBluetoothDevices.set(g,f);else Blockly.alert("Name cannot be empty",function(){c(g,f)})})};c(b,a)};Blast.Things.addWebBluetoothDevice=module$contents$Blast$Things_addWebBluetoothDevice;
...
module$contents$Blast$Interpreter_apiFunctions.push(["highlightBlock",module$contents$Blast_highlightBlock]);window.addEventListener("load",module$contents$Blast_init);Blast.Bluetooth.Eddystone={};
...
PUBLIC_ECDH_KEY_CHARACTERISTIC:"a3c87508-8ed3-4bdf-8a39-a01bebede295",EID_IDENTITY_KEY_CHARACTERISTIC:"a3c87509-8ed3-4bdf-8a39-a01bebede295",ADV_SLOT_DATA_CHARACTERISTIC:"a3c8750a-8ed3-4bdf-8a39-a01bebede295",FACTORY_RESET_CHARACTERISTIC:"a3c8750b-8ed3-4bdf-8a39-a01bebede295",REMAIN_CONNECTABLE_CHARACTERISTIC:"a3c8750c-8ed3-4bdf-8a39-a01bebede295"};module$contents$Blast$Bluetooth_optionalServices.push(Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE);
Blast.Bluetooth.Eddystone.getCapabilities=function(a){var b,c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone capabilities...","Eddystone",a),k.yield(module$contents$Blast$Bluetooth_gatt_read(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.CAPABILITIES_CHARACTERISTIC),2);c=k.yieldResult;c=new Int8Array(c.buffer);d=[];for(f=6;f<c.length&&!((g=d[d.length-
1])&&g>=c[f]);f++)d.push(c[f]);h={specVersion:c[0],maxSlots:c[1],maxEidPerSlot:c[2],isVarriableAdvIntervalSupported:0!==(c[3]&1),isVariableTxPowerSupported:0!==(c[3]&2),isUIDSupported:0!==(c[5]&1),isURLSupported:0!==(c[5]&2),isTLMSupported:0!==(c[5]&4),isEIDSupported:0!==(c[5]&8),supportedTxPowerLevels:d};b("Eddystone capabilities: <code>"+JSON.stringify(h)+"</code>","Eddystone",a);return k.return(h)})};
Blast.Bluetooth.Eddystone.getActiveSlot=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone active slot...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone active slot: <code>"+c+"</code>","Eddystone",a);return d.return(c)})};
Blast.Bluetooth.Eddystone.setActiveSlot=function(a,b){var c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone active slot to <code>"+b+"</code>...","Eddystone",a),f.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2);if(3!=f.nextAddress)return d=f.yieldResult,(0>b||b>=d.maxSlots)&&module$contents$Blast$Interpreter_throwError("Eddystone slot is not valid.\n         On this device the slot must be between 0 and "+
(d.maxSlots-1)+"."),f.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC,b.toString(16)),3);c("Eddystone active slot set to <code>"+b+"</code>","Eddystone",a);return f.return()})};
Blast.Bluetooth.Eddystone.getAdvertisingInterval=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertising interval...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone advertising interval: <code>"+
c+"</code>","Eddystone",a);return d.return(c)})};
Blast.Bluetooth.Eddystone.setAdvertisingInterval=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone advertising interval to <code>"+b+"</code>...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC,b.toString(16)),2);c("Eddystone advertising interval set to <code>"+
b+"</code>","Eddystone",a);return d.return()})};
Blast.Bluetooth.Eddystone.getTxPowerLevel=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone TX power level...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.RADIO_TX_POWER_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone TX power level: <code>"+c+"</code>","Eddystone",
a);return d.return(c)})};
Blast.Bluetooth.Eddystone.setTxPowerLevel=function(a,b){var c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone TX power level to <code>"+b+"</code>...","Eddystone",a),f.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2);if(3!=f.nextAddress)return d=f.yieldResult,-1===d.supportedTxPowerLevels.indexOf(b)?(module$contents$Blast$Interpreter_throwError("Eddystone TX power level is not valid.\n         On this device the TX power level must be one of "+d.supportedTxPowerLevels+
"."),f.return()):f.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.RADIO_TX_POWER_CHARACTERISTIC,b.toString(16)),3);c("Eddystone TX power level set to <code>"+b+"</code>","Eddystone",a);return f.return()})};
Blast.Bluetooth.Eddystone.getAdvertisedTxPower=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertised TX power...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone advertised TX power: <code>"+
c+"</code>","Eddystone",a);return d.return(c)})};
Blast.Bluetooth.Eddystone.setAdvertisedTxPower=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone advertised TX power to <code>"+b+"</code>...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC,b.toString(16)),2);c("Eddystone advertised TX power set to <code>"+
b+"</code>","Eddystone",a);return d.return()})};
Blast.Bluetooth.Eddystone.getLockState=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone lock state...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.LOCK_STATE_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone lock state: <code>"+c+"</code>","Eddystone",a);return d.return(c)})};
Blast.Bluetooth.Eddystone.getPublicECDHKey=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone public ECDH key...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.PUBLIC_ECDH_KEY_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone public ECDH key: <code>"+c+"</code>","Eddystone",
a);return d.return(c)})};
...
parseInt(l.substring(4,8),16),p=parseInt(l.substring(8,10),16)+parseInt(l.substring(10,12),16)/100,q=parseInt(l.substring(12,20),16);l=parseInt(l.substring(20,28),16);return{frameType:"TLM",batteryVoltage:n,beaconTemperature:p,pduCount:q,timeSinceReboot:l}},m.yield(module$contents$Blast$Bluetooth_gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);g=m.yieldResult;b("Got Eddystone advertising data: <code>"+g+"</code>","Eddystone",
a);h=g.substring(0,2);switch(h){case "00":return k=c(g),m.return(k.namespace+k.instance);case "10":return k=d(g),m.return(k.url);case "20":return k=f(g),m.return(k.beaconTemperature);case "30":return module$contents$Blast$Interpreter_throwError("EID frame type is not supported by blast."),m.return();default:return module$contents$Blast$Interpreter_throwError("Eddystone frame type is not valid."),m.return()}})};
Blast.Bluetooth.Eddystone.setAdvertisingData=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress){d=module$contents$Blast$Things_getThingsLog();d("Set Eddystone advertising data...","Eddystone",a);f=function(m){for(var l=["http://www.","https://www.","http://","https://"],n=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),p=[],q=0,r=new TextEncoder("utf-8"),t=0;t<l.length;t++)if(m.startsWith(l[t])){p.push(t);
...
var module$contents$Blast$generators$blast_writeEddystoneProperty=function(a,b,c,d,f,g){return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return a?null===b||void 0===b?(module$contents$Blast$Interpreter_throwError("No slot set."),g(),h.return()):c?h.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(module$contents$Blast$Interpreter_throwError("No property set."),g(),h.return()):(module$contents$Blast$Interpreter_throwError("No bluetooth device set."),
g(),h.return());case 2:switch(c){case "advertisedTxPower":return h.jumpTo(3);case "advertisementData":return h.jumpTo(4);case "advertisingInterval":return h.jumpTo(5);case "radioTxPower":return h.jumpTo(6)}h.jumpTo(7);break;case 3:return h.yield(Blast.Bluetooth.Eddystone.setAdvertisedTxPower(a,f),8);case 8:h.jumpTo(7);break;case 4:return h.yield(Blast.Bluetooth.Eddystone.setAdvertisingData(a,d,f),9);case 9:h.jumpTo(7);break;case 5:return h.yield(Blast.Bluetooth.Eddystone.setAdvertisingInterval(a,
f),10);case 10:h.jumpTo(7);break;case 6:return h.yield(Blast.Bluetooth.Eddystone.setTxPowerLevel(a,f),11);case 11:h.jumpTo(7);break;case 7:g(),h.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["writeEddystoneProperty",module$contents$Blast$generators$blast_writeEddystoneProperty]);
...
var module$contents$Blast$generators$blast_readEddystoneProperty=function(a,b,c,d){var f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return a?null===b||void 0===b?(module$contents$Blast$Interpreter_throwError("No slot set."),d(),g.return()):c?g.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(module$contents$Blast$Interpreter_throwError("No property set."),d(),g.return()):(module$contents$Blast$Interpreter_throwError("No bluetooth device set."),
d(),g.return());case 2:f=null;switch(c){case "advertisedTxPower":return g.jumpTo(3);case "advertisementData":return g.jumpTo(4);case "advertisingInterval":return g.jumpTo(5);case "lockState":return g.jumpTo(6);case "publicECDHKey":return g.jumpTo(7);case "radioTxPower":return g.jumpTo(8)}g.jumpTo(9);break;case 3:return g.yield(Blast.Bluetooth.Eddystone.getAdvertisedTxPower(a),10);case 10:f=g.yieldResult;g.jumpTo(9);break;case 4:return g.yield(Blast.Bluetooth.Eddystone.getAdvertisingData(a),11);case 11:f=
g.yieldResult;g.jumpTo(9);break;case 5:return g.yield(Blast.Bluetooth.Eddystone.getAdvertisingInterval(a),12);case 12:f=g.yieldResult;g.jumpTo(9);break;case 6:return g.yield(Blast.Bluetooth.Eddystone.getLockState(a),13);case 13:f=g.yieldResult;g.jumpTo(9);break;case 7:return g.yield(Blast.Bluetooth.Eddystone.getPublicECDHKey(a),14);case 14:f=g.yieldResult;g.jumpTo(9);break;case 8:return g.yield(Blast.Bluetooth.Eddystone.getTxPowerLevel(a),15);case 15:f=g.yieldResult;g.jumpTo(9);break;case 9:d(f),
g.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readEddystoneProperty",module$contents$Blast$generators$blast_readEddystoneProperty]);var module$exports$Blast$blocks$blinkstick={};
...
13);case 13:k("Adding <code>hidinput</code> event listener","hid",f.productName),g.addEventListener("hidinput",m),g.eventListenerAttached=!0,l.jumpToEnd()}})};module$contents$Blast$Interpreter_apiFunctions.push(["handleJoyConButtons",handleJoyConButtons]);var module$exports$Blast$blocks$ble_rgb_led_controller={};
