...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$63:f.$jscomp$loop$prop$type$63,$jscomp$loop$prop$name$64:f.$jscomp$loop$prop$name$64,$jscomp$loop$prop$block$65:f.$jscomp$loop$prop$block$65},h=b.next()){f.$jscomp$loop$prop$block$65=h.value;f.$jscomp$loop$prop$type$63=f.$jscomp$loop$prop$block$65.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$63||"things_webHID"==f.$jscomp$loop$prop$type$63){f.$jscomp$loop$prop$name$64=f.$jscomp$loop$prop$block$65.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$64))continue;h=document.createElement("tr");var g=document.createElement("td");g.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$64));var m=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
...
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));m.appendChild(k);h.appendChild(g);h.appendChild(m);h.appendChild(l);c.appendChild(h);d.push(f.$jscomp$loop$prop$name$64)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$67:f.$jscomp$loop$prop$type$67,$jscomp$loop$prop$name$68:f.$jscomp$loop$prop$name$68,$jscomp$loop$prop$block$69:f.$jscomp$loop$prop$block$69},h=b.next())if(f.$jscomp$loop$prop$block$69=h.value,f.$jscomp$loop$prop$type$67=f.$jscomp$loop$prop$block$69.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$67||"things_webHID"==f.$jscomp$loop$prop$type$67)if(f.$jscomp$loop$prop$name$68=f.$jscomp$loop$prop$block$69.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$68)){h=document.createElement("li");h.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$68);h.setAttribute("class","mdc-list-item");var g=document.createElement("span");g.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$68);g.setAttribute("class","mdc-list-item__graphic material-icons");
g.setAttribute("aria-hidden","true");g.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$67?"bluetooth_disabled":"usb_off";h.appendChild(g);g=document.createElement("span");g.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$68;g.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$68);
...
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(h);d.push(f.$jscomp$loop$prop$name$68)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Bluetooth.requestDevice=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){if(!navigator.bluetooth)return h.jumpTo(0);a||(a={acceptAllDevices:!0},a.optionalServices=Blast.Bluetooth.optionalServices);h.setCatchFinallyBlocks(3);return h.yield(navigator.bluetooth.requestDevice(a),5)}if(3!=h.nextAddress)return c=h.yieldResult,d=b||c.name,Blast.Things.addWebBluetoothDevice(c.id,d),Blast.workspace.refreshToolboxSelection(),h.return(c);f=h.enterCatchBlock();
Blast.throwError(f);h.jumpToEnd()})};Blast.Bluetooth.getDeviceById=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(navigator.bluetooth.getDevices(),2);b=h.yieldResult;c=$jscomp.makeIterator(b);for(d=c.next();!d.done;d=c.next())if(f=d.value,f.id==a)return h.return(f);Blast.throwError("Bluetooth device "+a+" wasn't found in paired devices.");h.jumpToEnd()})};
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function f(m){m=m.replace(/^0x/,"");0!=m.length%2&&(m="0"+m);var k=m.match(/[G-Z\s]/i);k&&console.log("WARNING: found non-hex characters",k);m=m.match(/[\dA-F]{2}/gi).map(function(l){return parseInt(l,16)});return(new Uint8Array(m)).buffer}var h,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:return m.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:h=m.yieldResult;if(!h)return m.return();
d=f(d);m.setCatchFinallyBlocks(3);return m.yield(h.writeValueWithoutResponse(d),5);case 5:m.leaveTryBlock(0);break;case 3:g=m.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),m.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.connect(a),2);case 2:return c=h.yieldResult,h.setCatchFinallyBlocks(3),h.yield(c.getPrimaryService(b),5);case 5:d=h.yieldResult;h.leaveTryBlock(4);break;case 3:f=h.enterCatchBlock(),console.error(f),Blast.throwError("The device is not compatible with the connected block.");case 4:return h.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=g.yieldResult;if(!d)return g.return();g.setCatchFinallyBlocks(3);return g.yield(d.getCharacteristic(c),5);case 5:f=g.yieldResult;g.leaveTryBlock(4);break;case 3:h=g.enterCatchBlock(),console.error(h),Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(f)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return d=Blast.Bluetooth.getCharacteristic(a,b,c),h.setCatchFinallyBlocks(2),h.yield(d.readValue(),4);if(2!=h.nextAddress)return h.return(h.yieldResult);f=h.enterCatchBlock();console.error(f);Blast.throwError("Error reading from Bluetooth device "+a);h.jumpToEnd()})};
Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=h.yieldResult;f=(new TextDecoder).decode(d);return h.return(f)})};Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=h.yieldResult;f=(new DataView(d)).getUint8(0);return h.return(f)})};
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return h.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=h.yieldResult;f=(new Uint8Array(d)).reduce(function(g,m){return g+("0"+m.toString(16)).slice(-2)},"");return h.return(f)})};
Blast.Bluetooth.gatt_subscribe=function(a,b,c,d){var f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return f=g.yieldResult,f.addEventListener("characteristicvaluechanged",d),Blast.Bluetooth.charEventListeners[c]=[f,"characteristicvaluechanged",d],g.setCatchFinallyBlocks(3),g.yield(f.startNotifications(),5);case 5:g.leaveTryBlock(0);break;case 3:h=g.enterCatchBlock(),console.error(h),
Blast.throwError("Error subscribing to Bluetooth device "+a),g.jumpToEnd()}})};
...
var switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(!a)return Blast.throwError("No LED Controller is set."),c(),f.return();d="7e000503"+b.substring(1,7)+"00ef";console.log(d);return f.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),2)}c();f.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.blinkstick_set_colors={init:function(){this.appendValueInput("COLOUR").setCheck("Colour").appendField("write colour property");this.appendValueInput("index").setCheck("Number").appendField("of LED #");this.appendValueInput("thing").setCheck("Thing").appendField("to BlinkStick");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Set the color properties of a tulogic BlinkStick.");this.setHelpUrl("https://www.blinkstick.com/")}};
...
var sendHttpRequest=function(a,b,c,d,f,h){var g,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");g=JSON.parse(c);m={method:b,headers:new Headers(g)};d&&(m.body=d);fetch(a,m).then(Blast.handleFetchErrors).then(function(l){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"status"==f&&h(l.status),p.yield(l.text(),2);n=p.yieldResult;h(n);p.jumpToEnd()})}).catch(function(l){Blast.throwError(l.message+
...
var urdfQueryWrapper=function(a,b,c,d){var f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){fetch(a).then(Blast.handleFetchErrors).then(function(g){var m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(g.text(),2);case 2:return f=l.yieldResult,urdf.clear(),m={format:b},l.yield(urdf.load(f,m),3);case 3:return l.yield(urdf.query(c),4);case 4:k=l.yieldResult,d(k),l.jumpToEnd()}})}).catch(function(g){Blast.throwError(g.message+
"\nSee console for details.")});h.jumpToEnd()})};Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var displayText=function(a){Blast.Ui.addMessage(a)};Blast.apiFunctions.push(["displayText",displayText]);
...
break;case 2:g=l.enterCatchBlock();if("InvalidStateError"!=g.name)return Blast.throwError(g),l.return();f.close();return l.yield(StreamDeck.openDevice(f),6);case 6:h=l.yieldResult;case 3:for(k=0;k<b.length;k++)if("1"===b.charAt(k)){m=k;break}if(void 0===m)return l.return();h.on(c,function(n){if(n===m){Blast.Interrupted=!0;var p=new Interpreter("");p.stateStack[0].scope=Blast.Interpreter.globalScope;p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(r){Blast.throwError("Error executing program:\n "+
e),console.error(r)}};q()}});Blast.cleanUpFunctions.push(function(){h.close();h.removeAllListeners()});l.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);
...
8,60,.8*k.width);n=l.getImageData(0,0,k.width,k.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&m.push(h.fillKeyBuffer(p,buffer.Buffer.from(n.data),{format:"rgba"}));l.restore();return q.yield(Promise.all(m),7);case 7:d(),q.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckWriteOnButtons",streamdeckWriteOnButtons]);
