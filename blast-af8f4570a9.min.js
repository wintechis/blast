...
if("things_webBluetooth"==f.$jscomp$loop$prop$type$74||"things_webHID"==f.$jscomp$loop$prop$type$74){f.$jscomp$loop$prop$name$75=f.$jscomp$loop$prop$block$76.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$75))continue;h=document.createElement("tr");var g=document.createElement("td");g.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$75));var n=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$75);k.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$75);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
...
g.setAttribute("aria-hidden","true");g.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$78?"bluetooth_disabled":"usb_off";h.appendChild(g);g=document.createElement("span");g.setAttribute("class","mdc-list-item__text");var n=document.createElement("span");n.setAttribute("class","mdc-list-item__primary-text");n.innerHTML=f.$jscomp$loop$prop$name$79;g.appendChild(n);n=document.createElement("span");n.setAttribute("class","mdc-list-item__secondary-text");n.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$79);
...
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$79).style.color="#0d30b1";k.$jscomp$loop$prop$block$80.firstElementChild.textContent=m.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
