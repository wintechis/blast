...
var switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){if(!a)return Blast.throwError("No LED Controller is set."),c(),h.return();d="7e000503"+b.substring(1,7)+"00ef";console.log(d);return h.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),2)}c();h.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.blinkstick_set_colors={init:function(){this.appendValueInput("index").setCheck("Number").appendField("write colour property of LED");this.appendValueInput("COLOUR").setCheck("Colour");this.appendValueInput("thing").setCheck("Thing").appendField("to BlinkStick");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Set the color properties of a tulogic BlinkStick.");this.setHelpUrl("https://www.blinkstick.com/")}};
...
b);m=[];for(p=0;p<g.byteLength;p++)m.push("0x"+("00"+g.getUint8(p).toString(16)).slice(-2));l=d(m);c(l[a]);n.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);
