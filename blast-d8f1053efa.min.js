...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$66:f.$jscomp$loop$prop$type$66,$jscomp$loop$prop$name$67:f.$jscomp$loop$prop$name$67,$jscomp$loop$prop$block$68:f.$jscomp$loop$prop$block$68},g=b.next()){f.$jscomp$loop$prop$block$68=g.value;f.$jscomp$loop$prop$type$66=f.$jscomp$loop$prop$block$68.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$66||"things_webHID"==f.$jscomp$loop$prop$type$66){f.$jscomp$loop$prop$name$67=f.$jscomp$loop$prop$block$68.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$67))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$67));var m=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$67);k.setAttribute("value","Pair");var l=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$67);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";l.appendChild(n);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
p.$jscomp$loop$prop$type$66?("things_webHID"==p.$jscomp$loop$prop$type$66&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(u){0===u.length&&Blast.throwError("Connection failed or cancelled by User.");var v=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(v,u[0]);Blast.Things.addWebHidDevice(v,p.$jscomp$loop$prop$name$67);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$67).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
p.$jscomp$loop$prop$name$67).style.color="green";p.$jscomp$loop$prop$block$68.firstElementChild.textContent=v;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(u){Blast.throwError("Connection failed or cancelled by User.");
console.error(u)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$67).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$67).style.color="green";p.$jscomp$loop$prop$block$68.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));m.appendChild(k);g.appendChild(h);g.appendChild(m);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$67)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$70:f.$jscomp$loop$prop$type$70,$jscomp$loop$prop$name$71:f.$jscomp$loop$prop$name$71,$jscomp$loop$prop$block$72:f.$jscomp$loop$prop$block$72},g=b.next())if(f.$jscomp$loop$prop$block$72=g.value,f.$jscomp$loop$prop$type$70=f.$jscomp$loop$prop$block$72.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$70||"things_webHID"==f.$jscomp$loop$prop$type$70)if(f.$jscomp$loop$prop$name$71=f.$jscomp$loop$prop$block$72.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$71)){g=document.createElement("li");g.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$71);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$71);h.setAttribute("class","mdc-list-item__graphic material-icons");
h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$70?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$71;h.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$71);
m.innerHTML="disconnected";h.appendChild(m);g.appendChild(h);g.addEventListener("click",function(k){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$70?("things_webHID"==k.$jscomp$loop$prop$type$70&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$71);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$71).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$71).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$71).style.color="#0d30b1";k.$jscomp$loop$prop$block$72.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;Blast.Things.addWebBluetoothDevice(n.id,k.$jscomp$loop$prop$name$71);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$71).innerHTML=
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$71).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$71).style.color="#0d30b1";k.$jscomp$loop$prop$block$72.firstElementChild.textContent=n.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$71)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=h.yieldResult;if(!f)return h.return();"string"===typeof d&&(d=hexStringToArrayBuffer(d));h.setCatchFinallyBlocks(3);return h.yield(f.writeValueWithoutResponse(d),5);case 5:h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),
h.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithResponse=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=h.yieldResult;if(!f)return h.return();"string"===typeof d&&(d=hexStringToArrayBuffer(d));h.setCatchFinallyBlocks(3);return h.yield(f.writeValueWithResponse(d),5);case 5:h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a),2);case 2:return c=g.yieldResult,g.setCatchFinallyBlocks(3),g.yield(c.getPrimaryService(b),5);case 5:d=g.yieldResult;g.leaveTryBlock(4);break;case 3:f=g.enterCatchBlock(),console.error(f),Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=h.yieldResult;if(!d)return h.return();h.setCatchFinallyBlocks(3);return h.yield(d.getCharacteristic(c),5);case 5:f=h.yieldResult;h.leaveTryBlock(4);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("The device is not compatible with the connected block.");case 4:return h.return(f)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return d=g.yieldResult,g.setCatchFinallyBlocks(3),g.yield(d.readValue(),5);case 5:return g.return(g.yieldResult);case 3:f=g.enterCatchBlock(),console.error(f),Blast.throwError("Error reading from Bluetooth device "+a),g.jumpToEnd()}})};
Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;f=(new TextDecoder).decode(d);return g.return(f)})};
...
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;console.log(d);f=(new Uint8Array(d.buffer)).reduce(function(h,m){return h+("0"+m.toString(16)).slice(-2)},"");return g.return(f)})};
Blast.Bluetooth.gatt_subscribe=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return f=h.yieldResult,f.addEventListener("characteristicvaluechanged",d),Blast.Bluetooth.charEventListeners[c]=[f,"characteristicvaluechanged",d],h.setCatchFinallyBlocks(3),h.yield(f.startNotifications(),5);case 5:h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),
Blast.throwError("Error subscribing to Bluetooth device "+a),h.jumpToEnd()}})};
...
Blast.Bluetooth.Eddystone.getEidIdentityKey=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.EID_IDENTITY_KEY_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.getAdvertisingData=function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return b=function(g){console.log(g);var h=parseInt(g.substring(2,4));switch(g.substring(4,6)){case "00":var m="http://www.";break;case "01":m="https://www.";break;case "02":m="http://";break;case "03":m="https://";break;default:Blast.throwError("Eddystone URL scheme is not valid.");return}var k=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");
g=g.substring(6,g.length);for(var l=0;l<g.length;l+=2){var n=parseInt(g.substring(l,l+2),16);m=n<k.length?m+k[n]:m+String.fromCharCode(n)}return{frameType:"URL",txPower:h,url:m}},f.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);c=f.yieldResult;d=c.substring(0,2);return"10"!==d?(Blast.throwError("Currently Blast only supports the Eddystone URL frame type."),f.return()):f.return(b(c).url)})};
...
(this.firstTime=!1,navigator.bluetooth||(Blockly.alert("Webbluetooth is not supported by this browser.\n\n        Upgrade to Chrome version 85 or later and enable Experimental Web Platform features."),this.dispose()))}};var SWITCH_LIGHTS_RGB_XML='\n<block type="switch_lights_rgb">\n  <value name="colour">\n    <block type="colour_picker">\n      <field name="COLOUR">#ff0000</field>\n    </block>\n  </value>\n</block>';Blast.Toolbox.addBlock("switch_lights_rgb","Properties",SWITCH_LIGHTS_RGB_XML);Blockly.JavaScript.switch_lights_rgb=function(a){var b=Blockly.JavaScript.valueToCode(a,"colour",Blockly.JavaScript.ORDER_ATOMIC)||Blockly.JavaScript.quote_("#000000");return"switchLights("+(Blockly.JavaScript.valueToCode(a,"thing",Blockly.JavaScript.ORDER_NONE)||"null")+", "+b+");\n"};var LEDServiceUUID="0000fff0-0000-1000-8000-00805f9b34fb";Blast.Bluetooth.optionalServices.push(LEDServiceUUID);
var switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(!a)return Blast.throwError("No LED Controller is set."),c(),f.return();d="7e000503"+b.substring(1,7)+"00ef";console.log(d);return f.yield(Blast.Bluetooth.gatt_writeWithoutResponse(a,LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",d),2)}c();f.jumpToEnd()})};Blast.asyncApiFunctions.push(["switchLights",switchLights]);Blockly.Blocks.http_request={init:function(){this.appendValueInput("uri").appendField("send HTTP request to URI").setCheck("URI");this.appendDummyInput().appendField("output").appendField(new Blockly.FieldDropdown([["status","status"],["response","body"]]),"OUTPUT");this.appendDummyInput().appendField("method").appendField(new Blockly.FieldDropdown([["GET","GET"],["PUT","PUT"],["POST","POST"],["DELETE","DELETE"]],this.httpRequestValidator),"METHOD");this.appendDummyInput().appendField("headers (comma separated)");
this.appendDummyInput().appendField(new Blockly.FieldTextInput('"Content-Type": "application/json", "Accept": "application/json"'),"HEADERS");this.setOutput(!0,"String");this.setTooltip("Invokes a HTTP request.");this.setColour(0)},httpRequestValidator:function(a){this.getSourceBlock().updateInputs(a);return a},updateInputs:function(a){this.removeInput("BODYINPUT",!0);"GET"!=a&&this.appendDummyInput("BODYINPUT").appendField("body").appendField(new Blockly.FieldMultilineInput('{\n     "object": {\n       "a": "b",\n       "c": "d",\n       "e": "f"\n     },\n     "array": [\n       1,\n       2\n     ],\n     "string": "Hello World"\n     }'),
"BODY")}};Blast.Toolbox.addBlock("http_request","Requests and Queries");
Blockly.Blocks.sparql_query={init:function(){this.appendValueInput("uri").appendField("run SPARQL Query from URI").setCheck("URI");this.appendDummyInput().appendField("Resource format").appendField(new Blockly.FieldDropdown([["JSON-LD","application/ld+json"],["Turtle (TriG)","application/trig"],["N-Quads","application/n-quads"]]),"format");this.appendDummyInput().appendField(new Blockly.FieldMultilineInput("SELECT *\n       WHERE { \n         ?s ?p ?o\n       }"),"query");this.setInputsInline(!1);
this.setColour(0);this.setOutput(!0,"table");this.setTooltip("Executes a sparql query")}};Blast.Toolbox.addBlock("sparql_query","Requests and Queries");
...
Blockly.Blocks.read_eddystone_property={init:function(){this.appendDummyInput("Property").appendField("read").appendField(new Blockly.FieldDropdown([["advertised tx power","advertisedTxPower"],["advertisement data","advertisementData"],["advertising interval","advertisingInterval"],["lock state","lockState"],["public ECDH key","publicECDHKey"],["EID identity key","eidIdentityKey"],["radio tx power","radioTxPower"]]),"Property").appendField("property");this.appendValueInput("Slot").setCheck("Number").appendField("at slot");
this.appendValueInput("Thing").appendField("of eddystone device").setCheck("Thing");this.setOutput(!0,["String","Number"]);this.setColour(255);this.setInputsInline(!0);this.setTooltip("Reads a property from an eddystone device.");this.setHelpUrl("https://github.com/google/eddystone/tree/master/configuration-service")}};var READ_EDDYSTONE_PROPERTY_XML='\n<block type="read_eddystone_property">\n  <value name="Slot">\n    <block type="math_number">\n      <field name="NUM">1</field>\n    </block>\n  </value>\n</block>';
Blast.Toolbox.addBlock("read_eddystone_property","Properties",READ_EDDYSTONE_PROPERTY_XML);Blockly.JavaScript.http_request=function(a){var b=Blockly.JavaScript.valueToCode(a,"uri",Blockly.JavaScript.ORDER_NONE)||null,c=a.getFieldValue("METHOD"),d=a.getFieldValue("HEADERS"),f=a.getFieldValue("OUTPUT");a=JSON.stringify(a.getFieldValue("BODY"))||null;return["sendHttpRequest("+b+",'"+c+"', \n      '{"+d+"}', "+a+", '"+f+"')\n",Blockly.JavaScript.ORDER_NONE]};
var sendHttpRequest=function(a,b,c,d,f,g){var h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");h=JSON.parse(c);m={method:b,headers:new Headers(h)};d&&(m.body=d);fetch(a,m).then(Blast.handleFetchErrors).then(function(l){var n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"status"==f&&g(l.status),p.yield(l.text(),2);n=p.yieldResult;g(n);p.jumpToEnd()})}).catch(function(l){Blast.throwError(l.message+
"\nSee console for details.")});k.jumpToEnd()})};Blast.asyncApiFunctions.push(["sendHttpRequest",sendHttpRequest]);Blockly.JavaScript.sparql_query=function(a){var b=a.getFieldValue("query"),c=Blockly.JavaScript.valueToCode(a,"uri",Blockly.JavaScript.ORDER_NONE);a=Blockly.JavaScript.quote_(a.getFieldValue("format"))||"";b=b.replace(/"/g,'\\"').replace(/[\n\r]/g," ");return["urdfQueryWrapper("+c+", "+a+", '"+b+"')",Blockly.JavaScript.ORDER_NONE]};
Blockly.JavaScript.sparql_ask=function(a){var b=a.getFieldValue("query"),c=Blockly.JavaScript.quote_(a.getFieldValue("format"))||"";a=Blockly.JavaScript.valueToCode(a,"uri",Blockly.JavaScript.ORDER_NONE);b=b.replace(/"/g,'\\"').replace(/[\n\r]/g," ");return["urdfQueryWrapper("+a+", "+c+", '"+b+"'')",Blockly.JavaScript.ORDER_NONE]};
var urdfQueryWrapper=function(a,b,c,d){var f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){fetch(a).then(Blast.handleFetchErrors).then(function(h){var m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(h.text(),2);case 2:return f=l.yieldResult,urdf.clear(),m={format:b},l.yield(urdf.load(f,m),3);case 3:return l.yield(urdf.query(c),4);case 4:k=l.yieldResult,d(k),l.jumpToEnd()}})}).catch(function(h){Blast.throwError(h.message+
"\nSee console for details.")});g.jumpToEnd()})};Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var displayText=function(a){Blast.Ui.addMessage(a)};Blast.apiFunctions.push(["displayText",displayText]);
Blockly.JavaScript.display_table=function(a){return"displayTable("+Blockly.JavaScript.valueToCode(a,"table",Blockly.JavaScript.ORDER_NONE)+");\n"};
var displayTable=function(a){if(0==a.length)Blast.Ui.addMessage("empty table");else{var b=a.reduce(function(d,f){for(var g in f)-1===d.indexOf(g)&&d.push(g);return d},[]),c="<tr>";b.forEach(function(d){return c+="<th>"+d+"</th>"});c+="</tr>";a.forEach(function(d){c+="<tr>";b.forEach(function(f){return c+="<td>"+(d[f]?d[f].value:"")+"</td>"});c+="</tr>"});a=document.createElement("table");a.classList.add("output_table");a.innerHTML=c;Blast.Ui.addElementToOutputContainer(a)}};
Blast.apiFunctions.push(["displayTable",displayTable]);Blockly.JavaScript.play_audio=function(a){return"playAudio("+Blockly.JavaScript.valueToCode(a,"URI",Blockly.JavaScript.ORDER_NONE)+");\n"};
var playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,f){var g=new Audio(a);g.preload="auto";g.autoplay=!0;g.onerror=function(h){Blast.throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(h);f(h)};g.onended=d}),2);b();c.jumpToEnd()})};Blast.asyncApiFunctions.push(["playAudio",playAudio]);
...
var writeEddystoneProperty=function(a,b,c,d,f){return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return a?b?c?g.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(Blast.throwError("No property set."),f(),g.return()):(Blast.throwError("No slot set."),f(),g.return()):(Blast.throwError("No bluetooth device set."),f(),g.return());case 2:switch(c){case "advertisedTxPower":return g.jumpTo(3);case "advertisementData":return g.jumpTo(4);case "advertisingInterval":return g.jumpTo(5);
...
var readEddystoneProperty=function(a,b,c,d){var f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return a?b?c?g.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(Blast.throwError("No property set."),d(),g.return()):(Blast.throwError("No slot set."),d(),g.return()):(Blast.throwError("No bluetooth device set."),d(),g.return());case 2:f=null;switch(c){case "advertisedTxPower":return g.jumpTo(3);case "advertisementData":return g.jumpTo(4);case "advertisingInterval":return g.jumpTo(5);
case "lockState":return g.jumpTo(6);case "publicECDHKey":return g.jumpTo(7);case "eidIdentityKey":return g.jumpTo(8);case "radioTxPower":return g.jumpTo(9)}g.jumpTo(10);break;case 3:return g.yield(Blast.Bluetooth.Eddystone.getAdvertisedTxPower(a),11);case 11:f=g.yieldResult;g.jumpTo(10);break;case 4:return g.yield(Blast.Bluetooth.Eddystone.getAdvertisingData(a),12);case 12:f=g.yieldResult;g.jumpTo(10);break;case 5:return g.yield(Blast.Bluetooth.Eddystone.getAdvertisingInterval(a),13);case 13:f=g.yieldResult;
g.jumpTo(10);break;case 6:return g.yield(Blast.Bluetooth.Eddystone.getLockState(a),14);case 14:f=g.yieldResult;g.jumpTo(10);break;case 7:return g.yield(Blast.Bluetooth.Eddystone.getPublicECDHKey(a),15);case 15:f=g.yieldResult;g.jumpTo(10);break;case 8:return g.yield(Blast.Bluetooth.Eddystone.getEidIdentityKey(a),16);case 16:f=g.yieldResult;g.jumpTo(10);break;case 9:return g.yield(Blast.Bluetooth.Eddystone.getTxPowerLevel(a),17);case 17:f=g.yieldResult;g.jumpTo(10);break;case 10:d(f),g.jumpToEnd()}})};
Blast.asyncApiFunctions.push(["readEddystoneProperty",readEddystoneProperty]);Blockly.Blocks.blinkstick_set_colors={init:function(){this.appendValueInput("COLOUR").setCheck("Colour").appendField("write colour property");this.appendValueInput("index").setCheck("Number").appendField("of LED #");this.appendValueInput("thing").setCheck("Thing").appendField("to BlinkStick");this.setInputsInline(!0);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(255);this.setTooltip("Set the color properties of a tulogic BlinkStick.");this.setHelpUrl("https://www.blinkstick.com/")}};
var BLINKSTICK_SET_COLORS_XML='\n<block type="blinkstick_set_colors">\n  <value name="index">\n    <block type="math_number">\n      <field name="NUM">0</field>\n    </block>\n  </value>\n  <value name="COLOUR">\n    <block type="colour_picker">\n      <field name="COLOUR">#00ff00</field>\n    </block>\n  </value>\n</block>\n';Blast.Toolbox.addBlock("blinkstick_set_colors","Properties",BLINKSTICK_SET_COLORS_XML);Blockly.JavaScript.blinkstick_set_colors=function(a){var b=Blockly.JavaScript.valueToCode(a,"COLOUR",Blockly.JavaScript.ORDER_ATOMIC)||Blockly.JavaScript.quote_("#000000"),c=Blockly.JavaScript.valueToCode(a,"index",Blockly.JavaScript.ORDER_ATOMIC)||"0";return"blinkstickSetColors("+(Blockly.JavaScript.valueToCode(a,"thing",Blockly.JavaScript.ORDER_ATOMIC)||"''")+", "+c+", "+b+")\n;"};
var blinkstickSetColors=function(a,b,c,d){var f,g,h,m,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:if(0>b||7<b)return Blast.throwError("BlinkStick index must be between 0 and 7."),d(),n.return();if(!a)return Blast.throwError("No BlinkStick block set."),d(),n.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Blinkstick via webHID."),d(),n.return();if(f.opened){n.jumpTo(2);
break}n.setCatchFinallyBlocks(3);return n.yield(f.open(),5);case 5:n.leaveTryBlock(2);break;case 3:n.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(8352!==f.vendorId||16869!==f.productId)return Blast.throwError("The connected device is not a BlinkStick."),d(),n.return();g=parseInt(c.substring(1,3),16);h=parseInt(c.substring(3,5),16);m=parseInt(c.substring(5,7),16);k=Int8Array.from([5,b,g,h,m]);l=function(p){var q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==
