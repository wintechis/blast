...
n){function p(t){return function(v){q[t]=v;r--;0==r&&m(q)}}var q=[],r=0;do q.push(void 0),r++,c(l.value).callWhenSettled_(p(q.length-1),n),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,f=0;f<d;f++){var g=a[f];if(b.call(c,g,f,a))return{i:f,v:g}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,f){return c==a&&"q"==d&&f==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var m=Object.seal({}),n=Object.seal({}),p=new a([[m,2],[n,3]]);if(2!=p.get(m)||3!=p.get(n))return!1;p.delete(m);p.set(n,4);return!p.has(m)&&4==p.get(n)}catch(q){return!1}}function c(){}function d(m){var n=typeof m;return"object"===n&&null!==m||"function"===n}function f(m){if(!$jscomp.owns(m,h)){var n=new c;$jscomp.defineProperty(m,h,{value:n})}}function g(m){if(!$jscomp.ISOLATE_POLYFILLS){var n=Object[m];n&&(Object[m]=
function(p){if(p instanceof c)return p;Object.isExtensible(p)&&f(p);return n(p)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var k=0,l=function(m){this.id_=(k+=Math.random()+1).toString();if(m){m=$jscomp.makeIterator(m);for(var n;!(n=m.next()).done;)n=n.value,this.set(n[0],n[1])}};l.prototype.set=function(m,n){if(!d(m))throw Error("Invalid WeakMap key");
...
f(this,l).entry)&&l.value};d.prototype.entries=function(){return g(this,function(l){return[l.key,l.value]})};d.prototype.keys=function(){return g(this,function(l){return l.key})};d.prototype.values=function(){return g(this,function(l){return l.value})};d.prototype.forEach=function(l,m){for(var n=this.entries(),p;!(p=n.next()).done;)p=p.value,l.call(m,p[1],p[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var f=function(l,m){var n=m&&typeof m;"object"==n||"function"==n?c.has(m)?n=c.get(m):
(n=""+ ++k,c.set(m,n)):n="p_"+m;var p=l.data_[n];if(p&&$jscomp.owns(l.data_,n))for(l=0;l<p.length;l++){var q=p[l];if(m!==m&&q.key!==q.key||m===q.key)return{id:n,list:p,index:l,entry:q}}return{id:n,list:p,index:-1,entry:void 0}},g=function(l,m){var n=l.head_;return $jscomp.iteratorPrototype(function(){if(n){for(;n.head!=l.head_;)n=n.previous;for(;n.next!=n.head;)return n=n.next,{done:!1,value:m(n)};n=null}return{done:!0,value:void 0}})},h=function(){var l={};return l.previous=l.next=l.head=l},k=0;
...
function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$83:f.$jscomp$loop$prop$type$83,$jscomp$loop$prop$name$84:f.$jscomp$loop$prop$name$84,$jscomp$loop$prop$block$85:f.$jscomp$loop$prop$block$85},g=b.next()){f.$jscomp$loop$prop$block$85=g.value;f.$jscomp$loop$prop$type$83=f.$jscomp$loop$prop$block$85.getAttribute("type");if("things_webBluetooth"==
f.$jscomp$loop$prop$type$83||"things_webHID"==f.$jscomp$loop$prop$type$83){f.$jscomp$loop$prop$name$84=f.$jscomp$loop$prop$block$85.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$84))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$84));var k=document.createElement("td"),l=document.createElement("input");l.setAttribute("type","button");l.setAttribute("id","pairButton-"+f.$jscomp$loop$prop$name$84);
l.setAttribute("value","Pair");var m=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$84);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";m.appendChild(n);l.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=p.$jscomp$loop$prop$type$83?
("things_webHID"==p.$jscomp$loop$prop$type$83&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(v){0===v.length&&module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");var w=Date.now().toString(36)+Math.random().toString(36).substr(2);module$contents$Blast$Things_addWebHidDevice(w,p.$jscomp$loop$prop$name$84,v[0]);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$84).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$84).style.color=
"green";p.$jscomp$loop$prop$block$85.firstElementChild.textContent=w;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}))}).catch(function(v){module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");console.error(v)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;
document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$84).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$84).style.color="green";p.$jscomp$loop$prop$block$85.firstElementChild.textContent=r.id;module$contents$Blast$Storage_allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}));t.jumpToEnd()})}}(f));k.appendChild(l);
g.appendChild(h);g.appendChild(k);g.appendChild(m);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$84)}document.getElementById("rc-cancel").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectCancelHandler_()})}},module$contents$Blast$Storage_generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$87:f.$jscomp$loop$prop$type$87,
$jscomp$loop$prop$name$88:f.$jscomp$loop$prop$name$88,$jscomp$loop$prop$block$89:f.$jscomp$loop$prop$block$89},g=b.next())if(f.$jscomp$loop$prop$block$89=g.value,f.$jscomp$loop$prop$type$87=f.$jscomp$loop$prop$block$89.getAttribute("type"),"things_webBluetooth"==f.$jscomp$loop$prop$type$87||"things_webHID"==f.$jscomp$loop$prop$type$87)if(f.$jscomp$loop$prop$name$88=f.$jscomp$loop$prop$block$89.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$88)){g=document.createElement("li");g.setAttribute("id",
"rc-item-"+f.$jscomp$loop$prop$name$88);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$88);h.setAttribute("class","mdc-list-item__graphic material-icons");h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$87?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var k=document.createElement("span");
k.setAttribute("class","mdc-list-item__primary-text");k.innerHTML=f.$jscomp$loop$prop$name$88;h.appendChild(k);k=document.createElement("span");k.setAttribute("class","mdc-list-item__secondary-text");k.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$88);k.innerHTML="disconnected";h.appendChild(k);g.appendChild(h);g.addEventListener("click",function(l){return function(){var m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=l.$jscomp$loop$prop$type$87?
("things_webHID"==l.$jscomp$loop$prop$type$87&&(m=[],navigator.hid.requestDevice({filters:m}).then(function(q){0===q.length&&module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);module$contents$Blast$Things_addWebHidDevice(r,l.$jscomp$loop$prop$name$88,q[0]);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$88).innerHTML="connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$88).innerHTML=
"usb";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$88).style.color="#0d30b1";l.$jscomp$loop$prop$block$89.firstElementChild.textContent=r;module$contents$Blast$Storage_allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}))}).catch(function(q){module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");console.error(q)})),
p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);n=p.yieldResult;module$contents$Blast$Things_addWebBluetoothDevice(n.id,l.$jscomp$loop$prop$name$88);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$88).innerHTML="connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$88).innerHTML="bluetooth";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$88).style.color="#0d30b1";l.$jscomp$loop$prop$block$89.firstElementChild.textContent=n.id;module$contents$Blast$Storage_allConnectedMobile_()&&
(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectDoneHandler_(a)}));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$88)}window.app.initLists()},module$contents$Blast$Storage_allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+
...
Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return l.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=l.yieldResult;d instanceof DataView||(d=new DataView(value));f=new Uint8Array(d.buffer);g=f.length;h=buffer.Buffer.from(f);k=h.readUIntBE(0,g);return l.return(k)})};
...
Blast.Bluetooth.Eddystone.getAdvertisingData=function(a){var b,c,d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertising data...","Eddystone",a),c=function(m){var n=parseInt(m.substring(2,4),16),p=m.substring(4,24);m=m.substring(25,37);return{frameType:"UID",txPower:n,namespace:p,instance:m}},d=function(m){var n=parseInt(m.substring(2,4),16);switch(m.substring(4,6)){case "00":var p=
"http://www.";break;case "01":p="https://www.";break;case "02":p="http://";break;case "03":p="https://";break;default:module$contents$Blast$Interpreter_throwError("Eddystone URL scheme is not valid.");return}var q=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");m=m.substring(6,m.length);for(var r=0;r<m.length;r+=2){var t=parseInt(m.substring(r,r+2),16);p=t<q.length?p+q[t]:p+String.fromCharCode(t)}return{frameType:"URL",txPower:n,url:p}},f=function(m){var n=
parseInt(m.substring(4,8),16),p=parseInt(m.substring(8,10),16)+parseInt(m.substring(10,12),16)/100,q=parseInt(m.substring(12,20),16);m=parseInt(m.substring(20,28),16);return{frameType:"TLM",batteryVoltage:n,beaconTemperature:p,pduCount:q,timeSinceReboot:m}},l.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);g=l.yieldResult;b("Got Eddystone advertising data: <code>"+g+"</code>","Eddystone",a);h=g.substring(0,
2);switch(h){case "00":return k=c(g),l.return(k.namespace+k.instance);case "10":return k=d(g),l.return(k.url);case "20":return k=f(g),l.return(k.beaconTemperature);case "30":return module$contents$Blast$Interpreter_throwError("EID frame type is not supported by blast."),l.return();default:return module$contents$Blast$Interpreter_throwError("Eddystone frame type is not valid."),l.return()}})};
Blast.Bluetooth.Eddystone.setAdvertisingData=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress){d=module$contents$Blast$Things_getThingsLog();d("Set Eddystone advertising data...","Eddystone",a);f=function(l){for(var m=["http://www.","https://www.","http://","https://"],n=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),p=[],q=0,r=new TextEncoder("utf-8"),t=0;t<m.length;t++)if(l.startsWith(m[t])){p.push(t);
q=m[t].length;break}for(;q<l.length;){m=q;for(t=0;t<n.length;t++)if(l.startsWith(n[t],q)){p.push(t);q+=n[t].length;break}m===q&&(p.push(r.encode(l[q])[0]),q++)}if(18<p.length)module$contents$Blast$Interpreter_throwError("URL is too long.");else return p.splice(0,0,16),new Uint8Array(p)};if("URL"===b)g=f(c);else if("UID"===b){if(!/^[0-9A-Fa-f]{32}$/.test(c))return module$contents$Blast$Interpreter_throwError("Eddystone UID must be 32 hexadecimal characters."),k.return();g="0x00"+c}return k.yield(Blast.Bluetooth.gatt_writeWithResponse(a,
...
Blockly.Procedures.flyoutCategory=function(a){function b(g,h){g=$jscomp.makeIterator(g);for(var k=g.next();!k.done;k=g.next()){k=k.value;var l=k[0],m=k[1];k=Blockly.utils.xml.createElement("block");k.setAttribute("type",h);k.setAttribute("gap",16);var n=Blockly.utils.xml.createElement("mutation");n.setAttribute("name",l);k.appendChild(n);l=$jscomp.makeIterator(m);for(m=l.next();!m.done;m=l.next()){m=m.value;var p=Blockly.utils.xml.createElement("arg");p.setAttribute("name",m);n.appendChild(p)}c.push(k)}}
...
var module$contents$Blast$generators$blast_sendHttpRequest=function(a,b,c,d,f,g){var h,k,l,m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return null!=a&&void 0!=a&&""!=a||module$contents$Blast$Interpreter_throwError("URI input of HttpRequest blocks must not be empty"),h=JSON.parse(c),k={method:b,headers:new Headers(h)},"GET"!==b&&d&&(k.body=d),p.setCatchFinallyBlocks(2),p.yield(fetch(a,k),4);case 4:return l=p.yieldResult,l.ok?"status"==f?(g(l.status),
p.return()):p.yield(l.text(),5):(module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+l.status+" "+l.statusText),p.return());case 5:m=p.yieldResult;g(m);p.leaveTryBlock(0);break;case 2:n=p.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+n.message),p.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["sendHttpRequest",module$contents$Blast$generators$blast_sendHttpRequest]);
...
k.yield(new Promise(function(l,m){b.onloadedmetadata=function(){f.width=b.videoWidth;f.height=b.videoHeight;g.drawImage(b,0,0,f.width,f.height);l()};video.onerror=function(n){module$contents$Blast$Interpreter_throwError("Error trying to capture image from camera. See console for details");console.error(n);m(n)}}),3);h=f.toDataURL("image/png");b.srcObject.getTracks().forEach(function(l){return l.stop()});b.remove();f.remove();a(h);k.jumpToEnd()})};
...
var module$contents$Blast$generators$blast_getRSSIWb=function(a,b){var c,d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return l.yield(navigator.bluetooth.getDevices(),2);c=l.yieldResult;d=null;f=$jscomp.makeIterator(c);for(g=f.next();!g.done;g=f.next())if(h=g.value,h.id===a){d=h;break}null==d&&module$contents$Blast$Interpreter_throwError("Error pairing with Bluetooth device.");k=new AbortController;d.addEventListener("advertisementreceived",function(m){return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){k.abort();
b(m.rssi);n.jumpToEnd()})});return l.yield(d.watchAdvertisements({signal:k.signal}),0)})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["getRSSIWb",module$contents$Blast$generators$blast_getRSSIWb]);
...
g.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readEddystoneProperty",module$contents$Blast$generators$blast_readEddystoneProperty]);var module$exports$Blast$blocks$huskyduino={};
...
var readJoyConProperty=function(a,b,c,d,f,g){var h,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:if(!a)return module$contents$Blast$Interpreter_throwError("No Joy-Con block set."),g(),m.return();h=module$contents$Blast$Things_getWebHidDevice(a);if(!h)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),g(),m.return();if(h.opened){m.jumpTo(2);break}m.setCatchFinallyBlocks(3);
return m.yield(h.open(),5);case 5:m.leaveTryBlock(2);break;case 3:m.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==h.vendorId||8198!==h.productId&&8199!==h.productId)return module$contents$Blast$Interpreter_throwError("The connected device is not a Joy-Con."),g(),m.return();8198===h.productId?k=new JoyConLeft(h):8199===h.productId&&(k=new JoyConRight(h));return m.yield(k.open(),6);case 6:return m.yield(k.enableStandardFullMode(),
7);case 7:return m.yield(k.enableIMUMode(),8);case 8:l=function(n){var p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){p=n.detail;if(!p||!p.actualOrientation)return r.return();q=module$contents$Blast$Things_getThingsLog();q("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(p)+"</code>","hid",h.productname);q("Removing <code>hidinput</code> event listener","hid",h.productname);k.removeEventListener("hidinput",l);""!==d?"accelerometers"===b?g(p[b][c][d].acc):
"gyroscopes"===b?g(p[b][c][d][f]):g(p[b][c][d]):g(p[b][c]);r.jumpToEnd()})};if(k.eventListenerAttached){m.jumpTo(0);break}return m.yield(k.open(),10);case 10:return m.yield(k.enableStandardFullMode(),11);case 11:return m.yield(k.enableIMUMode(),12);case 12:return m.yield(k.enableVibration(),13);case 13:thingsLog("Adding <code>hidinput</code> event listener","hid",h.productname),k.addEventListener("hidinput",l),k.eventListenerAttached=!0,m.jumpToEnd()}})};
...
var handleJoyConButtons=function(a,b,c,d){var f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return module$contents$Blast$Interpreter_throwError("No Joy-Con block set."),d(),l.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),d(),l.return();if(f.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);
...
7);case 7:return l.yield(g.enableIMUMode(),8);case 8:h=!1;k=function(m){var n,p,q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){n=m.detail;if(!n||!n.actualOrientation)return t.return();p=module$contents$Blast$Things_getThingsLog();p("Received <code>hidinput</code> event from Joy-Con: <code>"+JSON.stringify(n)+"</code>","hid",f.productName);n.buttonStatus[b]?h||(h=!0,module$contents$Blast$Interpreter_setInterrupted(!1),q=new Interpreter(""),q.stateStack[0].scope=module$contents$Blast$Interpreter_getInterpreter().globalScope,
q.appendCode(c),r=function(){try{q.step()?setTimeout(r,5):module$contents$Blast$Interpreter_setInterrupted(!1)}catch(v){module$contents$Blast$Interpreter_throwError("Error executing program:\n "+e),console.error(v)}},r()):h=!1;t.jumpToEnd()})};Blast.Interpreter.deviceEventHandlers.push({device:g,type:"hidinput",fn:k});if(g.eventListenerAttached){l.jumpTo(0);break}return l.yield(g.open(),10);case 10:return l.yield(g.enableStandardFullMode(),11);case 11:return l.yield(g.enableIMUMode(),12);case 12:return l.yield(g.enableVibration(),
13);case 13:thingsLog("Adding <code>hidinput</code> event listener","hid",f.productName),g.addEventListener("hidinput",k),g.eventListenerAttached=!0,l.jumpToEnd()}})};module$contents$Blast$Interpreter_apiFunctions.push(["handleJoyConButtons",handleJoyConButtons]);var module$exports$Blast$blocks$mirobot={};Blockly.Blocks.mirobot_pickup={init:function(){this.appendDummyInput().appendField("robot-arm, pick up").appendField(new Blockly.FieldDropdown([["blue","BLUE"],["red","RED"],["yellow","YELLOW"],["green","GREEN"]]),"box").appendField("box");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("Invokes pick-up action for the selected box.");this.setHelpUrl("")}};var module$exports$Blast$generators$mirobot={};Blockly.JavaScript.mirobot_pickup=function(a){return"mirobotPickUpBox("+Blockly.JavaScript.quote_(a.getFieldValue("box").toLowerCase())+");\n"};
...
var module$contents$Blast$generators$ruuvi_tag_getRuuviProperty=function(a,b,c){var d,f,g,h,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return d=function(n){var p={},q=n[0]&255,r=n[1]<<8|n[2]&255;32767<r&&(r-=65535);var t=((n[3]&255)<<8|n[4]&255)/400,v=((n[5]&255)<<8|n[6]&255)+5E4,w=(n[7]<<8|n[8]&255)/1E3,u=(n[9]<<8|n[10]&255)/1E3,y=(n[11]<<8|n[12]&255)/1E3,x=(n[13]&255)<<8|n[14]&255,z=n[15]&255;n=(n[16]&255)<<8|n[17]&255;p.destination_endpoint=q;p.temperature=
...
m.yield(f(0),2);(g=m.yieldResult)||module$contents$Blast$Interpreter_throwError("Timed out. No BLE advertising data found for "+b);h=[];for(k=0;k<g.byteLength;k++)h.push("0x"+("00"+g.getUint8(k).toString(16)).slice(-2));l=d(h);c(l[a]);m.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["getRuuviProperty",module$contents$Blast$generators$ruuvi_tag_getRuuviProperty]);var module$exports$Blast$blocks$streamdeck={};
...
Blockly.JavaScript.streamdeck_button_event=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,h="TRUE"==a.getFieldValue("button6")?1:0,k=Blockly.JavaScript.quote_(a.getFieldValue("upDown")),l=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+b+c+d+f+g+h);a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,
"statements"));Blockly.JavaScript.definitions_.eventHandlers=(Blockly.JavaScript.definitions_.eventHandlers||"")+("handleStreamdeck("+l+", "+b+", "+k+", "+a+");\n");return""};
...
var module$contents$Blast$generators$streamdeck_handleStreamdeck=function(a,b,c,d){var f,g,h,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),m.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),m.return();
m.setCatchFinallyBlocks(2);return m.yield(StreamDeck.openDevice(f),4);case 4:g=m.yieldResult;m.leaveTryBlock(3);break;case 2:h=m.enterCatchBlock();if("InvalidStateError"!=h.name)return module$contents$Blast$Interpreter_throwError(h),m.return();f.close();return m.yield(StreamDeck.openDevice(f),6);case 6:g=m.yieldResult;case 3:for(l=0;l<b.length;l++)if("1"===b.charAt(l)){k=l;break}if(void 0===k)return m.return();g.on(c,function(n){module$contents$Blast$generators$streamdeck_thingsLog("Received <code>"+
...
var module$contents$Blast$generators$streamdeck_streamdeckWriteOnButtons=function(a,b,c,d){var f,g,h,k,l,m,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),d(),q.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),
q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(f),4);case 4:g=q.yieldResult;q.leaveTryBlock(3);break;case 2:h=q.enterCatchBlock();if("InvalidStateError"!=h.name)return module$contents$Blast$Interpreter_throwError(h),d(),q.return();f.close();return q.yield(StreamDeck.openDevice(f),6);case 6:g=q.yieldResult;case 3:k=[];l=document.createElement("canvas");l.width=g.ICON_SIZE;l.height=g.ICON_SIZE;m=l.getContext("2d");m.save();m.clearRect(0,0,l.width,l.height);m.font=.8*l.height+
"px Arial";m.strokeStyle="blue";m.lineWidth=1;m.strokeText(c.toString(),8,60,.8*l.width);m.fillStyle="white";m.fillText(c.toString(),8,60,.8*l.width);n=m.getImageData(0,0,l.width,l.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&(module$contents$Blast$generators$streamdeck_thingsLog("Invoke <code>fillKeyImageData</code> with value <code>"+[p,n].toString()+"</code>","hid",f.productName),k.push(g.fillKeyBuffer(p,buffer.Buffer.from(n.data),{format:"rgba"})),module$contents$Blast$generators$streamdeck_thingsLog("Finished <code>fillKeyImageData</code>",
"hid",f.productName));m.restore();return q.yield(Promise.all(k),7);case 7:d(),q.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["streamdeckWriteOnButtons",module$contents$Blast$generators$streamdeck_streamdeckWriteOnButtons]);
