...
"Bluetooth"),g.return(d);case 2:f=g.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Error disconnecting from Bluetooth device "+a),console.error(f),g.jumpToEnd()}})},module$contents$Blast$Bluetooth_gatt_writeWithoutResponse=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:f=k.yieldResult;if(!f)return k.return();"string"===typeof d&&
(d=module$contents$Blast$Bluetooth_hexStringToArrayBuffer(d));k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Invoke <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);return k.yield(f.writeValueWithoutResponse(d),5);case 5:g("Finished <code>WriteValueWithoutResponse</code> on characteristic <code>"+(c+"</code> with value <code>"+d.toString()+"</code>"),"Bluetooth",a);k.leaveTryBlock(0);
break;case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),k.jumpToEnd()}})};Blast.Bluetooth.gatt_writeWithoutResponse=module$contents$Blast$Bluetooth_gatt_writeWithoutResponse;
var module$contents$Blast$Bluetooth_gatt_writeWithResponse=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:f=k.yieldResult;if(!f)return k.return();"string"===typeof d&&(d=module$contents$Blast$Bluetooth_hexStringToArrayBuffer(d));k.setCatchFinallyBlocks(3);g=module$contents$Blast$Things_getThingsLog();g("Invoke <code>WriteValueWithResponse</code> on characteristic <code>"+
...
Blast.Bluetooth.gatt_writeWithResponse=module$contents$Blast$Bluetooth_gatt_writeWithResponse;
...
var module$contents$Blast$Bluetooth_gatt_read=function(a,b,c){var d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:return d=k.yieldResult,k.setCatchFinallyBlocks(3),f=module$contents$Blast$Things_getThingsLog(),f("Invoke <code>ReadValue</code> on characteristic <code>"+c+"</code> from service <code>"+(b+"</code>"),"Bluetooth",a),k.yield(d.readValue(),5);case 5:return g=
k.yieldResult,f("Finished <code>ReadValue</code> on characteristic <code>"+c+"</code> from service <code>"+(b+"</code> - value: <code>"+g.toString()+"</code>"),"Bluetooth",a),k.return(g);case 3:h=k.enterCatchBlock(),console.error(h),module$contents$Blast$Interpreter_throwError("Error reading from Bluetooth device "+a),k.jumpToEnd()}})};Blast.Bluetooth.gatt_read=module$contents$Blast$Bluetooth_gatt_read;
var module$contents$Blast$Bluetooth_gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(module$contents$Blast$Bluetooth_gatt_read(a,b,c),2);d=g.yieldResult;f=(new TextDecoder).decode(d);return g.return(f)})};Blast.Bluetooth.gatt_read_text=module$contents$Blast$Bluetooth_gatt_read_text;
var module$contents$Blast$Bluetooth_gatt_read_number=function(a,b,c){var d,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return m.yield(module$contents$Blast$Bluetooth_gatt_read(a,b,c),2);d=m.yieldResult;d instanceof DataView||(d=new DataView(value));f=new Uint8Array(d.buffer);g=f.length;h=buffer.Buffer.from(f);k=h.readUIntBE(0,g);return m.return(k)})};Blast.Bluetooth.gatt_read_number=module$contents$Blast$Bluetooth_gatt_read_number;
var module$contents$Blast$Bluetooth_gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(module$contents$Blast$Bluetooth_gatt_read(a,b,c),2);d=g.yieldResult;f=(new Uint8Array(d.buffer)).reduce(function(h,k){return h+("0"+k.toString(16)).slice(-2)},"");return g.return(f)})};Blast.Bluetooth.gatt_read_hex=module$contents$Blast$Bluetooth_gatt_read_hex;
var module$contents$Blast$Bluetooth_gatt_subscribe=function(a,b,c,d){var f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:return k.yield(module$contents$Blast$Bluetooth_getCharacteristic(a,b,c),2);case 2:return f=k.yieldResult,g=module$contents$Blast$Things_getThingsLog(),g("Add 'characteristicvaluechanged' listener to characteristic "+c+(" of service <code>"+b+"</code>"),"Bluetooth",a),f.addEventListener("characteristicvaluechanged",d),module$contents$Blast$Bluetooth_charEventListeners[c]=
...
Blast.Bluetooth.gatt_subscribe=module$contents$Blast$Bluetooth_gatt_subscribe;
...
var module$contents$Blast$Eddystone_getCapabilities=function(a){var b,c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone capabilities...","Eddystone",a),k.yield(module$contents$Blast$Bluetooth_gatt_read(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.CAPABILITIES_CHARACTERISTIC),2);c=k.yieldResult;c=new Int8Array(c.buffer);d=[];for(f=6;f<
c.length&&!((g=d[d.length-1])&&g>=c[f]);f++)d.push(c[f]);h={specVersion:c[0],maxSlots:c[1],maxEidPerSlot:c[2],isVarriableAdvIntervalSupported:0!==(c[3]&1),isVariableTxPowerSupported:0!==(c[3]&2),isUIDSupported:0!==(c[5]&1),isURLSupported:0!==(c[5]&2),isTLMSupported:0!==(c[5]&4),isEIDSupported:0!==(c[5]&8),supportedTxPowerLevels:d};b("Eddystone capabilities: <code>"+JSON.stringify(h)+"</code>","Eddystone",a);return k.return(h)})},module$contents$Blast$Eddystone_getActiveSlot=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==
d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone active slot...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ACTIVE_SLOT_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone active slot: <code>"+c+"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getActiveSlot=module$contents$Blast$Eddystone_getActiveSlot;
...
(d.maxSlots-1)+"."),f.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ACTIVE_SLOT_CHARACTERISTIC,b.toString(16)),3);c("Eddystone active slot set to <code>"+b+"</code>","Eddystone",a);return f.return()})};Blast.Eddystone.setActiveSlot=module$contents$Blast$Eddystone_setActiveSlot;
var module$contents$Blast$Eddystone_getAdvertisingInterval=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertising interval...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone advertising interval: <code>"+
...
var module$contents$Blast$Eddystone_getTxPowerLevel=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone TX power level...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.RADIO_TX_POWER_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone TX power level: <code>"+
c+"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getTxPowerLevel=module$contents$Blast$Eddystone_getTxPowerLevel;
...
d.supportedTxPowerLevels+"."),f.return()):f.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.RADIO_TX_POWER_CHARACTERISTIC,b.toString(16)),3);c("Eddystone TX power level set to <code>"+b+"</code>","Eddystone",a);return f.return()})};Blast.Eddystone.setTxPowerLevel=module$contents$Blast$Eddystone_setTxPowerLevel;
var module$contents$Blast$Eddystone_getAdvertisedTxPower=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone advertised TX power...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone advertised TX power: <code>"+
...
var module$contents$Blast$Eddystone_setAdvertisedTxPower=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return c=module$contents$Blast$Things_getThingsLog(),c("Setting Eddystone advertised TX power to <code>"+b+"</code>...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_writeWithResponse(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC,b.toString(16)),
2);c("Eddystone advertised TX power set to <code>"+b+"</code>","Eddystone",a);return d.return()})};Blast.Eddystone.setAdvertisedTxPower=module$contents$Blast$Eddystone_setAdvertisedTxPower;
var module$contents$Blast$Eddystone_getLockState=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone lock state...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_number(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.LOCK_STATE_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone lock state: <code>"+c+"</code>",
"Eddystone",a);return d.return(c)})};Blast.Eddystone.getLockState=module$contents$Blast$Eddystone_getLockState;
var module$contents$Blast$Eddystone_getPublicECDHKey=function(a){var b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=module$contents$Blast$Things_getThingsLog(),b("Reading Eddystone public ECDH key...","Eddystone",a),d.yield(module$contents$Blast$Bluetooth_gatt_read_hex(a,module$contents$Blast$Eddystone_UUIDS.CONFIG_SERVICE,module$contents$Blast$Eddystone_UUIDS.PUBLIC_ECDH_KEY_CHARACTERISTIC),2);c=d.yieldResult;b("Got Eddystone public ECDH key: <code>"+
c+"</code>","Eddystone",a);return d.return(c)})};Blast.Eddystone.getPublicECDHKey=module$contents$Blast$Eddystone_getPublicECDHKey;
...
var module$contents$Blast$generators$ble_rgb_led_controller_switchLights=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(!a)return module$contents$Blast$Interpreter_throwError("No LED Controller is set."),c(),f.return();d="7e000503"+b.substring(1,7)+"00ef";return f.yield(module$contents$Blast$Bluetooth_gatt_writeWithoutResponse(a,module$contents$Blast$generators$ble_rgb_led_controller_LEDServiceUUID,"0000fff3-0000-1000-8000-00805f9b34fb",
d),2)}c();f.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["switchLights",module$contents$Blast$generators$ble_rgb_led_controller_switchLights]);var module$exports$Blast$blocks$huskyduino={};
...
var module$contents$Blast$generators$huskyduino_chooseAlgo=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_gatt_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be35d26-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["chooseAlgo",module$contents$Blast$generators$huskyduino_chooseAlgo]);
var module$contents$Blast$generators$huskyduino_learnID=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_gatt_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be35eca-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["learnID",module$contents$Blast$generators$huskyduino_learnID]);
var module$contents$Blast$generators$huskyduino_forgetAll=function(a,b,c){return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_gatt_writeWithoutResponse(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be361b8-f9b0-11eb-9a03-0242ac130003",b),2);c();d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["forgetAll",module$contents$Blast$generators$huskyduino_forgetAll]);
var module$contents$Blast$generators$huskyduino_readID=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(module$contents$Blast$Bluetooth_gatt_read_text(a,module$contents$Blast$generators$huskyduino_HuskyServiceUUID,"5be3628a-f9b0-11eb-9a03-0242ac130003"),2);c=d.yieldResult;b(c);d.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readID",module$contents$Blast$generators$huskyduino_readID]);var module$exports$Blast$blocks$joycon={};
...
c+", Error: "+g.status+" "+g.statusText),k.return();b(g.status);return k.leaveTryBlock(0)}h=k.enterCatchBlock();module$contents$Blast$Interpreter_throwError("Failed to get "+c+", Error: "+h);k.jumpToEnd()})};var module$exports$Blast$blocks$blinkstick={};
