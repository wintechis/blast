...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$53:f.$jscomp$loop$prop$type$53,$jscomp$loop$prop$name$54:f.$jscomp$loop$prop$name$54,$jscomp$loop$prop$block$55:f.$jscomp$loop$prop$block$55},g=b.next()){f.$jscomp$loop$prop$block$55=g.value;f.$jscomp$loop$prop$type$53=f.$jscomp$loop$prop$block$55.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$53||"things_webHID"==f.$jscomp$loop$prop$type$53){f.$jscomp$loop$prop$name$54=f.$jscomp$loop$prop$block$55.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$54))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$54));var n=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$54);k.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$54);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
p.$jscomp$loop$prop$type$53?("things_webHID"==p.$jscomp$loop$prop$type$53&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(u){0===u.length&&Blast.throwError("Connection failed or cancelled by User.");var v=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(v,u[0]);Blast.Things.addWebHidDevice(v,p.$jscomp$loop$prop$name$54);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$54).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
p.$jscomp$loop$prop$name$54).style.color="green";p.$jscomp$loop$prop$block$55.firstElementChild.textContent=v;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(u){Blast.throwError("Connection failed or cancelled by User.");
console.error(u)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$54).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$54).style.color="green";p.$jscomp$loop$prop$block$55.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));n.appendChild(k);g.appendChild(h);g.appendChild(n);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$54)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$57:f.$jscomp$loop$prop$type$57,$jscomp$loop$prop$name$58:f.$jscomp$loop$prop$name$58,$jscomp$loop$prop$block$59:f.$jscomp$loop$prop$block$59},g=b.next())if(f.$jscomp$loop$prop$block$59=g.value,f.$jscomp$loop$prop$type$57=f.$jscomp$loop$prop$block$59.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$57||"things_webHID"==f.$jscomp$loop$prop$type$57)if(f.$jscomp$loop$prop$name$58=f.$jscomp$loop$prop$block$59.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$58)){g=document.createElement("li");g.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$58);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$58);h.setAttribute("class","mdc-list-item__graphic material-icons");
h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$57?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var n=document.createElement("span");n.setAttribute("class","mdc-list-item__primary-text");n.innerHTML=f.$jscomp$loop$prop$name$58;h.appendChild(n);n=document.createElement("span");n.setAttribute("class","mdc-list-item__secondary-text");n.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$58);
n.innerHTML="disconnected";h.appendChild(n);g.appendChild(h);g.addEventListener("click",function(k){return function(){var l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$57?("things_webHID"==k.$jscomp$loop$prop$type$57&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$58);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$58).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$58).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$58).style.color="#0d30b1";k.$jscomp$loop$prop$block$59.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);m=p.yieldResult;Blast.Things.addWebBluetoothDevice(m.id,k.$jscomp$loop$prop$name$58);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$58).innerHTML=
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$58).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$58).style.color="#0d30b1";k.$jscomp$loop$prop$block$59.firstElementChild.textContent=m.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$58)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){function f(n){n=n.replace(/^0x/,"");0!=n.length%2&&(n="0"+n);var k=n.match(/[G-Z\s]/i);k&&console.log("WARNING: found non-hex characters",k);n=n.match(/[\dA-F]{2}/gi).map(function(l){return parseInt(l,16)});return(new Uint8Array(n)).buffer}var g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:return n.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:g=n.yieldResult;if(!g)return n.return();
d=f(d);n.setCatchFinallyBlocks(3);return n.yield(g.writeValueWithoutResponse(d),5);case 5:n.leaveTryBlock(0);break;case 3:h=n.enterCatchBlock(),console.error(h),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),n.jumpToEnd()}})};
...
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;f=(new Uint8Array(d)).reduce(function(h,n){return h+("0"+n.toString(16)).slice(-2)},"");return g.return(f)})};
...
var sendHttpRequest=function(a,b,c,d,f,g){var h,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty");h=JSON.parse(c);n={method:b,headers:new Headers(h)};d&&(n.body=d);fetch(a,n).then(Blast.handleFetchErrors).then(function(l){var m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"status"==f&&g(l.status),p.yield(l.text(),2);m=p.yieldResult;g(m);p.jumpToEnd()})}).catch(function(l){Blast.throwError(l.message+
...
var urdfQueryWrapper=function(a,b,c){var d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){urdf.clear();d="\n FROM <"+a+">\n";b=b.slice(0,b.indexOf("WHERE"))+d+b.slice(b.indexOf("WHERE"));urdf.query(b).then(function(g){c(g)}).catch(function(g){console.error(g);Blast.throwError(g.message+"\nSee console for details.")});f.jumpToEnd()})};Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);
...
return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){p=m.detail;if(!p||!p.actualOrientation)return q.return();n.removeEventListener("hidinput",k);""!==d?"accelerometers"===b?g(p[b][c][d].acc):"gyroscopes"===b?g(p[b][c][d][f]):g(p[b][c][d]):g(p[b][c]);q.jumpToEnd()})};if(n.eventListenerAttached){l.jumpTo(0);break}return l.yield(n.open(),10);case 10:return l.yield(n.enableStandardFullMode(),11);case 11:return l.yield(n.enableIMUMode(),12);case 12:return l.yield(n.enableVibration(),13);case 13:n.addEventListener("hidinput",
k),n.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);
...
break;case 2:h=l.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),l.return();f.close();return l.yield(StreamDeck.openDevice(f),6);case 6:g=l.yieldResult;case 3:for(k=0;k<b.length;k++)if("1"===b.charAt(k)){n=k;break}if(void 0===n)return l.return();g.on(c,function(m){if(m===n){Blast.Interrupted=!0;var p=new Interpreter("");p.stateStack[0].scope=Blast.Interpreter.globalScope;p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(r){Blast.throwError("Error executing program:\n "+
...
8,60,.8*k.width);m=l.getImageData(0,0,k.width,k.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&n.push(g.fillKeyBuffer(p,buffer.Buffer.from(m.data),{format:"rgba"}));l.restore();return q.yield(Promise.all(n),7);case 7:d(),q.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckWriteOnButtons",streamdeckWriteOnButtons]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
