...
Blast.Bluetooth.Eddystone.getCapabilities=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.CAPABILITIES_CHARACTERISTIC),2);b=g.yieldResult;b=new Int8Array(b.buffer);c=[];for(d=6;d<b.length&&!((f=c[c.length-1])&&f>=b[d]);d++)c.push(b[d]);return g.return({specVersion:b[0],maxSlots:b[1],maxEidPerSlot:b[2],isVarriableAdvIntervalSupported:0!==
(b[3]&1),isVariableTxPowerSupported:0!==(b[3]&2),isUIDSupported:0!==(b[5]&1),isURLSupported:0!==(b[5]&2),isTLMSupported:0!==(b[5]&4),isEIDSupported:0!==(b[5]&8),supportedTxPowerLevels:c})})};
Blast.Bluetooth.Eddystone.getActiveSlot=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.setActiveSlot=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){return 1==d.nextAddress?d.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2):3!=d.nextAddress?(c=d.yieldResult,(0>b||b>=c.maxSlots)&&Blast.throwError("Eddystone slot is not valid.\n         On this device the slot must be between 0 and "+(c.maxSlots-1)+"."),d.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC,
b.toString(16)),3)):d.return()})};Blast.Bluetooth.Eddystone.getAdvertisingInterval=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.setAdvertisingInterval=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){return 1==c.nextAddress?c.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC,b.toString(16)),2):c.return()})};
Blast.Bluetooth.Eddystone.getTxPowerLevel=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.RADIO_TX_POWER_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.setTxPowerLevel=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){return 1==d.nextAddress?d.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2):3!=d.nextAddress?(c=d.yieldResult,-1===c.supportedTxPowerLevels.indexOf(b)?(Blast.throwError("Eddystone TX power level is not valid.\n         On this device the TX power level must be one of "+c.supportedTxPowerLevels+"."),d.return()):d.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,
Blast.Bluetooth.Eddystone.UUIDS.RADIO_TX_POWER_CHARACTERISTIC,b.toString(16)),3)):d.return()})};Blast.Bluetooth.Eddystone.getAdvertisedTxPower=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.setAdvertisedTxPower=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){return 1==c.nextAddress?c.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC,b.toString(16)),2):c.return()})};
Blast.Bluetooth.Eddystone.getLockState=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.LOCK_STATE_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.getPublicECDHKey=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.PUBLIC_ECDH_KEY_CHARACTERISTIC),2);b=c.yieldResult;return c.return(b)})};
Blast.Bluetooth.Eddystone.getAdvertisingData=function(a){var b,c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return b=function(k){var l=parseInt(k.substring(2,4),16),n=k.substring(4,24);k=k.substring(25,37);return{frameType:"UID",txPower:l,namespace:n,instance:k}},c=function(k){var l=parseInt(k.substring(2,4),16);switch(k.substring(4,6)){case "00":var n="http://www.";break;case "01":n="https://www.";break;case "02":n="http://";break;case "03":n="https://";
break;default:Blast.throwError("Eddystone URL scheme is not valid.");return}var p=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");k=k.substring(6,k.length);for(var q=0;q<k.length;q+=2){var r=parseInt(k.substring(q,q+2),16);n=r<p.length?n+p[r]:n+String.fromCharCode(r)}return{frameType:"URL",txPower:l,url:n}},d=function(k){console.log(k);var l=parseInt(k.substring(4,8),16),n=parseInt(k.substring(8,10),16)+parseInt(k.substring(10,12),16)/100,p=parseInt(k.substring(12,
20),16);k=parseInt(k.substring(20,28),16);return{frameType:"TLM",batteryVoltage:l,beaconTemperature:n,pduCount:p,timeSinceReboot:k}},m.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);f=m.yieldResult;g=f.substring(0,2);switch(g){case "00":return h=b(f),m.return(h.namespace+h.instance);case "10":return h=c(f),m.return(h.url);case "20":return h=d(f),m.return(h.beaconTemperature);case "30":return Blast.throwError("EID frame type is not supported by blast."),
m.return();default:return Blast.throwError("Eddystone frame type is not valid."),m.return()}})};
Blast.Bluetooth.Eddystone.setAdvertisingData=function(a,b){var c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){c=function(g){for(var h=["http://www.","https://www.","http://","https://"],m=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),k=[],l=0,n=new TextEncoder("utf-8"),p=0;p<h.length;p++)if(g.startsWith(h[p])){k.push(p);l=h[p].length;break}for(;l<g.length;){h=l;for(p=0;p<m.length;p++)if(g.startsWith(m[p],l)){k.push(p);l+=m[p].length;
break}h===l&&(k.push(n.encode(g[l])[0]),l++)}if(18<k.length)Blast.throwError("URL is too long.");else return k.splice(0,0,16),new Uint8Array(k)};d=c(b);return f.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,d),0)})};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(f){f=f?f.toString():"";return Blast.highlightBlock(f)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(f){Blast.Interrupted=f};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
