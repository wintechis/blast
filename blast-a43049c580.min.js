...
m.callWhenSettled_(p.resolve,p.reject)};h.prototype.settleSameAsThenable_=function(m,p){var l=this.createResolveAndReject_();try{m.call(p,l.resolve,l.reject)}catch(n){l.reject(n)}};h.prototype.then=function(m,p){function l(w,y){return"function"==typeof w?function(C){try{n(w(C))}catch(D){q(D)}}:y}var n,q,t=new h(function(w,y){n=w;q=y});this.callWhenSettled_(l(m,n),l(p,q));return t};h.prototype.catch=function(m){return this.then(void 0,m)};h.prototype.callWhenSettled_=function(m,p){function l(){switch(n.state_){case 1:m(n.result_);
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],h={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;h={$jscomp$loop$prop$type$62:h.$jscomp$loop$prop$type$62,$jscomp$loop$prop$name$63:h.$jscomp$loop$prop$name$63,$jscomp$loop$prop$block$64:h.$jscomp$loop$prop$block$64},g=b.next()){h.$jscomp$loop$prop$block$64=g.value;h.$jscomp$loop$prop$type$62=h.$jscomp$loop$prop$block$64.getAttribute("type");
if("things_webBluetooth"==h.$jscomp$loop$prop$type$62||"things_webHID"==h.$jscomp$loop$prop$type$62){h.$jscomp$loop$prop$name$63=h.$jscomp$loop$prop$block$64.firstElementChild.textContent;if(d.includes(h.$jscomp$loop$prop$name$63))continue;g=document.createElement("tr");var m=document.createElement("td");m.appendChild(document.createTextNode(h.$jscomp$loop$prop$name$63));var p=document.createElement("td"),l=document.createElement("input");l.setAttribute("type","button");l.setAttribute("id","pairButton-"+
h.$jscomp$loop$prop$name$63);l.setAttribute("value","Pair");var n=document.createElement("td"),q=document.createElement("span");q.setAttribute("id","pairStatus-"+h.$jscomp$loop$prop$name$63);q.innerHTML="&#x2718;";q.style.color="red";q.style.fontSize="20px";q.style.fontWeight="bold";q.style.marginRight="10px";n.appendChild(q);l.addEventListener("click",function(t){return function(){var w,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(C){if(1==C.nextAddress)return"things_webBluetooth"!=
t.$jscomp$loop$prop$type$62?("things_webHID"==t.$jscomp$loop$prop$type$62&&(w=[],navigator.hid.requestDevice({filters:w}).then(function(D){0===D.length&&Blast.throwError("Connection failed or cancelled by User.");var B=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(B,D[0]);Blast.Things.addWebHidDevice(B,t.$jscomp$loop$prop$name$63);document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$63).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
t.$jscomp$loop$prop$name$63).style.color="green";t.$jscomp$loop$prop$block$64.firstElementChild.textContent=B;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(D){Blast.throwError("Connection failed or cancelled by User.");
console.error(D)})),C.jumpTo(0)):C.yield(Blast.Bluetooth.requestDevice(),3);y=C.yieldResult;document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$63).innerHTML="&#x2714;";document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$63).style.color="green";t.$jscomp$loop$prop$block$64.firstElementChild.textContent=y.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));C.jumpToEnd()})}}(h));p.appendChild(l);g.appendChild(m);g.appendChild(p);g.appendChild(n);c.appendChild(g);d.push(h.$jscomp$loop$prop$name$63)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],h={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;h={$jscomp$loop$prop$type$66:h.$jscomp$loop$prop$type$66,$jscomp$loop$prop$name$67:h.$jscomp$loop$prop$name$67,$jscomp$loop$prop$block$68:h.$jscomp$loop$prop$block$68},g=b.next())if(h.$jscomp$loop$prop$block$68=g.value,h.$jscomp$loop$prop$type$66=h.$jscomp$loop$prop$block$68.getAttribute("type"),
"things_webBluetooth"==h.$jscomp$loop$prop$type$66||"things_webHID"==h.$jscomp$loop$prop$type$66)if(h.$jscomp$loop$prop$name$67=h.$jscomp$loop$prop$block$68.firstElementChild.textContent,!d.includes(h.$jscomp$loop$prop$name$67)){g=document.createElement("li");g.setAttribute("id","rc-item-"+h.$jscomp$loop$prop$name$67);g.setAttribute("class","mdc-list-item");var m=document.createElement("span");m.setAttribute("id","rc-icon-"+h.$jscomp$loop$prop$name$67);m.setAttribute("class","mdc-list-item__graphic material-icons");
m.setAttribute("aria-hidden","true");m.innerHTML="things_webBluetooth"==h.$jscomp$loop$prop$type$66?"bluetooth_disabled":"usb_off";g.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__text");var p=document.createElement("span");p.setAttribute("class","mdc-list-item__primary-text");p.innerHTML=h.$jscomp$loop$prop$name$67;m.appendChild(p);p=document.createElement("span");p.setAttribute("class","mdc-list-item__secondary-text");p.setAttribute("id","rc-status-"+h.$jscomp$loop$prop$name$67);
p.innerHTML="disconnected";m.appendChild(p);g.appendChild(m);g.addEventListener("click",function(l){return function(){var n,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=l.$jscomp$loop$prop$type$66?("things_webHID"==l.$jscomp$loop$prop$type$66&&(n=[],navigator.hid.requestDevice({filters:n}).then(function(w){0===w.length&&Blast.throwError("Connection failed or cancelled by User.");var y=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(y,w[0]);Blast.Things.addWebHidDevice(y,l.$jscomp$loop$prop$name$67);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$67).innerHTML="connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$67).innerHTML="usb";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$67).style.color="#0d30b1";l.$jscomp$loop$prop$block$68.firstElementChild.textContent=y;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(w){Blast.throwError("Connection failed or cancelled by User.");console.error(w)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);q=t.yieldResult;Blast.Things.addWebBluetoothDevice(q.id,l.$jscomp$loop$prop$name$67);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$67).innerHTML=
"connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$67).innerHTML="bluetooth";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$67).style.color="#0d30b1";l.$jscomp$loop$prop$block$68.firstElementChild.textContent=q.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(h));c.appendChild(g);d.push(h.$jscomp$loop$prop$name$67)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(h,g){return Blast.States.eventChecker(h,g)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return Blast.States.startEventChecker()}));c=function(h){return prompt(h)};a.setProperty(b,"prompt",a.createNativeFunction(c))};Blockly.JavaScript.repeat=Blockly.JavaScript.controls_repeat_ext;Blockly.JavaScript.while_until=Blockly.JavaScript.controls_whileUntil;Blockly.JavaScript["for"]=Blockly.JavaScript.controls_for;Blockly.JavaScript.break_continue=Blockly.JavaScript.controls_flow_statements;Blockly.JavaScript.conditional_statement=Blockly.JavaScript.controls_if;Blockly.JavaScript.wait_seconds=function(a){return"waitForSeconds("+(Blockly.JavaScript.valueToCode(a,"SECONDS",Blockly.JavaScript.ORDER_ATOMIC)||0)+");\n"};
...
Blockly.Blocks.streamdeck_color_buttons={init:function(){this.appendValueInput("id").setCheck("Thing").appendField("Streamdeck mini");this.appendValueInput("color").setCheck("Colour").appendField("fill button with colour");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE"),"button1").appendField(new Blockly.FieldCheckbox("FALSE"),"button2").appendField(new Blockly.FieldCheckbox("FALSE"),"button3");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE"),
"button4").appendField(new Blockly.FieldCheckbox("FALSE"),"button5").appendField(new Blockly.FieldCheckbox("FALSE"),"button6");this.setColour(255);this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setTooltip("");this.setHelpUrl("");this.requested=!1;this.keyState=Array(6).fill(!1)}};Blast.Toolbox.addBlock("streamdeck_color_buttons","Properties");Blockly.JavaScript.streamdeck_button_event=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,h="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,m="TRUE"==a.getFieldValue("button6")?1:0,p=Blockly.JavaScript.quote_(a.getFieldValue("upDown")),l=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+b+c+d+h+g+m);a=Blockly.JavaScript.quote_(Blockly.JavaScript.statementToCode(a,
...
var streamdeckColorButtons=function(a,b,c,d){var h,g,m,p,l,n,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){switch(t.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),t.return();h=Blast.Things.webHidDevices.get(a);if(!h)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),t.return();t.setCatchFinallyBlocks(2);return t.yield(StreamDeck.openDevice(h),4);case 4:g=t.yieldResult;
t.leaveTryBlock(3);break;case 2:m=t.enterCatchBlock();if("InvalidStateError"!=m.name)return Blast.throwError(m),d(),t.return();h.close();return t.yield(StreamDeck.openDevice(h),6);case 6:g=t.yieldResult;case 3:p=parseInt(c.substring(1,3),16),l=parseInt(c.substring(3,5),16),n=parseInt(c.substring(5,7),16),q=0;case 7:if(!(q<b.length)){t.jumpTo(9);break}if("1"!==b.charAt(q)){t.jumpTo(8);break}return t.yield(g.fillKeyColor(q,p,l,n),8);case 8:q++;t.jumpTo(7);break;case 9:d(),t.jumpToEnd()}})};
...
l%4)throw Error("Invalid string. Length must be a multiple of 4");p=p.indexOf("=");-1===p&&(p=l);return[p,p===l?0:4-p%4]}c.byteLength=function(p){p=d(p);var l=p[1];return 3*(p[0]+l)/4-l};c.toByteArray=function(p){var l=d(p);var n=l[0];l=l[1];var q=new m(3*(n+l)/4-l),t=0,w=0<l?n-4:n,y;for(y=0;y<w;y+=4)n=g[p.charCodeAt(y)]<<18|g[p.charCodeAt(y+1)]<<12|g[p.charCodeAt(y+2)]<<6|g[p.charCodeAt(y+3)],q[t++]=n>>16&255,q[t++]=n>>8&255,q[t++]=n&255;2===l&&(n=g[p.charCodeAt(y)]<<2|g[p.charCodeAt(y+1)]>>4,q[t++]=
n&255);1===l&&(n=g[p.charCodeAt(y)]<<10|g[p.charCodeAt(y+1)]<<4|g[p.charCodeAt(y+2)]>>2,q[t++]=n>>8&255,q[t++]=n&255);return q};c.fromByteArray=function(p){for(var l=p.length,n=l%3,q=[],t=0,w=l-n;t<w;t+=16383){for(var y=q,C=y.push,D,B=p,v=t+16383>w?w:t+16383,x=[],z=t;z<v;z+=3)D=(B[z]<<16&16711680)+(B[z+1]<<8&65280)+(B[z+2]&255),x.push(h[D>>18&63]+h[D>>12&63]+h[D>>6&63]+h[D&63]);D=x.join("");C.call(y,D)}1===n?(p=p[l-1],q.push(h[p>>2]+h[p<<4&63]+"==")):2===n&&(p=(p[l-2]<<8)+p[l-1],q.push(h[p>>10]+h[p>>
...
r;case "hex":return r>>>1;case "base64":return S(f).length;default:if(A)return u?-1:L(f).length;k=(""+k).toLowerCase();A=!0}}function y(f,k,r){var u=!1;if(void 0===k||0>k)k=0;if(k>this.length)return"";if(void 0===r||r>this.length)r=this.length;if(0>=r)return"";r>>>=0;k>>>=0;if(r<=k)return"";for(f||(f="utf8");;)switch(f){case "hex":f=k;k=r;r=this.length;if(!f||0>f)f=0;if(!k||0>k||k>r)k=r;u="";for(r=f;r<k;++r)f=u,u=this[r],u=16>u?"0"+u.toString(16):u.toString(16),u=f+u;return u;case "utf8":case "utf-8":return v(this,
...
}function z(f,k,r,u,A,F){if(!g.isBuffer(f))throw new TypeError('"buffer" argument must be a Buffer instance');if(k>A||k<F)throw new RangeError('"value" argument is out of bounds');if(r+u>f.length)throw new RangeError("Index out of range");}function E(f,k,r,u,A,F){if(r+u>f.length)throw new RangeError("Index out of range");if(0>r)throw new RangeError("Index out of range");}function G(f,k,r,u,A){k=+k;r>>>=0;A||E(f,k,r,4,3.4028234663852886E38,-3.4028234663852886E38);N.write(f,k,r,u,23,4);return r+4}function H(f,
...
24|this[f+1]<<16|this[f+2]<<8|this[f+3]};g.prototype.readFloatLE=function(f,k){f>>>=0;k||x(f,4,this.length);return N.read(this,f,!0,23,4)};g.prototype.readFloatBE=function(f,k){f>>>=0;k||x(f,4,this.length);return N.read(this,f,!1,23,4)};g.prototype.readDoubleLE=function(f,k){f>>>=0;k||x(f,8,this.length);return N.read(this,f,!0,52,8)};g.prototype.readDoubleBE=function(f,k){f>>>=0;k||x(f,8,this.length);return N.read(this,f,!1,52,8)};g.prototype.writeUIntLE=function(f,k,r,u){f=+f;k>>>=0;r>>>=0;u||z(this,
f,k,r,Math.pow(2,8*r)-1,0);u=1;var A=0;for(this[k]=f&255;++A<r&&(u*=256);)this[k+A]=f/u&255;return k+r};g.prototype.writeUIntBE=function(f,k,r,u){f=+f;k>>>=0;r>>>=0;u||z(this,f,k,r,Math.pow(2,8*r)-1,0);u=r-1;var A=1;for(this[k+u]=f&255;0<=--u&&(A*=256);)this[k+u]=f/A&255;return k+r};g.prototype.writeUInt8=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,1,255,0);this[k]=f&255;return k+1};g.prototype.writeUInt16LE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,2,65535,0);this[k]=f&255;this[k+1]=f>>>8;return k+
2};g.prototype.writeUInt16BE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,2,65535,0);this[k]=f>>>8;this[k+1]=f&255;return k+2};g.prototype.writeUInt32LE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,4,4294967295,0);this[k+3]=f>>>24;this[k+2]=f>>>16;this[k+1]=f>>>8;this[k]=f&255;return k+4};g.prototype.writeUInt32BE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,4,4294967295,0);this[k]=f>>>24;this[k+1]=f>>>16;this[k+2]=f>>>8;this[k+3]=f&255;return k+4};g.prototype.writeIntLE=function(f,k,r,u){f=+f;k>>>=0;u||(u=
Math.pow(2,8*r-1),z(this,f,k,r,u-1,-u));u=0;var A=1,F=0;for(this[k]=f&255;++u<r&&(A*=256);)0>f&&0===F&&0!==this[k+u-1]&&(F=1),this[k+u]=(f/A>>0)-F&255;return k+r};g.prototype.writeIntBE=function(f,k,r,u){f=+f;k>>>=0;u||(u=Math.pow(2,8*r-1),z(this,f,k,r,u-1,-u));u=r-1;var A=1,F=0;for(this[k+u]=f&255;0<=--u&&(A*=256);)0>f&&0===F&&0!==this[k+u+1]&&(F=1),this[k+u]=(f/A>>0)-F&255;return k+r};g.prototype.writeInt8=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,1,127,-128);0>f&&(f=255+f+1);this[k]=f&255;return k+
1};g.prototype.writeInt16LE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,2,32767,-32768);this[k]=f&255;this[k+1]=f>>>8;return k+2};g.prototype.writeInt16BE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,2,32767,-32768);this[k]=f>>>8;this[k+1]=f&255;return k+2};g.prototype.writeInt32LE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,4,2147483647,-2147483648);this[k]=f&255;this[k+1]=f>>>8;this[k+2]=f>>>16;this[k+3]=f>>>24;return k+4};g.prototype.writeInt32BE=function(f,k,r){f=+f;k>>>=0;r||z(this,f,k,4,2147483647,
...
this.listener.apply(this.target,arguments)}function p(v,x,z){v={fired:!1,wrapFn:void 0,target:v,type:x,listener:z};x=m.bind(v);x.listener=z;return v.wrapFn=x}function l(v,x,z){v=v._events;if(void 0===v)return[];x=v[x];if(void 0===x)return[];if("function"===typeof x)return z?[x.listener||x]:[x];if(z)for(z=Array(x.length),v=0;v<z.length;++v)z[v]=x[v].listener||x[v];else z=q(x,x.length);return z}function n(v){var x=this._events;if(void 0!==x){v=x[v];if("function"===typeof v)return 1;if(void 0!==v)return v.length}return 0}
...
z)for(x=z.length-1;0<=x;x--)this.removeListener(v,z[x]);return this};d.prototype.listeners=function(v){return l(this,v,!0)};d.prototype.rawListeners=function(v){return l(this,v,!1)};d.listenerCount=function(v,x){return"function"===typeof v.listenerCount?v.listenerCount(x):n.call(v,x)};d.prototype.listenerCount=n;d.prototype.eventNames=function(){return 0<this._eventsCount?C(this._events):[]}},{}],4:[function(a,b,c){c.read=function(d,h,g,m,p){var l=8*p-m-1;var n=(1<<l)-1,q=n>>1,t=-7;p=g?p-1:0;var w=
g?-1:1,y=d[h+p];p+=w;g=y&(1<<-t)-1;y>>=-t;for(t+=l;0<t;g=256*g+d[h+p],p+=w,t-=8);l=g&(1<<-t)-1;g>>=-t;for(t+=m;0<t;l=256*l+d[h+p],p+=w,t-=8);if(0===g)g=1-q;else{if(g===n)return l?NaN:Infinity*(y?-1:1);l+=Math.pow(2,m);g-=q}return(y?-1:1)*l*Math.pow(2,g-m)};c.write=function(d,h,g,m,p,l){var n,q=8*l-p-1,t=(1<<q)-1,w=t>>1,y=23===p?Math.pow(2,-24)-Math.pow(2,-77):0;l=m?0:l-1;var C=m?1:-1,D=0>h||0===h&&0>1/h?1:0;h=Math.abs(h);isNaN(h)||Infinity===h?(h=isNaN(h)?1:0,m=t):(m=Math.floor(Math.log(h)/Math.LN2),
1>h*(n=Math.pow(2,-m))&&(m--,n*=2),h=1<=m+w?h+y/n:h+y*Math.pow(2,1-w),2<=h*n&&(m++,n/=2),m+w>=t?(h=0,m=t):1<=m+w?(h=(h*n-1)*Math.pow(2,p),m+=w):(h=h*Math.pow(2,w-1)*Math.pow(2,p),m=0));for(;8<=p;d[g+l]=h&255,l+=C,h/=256,p-=8);m=m<<p|h;for(q+=p;0<q;d[g+l]=m&255,l+=C,m/=256,q-=8);d[g+l-C]|=128*D}},{}],5:[function(a,b,c){function d(){throw Error("setTimeout has not been defined");}function h(){throw Error("clearTimeout has not been defined");}function g(v){if(t===setTimeout)return setTimeout(v,0);if((t===
d||!t)&&setTimeout)return t=setTimeout,setTimeout(v,0);try{return t(v,0)}catch(x){try{return t.call(null,v,0)}catch(z){return t.call(this,v,0)}}}function m(v){if(w===clearTimeout)return clearTimeout(v);if((w===h||!w)&&clearTimeout)return w=clearTimeout,clearTimeout(v);try{return w(v)}catch(x){try{return w.call(null,v)}catch(z){return w.call(this,v)}}}function p(){C&&D&&(C=!1,D.length?y=D.concat(y):B=-1,y.length&&l())}function l(){if(!C){var v=g(p);C=!0;for(var x=y.length;x;){D=y;for(y=[];++B<x;)D&&
D[B].run();B=-1;x=y.length}D=null;C=!1;m(v)}}function n(v,x){this.fun=v;this.array=x}function q(){}a=b.exports={};try{var t="function"===typeof setTimeout?setTimeout:d}catch(v){t=d}try{var w="function"===typeof clearTimeout?clearTimeout:h}catch(v){w=h}var y=[],C=!1,D,B=-1;a.nextTick=function(v){var x=Array(arguments.length-1);if(1<arguments.length)for(var z=1;z<arguments.length;z++)x[z-1]=arguments[z];y.push(new n(v,x));1!==y.length||C||g(l)};n.prototype.run=function(){this.fun.apply(null,this.array)};
...
v&&D.reduce(function(x,z){var E=z[0];if(x)return x;x=z[1].exec(v);return!!x&&[E,x]},!1)}function g(v){var x=h(v);if(!x)return null;var z=x[0];x=x[1];if("searchbot"===z)return new w;var E=x[1]&&x[1].split(".").join("_").split("_").slice(0,3);if(E){if(3>E.length){x=l([],E,!0);E=3-E.length;for(var G=[],H=0;H<E;H++)G.push("0");E=l(x,G,!0)}}else E=[];x=E.join(".");E=m(v);return(v=C.exec(v))&&v[1]?new t(z,x,E,v[1]):new n(z,x,E)}function m(v){for(var x=0,z=B.length;x<z;x++){var E=B[x],G=E[0];if(E[1].exec(v))return G}return null}
function p(){return"undefined"!==typeof d&&d.version?new q(d.version.slice(1)):null}var l=this&&this.__spreadArray||function(v,x,z){if(z||2===arguments.length)for(var E=0,G=x.length,H;E<G;E++)!H&&E in x||(H||(H=Array.prototype.slice.call(x,0,E)),H[E]=x[E]);return v.concat(H||Array.prototype.slice.call(x))};Object.defineProperty(c,"__esModule",{value:!0});c.getNodeVersion=c.detectOS=c.parseUserAgent=c.browserName=c.detect=c.ReactNativeInfo=c.BotInfo=c.SearchBotDeviceInfo=c.NodeInfo=c.BrowserInfo=void 0;
...
})})}},{}],9:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});var d=a("eventemitter3"),h=a("p-timeout"),g=a("./priority-queue"),m=function(){},p=new h.TimeoutError;a=function(l){var n,q,t,w;var y=d.call(this)||this;y._intervalCount=0;y._intervalEnd=0;y._pendingCount=0;y._resolveEmpty=m;y._resolveIdle=m;l=Object.assign({carryoverConcurrencyCount:!1,intervalCap:Infinity,interval:0,concurrency:Infinity,autoStart:!0,queueClass:g.default},l);if(!("number"===typeof l.intervalCap&&1<=l.intervalCap))throw new TypeError("Expected `intervalCap` to be a number from 1 and up, got `"+
(null!==(q=null===(n=l.intervalCap)||void 0===n?void 0:n.toString())&&void 0!==q?q:"")+"` ("+typeof l.intervalCap+")");if(void 0===l.interval||!(Number.isFinite(l.interval)&&0<=l.interval))throw new TypeError("Expected `interval` to be a finite number >= 0, got `"+(null!==(w=null===(t=l.interval)||void 0===t?void 0:t.toString())&&void 0!==w?w:"")+"` ("+typeof l.interval+")");y._carryoverConcurrencyCount=l.carryoverConcurrencyCount;y._isIntervalIgnored=Infinity===l.intervalCap||0===l.interval;y._intervalCap=
l.intervalCap;y._interval=l.interval;y._queue=new l.queueClass;y._queueClass=l.queueClass;y.concurrency=l.concurrency;y._timeout=l.timeout;y._throwOnTimeout=!0===l.throwOnTimeout;y._isPaused=!1===l.autoStart;return y};$jscomp.inherits(a,d);a.prototype._next=function(){this._pendingCount--;this._tryToStartAnother();this.emit("next")};a.prototype._resolvePromises=function(){this._resolveEmpty();this._resolveEmpty=m;0===this._pendingCount&&(this._resolveIdle(),this._resolveIdle=m,this.emit("idle"))};
...
y){q._queue.enqueue(function(){var C,D,B;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){switch(v.nextAddress){case 1:return q._pendingCount++,q._intervalCount++,v.setCatchFinallyBlocks(2),C=void 0===q._timeout&&void 0===n.timeout?l():h.default(Promise.resolve(l()),void 0===n.timeout?q._timeout:n.timeout,function(){(void 0===n.throwOnTimeout?q._throwOnTimeout:n.throwOnTimeout)&&y(p)}),D=w,v.yield(C,4);case 4:D(v.yieldResult);v.leaveTryBlock(3);break;case 2:B=v.enterCatchBlock(),y(B);
case 3:q._next(),v.jumpToEnd()}})},n);q._tryToStartAnother();q.emit("add")}))})};a.prototype.addAll=function(l,n){var q=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){return t.return(Promise.all(l.map(function(w){return $jscomp.asyncExecutePromiseGeneratorProgram(function(y){return y.return(q.add(w,n))})})))})};a.prototype.start=function(){if(!this._isPaused)return this;this._isPaused=!1;this._processQueue();return this};a.prototype.pause=function(){this._isPaused=!0};a.prototype.clear=
...
a("buffer").Buffer)},{"../util":24,"./base":15,buffer:2}],15:[function(a,b,c){(function(d){(function(){Object.defineProperty(c,"__esModule",{value:!0});c.StreamDeckBase=void 0;var h=a("eventemitter3"),g=function(m,p,l){var n=h.call(this)||this;n.deviceProperties=l;n.device=m;n.keyState=Array(n.NUM_KEYS).fill(!1);n.device.dataKeyOffset=l.KEY_DATA_OFFSET;n.device.on("input",function(q){for(var t=0;t<n.NUM_KEYS;t++){var w=!!q[t],y=n.transformKeyIndex(t);w!==n.keyState[y]&&((n.keyState[y]=w)?n.emit("down",
y):n.emit("up",y))}});n.device.on("error",function(q){n.emit("error",q)});return n};$jscomp.inherits(g,h);g.prototype.checkValidKeyIndex=function(m){if(0>m||m>=this.NUM_KEYS)throw new TypeError("Expected a valid keyIndex 0 - "+(this.NUM_KEYS-1));};g.prototype.close=function(){return this.device.close()};g.prototype.fillKeyColor=function(m,p,l,n){var q=this,t,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(y){q.checkValidKeyIndex(m);q.checkRGBValue(p);q.checkRGBValue(l);q.checkRGBValue(n);
t=d.alloc(q.ICON_BYTES,d.from([p,l,n]));w=q.transformKeyIndex(m);return y.yield(q.fillImageRange(w,t,{format:"rgb",offset:0,stride:3*q.ICON_SIZE}),0)})};g.prototype.fillKeyBuffer=function(m,p,l){var n=this,q,t,w,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(C){n.checkValidKeyIndex(m);t=null!==(q=null===l||void 0===l?void 0:l.format)&&void 0!==q?q:"rgb";n.checkSourceFormat(t);w=n.ICON_PIXELS*t.length;if(p.length!==w)throw new RangeError("Expected image buffer of length "+w+", got length "+
p.length);y=n.transformKeyIndex(m);return C.yield(n.fillImageRange(y,p,{format:t,offset:0,stride:n.ICON_SIZE*t.length}),0)})};g.prototype.fillPanelBuffer=function(m,p){var l=this,n,q,t,w,y,C,D,B,v,x,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(E){q=null!==(n=null===p||void 0===p?void 0:p.format)&&void 0!==n?n:"rgb";l.checkSourceFormat(q);t=l.ICON_PIXELS*q.length*l.NUM_KEYS;if(m.length!==t)throw new RangeError("Expected image buffer of length "+t+", got length "+m.length);w=l.ICON_SIZE*
q.length;y=w*l.KEY_COLUMNS;C=[];for(D=0;D<l.KEY_ROWS;D++)for(B=y*D*l.ICON_SIZE,v=0;v<l.KEY_COLUMNS;v++)x=D*l.KEY_COLUMNS,x="ltr"===l.deviceProperties.KEY_DIRECTION?x+v:x+(l.KEY_COLUMNS-v-1),z=v*w,C.push(l.fillImageRange(x,m,{format:q,offset:B+z,stride:y}));return E.yield(C,0)})};g.prototype.clearKey=function(m){var p=this,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){p.checkValidKeyIndex(m);l=d.alloc(p.ICON_BYTES,0);n=p.transformKeyIndex(m);return q.yield(p.fillImageRange(n,l,
...
c.imageToByteArray=void 0;c.imageToByteArray=function(h,g,m,p,l,n){for(var q=d.alloc(m+n*n*l.length),t=g.format.substring(0,3)!==l.substring(0,3),w=0;w<n;w++)for(var y=m+n*l.length*w,C=0;C<n;C++){var D=p(C,w),B=D.y*g.stride+g.offset+D.x*g.format.length;D=h.readUInt8(B);var v=h.readUInt8(B+1);B=h.readUInt8(B+2);var x=y+C*l.length;t?(q.writeUInt8(B,x),q.writeUInt8(v,x+1),q.writeUInt8(D,x+2)):(q.writeUInt8(D,x),q.writeUInt8(v,x+1),q.writeUInt8(B,x+2));4===l.length&&q.writeUInt8(255,x+3)}return q};c.BMP_HEADER_LENGTH=
