...
var module$contents$Blast$Interpreter_eventInWorkspace=[];Blast.Interpreter.eventInWorkspace=module$contents$Blast$Interpreter_eventInWorkspace;var module$contents$Blast$Interpreter_deviceEventHandlers=[];Blast.Interpreter.deviceEventHandlers=module$contents$Blast$Interpreter_deviceEventHandlers;var module$contents$Blast$Interpreter_cleanUpFunctions=[];Blast.Interpreter.cleanUpFunctions=module$contents$Blast$Interpreter_cleanUpFunctions;
...
setTimeout(module$contents$Blast$Interpreter_runner_,1):module$contents$Blast$Interpreter_interpreter.step()?setTimeout(module$contents$Blast$Interpreter_runner_,1):module$contents$Blast$Interpreter_statesInterpreterRunning||0<module$contents$Blast$Interpreter_eventInWorkspace.length||(module$contents$Blast$Interpreter_setStatus(module$contents$Blast$Interpreter_statusValues.READY),module$contents$Blast$Interpreter_stdInfo("execution completed"),module$contents$Blast$Interpreter_resetInterpreter())}catch(a){module$contents$Blast$Interpreter_throwError(a),
...
Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,f),2)}h=g.yieldResult;module$contents$Blast$Ui_addToLog("Eddystone advertising data set to <code>"+c+"</code>","Eddystone",a);return g.return(h)})};var COLOUR_RGB_XML='\n<block type="colour_rgb">\n    <value name="RED">\n        <block type="math_number">\n            <field name="NUM">100</field>\n        </block>\n    </value>\n    <value name="GREEN">\n        <block type="math_number">\n            <field name="NUM">50</field>\n        </block>\n    </value>\n    <value name="BLUE">\n        <block type="math_number">\n            <field name="NUM">0</field>\n        </block>\n    </value>\n</block>';
...
var waitForSeconds=function(a,b){setTimeout(b,1E3*a)};module$contents$Blast$Interpreter_asyncApiFunctions.push(["waitForSeconds",waitForSeconds]);Blockly.JavaScript.state_definition=function(a){return null};
...
this.setHelpUrl("");this.requested=!1},addEvent:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){module$contents$Blast$Interpreter_eventInWorkspace.push(a.id);module$contents$Blast$Interpreter_getWorkspace().addChangeListener(function(c){return a.onDispose(c)});b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==
a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=module$contents$Blast$Interpreter_eventInWorkspace.indexOf(this.id);-1!==a&&module$contents$Blast$Interpreter_eventInWorkspace.splice(a,1)}};module$contents$Blast$Toolbox_addBlock("joycon_button_events","States and Events");Blockly.JavaScript.joycon_read_property=function(a){var b=a.getFieldValue("property"),c=a.getFieldValue("propertySubValue")||"",d=a.getFieldValue("propertySubValue2")||"",f=a.getFieldValue("propertySubValue3")||"";return["readJoyConProperty("+Blockly.JavaScript.valueToCode(a,"Thing",Blockly.JavaScript.ORDER_NONE)+", '"+b+"', '"+c+"', '"+d+"', '"+f+"')",Blockly.JavaScript.ORDER_NONE]};
...
"button6")}),"button6");this.appendDummyInput().appendField("do");this.appendStatementInput("statements").setCheck(null);this.setColour(180);this.setTooltip("");this.setHelpUrl("");this.requested=!1;this.keyState=Array(6).fill(!1)},uncheckAllOtherCheckboxes:function(a,b){if("TRUE"===a)for(a=1;6>=a;a++)"button"+a!=b&&this.setFieldValue("FALSE","button"+a)},addEvent:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){module$contents$Blast$Interpreter_eventInWorkspace.push(a.id);
module$contents$Blast$Interpreter_getWorkspace().addChangeListener(function(c){return a.onDispose(c)});b.jumpToEnd()})},onchange:function(){this.isInFlyout||this.requested||!this.rendered||this.addEvent()},onDispose:function(a){a.type===Blockly.Events.BLOCK_DELETE&&a.type===Blockly.Events.BLOCK_DELETE&&-1!==a.ids.indexOf(this.id)&&this.removeFromEvents()},removeFromEvents:function(){var a=module$contents$Blast$Interpreter_eventInWorkspace.indexOf(this.id);-1!==a&&module$contents$Blast$Interpreter_eventInWorkspace.splice(a,
