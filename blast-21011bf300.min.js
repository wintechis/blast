...
m){function p(t){return function(u){q[t]=u;r--;0==r&&l(q)}}var q=[],r=0;do q.push(void 0),r++,c(k.value).callWhenSettled_(p(q.length-1),m),k=n.next();while(!k.done)})};return f},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,f){return c==a&&"q"==d&&f==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");var Blast={States:{}};Blast.States.Interpreter=null;Blast.States.runner_=null;Blast.States.latestCode="";Blast.States.eventCode=new Map;Blast.States.eventValues=new Map;Blast.States.eventChecker=function(a,b){var c=Blast.States.eventValues.get(a);Blast.States.eventValues.set(a,b);return void 0!=c?!c&&b:!1};Blast.States.addEventCode=function(a,b){Blast.States.eventCode.set(a,b)};Blast.States.removeEventCode=function(a){Blast.States.eventCode.delete(a)};
...
Blast.Storage.generatePairButtonsDesktop_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$67:f.$jscomp$loop$prop$type$67,$jscomp$loop$prop$name$68:f.$jscomp$loop$prop$name$68,$jscomp$loop$prop$block$69:f.$jscomp$loop$prop$block$69},g=b.next()){f.$jscomp$loop$prop$block$69=g.value;f.$jscomp$loop$prop$type$67=f.$jscomp$loop$prop$block$69.getAttribute("type");
if("things_webBluetooth"==f.$jscomp$loop$prop$type$67||"things_webHID"==f.$jscomp$loop$prop$type$67){f.$jscomp$loop$prop$name$68=f.$jscomp$loop$prop$block$69.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$68))continue;g=document.createElement("tr");var h=document.createElement("td");h.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$68));var n=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+
f.$jscomp$loop$prop$name$68);k.setAttribute("value","Pair");var l=document.createElement("td"),m=document.createElement("span");m.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$68);m.innerHTML="&#x2718;";m.style.color="red";m.style.fontSize="20px";m.style.fontWeight="bold";m.style.marginRight="10px";l.appendChild(m);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=
p.$jscomp$loop$prop$type$67?("things_webHID"==p.$jscomp$loop$prop$type$67&&(q=[],navigator.hid.requestDevice({filters:q}).then(function(u){0===u.length&&Blast.throwError("Connection failed or cancelled by User.");var v=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(v,u[0]);Blast.Things.addWebHidDevice(v,p.$jscomp$loop$prop$name$68);document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$68).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
p.$jscomp$loop$prop$name$68).style.color="green";p.$jscomp$loop$prop$block$69.firstElementChild.textContent=v;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(u){Blast.throwError("Connection failed or cancelled by User.");
console.error(u)})),t.jumpTo(0)):t.yield(Blast.Bluetooth.requestDevice(),3);r=t.yieldResult;document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$68).innerHTML="&#x2714;";document.getElementById("pairStatus-"+p.$jscomp$loop$prop$name$68).style.color="green";p.$jscomp$loop$prop$block$69.firstElementChild.textContent=r.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));t.jumpToEnd()})}}(f));n.appendChild(k);g.appendChild(h);g.appendChild(n);g.appendChild(l);c.appendChild(g);d.push(f.$jscomp$loop$prop$name$68)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
Blast.Storage.generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var g=b.next();!g.done;f={$jscomp$loop$prop$type$71:f.$jscomp$loop$prop$type$71,$jscomp$loop$prop$name$72:f.$jscomp$loop$prop$name$72,$jscomp$loop$prop$block$73:f.$jscomp$loop$prop$block$73},g=b.next())if(f.$jscomp$loop$prop$block$73=g.value,f.$jscomp$loop$prop$type$71=f.$jscomp$loop$prop$block$73.getAttribute("type"),
"things_webBluetooth"==f.$jscomp$loop$prop$type$71||"things_webHID"==f.$jscomp$loop$prop$type$71)if(f.$jscomp$loop$prop$name$72=f.$jscomp$loop$prop$block$73.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$72)){g=document.createElement("li");g.setAttribute("id","rc-item-"+f.$jscomp$loop$prop$name$72);g.setAttribute("class","mdc-list-item");var h=document.createElement("span");h.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$72);h.setAttribute("class","mdc-list-item__graphic material-icons");
h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$71?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var n=document.createElement("span");n.setAttribute("class","mdc-list-item__primary-text");n.innerHTML=f.$jscomp$loop$prop$name$72;h.appendChild(n);n=document.createElement("span");n.setAttribute("class","mdc-list-item__secondary-text");n.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$72);
n.innerHTML="disconnected";h.appendChild(n);g.appendChild(h);g.addEventListener("click",function(k){return function(){var l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$71?("things_webHID"==k.$jscomp$loop$prop$type$71&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
Blast.Things.webHidDevices.set(r,q[0]);Blast.Things.addWebHidDevice(r,k.$jscomp$loop$prop$name$72);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$72).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$72).innerHTML="usb";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$72).style.color="#0d30b1";k.$jscomp$loop$prop$block$73.firstElementChild.textContent=r;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(q){Blast.throwError("Connection failed or cancelled by User.");console.error(q)})),p.jumpTo(0)):p.yield(Blast.Bluetooth.requestDevice(),3);m=p.yieldResult;Blast.Things.addWebBluetoothDevice(m.id,k.$jscomp$loop$prop$name$72);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$72).innerHTML=
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$72).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$72).style.color="#0d30b1";k.$jscomp$loop$prop$block$73.firstElementChild.textContent=m.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
function(){return Blast.Storage.reconnectDoneHandler_(a)})));p.jumpToEnd()})}}(f));c.appendChild(g);d.push(f.$jscomp$loop$prop$name$72)}window.app.initLists()};Blast.Storage.allConnectedDesktop_=function(){var a=document.getElementById("rc-tbody").querySelectorAll("tr");a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if("\u2718"==document.getElementById("pairStatus-"+b.value.firstElementChild.textContent).innerHTML)return!1;return!0};
...
for(d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createAsyncFunction(d[1]));c=function(f,g){return Blast.States.eventChecker(f,g)};a.setProperty(b,"eventChecker",a.createNativeFunction(c));a.setProperty(b,"startEventChecker",a.createNativeFunction(function(){return Blast.States.startEventChecker()}));c=function(f){return prompt(f)};a.setProperty(b,"prompt",a.createNativeFunction(c))};Blockly.JavaScript.repeat=Blockly.JavaScript.controls_repeat_ext;Blockly.JavaScript.while_until=Blockly.JavaScript.controls_whileUntil;Blockly.JavaScript["for"]=Blockly.JavaScript.controls_for;Blockly.JavaScript.break_continue=Blockly.JavaScript.controls_flow_statements;Blockly.JavaScript.conditional_statement=Blockly.JavaScript.controls_if;Blockly.JavaScript.wait_seconds=function(a){return"waitForSeconds("+(Blockly.JavaScript.valueToCode(a,"SECONDS",Blockly.JavaScript.ORDER_ATOMIC)||0)+");\n"};
...
this.setColour(0);this.setOutput(!0,"table");this.setTooltip("Executes a sparql query")}};Blast.Toolbox.addBlock("sparql_query","Requests and Queries");
...
var urdfQueryWrapper=function(a,b,c,d){var f,g,h,n,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.setCatchFinallyBlocks(2),l.yield(fetch(a),4);case 4:return f=l.yieldResult,f.ok?l.yield(f.text(),5):(Blast.throwError("Failed to get "+a+", Error: "+f.status+" "+f.statusText),l.return());case 5:return g=l.yieldResult,urdf.clear(),h={format:b},l.yield(urdf.load(g,h),6);case 6:return l.yield(urdf.query(c),7);case 7:n=l.yieldResult;d(n);l.leaveTryBlock(0);
break;case 2:k=l.enterCatchBlock(),Blast.throwError("Failed to get "+a+", Error: "+k.message),l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["urdfQueryWrapper",urdfQueryWrapper]);Blockly.JavaScript.display_text=function(a){return"displayText("+(Blockly.JavaScript.valueToCode(a,"text",Blockly.JavaScript.ORDER_NONE)||"''")+");\n"};var displayText=function(a){Blast.Ui.addMessage(a)};Blast.apiFunctions.push(["displayText",displayText]);
