...
m.callWhenSettled_(p.resolve,p.reject)};h.prototype.settleSameAsThenable_=function(m,p){var l=this.createResolveAndReject_();try{m.call(p,l.resolve,l.reject)}catch(n){l.reject(n)}};h.prototype.then=function(m,p){function l(w,z){return"function"==typeof w?function(B){try{n(w(B))}catch(D){q(D)}}:z}var n,q,t=new h(function(w,z){n=w;q=z});this.callWhenSettled_(l(m,n),l(p,q));return t};h.prototype.catch=function(m){return this.then(void 0,m)};h.prototype.callWhenSettled_=function(m,p){function l(){switch(n.state_){case 1:m(n.result_);
...
q){function t(B){return function(D){w[B]=D;z--;0==z&&n(w)}}var w=[],z=0;do w.push(void 0),z++,c(l.value).callWhenSettled_(t(w.length-1),q),l=p.next();while(!l.done)})};return h},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,h){return c==a&&"q"==d&&h==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
...
h.$jscomp$loop$prop$name$62);l.setAttribute("value","Pair");var n=document.createElement("td"),q=document.createElement("span");q.setAttribute("id","pairStatus-"+h.$jscomp$loop$prop$name$62);q.innerHTML="&#x2718;";q.style.color="red";q.style.fontSize="20px";q.style.fontWeight="bold";q.style.marginRight="10px";n.appendChild(q);l.addEventListener("click",function(t){return function(){var w,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){if(1==B.nextAddress)return"things_webBluetooth"!=
t.$jscomp$loop$prop$type$61?("things_webHID"==t.$jscomp$loop$prop$type$61&&(w=[],navigator.hid.requestDevice({filters:w}).then(function(D){0===D.length&&Blast.throwError("Connection failed or cancelled by User.");var C=Date.now().toString(36)+Math.random().toString(36).substr(2);Blast.Things.webHidDevices.set(C,D[0]);Blast.Things.addWebHidDevice(C,t.$jscomp$loop$prop$name$62);document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$62).innerHTML="&#x2714;";document.getElementById("pairStatus-"+
t.$jscomp$loop$prop$name$62).style.color="green";t.$jscomp$loop$prop$block$63.firstElementChild.textContent=C;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})))}).catch(function(D){Blast.throwError("Connection failed or cancelled by User.");
console.error(D)})),B.jumpTo(0)):B.yield(Blast.Bluetooth.requestDevice(),3);z=B.yieldResult;document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$62).innerHTML="&#x2714;";document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$62).style.color="green";t.$jscomp$loop$prop$block$63.firstElementChild.textContent=z.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
!0),document.getElementById("rc-done").addEventListener("click",function(){return Blast.Storage.reconnectDoneHandler_(a)})));B.jumpToEnd()})}}(h));p.appendChild(l);g.appendChild(m);g.appendChild(p);g.appendChild(n);c.appendChild(g);d.push(h.$jscomp$loop$prop$name$62)}document.getElementById("rc-cancel").addEventListener("click",function(){return Blast.Storage.reconnectCancelHandler_()})}};
...
d=h(d);p.setCatchFinallyBlocks(3);console.log("Writing to "+g.uuid);return p.yield(g.writeValueWithoutResponse(d),5);case 5:console.log("Wrote to "+g.uuid);p.leaveTryBlock(4);break;case 3:m=p.enterCatchBlock(),console.error(m),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block.");case 4:return p.yield(Blast.Bluetooth.disconnect(a),6);case 6:console.log("Disconnected from "+a),p.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a),2);case 2:return c=g.yieldResult,console.log("connected to "+c),g.setCatchFinallyBlocks(3),console.log("Getting primary service "+b+" from "+a),g.yield(c.getPrimaryService(b),5);case 5:d=g.yieldResult;console.log("Got primary service "+b+" from "+a);g.leaveTryBlock(4);break;case 3:h=g.enterCatchBlock(),console.error(h),
Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,h,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:return m.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=m.yieldResult;if(!d)return m.return();m.setCatchFinallyBlocks(3);console.log("Getting characteristic "+c+" from "+a);return m.yield(d.getCharacteristic(c),5);case 5:h=m.yieldResult;console.log("Got characteristic "+c+" from "+a);m.leaveTryBlock(4);break;case 3:g=m.enterCatchBlock(),
console.error(g),Blast.throwError("The device is not compatible with the connected block.");case 4:return m.return(h)}})};
...
a.next()){var c=Blast.Bluetooth.charEventListeners[b.value];b=c[0];var d=c[1];c=c[2];b.stopNotifications();b.removeEventListener(d,c)}Blast.Bluetooth.charEventListeners={}}Blast.Bluetooth.LEScanResults={}};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(h){h=h?h.toString():"";return Blast.highlightBlock(h)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(h){Blast.Interrupted=h};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
t,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(z){q=n.detail;if(!q||!q.actualOrientation)return z.return();q.buttonStatus[b]?m||(m=!0,Blast.Interrupted=!1,t=new Interpreter(""),t.stateStack[0].scope=Blast.Interpreter.globalScope,t.appendCode(c),w=function(){try{t.step()?setTimeout(w,5):Blast.Interrupted=!1}catch(B){Blast.throwError("Error executing program:\n "+e),console.error(B)}},w()):m=!1;z.jumpToEnd()})};Blast.deviceEventHandlers.push({device:g,type:"hidinput",fn:p});if(g.eventListenerAttached){l.jumpTo(0);
...
var handleStreamdeck=function(a,b,c,d,h){var g,m,p,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),h(),q.return();g=Blast.Things.webHidDevices.get(a);if(!g)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),h(),q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(g),4);case 4:m=q.yieldResult;q.leaveTryBlock(3);
break;case 2:p=q.enterCatchBlock();if("InvalidStateError"!=p.name)return Blast.throwError(p),h(),q.return();g.close();return q.yield(StreamDeck.openDevice(g),6);case 6:m=q.yieldResult;case 3:for(n=0;n<b.length;n++)if(1===b.indexOf(n)){l=n;break}if(void 0===l)return h(),q.return();m.on(c,function(t){if(t===l){Blast.Interrupted=!0;var w=new Interpreter("");w.stateStack[0].scope=Blast.Interpreter.globalScope;w.appendCode(d);var z=function(){try{w.step()?setTimeout(z,5):Blast.Interrupted=!1}catch(B){Blast.throwError("Error executing program:\n "+
e),console.error(B)}};z()}});Blast.cleanUpFunctions.push(function(){m.close();m.removeAllListeners()});q.jumpToEnd()}})};Blast.asyncApiFunctions.push(["handleStreamdeck",handleStreamdeck]);/*
...
n&255);1===l&&(n=g[p.charCodeAt(z)]<<10|g[p.charCodeAt(z+1)]<<4|g[p.charCodeAt(z+2)]>>2,q[t++]=n>>8&255,q[t++]=n&255);return q};c.fromByteArray=function(p){for(var l=p.length,n=l%3,q=[],t=0,w=l-n;t<w;t+=16383){for(var z=q,B=z.push,D,C=p,v=t+16383>w?w:t+16383,x=[],y=t;y<v;y+=3)D=(C[y]<<16&16711680)+(C[y+1]<<8&65280)+(C[y+2]&255),x.push(h[D>>18&63]+h[D>>12&63]+h[D>>6&63]+h[D&63]);D=x.join("");B.call(z,D)}1===n?(p=p[l-1],q.push(h[p>>2]+h[p<<4&63]+"==")):2===n&&(p=(p[l-2]<<8)+p[l-1],q.push(h[p>>10]+h[p>>
...
f);f=(f+"").toLowerCase();u=!0}}function B(f,k,r){var u=f[k];f[k]=f[r];f[r]=u}function D(f,k,r,u,A){if(0===f.length)return-1;"string"===typeof r?(u=r,r=0):2147483647<r?r=2147483647:-2147483648>r&&(r=-2147483648);r=+r;r!==r&&(r=A?0:f.length-1);0>r&&(r=f.length+r);if(r>=f.length){if(A)return-1;r=f.length-1}else if(0>r)if(A)r=0;else return-1;"string"===typeof k&&(k=g.from(k,u));if(g.isBuffer(k))return 0===k.length?-1:C(f,k,r,u,A);if("number"===typeof k)return k&=255,"function"===typeof Uint8Array.prototype.indexOf?
A?Uint8Array.prototype.indexOf.call(f,k,r):Uint8Array.prototype.lastIndexOf.call(f,k,r):C(f,[k],r,u,A);throw new TypeError("val must be string, number or Buffer");}function C(f,k,r,u,A){function F(O,T){return 1===I?O[T]:O.readUInt16BE(T*I)}var I=1,J=f.length,K=k.length;if(void 0!==u&&(u=String(u).toLowerCase(),"ucs2"===u||"ucs-2"===u||"utf16le"===u||"utf-16le"===u)){if(2>f.length||2>k.length)return-1;I=2;J/=2;K/=2;r/=2}if(A)for(u=-1;r<J;r++)if(F(f,r)===F(k,-1===u?0:r-u)){if(-1===u&&(u=r),r-u+1===
...
typeof a.apply?a.apply:function(v,x,y){return Function.prototype.apply.call(v,x,y)};var B=a&&"function"===typeof a.ownKeys?a.ownKeys:Object.getOwnPropertySymbols?function(v){return Object.getOwnPropertyNames(v).concat(Object.getOwnPropertySymbols(v))}:function(v){return Object.getOwnPropertyNames(v)};var D=Number.isNaN||function(v){return v!==v};b.exports=d;b.exports.once=function(v,x){return new Promise(function(y,E){function G(L){v.removeListener(x,H);E(L)}function H(){"function"===typeof v.removeListener&&
v.removeListener("error",G);y([].slice.call(arguments))}w(v,x,H,{once:!0});"error"!==x&&t(v,G,{once:!0})})};d.EventEmitter=d;d.prototype._events=void 0;d.prototype._eventsCount=0;d.prototype._maxListeners=void 0;var C=10;Object.defineProperty(d,"defaultMaxListeners",{enumerable:!0,get:function(){return C},set:function(v){if("number"!==typeof v||0>v||D(v))throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received '+v+".");C=v}});d.init=function(){if(void 0===
...
y)for(x=y.length-1;0<=x;x--)this.removeListener(v,y[x]);return this};d.prototype.listeners=function(v){return l(this,v,!0)};d.prototype.rawListeners=function(v){return l(this,v,!1)};d.listenerCount=function(v,x){return"function"===typeof v.listenerCount?v.listenerCount(x):n.call(v,x)};d.prototype.listenerCount=n;d.prototype.eventNames=function(){return 0<this._eventsCount?B(this._events):[]}},{}],4:[function(a,b,c){c.read=function(d,h,g,m,p){var l=8*p-m-1;var n=(1<<l)-1,q=n>>1,t=-7;p=g?p-1:0;var w=
g?-1:1,z=d[h+p];p+=w;g=z&(1<<-t)-1;z>>=-t;for(t+=l;0<t;g=256*g+d[h+p],p+=w,t-=8);l=g&(1<<-t)-1;g>>=-t;for(t+=m;0<t;l=256*l+d[h+p],p+=w,t-=8);if(0===g)g=1-q;else{if(g===n)return l?NaN:Infinity*(z?-1:1);l+=Math.pow(2,m);g-=q}return(z?-1:1)*l*Math.pow(2,g-m)};c.write=function(d,h,g,m,p,l){var n,q=8*l-p-1,t=(1<<q)-1,w=t>>1,z=23===p?Math.pow(2,-24)-Math.pow(2,-77):0;l=m?0:l-1;var B=m?1:-1,D=0>h||0===h&&0>1/h?1:0;h=Math.abs(h);isNaN(h)||Infinity===h?(h=isNaN(h)?1:0,m=t):(m=Math.floor(Math.log(h)/Math.LN2),
1>h*(n=Math.pow(2,-m))&&(m--,n*=2),h=1<=m+w?h+z/n:h+z*Math.pow(2,1-w),2<=h*n&&(m++,n/=2),m+w>=t?(h=0,m=t):1<=m+w?(h=(h*n-1)*Math.pow(2,p),m+=w):(h=h*Math.pow(2,w-1)*Math.pow(2,p),m=0));for(;8<=p;d[g+l]=h&255,l+=B,h/=256,p-=8);m=m<<p|h;for(q+=p;0<q;d[g+l]=m&255,l+=B,m/=256,q-=8);d[g+l-B]|=128*D}},{}],5:[function(a,b,c){function d(){throw Error("setTimeout has not been defined");}function h(){throw Error("clearTimeout has not been defined");}function g(v){if(t===setTimeout)return setTimeout(v,0);if((t===
d||!t)&&setTimeout)return t=setTimeout,setTimeout(v,0);try{return t(v,0)}catch(x){try{return t.call(null,v,0)}catch(y){return t.call(this,v,0)}}}function m(v){if(w===clearTimeout)return clearTimeout(v);if((w===h||!w)&&clearTimeout)return w=clearTimeout,clearTimeout(v);try{return w(v)}catch(x){try{return w.call(null,v)}catch(y){return w.call(this,v)}}}function p(){B&&D&&(B=!1,D.length?z=D.concat(z):C=-1,z.length&&l())}function l(){if(!B){var v=g(p);B=!0;for(var x=z.length;x;){D=z;for(z=[];++C<x;)D&&
D[C].run();C=-1;x=z.length}D=null;B=!1;m(v)}}function n(v,x){this.fun=v;this.array=x}function q(){}a=b.exports={};try{var t="function"===typeof setTimeout?setTimeout:d}catch(v){t=d}try{var w="function"===typeof clearTimeout?clearTimeout:h}catch(v){w=h}var z=[],B=!1,D,C=-1;a.nextTick=function(v){var x=Array(arguments.length-1);if(1<arguments.length)for(var y=1;y<arguments.length;y++)x[y-1]=arguments[y];z.push(new n(v,x));1!==z.length||B||g(l)};n.prototype.run=function(){this.fun.apply(null,this.array)};
...
v&&D.reduce(function(x,y){var E=y[0];if(x)return x;x=y[1].exec(v);return!!x&&[E,x]},!1)}function g(v){var x=h(v);if(!x)return null;var y=x[0];x=x[1];if("searchbot"===y)return new w;var E=x[1]&&x[1].split(".").join("_").split("_").slice(0,3);if(E){if(3>E.length){x=l([],E,!0);E=3-E.length;for(var G=[],H=0;H<E;H++)G.push("0");E=l(x,G,!0)}}else E=[];x=E.join(".");E=m(v);return(v=B.exec(v))&&v[1]?new t(y,x,E,v[1]):new n(y,x,E)}function m(v){for(var x=0,y=C.length;x<y;x++){var E=C[x],G=E[0];if(E[1].exec(v))return G}return null}
...
this.type="react-native";this.os=this.version=null}}();c.ReactNativeInfo=z;var B=/(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask Jeeves\/Teoma|ia_archiver)/,D=[["aol",/AOLShield\/([0-9\._]+)/],["edge",/Edge\/([0-9\._]+)/],["edge-ios",/EdgiOS\/([0-9\._]+)/],["yandexbrowser",/YaBrowser\/([0-9\._]+)/],["kakaotalk",/KAKAOTALK\s([0-9\.]+)/],["samsung",/SamsungBrowser\/([0-9\.]+)/],["silk",/\bSilk\/([0-9._-]+)\b/],["miui",/MiuiBrowser\/([0-9\.]+)$/],["beaker",/BeakerBrowser\/([0-9\.]+)/],["edge-chromium",
...
null};c.parseUserAgent=g;c.detectOS=m;c.getNodeVersion=p}).call(this)}).call(this,a("_process"))},{_process:5}],7:[function(a,b,c){function d(){}function h(q,t,w){this.fn=q;this.context=t;this.once=w||!1}function g(q,t,w,z,B){if("function"!==typeof w)throw new TypeError("The listener must be a function");w=new h(w,z||q,B);t=n?n+t:t;q._events[t]?q._events[t].fn?q._events[t]=[q._events[t],w]:q._events[t].push(w):(q._events[t]=w,q._eventsCount++);return q}function m(q,t){0===--q._eventsCount?q._events=
...
for(var t=0,w=q.length,z=Array(w);t<w;t++)z[t]=q[t].fn;return z};p.prototype.listenerCount=function(q){return(q=this._events[n?n+q:q])?q.fn?1:q.length:0};p.prototype.emit=function(q,t,w,z,B,D){var C=n?n+q:q;if(!this._events[C])return!1;C=this._events[C];var v=arguments.length,x;if(C.fn){C.once&&this.removeListener(q,C.fn,void 0,!0);switch(v){case 1:return C.fn.call(C.context),!0;case 2:return C.fn.call(C.context,t),!0;case 3:return C.fn.call(C.context,t,w),!0;case 4:return C.fn.call(C.context,t,w,
z),!0;case 5:return C.fn.call(C.context,t,w,z,B),!0;case 6:return C.fn.call(C.context,t,w,z,B,D),!0}var y=1;for(x=Array(v-1);y<v;y++)x[y-1]=arguments[y];C.fn.apply(C.context,x)}else{var E=C.length;for(y=0;y<E;y++)switch(C[y].once&&this.removeListener(q,C[y].fn,void 0,!0),v){case 1:C[y].fn.call(C[y].context);break;case 2:C[y].fn.call(C[y].context,t);break;case 3:C[y].fn.call(C[y].context,t,w);break;case 4:C[y].fn.call(C[y].context,t,w,z);break;default:if(!x){var G=1;for(x=Array(v-1);G<v;G++)x[G-1]=
arguments[G]}C[y].fn.apply(C[y].context,x)}}return!0};p.prototype.on=function(q,t,w){return g(this,q,t,w,!1)};p.prototype.once=function(q,t,w){return g(this,q,t,w,!0)};p.prototype.removeListener=function(q,t,w,z){q=n?n+q:q;if(!this._events[q])return this;if(!t)return m(this,q),this;var B=this._events[q];if(B.fn)B.fn!==t||z&&!B.once||w&&B.context!==w||m(this,q);else{for(var D=0,C=[],v=B.length;D<v;D++)(B[D].fn!==t||z&&!B[D].once||w&&B[D].context!==w)&&C.push(B[D]);C.length?this._events[q]=1===C.length?
C[0]:C:m(this,q)}return this};p.prototype.removeAllListeners=function(q){q?(q=n?n+q:q,this._events[q]&&m(this,q)):(this._events=new d,this._eventsCount=0);return this};p.prototype.off=p.prototype.removeListener;p.prototype.addListener=p.prototype.on;p.prefixed=n;p.EventEmitter=p;"undefined"!==typeof b&&(b.exports=p)},{}],8:[function(a,b,c){b.exports=function(d,h){h=h||function(){};return d.then(function(g){return(new Promise(function(m){m(h())})).then(function(){return g})},function(g){return(new Promise(function(m){m(h())})).then(function(){throw g;
...
z){q._queue.enqueue(function(){var B,D,C;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){switch(v.nextAddress){case 1:return q._pendingCount++,q._intervalCount++,v.setCatchFinallyBlocks(2),B=void 0===q._timeout&&void 0===n.timeout?l():h.default(Promise.resolve(l()),void 0===n.timeout?q._timeout:n.timeout,function(){(void 0===n.throwOnTimeout?q._throwOnTimeout:n.throwOnTimeout)&&z(p)}),D=w,v.yield(B,4);case 4:D(v.yieldResult);v.leaveTryBlock(3);break;case 2:C=v.enterCatchBlock(),z(C);
...
t=d.alloc(q.ICON_BYTES,d.from([p,l,n]));w=q.transformKeyIndex(m);return z.yield(q.fillImageRange(w,t,{format:"rgb",offset:0,stride:3*q.ICON_SIZE}),0)})};g.prototype.fillKeyBuffer=function(m,p,l){var n=this,q,t,w,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){n.checkValidKeyIndex(m);t=null!==(q=null===l||void 0===l?void 0:l.format)&&void 0!==q?q:"rgb";n.checkSourceFormat(t);w=n.ICON_PIXELS*t.length;if(p.length!==w)throw new RangeError("Expected image buffer of length "+w+", got length "+
p.length);z=n.transformKeyIndex(m);return B.yield(n.fillImageRange(z,p,{format:t,offset:0,stride:n.ICON_SIZE*t.length}),0)})};g.prototype.fillPanelBuffer=function(m,p){var l=this,n,q,t,w,z,B,D,C,v,x,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(E){q=null!==(n=null===p||void 0===p?void 0:p.format)&&void 0!==n?n:"rgb";l.checkSourceFormat(q);t=l.ICON_PIXELS*q.length*l.NUM_KEYS;if(m.length!==t)throw new RangeError("Expected image buffer of length "+t+", got length "+m.length);w=l.ICON_SIZE*
q.length;z=w*l.KEY_COLUMNS;B=[];for(D=0;D<l.KEY_ROWS;D++)for(C=z*D*l.ICON_SIZE,v=0;v<l.KEY_COLUMNS;v++)x=D*l.KEY_COLUMNS,x="ltr"===l.deviceProperties.KEY_DIRECTION?x+v:x+(l.KEY_COLUMNS-v-1),y=v*w,B.push(l.fillImageRange(x,m,{format:q,offset:C+y,stride:z}));return E.yield(B,0)})};g.prototype.clearKey=function(m){var p=this,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){p.checkValidKeyIndex(m);l=d.alloc(p.ICON_BYTES,0);n=p.transformKeyIndex(m);return q.yield(p.fillImageRange(n,l,
...
c.imageToByteArray=void 0;c.imageToByteArray=function(h,g,m,p,l,n){for(var q=d.alloc(m+n*n*l.length),t=g.format.substring(0,3)!==l.substring(0,3),w=0;w<n;w++)for(var z=m+n*l.length*w,B=0;B<n;B++){var D=p(B,w),C=D.y*g.stride+g.offset+D.x*g.format.length;D=h.readUInt8(C);var v=h.readUInt8(C+1);C=h.readUInt8(C+2);var x=z+B*l.length;t?(q.writeUInt8(C,x),q.writeUInt8(v,x+1),q.writeUInt8(D,x+2)):(q.writeUInt8(D,x),q.writeUInt8(v,x+1),q.writeUInt8(C,x+2));4===l.length&&q.writeUInt8(255,x+3)}return q};c.BMP_HEADER_LENGTH=
...
q.nextAddress?q.yield(new Promise(function(t,w){var z=document.createElement("canvas");z.width=g;z.height=m;var B=z.getContext("2d");if(B){var D=B.createImageData(g,m);D.data.set(h);B.putImageData(D,0,0);z.toBlob(function(C){C?t(C):w()},"image/jpeg",.9)}else w()}),2):3!=q.nextAddress?(p=q.yieldResult,l=d,n=l.from,q.yield(p.arrayBuffer(),3)):q.return(n.call(l,q.yieldResult))})}}).call(this)}).call(this,a("buffer").Buffer)},{buffer:2}],27:[function(a,b,c){(function(d){(function(){Object.defineProperty(c,
...
m=m.getImageData(0,0,this.ICON_SIZE*this.KEY_COLUMNS,this.ICON_SIZE*this.KEY_ROWS);return this.device.fillPanelBuffer(d.from(m.data),{format:"rgba"})};c.StreamDeckWeb=g}).call(this)}).call(this,a("buffer").Buffer)},{"@elgato-stream-deck/core":13,buffer:2}],"@elgato-stream-deck/webhid":[function(a,b,c){function d(t,w){var z,B,D,C;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){if(1==v.nextAddress){z=g.DEVICE_MODELS.find(function(x){return x.productId===t.productId});if(!z)throw Error("Stream Deck is of unexpected type.");
if(z.id===g.DeviceModelId.ORIGINAL&&(B=h.detect())&&"Linux"===B.os)throw Error("This is not supported on linux");return v.yield(t.open(),2)}D=Object.assign({},{useOriginalKeyOrder:!1,encodeJPEG:p.encodeJPEG},w);C=new z.class(new m.WebHIDDevice(t),D||{});return v.return(new l.StreamDeckWeb(C))})}Object.defineProperty(c,"__esModule",{value:!0});c.openDevice=c.getStreamDecks=c.requestStreamDecks=c.StreamDeckWeb=c.DeviceModelId=void 0;var h=a("detect-browser"),g=a("@elgato-stream-deck/core"),m=a("./device"),
p=a("./jpeg"),l=a("./wrapper"),n=a("@elgato-stream-deck/core");Object.defineProperty(c,"DeviceModelId",{enumerable:!0,get:function(){return n.DeviceModelId}});var q=a("./wrapper");Object.defineProperty(c,"StreamDeckWeb",{enumerable:!0,get:function(){return q.StreamDeckWeb}});c.requestStreamDecks=function(t){return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){return w.return(navigator.hid.requestDevice({filters:[{vendorId:g.VENDOR_ID}]}).then(function(z){return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){return B.return(Promise.all(z.map(function(D){return d(D,
t)})))})}))})};c.getStreamDecks=function(t){return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){return w.return(navigator.hid.getDevices().then(function(z){return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){return B.return(Promise.all(z.map(function(D){return d(D,t)})))})}))})};c.openDevice=d},{"./device":25,"./jpeg":26,"./wrapper":27,"@elgato-stream-deck/core":13,"detect-browser":6}]},{},[]);Blockly.Blocks.text_to_speech={init:function(){this.appendValueInput("text").appendField("Text to Speech").setCheck("String");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setColour(0);this.setTooltip("");this.setHelpUrl("")}};Blast.Toolbox.addBlock("text_to_speech","actions");
