...
Blockly.Blocks['sparql_query'] = {
    ...
    init: function () {
        ...
        this.appendDummyInput().appendField(new Blockly.FieldMultilineInput(`SELECT *
       WHERE { 
         ?s ?p ?o
       }`), 'query');
...
Blockly.Blocks['sparql_ask'] = {
    ...
    init: function () {
        ...
        this.appendDummyInput().appendField(new Blockly.FieldMultilineInput(`PREFIX sosa: <http://www.w3.org/ns/sosa/>
     ASK 
     WHERE {
