...
Blockly.JavaScript['streamdeck_button_event'] = function (block) {
    ...
    const id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_NONE) || null;
    const buttons = Blockly.JavaScript.quote_(`${button1}${button2}${button3}${button4}${button5}${button6}`);
...
Blockly.JavaScript['streamdeck_color_buttons'] = function (block) {
    ...
    const button5 = block.getFieldValue('button5') == 'TRUE' ? 1 : 0;
    const button6 = block.getFieldValue('button6') == 'TRUE' ? 1 : 0;
    const color = Blockly.JavaScript.valueToCode(block, 'color', Blockly.JavaScript.ORDER_NONE) || Blockly.JavaScript.quote_('#000000');
    const id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_NONE) || null;
    const buttons = Blockly.JavaScript.quote_(`${button1}${button2}${button3}${button4}${button5}${button6}`);
...
Blockly.JavaScript['streamdeck_write_on_buttons'] = function (block) {
    ...
    const button5 = block.getFieldValue('button5') == 'TRUE' ? 1 : 0;
    const button6 = block.getFieldValue('button6') == 'TRUE' ? 1 : 0;
    const value = Blockly.JavaScript.valueToCode(block, 'value', Blockly.JavaScript.ORDER_NONE) || Blockly.JavaScript.quote_('');
    const id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_NONE) || null;
    const buttons = Blockly.JavaScript.quote_(`${button1}${button2}${button3}${button4}${button5}${button6}`);
...
Blockly.JavaScript['streamdeck_set_brightness'] = function (block) {
    const value = Blockly.JavaScript.valueToCode(block, 'value', Blockly.JavaScript.ORDER_NONE) || Blockly.JavaScript.quote_('100');
    const id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_NONE) || null;
