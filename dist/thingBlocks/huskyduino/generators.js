...
Blockly.JavaScript['huskylens_write_id'] = function (block) {
    const input = Blockly.JavaScript.valueToCode(block, 'ID', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['huskylens_write_forget_flag'] = function (block) {
    const flag = Blockly.JavaScript.valueToCode(block, 'forgetFlag', Blockly.JavaScript.ORDER_ATOMIC);
    const thing = Blockly.JavaScript.valueToCode(block, 'Thing', Blockly.JavaScript.ORDER_ATOMIC);
...
const chooseAlgo = async function (thing, value, callback) {
    ...
    await writeWithoutResponse(thing, HuskyServiceUUID, characteristicUUID, value);
    callback();
};
