...
Blockly.JavaScript['write_eddystone_property'] = function (block) {
    ...
    const slot = Blockly.JavaScript.valueToCode(block, 'Slot', Blockly.JavaScript.ORDER_NONE) || null;
...
const readBluetoothService = async function (webBluetoothId, characteristic, callback) {
    ...
    const value = await readText(webBluetoothId, characteristics[characteristic].service, characteristics[characteristic].characteristic);
    callback(value);
};
