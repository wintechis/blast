...
Blockly.Procedures.flyoutCategory = function (workspace) {
    ...
    if (Blockly.Blocks['procedures_defnoreturn']) {
        ...
        nameField.appendChild(Blockly.utils.xml.createTextNode(Blockly.Msg['PROCEDURES_DEFNORETURN_PROCEDURE']));
    ...
    if (Blockly.Blocks['procedures_defreturn']) {
        ...
        const nameField = Blockly.utils.xml.createElement('field');
        nameField.setAttribute('name', 'NAME');
        nameField.appendChild(Blockly.utils.xml.createTextNode(Blockly.Msg['PROCEDURES_DEFRETURN_PROCEDURE']));
        block.appendChild(nameField);
        xmlList.push(block);
    }
