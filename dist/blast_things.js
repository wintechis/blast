...
export const addWebBluetoothDevice = function (webBluetoothId, deviceName) {
    ...
    const promptAndCheckWithAlert = function (name, id) {
        Blockly.Variables.promptName('Pair successful! Now give your device a name.', name, function (text) {
            if (text) {
...
export const addWebHidDevice = function (uid, deviceName, device) {
    // This function needs to be named so it can be called recursively.
    const promptAndCheckWithAlert = function (name, id) {
        Blockly.Variables.promptName('Connection established! Now give your device a name.', name, function (text) {
            if (text) {
...
//# sourceMappingURL=blast_things.js.map