...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(h){return h instanceof f?h:new f(function(m,k){m(h)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(h){if(null==this.batch_){this.batch_=[];var m=this;this.asyncExecuteFunction(function(){m.executeBatch_()})}this.batch_.push(h)};
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(h){d(h,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var h=this.batch_;this.batch_=[];for(var m=0;m<h.length;++m){var k=h[m];h[m]=null;try{k()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};b.prototype.asyncThrow_=function(h){this.asyncExecuteFunction(function(){throw h;})};var f=function(h){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var m=this.createResolveAndReject_();
try{h(m.resolve,m.reject)}catch(k){m.reject(k)}};f.prototype.createResolveAndReject_=function(){function h(l){return function(n){k||(k=!0,l.call(m,n))}}var m=this,k=!1;return{resolve:h(this.resolveTo_),reject:h(this.reject_)}};f.prototype.resolveTo_=function(h){if(h===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(h instanceof f)this.settleSameAsPromise_(h);else{a:switch(typeof h){case "object":var m=null!=h;break a;case "function":m=!0;break a;default:m=!1}m?this.resolveToNonPromiseObj_(h):
this.fulfill_(h)}};f.prototype.resolveToNonPromiseObj_=function(h){var m=void 0;try{m=h.then}catch(k){this.reject_(k);return}"function"==typeof m?this.settleSameAsThenable_(m,h):this.fulfill_(h)};f.prototype.reject_=function(h){this.settle_(2,h)};f.prototype.fulfill_=function(h){this.settle_(1,h)};f.prototype.settle_=function(h,m){if(0!=this.state_)throw Error("Cannot settle("+h+", "+m+"): Promise already settled in state"+this.state_);this.state_=h;this.result_=m;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};f.prototype.scheduleUnhandledRejectionCheck_=function(){var h=this;d(function(){if(h.notifyUnhandledRejection_()){var m=$jscomp.global.console;"undefined"!==typeof m&&m.error(h.result_)}},1)};f.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var h=$jscomp.global.CustomEvent,m=$jscomp.global.Event,k=$jscomp.global.dispatchEvent;if("undefined"===typeof k)return!0;"function"===typeof h?h=new h("unhandledrejection",{cancelable:!0}):
...
h.callWhenSettled_(m.resolve,m.reject)};f.prototype.settleSameAsThenable_=function(h,m){var k=this.createResolveAndReject_();try{h.call(m,k.resolve,k.reject)}catch(l){k.reject(l)}};f.prototype.then=function(h,m){function k(q,r){return"function"==typeof q?function(t){try{l(q(t))}catch(u){n(u)}}:r}var l,n,p=new f(function(q,r){l=q;n=r});this.callWhenSettled_(k(h,l),k(m,n));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,m){function k(){switch(l.state_){case 1:h(l.result_);
break;case 2:m(l.result_);break;default:throw Error("Unexpected state: "+l.state_);}}var l=this;null==this.onSettledCallbacks_?g.asyncExecute(k):this.onSettledCallbacks_.push(k);this.isRejectionHandled_=!0};f.resolve=c;f.reject=function(h){return new f(function(m,k){k(h)})};f.race=function(h){return new f(function(m,k){for(var l=$jscomp.makeIterator(h),n=l.next();!n.done;n=l.next())c(n.value).callWhenSettled_(m,k)})};f.all=function(h){var m=$jscomp.makeIterator(h),k=m.next();return k.done?c([]):new f(function(l,
n){function p(t){return function(u){q[t]=u;r--;0==r&&l(q)}}var q=[],r=0;do q.push(void 0),r++,c(k.value).callWhenSettled_(p(q.length-1),n),k=m.next();while(!k.done)})};return f},"es6","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,f){return c==a&&"q"==d&&f==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
...
function(p){if(p instanceof c)return p;Object.isExtensible(p)&&f(p);return n(p)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var m=0,k=function(l){this.id_=(m+=Math.random()+1).toString();if(l){l=$jscomp.makeIterator(l);for(var n;!(n=l.next()).done;)n=n.value,this.set(n[0],n[1])}};k.prototype.set=function(l,n){if(!d(l))throw Error("Invalid WeakMap key");
f(l);if(!$jscomp.owns(l,h))throw Error("WeakMap key fail: "+l);l[h][this.id_]=n;return this};k.prototype.get=function(l){return d(l)&&$jscomp.owns(l,h)?l[h][this.id_]:void 0};k.prototype.has=function(l){return d(l)&&$jscomp.owns(l,h)&&$jscomp.owns(l[h],this.id_)};k.prototype.delete=function(l){return d(l)&&$jscomp.owns(l,h)&&$jscomp.owns(l[h],this.id_)?delete l[h][this.id_]:!1};return k},"es6","es3");$jscomp.MapEntry=function(){};
...
f(this,k).entry)&&k.value};d.prototype.entries=function(){return g(this,function(k){return[k.key,k.value]})};d.prototype.keys=function(){return g(this,function(k){return k.key})};d.prototype.values=function(){return g(this,function(k){return k.value})};d.prototype.forEach=function(k,l){for(var n=this.entries(),p;!(p=n.next()).done;)p=p.value,k.call(l,p[1],p[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var f=function(k,l){var n=l&&typeof l;"object"==n||"function"==n?c.has(l)?n=c.get(l):
(n=""+ ++m,c.set(l,n)):n="p_"+l;var p=k.data_[n];if(p&&$jscomp.owns(k.data_,n))for(k=0;k<p.length;k++){var q=p[k];if(l!==l&&q.key!==q.key||l===q.key)return{id:n,list:p,index:k,entry:q}}return{id:n,list:p,index:-1,entry:void 0}},g=function(k,l){var n=k.head_;return $jscomp.iteratorPrototype(function(){if(n){for(;n.head!=k.head_;)n=n.previous;for(;n.next!=n.head;)return n=n.next,{done:!1,value:l(n)};n=null}return{done:!0,value:void 0}})},h=function(){var k={};return k.previous=k.next=k.head=k},m=0;
...
Blast.Ui.addToLog=function(a){var b=document.getElementById("content_deviceLogs");a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>");var c=new Date;a="["+(("0"+c.getHours()).slice(-2)+":"+("0"+c.getMinutes()).slice(-2)+":"+("0"+c.getSeconds()).slice(-2))+"] "+a;b.innerHTML=b.innerHTML+a+"\r\n";b.scrollTop=b.scrollHeight};
...
h.setAttribute("aria-hidden","true");h.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$71?"bluetooth_disabled":"usb_off";g.appendChild(h);h=document.createElement("span");h.setAttribute("class","mdc-list-item__text");var m=document.createElement("span");m.setAttribute("class","mdc-list-item__primary-text");m.innerHTML=f.$jscomp$loop$prop$name$72;h.appendChild(m);m=document.createElement("span");m.setAttribute("class","mdc-list-item__secondary-text");m.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$72);
m.innerHTML="disconnected";h.appendChild(m);g.appendChild(h);g.addEventListener("click",function(k){return function(){var l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$71?("things_webHID"==k.$jscomp$loop$prop$type$71&&(l=[],navigator.hid.requestDevice({filters:l}).then(function(q){0===q.length&&Blast.throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);
...
"connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$72).innerHTML="bluetooth";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$72).style.color="#0d30b1";k.$jscomp$loop$prop$block$73.firstElementChild.textContent=n.id;Blast.Storage.allConnectedMobile_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",!0),document.getElementById("rc-done").addEventListener("click",
...
Blast.Bluetooth.requestDevice=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress){Blast.Ui.addToLog("Requesting Bluetooth device...");if(!navigator.bluetooth)return g.jumpTo(0);a||(a={acceptAllDevices:!0},a.optionalServices=Blast.Bluetooth.optionalServices);g.setCatchFinallyBlocks(3);return g.yield(navigator.bluetooth.requestDevice(a),5)}if(3!=g.nextAddress)return c=g.yieldResult,Blast.Ui.addToLog("Bluetooth device found: "+c.name),d=b||c.name,
...
Blast.Bluetooth.getDeviceById=function(a){var b,c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return Blast.Ui.addToLog("Getting previously paired device with id "+a),g.yield(navigator.bluetooth.getDevices(),2);b=g.yieldResult;c=$jscomp.makeIterator(b);for(d=c.next();!d.done;d=c.next())if(f=d.value,f.id==a)return Blast.Ui.addToLog("Found previously paired device with id "+a),g.return(f);Blast.throwError("Bluetooth device "+a+" wasn't found in paired devices.");
g.jumpToEnd()})};
Blast.Bluetooth.connect=function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.setCatchFinallyBlocks(2),f.yield(Blast.Bluetooth.getDeviceById(a),4);case 4:return b=f.yieldResult,Blast.Ui.addToLog("Connecting to Bluetooth device with id "+a),f.yield(b.gatt.connect(),5);case 5:return c=f.yieldResult,Blast.Ui.addToLog("Connected to Bluetooth device with id "+a),f.return(c);case 2:d=f.enterCatchBlock(),Blast.throwError("Error connecting to Bluetooth device "+a),
console.error(d),f.jumpToEnd()}})};
Blast.Bluetooth.disconnect=function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.setCatchFinallyBlocks(2),f.yield(Blast.Bluetooth.getDeviceById(a),4);case 4:return b=f.yieldResult,Blast.Ui.addToLog("Disconnecting from Bluetooth device with id "+a),f.yield(b.gatt.disconnect(),5);case 5:return c=f.yieldResult,Blast.Ui.addToLog("Disconnected from Bluetooth device with id "+a),f.return(c);case 2:d=f.enterCatchBlock(),Blast.throwError("Error disconnecting from Bluetooth device "+
a),console.error(d),f.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithoutResponse=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=h.yieldResult;if(!f)return h.return();"string"===typeof d&&(Blast.Ui.addToLog("Converting string "+d+" to ArrayBuffer"),d=hexStringToArrayBuffer(d),Blast.Ui.addToLog("Converted to ArrayBuffer "+d));h.setCatchFinallyBlocks(3);Blast.Ui.addToLog("Invoke WriteValueWithoutResponse on characteristic "+f+
(" of device "+a+" with value "+d));return h.yield(f.writeValueWithoutResponse(d),5);case 5:Blast.Ui.addToLog("Finished WriteValueWithoutResponse on characteristic "+f+(" of device "+a+" with value "+d));h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
Blast.Bluetooth.gatt_writeWithResponse=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:f=h.yieldResult;if(!f)return h.return();"string"===typeof d&&(Blast.Ui.addToLog("Converting string "+d+" to ArrayBuffer"),d=hexStringToArrayBuffer(d),Blast.Ui.addToLog("Converted to ArrayBuffer "+d));h.setCatchFinallyBlocks(3);Blast.Ui.addToLog("Invoke WriteValueWithResponse on characteristic "+
f+(" of device "+a+" with value "+d));return h.yield(f.writeValueWithResponse(d),5);case 5:Blast.Ui.addToLog("Finished WriteValueWithResponse on characteristic "+f+(" of device "+a+" with value "+d));h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error writing to Bluetooth device.\nMake sure the device is compatible with the connected block."),h.jumpToEnd()}})};
Blast.Bluetooth.getPrimaryService=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(Blast.Bluetooth.connect(a),2);case 2:return c=g.yieldResult,g.setCatchFinallyBlocks(3),Blast.Ui.addToLog("Getting primary service "+b+" from device "+a),g.yield(c.getPrimaryService(b),5);case 5:d=g.yieldResult;Blast.Ui.addToLog("Got primary service "+b+" from device "+a);g.leaveTryBlock(4);break;case 3:f=g.enterCatchBlock(),console.error(f),
Blast.throwError("The device is not compatible with the connected block.");case 4:return g.return(d)}})};
Blast.Bluetooth.getCharacteristic=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getPrimaryService(a,b),2);case 2:d=h.yieldResult;if(!d)return h.return();h.setCatchFinallyBlocks(3);Blast.Ui.addToLog("Getting characteristic "+c+" from service "+b+" of device "+a);return h.yield(d.getCharacteristic(c),5);case 5:f=h.yieldResult;Blast.Ui.addToLog("Got characteristic "+c+" from service "+b+" of device "+
a);h.leaveTryBlock(4);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("The device is not compatible with the connected block.");case 4:return h.return(f)}})};
Blast.Bluetooth.gatt_read=function(a,b,c){var d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return d=h.yieldResult,h.setCatchFinallyBlocks(3),Blast.Ui.addToLog("Invoke ReadValue on characteristic "+d+(" from service "+b+" of device "+a)),h.yield(d.readValue(),5);case 5:return f=h.yieldResult,Blast.Ui.addToLog("Finished ReadValue on characteristic "+d+(" from service "+b+" of device "+
a+" - value: "+f)),h.return(f);case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error reading from Bluetooth device "+a),h.jumpToEnd()}})};Blast.Bluetooth.gatt_read_text=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;Blast.Ui.addToLog("Converting ArrayBuffer "+d+" to string");f=(new TextDecoder).decode(d);Blast.Ui.addToLog("Converted to string "+f);return g.return(f)})};
Blast.Bluetooth.gatt_read_number=function(a,b,c){var d,f,g,h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=k.yieldResult;d instanceof DataView||(d=new DataView(value));Blast.Ui.addToLog("Converting ArrayBuffer "+d+" to number");f=new Uint8Array(d.buffer);g=f.length;h=buffer.Buffer.from(f);m=h.readUIntBE(0,g);Blast.Ui.addToLog("Converted to number "+m);return k.return(m)})};
Blast.Bluetooth.gatt_read_hex=function(a,b,c){var d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(Blast.Bluetooth.gatt_read(a,b,c),2);d=g.yieldResult;Blast.Ui.addToLog("Converting ArrayBuffer "+d+" to hex");f=(new Uint8Array(d.buffer)).reduce(function(h,m){return h+("0"+m.toString(16)).slice(-2)},"");Blast.Ui.addToLog("Converted to hex "+f);return g.return(f)})};
Blast.Bluetooth.gatt_subscribe=function(a,b,c,d){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(Blast.Bluetooth.getCharacteristic(a,b,c),2);case 2:return f=h.yieldResult,Blast.Ui.addToLog("Add 'characteristicvaluechanged' listener to characteristic "+c+(" of service "+b+" of device "+a)),f.addEventListener("characteristicvaluechanged",d),Blast.Bluetooth.charEventListeners[c]=[f,"characteristicvaluechanged",d],h.setCatchFinallyBlocks(3),
Blast.Ui.addToLog("Invoke startNotifications on characteristic "+c+(" from service "+b+" of device "+a)),h.yield(f.startNotifications(),5);case 5:Blast.Ui.addToLog("Finished startNotifications on characteristic "+c+(" from service "+b+" of device "+a));h.leaveTryBlock(0);break;case 3:g=h.enterCatchBlock(),console.error(g),Blast.throwError("Error subscribing to Bluetooth device "+a),h.jumpToEnd()}})};
Blast.Bluetooth.startLEScan=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){if(Blast.Bluetooth.isLEScanRunning)return a.return();Blast.Bluetooth.cacheLEScanResults();Blast.Bluetooth.isLEScanRunning=!0;Blast.Ui.addToLog("Requesting LE Scan");Blockly.alert("Please click allow on the LE Scan prompt now, then close this dialog.",navigator.bluetooth.requestLEScan({acceptAllAdvertisements:!0,keepRepeatedDevices:!0}));setTimeout(Blast.Bluetooth.stopLEScan,3E4);a.jumpToEnd()})};
Blast.Bluetooth.stopLEScan=function(){Blast.Bluetooth.isLEScanRunning&&(Blast.Ui.addToLog("Stopping LE Scan"),navigator.bluetooth.stopLEScan(),Blast.Bluetooth.isLEScanRunning=!1)};Blast.Bluetooth.cacheLEScanResults=function(){Blast.Bluetooth.addEventListener("advertisementreceived",function(a){var b=a.device.id;Blast.Bluetooth.LEScanResults[b]||(Blast.Bluetooth.LEScanResults[b]=[]);Blast.Bluetooth.LEScanResults[b].unshift(a)})};
...
Blast.Bluetooth.tearDown=function(){Blast.Ui.addToLog("Tearing down webBluetooth");Blast.Bluetooth.isLEScanRunning&&(Blast.Bluetooth.isLEScanRunning=!1);if(Blast.Bluetooth.eventListeners){for(var a=$jscomp.makeIterator(Blast.Bluetooth.eventListeners),b=a.next();!b.done;b=a.next())b=b.value,Blast.Bluetooth.removeEventListener(b[0],b[1]);Blast.Bluetooth.eventListeners=[]}if(Blast.Bluetooth.charEventListeners){a=$jscomp.makeIterator(Object.keys(Blast.Bluetooth.charEventListeners));for(b=a.next();!b.done;b=
a.next()){var c=Blast.Bluetooth.charEventListeners[b.value];b=c[0];var d=c[1];c=c[2];b.stopNotifications();b.removeEventListener(d,c)}Blast.Bluetooth.charEventListeners={}}Blast.Bluetooth.LEScanResults={}};Blast.Bluetooth.Eddystone={};
...
Blast.Bluetooth.Eddystone.getCapabilities=function(a){var b,c,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return Blast.Ui.addToLog("Reading Eddystone capabilities..."),h.yield(Blast.Bluetooth.gatt_read(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.CAPABILITIES_CHARACTERISTIC),2);b=h.yieldResult;b=new Int8Array(b.buffer);c=[];for(d=6;d<b.length&&!((f=c[c.length-1])&&f>=b[d]);d++)c.push(b[d]);g={specVersion:b[0],maxSlots:b[1],
maxEidPerSlot:b[2],isVarriableAdvIntervalSupported:0!==(b[3]&1),isVariableTxPowerSupported:0!==(b[3]&2),isUIDSupported:0!==(b[5]&1),isURLSupported:0!==(b[5]&2),isTLMSupported:0!==(b[5]&4),isEIDSupported:0!==(b[5]&8),supportedTxPowerLevels:c};Blast.Ui.addToLog("Eddystone capabilities: "+JSON.stringify(g));return h.return(g)})};
Blast.Bluetooth.Eddystone.getActiveSlot=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Reading Eddystone active slot..."),c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC),2);b=c.yieldResult;Blast.Ui.addToLog("Eddystone active slot: "+b);return c.return(b)})};
Blast.Bluetooth.Eddystone.setActiveSlot=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return Blast.Ui.addToLog("Setting Eddystone active slot to "+b+"..."),d.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2);if(3!=d.nextAddress)return c=d.yieldResult,(0>b||b>=c.maxSlots)&&Blast.throwError("Eddystone slot is not valid.\n         On this device the slot must be between 0 and "+(c.maxSlots-1)+"."),d.yield(Blast.Bluetooth.gatt_writeWithResponse(a,
Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ACTIVE_SLOT_CHARACTERISTIC,b.toString(16)),3);Blast.Ui.addToLog("Eddystone active slot set to "+b);return d.return()})};
Blast.Bluetooth.Eddystone.getAdvertisingInterval=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Reading Eddystone advertising interval..."),c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC),2);b=c.yieldResult;Blast.Ui.addToLog("Eddystone advertising interval: "+b);return c.return(b)})};
Blast.Bluetooth.Eddystone.setAdvertisingInterval=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Setting Eddystone advertising interval to "+b+"..."),c.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISING_INTERVAL_CHARACTERISTIC,b.toString(16)),2);Blast.Ui.addToLog("Eddystone advertising interval set to "+b);return c.return()})};
Blast.Bluetooth.Eddystone.getTxPowerLevel=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Reading Eddystone TX power level..."),c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.RADIO_TX_POWER_CHARACTERISTIC),2);b=c.yieldResult;Blast.Ui.addToLog("Eddystone TX power level: "+b);return c.return(b)})};
Blast.Bluetooth.Eddystone.setTxPowerLevel=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return Blast.Ui.addToLog("Setting Eddystone TX power level to "+b+"..."),d.yield(Blast.Bluetooth.Eddystone.getCapabilities(a),2);if(3!=d.nextAddress)return c=d.yieldResult,-1===c.supportedTxPowerLevels.indexOf(b)?(Blast.throwError("Eddystone TX power level is not valid.\n         On this device the TX power level must be one of "+c.supportedTxPowerLevels+
"."),d.return()):d.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.RADIO_TX_POWER_CHARACTERISTIC,b.toString(16)),3);Blast.Ui.addToLog("Eddystone TX power level set to "+b);return d.return()})};
Blast.Bluetooth.Eddystone.getAdvertisedTxPower=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Reading Eddystone advertised TX power..."),c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC),2);b=c.yieldResult;Blast.Ui.addToLog("Eddystone advertised TX power: "+b);return c.return(b)})};
Blast.Bluetooth.Eddystone.setAdvertisedTxPower=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Setting Eddystone advertised TX power to "+b+"..."),c.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADVERTISED_TX_POWER_CHARACTERISTIC,b.toString(16)),2);Blast.Ui.addToLog("Eddystone advertised TX power set to "+b);return c.return()})};
Blast.Bluetooth.Eddystone.getLockState=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Reading Eddystone lock state..."),c.yield(Blast.Bluetooth.gatt_read_number(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.LOCK_STATE_CHARACTERISTIC),2);b=c.yieldResult;Blast.Ui.addToLog("Eddystone lock state: "+b);return c.return(b)})};
Blast.Bluetooth.Eddystone.getPublicECDHKey=function(a){var b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return Blast.Ui.addToLog("Reading Eddystone public ECDH key..."),c.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.PUBLIC_ECDH_KEY_CHARACTERISTIC),2);b=c.yieldResult;Blast.Ui.addToLog("Eddystone public ECDH key: "+b);return c.return(b)})};
Blast.Bluetooth.Eddystone.getAdvertisingData=function(a){var b,c,d,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return Blast.Ui.addToLog("Reading Eddystone advertising data..."),b=function(k){var l=parseInt(k.substring(2,4),16),n=k.substring(4,24);k=k.substring(25,37);return{frameType:"UID",txPower:l,namespace:n,instance:k}},c=function(k){var l=parseInt(k.substring(2,4),16);switch(k.substring(4,6)){case "00":var n="http://www.";break;case "01":n="https://www.";
break;case "02":n="http://";break;case "03":n="https://";break;default:Blast.throwError("Eddystone URL scheme is not valid.");return}var p=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" ");k=k.substring(6,k.length);for(var q=0;q<k.length;q+=2){var r=parseInt(k.substring(q,q+2),16);n=r<p.length?n+p[r]:n+String.fromCharCode(r)}return{frameType:"URL",txPower:l,url:n}},d=function(k){var l=parseInt(k.substring(4,8),16),n=parseInt(k.substring(8,10),16)+parseInt(k.substring(10,
12),16)/100,p=parseInt(k.substring(12,20),16);k=parseInt(k.substring(20,28),16);return{frameType:"TLM",batteryVoltage:l,beaconTemperature:n,pduCount:p,timeSinceReboot:k}},m.yield(Blast.Bluetooth.gatt_read_hex(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC),2);f=m.yieldResult;Blast.Ui.addToLog("Eddystone advertising data: "+f);g=f.substring(0,2);switch(g){case "00":return h=b(f),m.return(h.namespace+h.instance);case "10":return h=c(f),
m.return(h.url);case "20":return h=d(f),m.return(h.beaconTemperature);case "30":return Blast.throwError("EID frame type is not supported by blast."),m.return();default:return Blast.throwError("Eddystone frame type is not valid."),m.return()}})};
Blast.Bluetooth.Eddystone.setAdvertisingData=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return Blast.Ui.addToLog("Writing Eddystone advertising data..."),c=function(h){for(var m=["http://www.","https://www.","http://","https://"],k=".com/ .org/ .edu/ .net/ .info/ .biz/ .gov/ .com .org .edu .net .info .biz .gov".split(" "),l=[],n=0,p=new TextEncoder("utf-8"),q=0;q<m.length;q++)if(h.startsWith(m[q])){l.push(q);n=m[q].length;break}for(;n<
h.length;){m=n;for(q=0;q<k.length;q++)if(h.startsWith(k[q],n)){l.push(q);n+=k[q].length;break}m===n&&(l.push(p.encode(h[n])[0]),n++)}if(18<l.length)Blast.throwError("URL is too long.");else return l.splice(0,0,16),new Uint8Array(l)},d=c(b),g.yield(Blast.Bluetooth.gatt_writeWithResponse(a,Blast.Bluetooth.Eddystone.UUIDS.CONFIG_SERVICE,Blast.Bluetooth.Eddystone.UUIDS.ADV_SLOT_DATA_CHARACTERISTIC,d),2);f=g.yieldResult;Blast.Ui.addToLog("Eddystone advertising data written.");return g.return(f)})};function initApi(a,b){Blockly.JavaScript.addReservedWords("highlightBlock","eventChecker");var c=function(f){f=f?f.toString():"";return Blast.highlightBlock(f)};a.setProperty(b,"highlightBlock",a.createNativeFunction(c));c=function(f){Blast.Interrupted=f};a.setProperty(b,"setInterrupt",a.createNativeFunction(c));c=$jscomp.makeIterator(Blast.apiFunctions);for(var d=c.next();!d.done;d=c.next())d=d.value,a.setProperty(b,d[0],a.createNativeFunction(d[1]));c=$jscomp.makeIterator(Blast.asyncApiFunctions);
...
Blockly.Procedures.flyoutCategory=function(a){function b(g,h){g=$jscomp.makeIterator(g);for(var m=g.next();!m.done;m=g.next()){m=m.value;var k=m[0],l=m[1];m=Blockly.utils.xml.createElement("block");m.setAttribute("type",h);m.setAttribute("gap",16);var n=Blockly.utils.xml.createElement("mutation");n.setAttribute("name",k);m.appendChild(n);k=$jscomp.makeIterator(l);for(l=k.next();!l.done;l=k.next()){l=l.value;var p=Blockly.utils.xml.createElement("arg");p.setAttribute("name",l);n.appendChild(p)}c.push(m)}}
...
a),Blockly.JavaScript.INDENT));for(var f=a.getFieldValue("STACK")||"",g=[],h=a.getVars(),m=0;m<h.length;m++)g[m]=Blockly.JavaScript.variableDB_.getName(h[m],Blockly.VARIABLE_CATEGORY_NAME);c="function "+b+"("+g.join(", ")+") {\n"+c+d+f+"\n}";c=Blockly.JavaScript.scrub_(a,c);Blockly.JavaScript.definitions_["%"+b]=c;return null};Blockly.JavaScript.procedures_defnoreturn=Blockly.JavaScript.procedures_defreturn;
...
>>>>>>> 62e6f378f0bc1df86eb2e523bdf4f0f62a4e1a4e:blast-a5f519364d.min.js
...
var sendHttpRequest=function(a,b,c,d,f,g){var h,m,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return null!=a&&void 0!=a&&""!=a||Blast.throwError("URI input of HttpRequest blocks must not be empty"),h=JSON.parse(c),m={method:b,headers:new Headers(h)},d&&(m.body=d),p.setCatchFinallyBlocks(2),p.yield(fetch(a,m),4);case 4:k=p.yieldResult;if(!k.ok)return Blast.throwError("Failed to get "+a+", Error: "+k.status+" "+k.statusText),p.return();"status"==
f&&g(k.status);return p.yield(k.text(),5);case 5:l=p.yieldResult;g(l);p.leaveTryBlock(0);break;case 2:n=p.enterCatchBlock(),Blast.throwError("Failed to get "+a+", Error: "+n.message),p.jumpToEnd()}})};Blast.asyncApiFunctions.push(["sendHttpRequest",sendHttpRequest]);
...
var urdfQueryWrapper=function(a,b,c,d){var f,g,h,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.setCatchFinallyBlocks(2),l.yield(fetch(a),4);case 4:return f=l.yieldResult,f.ok?l.yield(f.text(),5):(Blast.throwError("Failed to get "+a+", Error: "+f.status+" "+f.statusText),l.return());case 5:return g=l.yieldResult,urdf.clear(),h={format:b},l.yield(urdf.load(g,h),6);case 6:return l.yield(urdf.query(c),7);case 7:m=l.yieldResult;d(m);l.leaveTryBlock(0);
...
var getRSSIWb=function(a,b){var c,d,f,g,h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return k.yield(navigator.bluetooth.getDevices(),2);c=k.yieldResult;d=null;f=$jscomp.makeIterator(c);for(g=f.next();!g.done;g=f.next())if(h=g.value,h.id===a){d=h;break}null==d&&Blast.throwError("Error pairing with Bluetooth device.");m=new AbortController;d.addEventListener("advertisementreceived",function(l){return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){m.abort();
...
var readJoyConProperty=function(a,b,c,d,f,g){var h,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!a)return Blast.throwError("No Joy-Con block set."),g(),l.return();h=Blast.Things.webHidDevices.get(a);if(!h)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),g(),l.return();if(h.opened){l.jumpTo(2);break}l.setCatchFinallyBlocks(3);return l.yield(h.open(),5);case 5:l.leaveTryBlock(2);
break;case 3:l.enterCatchBlock(),Blast.throwError("Failed to open device, your browser or OS probably doesn't support webHID.");case 2:if(1406!==h.vendorId||8198!==h.productId&&8199!==h.productId)return Blast.throwError("The connected device is not a Joy-Con."),g(),l.return();8198===h.productId?m=new JoyConLeft(h):8199===h.productId&&(m=new JoyConRight(h));return l.yield(m.open(),6);case 6:return l.yield(m.enableStandardFullMode(),7);case 7:return l.yield(m.enableIMUMode(),8);case 8:k=function(n){var p;
return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){p=n.detail;if(!p||!p.actualOrientation)return q.return();m.removeEventListener("hidinput",k);""!==d?"accelerometers"===b?g(p[b][c][d].acc):"gyroscopes"===b?g(p[b][c][d][f]):g(p[b][c][d]):g(p[b][c]);q.jumpToEnd()})};if(m.eventListenerAttached){l.jumpTo(0);break}return l.yield(m.open(),10);case 10:return l.yield(m.enableStandardFullMode(),11);case 11:return l.yield(m.enableIMUMode(),12);case 12:return l.yield(m.enableVibration(),13);case 13:m.addEventListener("hidinput",
k),m.eventListenerAttached=!0,l.jumpToEnd()}})};Blast.asyncApiFunctions.push(["readJoyConProperty",readJoyConProperty]);
...
var getRuuviProperty=function(a,b,c){var d,f,g,h,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return d=function(n){var p={},q=n[0]&255,r=n[1]<<8|n[2]&255;32767<r&&(r-=65535);var t=((n[3]&255)<<8|n[4]&255)/400,u=((n[5]&255)<<8|n[6]&255)+5E4,v=(n[7]<<8|n[8]&255)/1E3,x=(n[9]<<8|n[10]&255)/1E3,y=(n[11]<<8|n[12]&255)/1E3,w=(n[13]&255)<<8|n[14]&255,z=n[15]&255;n=(n[16]&255)<<8|n[17]&255;p.destination_endpoint=q;p.temperature=r/200;p.humidity=t;p.pressure=u;p.accelerationX=
v;p.accelerationY=x;p.accelerationZ=y;p.batteryVoltage=(w>>>5)/1E3+1.6;p.txPower=2*(w&31)-40;p.movementCounter=z;p.measurementSequenceNumber=n;return p},f=function(n){if(30>n){var p=Blast.Bluetooth.LEScanResults[b];if(p){p=$jscomp.makeIterator(p);for(var q=p.next();!q.done;q=p.next())if((q=q.value.manufacturerData.get(1177))&&5==q.getUint8(0))return q}return new Promise(function(r){setTimeout(function(){r(f(n+1))},1E3)})}},Blast.Bluetooth.startLEScan(b),l.yield(f(0),2);(g=l.yieldResult)||Blast.throwError("Timed out. No BLE advertising data found for "+
b);h=[];for(m=0;m<g.byteLength;m++)h.push("0x"+("00"+g.getUint8(m).toString(16)).slice(-2));k=d(h);c(k[a]);l.jumpToEnd()})};Blast.asyncApiFunctions.push(["getRuuviProperty",getRuuviProperty]);Blockly.Blocks.streamdeck_button_event={init:function(){var a=this;this.appendValueInput("id").setCheck("Thing").appendField("Streamdeck mini");this.appendDummyInput().appendField("on button").appendField(new Blockly.FieldDropdown([["up","up"],["down","down"]]),"upDown");this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,"button1")}),"button1").appendField(new Blockly.FieldCheckbox("FALSE",function(b){return a.uncheckAllOtherCheckboxes(b,
...
Blockly.JavaScript.streamdeck_color_buttons=function(a){var b="TRUE"==a.getFieldValue("button1")?1:0,c="TRUE"==a.getFieldValue("button2")?1:0,d="TRUE"==a.getFieldValue("button3")?1:0,f="TRUE"==a.getFieldValue("button4")?1:0,g="TRUE"==a.getFieldValue("button5")?1:0,h="TRUE"==a.getFieldValue("button6")?1:0,m=Blockly.JavaScript.valueToCode(a,"color",Blockly.JavaScript.ORDER_NONE)||Blockly.JavaScript.quote_("#000000");a=Blockly.JavaScript.valueToCode(a,"id",Blockly.JavaScript.ORDER_NONE)||null;b=Blockly.JavaScript.quote_(""+
b+c+d+f+g+h);return"streamdeckColorButtons("+a+", "+b+", "+m+");\n"};
var handleStreamdeck=function(a,b,c,d){var f,g,h,m,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),l.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),l.return();l.setCatchFinallyBlocks(2);return l.yield(StreamDeck.openDevice(f),4);case 4:g=l.yieldResult;l.leaveTryBlock(3);
break;case 2:h=l.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),l.return();f.close();return l.yield(StreamDeck.openDevice(f),6);case 6:g=l.yieldResult;case 3:for(k=0;k<b.length;k++)if("1"===b.charAt(k)){m=k;break}if(void 0===m)return l.return();g.on(c,function(n){if(n===m){Blast.Interrupted=!0;var p=new Interpreter("");p.stateStack[0].scope=Blast.Interpreter.globalScope;p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):Blast.Interrupted=!1}catch(r){Blast.throwError("Error executing program:\n "+
e),console.error(r)}};q()}});Blast.cleanUpFunctions.push(function(){g.close();g.removeAllListeners()});l.jumpToEnd()}})};Blast.apiFunctions.push(["handleStreamdeck",handleStreamdeck]);
var streamdeckColorButtons=function(a,b,c,d){var f,g,h,m,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),p.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),p.return();p.setCatchFinallyBlocks(2);return p.yield(StreamDeck.openDevice(f),4);case 4:g=p.yieldResult;
p.leaveTryBlock(3);break;case 2:h=p.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),d(),p.return();f.close();return p.yield(StreamDeck.openDevice(f),6);case 6:g=p.yieldResult;case 3:m=parseInt(c.substring(1,3),16),k=parseInt(c.substring(3,5),16),l=parseInt(c.substring(5,7),16),n=0;case 7:if(!(n<b.length)){p.jumpTo(9);break}if("1"!==b.charAt(n)){p.jumpTo(8);break}return p.yield(g.fillKeyColor(n,m,k,l),8);case 8:n++;p.jumpTo(7);break;case 9:d(),p.jumpToEnd()}})};
...
b+c+d+f+g+h);return"streamdeckWriteOnButtons("+a+", "+b+", "+m+");\n"};
var streamdeckWriteOnButtons=function(a,b,c,d){var f,g,h,m,k,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return Blast.throwError("No streamdeck block set."),d(),q.return();f=Blast.Things.webHidDevices.get(a);if(!f)return Blast.throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(f),4);case 4:g=q.yieldResult;
q.leaveTryBlock(3);break;case 2:h=q.enterCatchBlock();if("InvalidStateError"!=h.name)return Blast.throwError(h),d(),q.return();f.close();return q.yield(StreamDeck.openDevice(f),6);case 6:g=q.yieldResult;case 3:m=[];k=document.createElement("canvas");k.width=g.ICON_SIZE;k.height=g.ICON_SIZE;l=k.getContext("2d");l.save();l.clearRect(0,0,k.width,k.height);l.font=.8*k.height+"px Arial";l.strokeStyle="blue";l.lineWidth=1;l.strokeText(c.toString(),8,60,.8*k.width);l.fillStyle="white";l.fillText(c.toString(),
8,60,.8*k.width);n=l.getImageData(0,0,k.width,k.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&m.push(g.fillKeyBuffer(p,buffer.Buffer.from(n.data),{format:"rgba"}));l.restore();return q.yield(Promise.all(m),7);case 7:d(),q.jumpToEnd()}})};Blast.asyncApiFunctions.push(["streamdeckWriteOnButtons",streamdeckWriteOnButtons]);
...
var webSpeech=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){c=Blast.workspace.getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";f="";d.onresult=function(h){for(var m=h.resultIndex;m<h.results.length;++m)h.results[m].isFinal&&(f+=h.results[m][0].transcript)};d.onend=function(){b(f)};d.start();g.jumpToEnd()})};Blast.asyncApiFunctions.push(["webSpeech",webSpeech]);
