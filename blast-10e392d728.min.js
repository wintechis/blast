...
h.$jscomp$loop$prop$name$62);l.setAttribute("value","Pair");var n=document.createElement("td"),q=document.createElement("span");q.setAttribute("id","pairStatus-"+h.$jscomp$loop$prop$name$62);q.innerHTML="&#x2718;";q.style.color="red";q.style.fontSize="20px";q.style.fontWeight="bold";q.style.marginRight="10px";n.appendChild(q);l.addEventListener("click",function(t){return function(){var w,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(C){if(1==C.nextAddress)return"things_webBluetooth"!=
...
console.error(D)})),C.jumpTo(0)):C.yield(Blast.Bluetooth.requestDevice(),3);y=C.yieldResult;document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$62).innerHTML="&#x2714;";document.getElementById("pairStatus-"+t.$jscomp$loop$prop$name$62).style.color="green";t.$jscomp$loop$prop$block$63.firstElementChild.textContent=y.id;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||(document.getElementById("rc-done").setAttribute("data-hasEvent",
...
Blast.Things.webHidDevices.set(y,w[0]);Blast.Things.addWebHidDevice(y,l.$jscomp$loop$prop$name$66);document.getElementById("rc-status-"+l.$jscomp$loop$prop$name$66).innerHTML="connected";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$66).innerHTML="usb";document.getElementById("rc-icon-"+l.$jscomp$loop$prop$name$66).style.color="#0d30b1";l.$jscomp$loop$prop$block$67.firstElementChild.textContent=y;Blast.Storage.allConnectedDesktop_()&&(document.getElementById("rc-done").disabled=!1,document.getElementById("rc-done").getAttribute("data-hasEvent")||
