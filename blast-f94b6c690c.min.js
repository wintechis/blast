...
function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-tbody");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$75:f.$jscomp$loop$prop$type$75,$jscomp$loop$prop$name$76:f.$jscomp$loop$prop$name$76,$jscomp$loop$prop$block$77:f.$jscomp$loop$prop$block$77},h=b.next()){f.$jscomp$loop$prop$block$77=h.value;f.$jscomp$loop$prop$type$75=f.$jscomp$loop$prop$block$77.getAttribute("type");if("things_webBluetooth"==
f.$jscomp$loop$prop$type$75||"things_webHID"==f.$jscomp$loop$prop$type$75){f.$jscomp$loop$prop$name$76=f.$jscomp$loop$prop$block$77.firstElementChild.textContent;if(d.includes(f.$jscomp$loop$prop$name$76))continue;h=document.createElement("tr");var g=document.createElement("td");g.appendChild(document.createTextNode(f.$jscomp$loop$prop$name$76));var l=document.createElement("td"),k=document.createElement("input");k.setAttribute("type","button");k.setAttribute("id","pairButton-"+f.$jscomp$loop$prop$name$76);
k.setAttribute("value","Pair");var m=document.createElement("td"),n=document.createElement("span");n.setAttribute("id","pairStatus-"+f.$jscomp$loop$prop$name$76);n.innerHTML="&#x2718;";n.style.color="red";n.style.fontSize="20px";n.style.fontWeight="bold";n.style.marginRight="10px";m.appendChild(n);k.addEventListener("click",function(p){return function(){var q,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress)return"things_webBluetooth"!=p.$jscomp$loop$prop$type$75?
...
h.appendChild(g);h.appendChild(l);h.appendChild(m);c.appendChild(h);d.push(f.$jscomp$loop$prop$name$76)}document.getElementById("rc-cancel").addEventListener("click",function(){return module$contents$Blast$Storage_reconnectCancelHandler_()})}},module$contents$Blast$Storage_generatePairButtonsMobile_=function(a){for(var b=a.querySelectorAll("block"),c=document.getElementById("rc-list");c.firstChild;)c.removeChild(c.firstChild);var d=[],f={};b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;f={$jscomp$loop$prop$type$79:f.$jscomp$loop$prop$type$79,
$jscomp$loop$prop$name$80:f.$jscomp$loop$prop$name$80,$jscomp$loop$prop$block$81:f.$jscomp$loop$prop$block$81},h=b.next())if(f.$jscomp$loop$prop$block$81=h.value,f.$jscomp$loop$prop$type$79=f.$jscomp$loop$prop$block$81.getAttribute("type"),"things_webBluetooth"==f.$jscomp$loop$prop$type$79||"things_webHID"==f.$jscomp$loop$prop$type$79)if(f.$jscomp$loop$prop$name$80=f.$jscomp$loop$prop$block$81.firstElementChild.textContent,!d.includes(f.$jscomp$loop$prop$name$80)){h=document.createElement("li");h.setAttribute("id",
"rc-item-"+f.$jscomp$loop$prop$name$80);h.setAttribute("class","mdc-list-item");var g=document.createElement("span");g.setAttribute("id","rc-icon-"+f.$jscomp$loop$prop$name$80);g.setAttribute("class","mdc-list-item__graphic material-icons");g.setAttribute("aria-hidden","true");g.innerHTML="things_webBluetooth"==f.$jscomp$loop$prop$type$79?"bluetooth_disabled":"usb_off";h.appendChild(g);g=document.createElement("span");g.setAttribute("class","mdc-list-item__text");var l=document.createElement("span");
l.setAttribute("class","mdc-list-item__primary-text");l.innerHTML=f.$jscomp$loop$prop$name$80;g.appendChild(l);l=document.createElement("span");l.setAttribute("class","mdc-list-item__secondary-text");l.setAttribute("id","rc-status-"+f.$jscomp$loop$prop$name$80);l.innerHTML="disconnected";g.appendChild(l);h.appendChild(g);h.addEventListener("click",function(k){return function(){var m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return"things_webBluetooth"!=k.$jscomp$loop$prop$type$79?
("things_webHID"==k.$jscomp$loop$prop$type$79&&(m=[],navigator.hid.requestDevice({filters:m}).then(function(q){0===q.length&&module$contents$Blast$Interpreter_throwError("Connection failed or cancelled by User.");var r=Date.now().toString(36)+Math.random().toString(36).substr(2);module$contents$Blast$Things_addWebHidDevice(r,k.$jscomp$loop$prop$name$80,q[0]);document.getElementById("rc-status-"+k.$jscomp$loop$prop$name$80).innerHTML="connected";document.getElementById("rc-icon-"+k.$jscomp$loop$prop$name$80).innerHTML=
...
module$contents$Blast$Interpreter_asyncApiFunctions.push(["switchLights",module$contents$Blast$generators$ble_rgb_led_controller_switchLights]);var module$exports$Blast$blocks$blast={};
...
var module$contents$Blast$generators$blast_sendHttpRequest=function(a,b,c,d,f,h){var g,l,k,m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return null!=a&&void 0!=a&&""!=a||module$contents$Blast$Interpreter_throwError("URI input of HttpRequest blocks must not be empty"),g=JSON.parse(c),l={method:b,headers:new Headers(g)},"GET"!==b&&d&&(l.body=d),p.setCatchFinallyBlocks(2),p.yield(fetch(a,l),4);case 4:return k=p.yieldResult,k.ok?"status"==f?(h(k.status),
p.return()):p.yield(k.text(),5):(module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+k.status+" "+k.statusText),p.return());case 5:m=p.yieldResult;h(m);p.leaveTryBlock(0);break;case 2:n=p.enterCatchBlock(),module$contents$Blast$Interpreter_throwError("Failed to get "+a+", Error: "+n.message),p.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["sendHttpRequest",module$contents$Blast$generators$blast_sendHttpRequest]);
...
var module$contents$Blast$generators$blast_playAudio=function(a,b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(new Promise(function(d,f){var h=new Audio(a);h.preload="auto";h.autoplay=!0;h.onerror=function(g){module$contents$Blast$Interpreter_throwError("Error trying to play audio from \n"+a+"\n See console for details");console.error(g);f(g)};h.onended=d}),2);b();c.jumpToEnd()})};
...
b(m.rssi);n.jumpToEnd()})});return k.yield(d.watchAdvertisements({signal:l.signal}),0)})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["getRSSIWb",module$contents$Blast$generators$blast_getRSSIWb]);
...
var module$contents$Blast$generators$blast_writeEddystoneProperty=function(a,b,c,d,f,h){return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return a?null===b||void 0===b?(module$contents$Blast$Interpreter_throwError("No slot set."),h(),g.return()):c?g.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(module$contents$Blast$Interpreter_throwError("No property set."),h(),g.return()):(module$contents$Blast$Interpreter_throwError("No bluetooth device set."),
h(),g.return());case 2:switch(c){case "advertisedTxPower":return g.jumpTo(3);case "advertisementData":return g.jumpTo(4);case "advertisingInterval":return g.jumpTo(5);case "radioTxPower":return g.jumpTo(6)}g.jumpTo(7);break;case 3:return g.yield(Blast.Bluetooth.Eddystone.setAdvertisedTxPower(a,f),8);case 8:g.jumpTo(7);break;case 4:return g.yield(Blast.Bluetooth.Eddystone.setAdvertisingData(a,d,f),9);case 9:g.jumpTo(7);break;case 5:return g.yield(Blast.Bluetooth.Eddystone.setAdvertisingInterval(a,
f),10);case 10:g.jumpTo(7);break;case 6:return g.yield(Blast.Bluetooth.Eddystone.setTxPowerLevel(a,f),11);case 11:g.jumpTo(7);break;case 7:h(),g.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["writeEddystoneProperty",module$contents$Blast$generators$blast_writeEddystoneProperty]);
...
var module$contents$Blast$generators$blast_readEddystoneProperty=function(a,b,c,d){var f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return a?null===b||void 0===b?(module$contents$Blast$Interpreter_throwError("No slot set."),d(),h.return()):c?h.yield(Blast.Bluetooth.Eddystone.setActiveSlot(a,b),2):(module$contents$Blast$Interpreter_throwError("No property set."),d(),h.return()):(module$contents$Blast$Interpreter_throwError("No bluetooth device set."),
d(),h.return());case 2:f=null;switch(c){case "advertisedTxPower":return h.jumpTo(3);case "advertisementData":return h.jumpTo(4);case "advertisingInterval":return h.jumpTo(5);case "lockState":return h.jumpTo(6);case "publicECDHKey":return h.jumpTo(7);case "radioTxPower":return h.jumpTo(8)}h.jumpTo(9);break;case 3:return h.yield(Blast.Bluetooth.Eddystone.getAdvertisedTxPower(a),10);case 10:f=h.yieldResult;h.jumpTo(9);break;case 4:return h.yield(Blast.Bluetooth.Eddystone.getAdvertisingData(a),11);case 11:f=
h.yieldResult;h.jumpTo(9);break;case 5:return h.yield(Blast.Bluetooth.Eddystone.getAdvertisingInterval(a),12);case 12:f=h.yieldResult;h.jumpTo(9);break;case 6:return h.yield(Blast.Bluetooth.Eddystone.getLockState(a),13);case 13:f=h.yieldResult;h.jumpTo(9);break;case 7:return h.yield(Blast.Bluetooth.Eddystone.getPublicECDHKey(a),14);case 14:f=h.yieldResult;h.jumpTo(9);break;case 8:return h.yield(Blast.Bluetooth.Eddystone.getTxPowerLevel(a),15);case 15:f=h.yieldResult;h.jumpTo(9);break;case 9:d(f),
h.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["readEddystoneProperty",module$contents$Blast$generators$blast_readEddystoneProperty]);var module$exports$Blast$blocks$blinkstick={};
...
var readJoyConProperty=function(a,b,c,d,f,h){var g,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:if(!a)return module$contents$Blast$Interpreter_throwError("No Joy-Con block set."),h(),m.return();g=module$contents$Blast$Things_getWebHidDevice(a);if(!g)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),h(),m.return();if(g.opened){m.jumpTo(2);break}m.setCatchFinallyBlocks(3);
...
var handleJoyConButtons=function(a,b,c,d){var f,h,g,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:if(!a)return module$contents$Blast$Interpreter_throwError("No Joy-Con block set."),d(),k.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the JoyCon via webHID"),d(),k.return();if(f.opened){k.jumpTo(2);break}k.setCatchFinallyBlocks(3);
...
var module$contents$Blast$generators$ruuvi_tag_getRuuviProperty=function(a,b,c){var d,f,h,g,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return d=function(n){var p={},q=n[0]&255,r=n[1]<<8|n[2]&255;32767<r&&(r-=65535);var t=((n[3]&255)<<8|n[4]&255)/400,v=((n[5]&255)<<8|n[6]&255)+5E4,w=(n[7]<<8|n[8]&255)/1E3,u=(n[9]<<8|n[10]&255)/1E3,y=(n[11]<<8|n[12]&255)/1E3,x=(n[13]&255)<<8|n[14]&255,z=n[15]&255;n=(n[16]&255)<<8|n[17]&255;p.destination_endpoint=q;p.temperature=
...
m.yield(f(0),2);(h=m.yieldResult)||module$contents$Blast$Interpreter_throwError("Timed out. No BLE advertising data found for "+b);g=[];for(l=0;l<h.byteLength;l++)g.push("0x"+("00"+h.getUint8(l).toString(16)).slice(-2));k=d(g);c(k[a]);m.jumpToEnd()})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["getRuuviProperty",module$contents$Blast$generators$ruuvi_tag_getRuuviProperty]);var module$exports$Blast$blocks$streamdeck={};
...
module$contents$Blast$Toolbox_addBlock("streamdeck_set_brightness","Properties",module$contents$Blast$blocks$streamdeck_STREAMDECK_SET_BRIGHTNESS_XML);var module$exports$Blast$generators$streamdeck={};
...
var module$contents$Blast$generators$streamdeck_handleStreamdeck=function(a,b,c,d){var f,h,g,l,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),m.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),m.return();
m.setCatchFinallyBlocks(2);return m.yield(StreamDeck.openDevice(f),4);case 4:h=m.yieldResult;m.leaveTryBlock(3);break;case 2:g=m.enterCatchBlock();if("InvalidStateError"!=g.name)return module$contents$Blast$Interpreter_throwError(g),m.return();f.close();return m.yield(StreamDeck.openDevice(f),6);case 6:h=m.yieldResult;case 3:for(k=0;k<b.length;k++)if("1"===b.charAt(k)){l=k;break}if(void 0===l)return m.return();h.on(c,function(n){module$contents$Blast$Ui_addToLog("Received <code>"+c+"</code> event on button <code>"+
n+"</code>","hid",f.productName);if(n===l){module$contents$Blast$Interpreter_setInterrupted(!0);var p=new Interpreter("");p.stateStack[0].scope=module$contents$Blast$Interpreter_getInterpreter().globalScope;p.appendCode(d);var q=function(){try{p.step()?setTimeout(q,5):module$contents$Blast$Interpreter_setInterrupted(!1)}catch(r){module$contents$Blast$Interpreter_throwError("Error executing program:\n "+e),console.error(r)}};q()}});module$contents$Blast$Interpreter_addCleanUpFunction(function(){module$contents$Blast$Ui_addToLog("Removing all listeners",
"hid",f.productName);h.close();h.removeAllListeners()});m.jumpToEnd()}})};module$contents$Blast$Interpreter_apiFunctions.push(["handleStreamdeck",module$contents$Blast$generators$streamdeck_handleStreamdeck]);
...
var module$contents$Blast$generators$streamdeck_streamdeckWriteOnButtons=function(a,b,c,d){var f,h,g,l,k,m,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),d(),q.return();f=module$contents$Blast$Things_getWebHidDevice(a);if(!f)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),d(),
q.return();q.setCatchFinallyBlocks(2);return q.yield(StreamDeck.openDevice(f),4);case 4:h=q.yieldResult;q.leaveTryBlock(3);break;case 2:g=q.enterCatchBlock();if("InvalidStateError"!=g.name)return module$contents$Blast$Interpreter_throwError(g),d(),q.return();f.close();return q.yield(StreamDeck.openDevice(f),6);case 6:h=q.yieldResult;case 3:l=[];k=document.createElement("canvas");k.width=h.ICON_SIZE;k.height=h.ICON_SIZE;m=k.getContext("2d");m.save();m.clearRect(0,0,k.width,k.height);m.font=.8*k.height+
"px Arial";m.strokeStyle="blue";m.lineWidth=1;m.strokeText(c.toString(),8,60,.8*k.width);m.fillStyle="white";m.fillText(c.toString(),8,60,.8*k.width);n=m.getImageData(0,0,k.width,k.height);for(p=0;p<b.length;p++)"1"===b.charAt(p)&&(module$contents$Blast$Ui_addToLog("Invoke <code>fillKeyImageData</code> with value <code>"+[p,n].toString()+"</code>","hid",f.productName),l.push(h.fillKeyBuffer(p,buffer.Buffer.from(n.data),{format:"rgba"})),module$contents$Blast$Ui_addToLog("Finished <code>fillKeyImageData</code>",
"hid",f.productName));m.restore();return q.yield(Promise.all(l),7);case 7:d(),q.jumpToEnd()}})};module$contents$Blast$Interpreter_asyncApiFunctions.push(["streamdeckWriteOnButtons",module$contents$Blast$generators$streamdeck_streamdeckWriteOnButtons]);
...
var module$contents$Blast$generators$streamdeck_streamdeckSetBrightness=function(a,b,c){var d,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:if(null===a)return module$contents$Blast$Interpreter_throwError("No streamdeck block set."),c(),g.return();if(1>b||100<b)return module$contents$Blast$Interpreter_throwError("Brightness must be between 1 and 100."),c(),g.return();d=module$contents$Blast$Things_getWebHidDevice(a);if(!d)return module$contents$Blast$Interpreter_throwError("Connected device is not a HID device.\nMake sure you are connecting the Streamdeck via webHID"),
...
var module$contents$Blast$generators$web_speech_webSpeech=function(a,b){var c,d,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){c=module$contents$Blast$Interpreter_getWorkspace().getBlockById(a);d=c.recognition;d.continuous=!1;d.lang="en-US";f="";d.onresult=function(g){for(var l=g.resultIndex;l<g.results.length;++l)g.results[l].isFinal&&(f+=g.results[l][0].transcript)};d.onend=function(){b(f)};d.start();h.jumpToEnd()})};
...
var module$contents$Blast$generators$xiamoi_thermometer_readMijiaProperty=function(a,b,c){b?Blast.Bluetooth.gatt_subscribe(b,module$contents$Blast$generators$xiamoi_thermometer_XiaomiServiceUUID,"ebe0ccc1-7a0a-4b0c-8a1a-6ff2997da3a6",function(d){var f=d.target.value,h=f.getUint8(1)&128;d=(f.getUint8(1)&127)<<8|f.getUint8(0);h&&(d-=32767);d/=100;f=f.getUint8(2);"temperature"===a?c(d):"humidity"===a&&c(f)}):(module$contents$Blast$Interpreter_throwError("No Thermometer is set."),c())};
